...
box_mesh.py $mesh -c hex8 -x $N -y $N -z $N --height=$SFEM_BOX_SIZE --width=$SFEM_BOX_SIZE --depth=$SFEM_BOX_SIZE $BOX_MESH_EXTRA_OPTIONS
...
boundary_nodes()
{
	...
	echo "- i0: i0.int32.raw" >>  $mesh/$name/meta.yaml
	echo "- i1: i1.int32.raw" >>  $mesh/$name/meta.yaml
	echo "- i2: i2.int32.raw" >>  $mesh/$name/meta.yaml
	echo "- i3: i3.int32.raw" >>  $mesh/$name/meta.yaml
