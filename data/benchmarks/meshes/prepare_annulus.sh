...
if (($# != 1))
then
	printf "usage: $0 <annulus_mesh.vtk>\n" 1>&2
	exit -1
fi
...
db_to_raw.py $mesh_db $mesh_raw --select_elem_type=tetra
$LAUNCH skin $mesh_raw $mesh_surface

$LAUNCH select_surf $mesh_surface  1.5  0 	0.5 0.99	$mesh_surface/sides_inlet.raw
$LAUNCH select_surf $mesh_surface  0 	1.5 0.5	0.99	$mesh_surface/sides_outlet.raw
