...
// int build_n2e_for_elem_type(const smesh::ElemType element_type,
...
//                             element_idx_t     **out_elindex) {
//     // TODO (maybe)
//     if (element_type != smesh::MACRO_TET4 /*&& element_type != smesh::MACRO_TRI3*/) {
...
//     if (element_type == smesh::MACRO_TET4) {
...
//         build_n2e(n_elements, n_nodes, elem_num_nodes(smesh::TET4), elems, &n2eptr, &elindex);
//     } else {
