...
SFEM_DEVICE_KERNEL void Tri3_jacobian_kernel(
...
SFEM_DEVICE_KERNEL void Tri3_jacobian_inverse_kernel(
const ptrdiff_t nelements,
const geom_t *const SFEM_RESTRICT xyz,
real_t *const SFEM_RESTRICT jacobian) 
{
...
static void Tri3_pack_elements
(
    const ptrdiff_t n,
...
{
    SFEM_RANGE_PUSH("Tri3_pack_elements");
    {
