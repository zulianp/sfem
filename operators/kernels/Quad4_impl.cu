...
SFEM_DEVICE_KERNEL void Quad4_jacobian_kernel(
...
SFEM_DEVICE_KERNEL void Quad4_jacobian_inverse_kernel(
const ptrdiff_t nelements,
const geom_t *const SFEM_RESTRICT xyz,
real_t *const SFEM_RESTRICT jacobian) 
{
...
static void Quad4_pack_elements
(
    const ptrdiff_t n,
...
{
    SFEM_RANGE_PUSH("Quad4_pack_elements");
    {
