...
SFEM_DEVICE_KERNEL void Tet4_jacobian_kernel(
...
SFEM_DEVICE_KERNEL void Tet4_jacobian_inverse_kernel(
const ptrdiff_t nelements,
const geom_t *const SFEM_RESTRICT xyz,
real_t *const SFEM_RESTRICT jacobian)
{
...
static void Tet4_host_pack_elements
(
const ptrdiff_t n,
...
{
    SFEM_NVTX_SCOPE("Tet4_host_pack_elements");
    {
...
static void Tet4_host_pack_vector
(
const ptrdiff_t n,
const ptrdiff_t element_offset,
idx_t **const SFEM_RESTRICT elems,
...
{
    SFEM_NVTX_SCOPE("Tet4_host_pack_vector");
    {
...
template <typename T>
SFEM_DEVICE_KERNEL void Tet4_pack_kernel(
const ptrdiff_t nelements,
...
SFEM_DEVICE_FUNCTION int Tet4_linear_search
(
const idx_t target,
...
SFEM_DEVICE_FUNCTION int Tet4_find_col
(
const idx_t key,
...
SFEM_DEVICE_FUNCTION void Tet4_find_cols
(
const idx_t *targets,
const idx_t *const row,
const int lenrow,
...
SFEM_DEVICE_KERNEL void Tet4_vector_local_to_global_kernel
(
const ptrdiff_t nelements,
idx_t **const SFEM_RESTRICT elems,
...
SFEM_DEVICE_KERNEL void Tet4_block_vector_local_to_global_kernel
(
const ptrdiff_t nelements,
idx_t **const SFEM_RESTRICT elems,
const int stride_element_vector,
...
SFEM_DEVICE_KERNEL void Tet4_matrix_local_to_global_kernel
(
const ptrdiff_t nelements,
idx_t **const SFEM_RESTRICT elems,
...
SFEM_DEVICE_KERNEL void Tet4_block_matrix_local_to_global_kernel
(
const ptrdiff_t nelements,
idx_t **const SFEM_RESTRICT elems,
const int stride_element_matrix,
