#ifndef CU_PROTEUS_HEX8_LINEAR_ELASTICITY_H
#define CU_PROTEUS_HEX8_LINEAR_ELASTICITY_H
...
int cu_proteus_affine_hex8_linear_elasticity_apply(
        const int level,
...
#endif
#endif  // CU_PROTEUS_HEX8_LINEAR_ELASTICITY_H
