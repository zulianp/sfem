...
ptrdiff_t max_node_id(const smesh::ElemType type,
...
int hierarchical_prolongation(const smesh::ElemType from_element,
                              const smesh::ElemType to_element,
                              const ptrdiff_t nelements,
                              idx_t **const SFEM_RESTRICT elements,
                              const int vec_size,
                              const real_t *const SFEM_RESTRICT from,
                              real_t *const SFEM_RESTRICT to) {
    if (from_element == smesh::TET4 && (to_element == smesh::TET10 || to_element == smesh::MACRO_TET4)) {
#pragma omp parallel for
    ...
    } else if (from_element == smesh::TRI3 && (to_element == smesh::TRI6 || to_element == smesh::MACRO_TRI3)) {
#pragma omp parallel for
        for (ptrdiff_t e = 0; e < nelements; e++) {
            // P1
            const idx_t i0 = elements[0][e];
...
int hierarchical_restriction_with_counting(const smesh::ElemType from_element,
                                           const smesh::ElemType to_element,
                                           const ptrdiff_t nelements,
                                           idx_t **const SFEM_RESTRICT elements,
                                           ...
                                           const real_t *const SFEM_RESTRICT from,
                                           real_t *const SFEM_RESTRICT to) {
    if (to_element == smesh::TET4 && (from_element == smesh::TET10 || from_element == smesh::MACRO_TET4)) {
#pragma omp parallel for
        for (ptrdiff_t e = 0; e < nelements; e++) {
            // P1
            const idx_t i0 = elements[0][e];
...
#pragma omp atomic update
    ...
    } else if (to_element == smesh::TRI3 && (from_element == smesh::TRI6 || from_element == smesh::MACRO_TRI3)) {
#pragma omp parallel for
        for (ptrdiff_t e = 0; e < nelements; e++) {
            // P1
            const idx_t i0 = elements[0][e];
