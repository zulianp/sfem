...
//     return linear_elasticity_assemble_apply_soa(
//             element_type, elements, nnodes, elements, points, mu, lambda, u, values);
// }
    ...
    switch (element_type) {
        case TRI3: {
            tri3_linear_elasticity_apply_soa(
                    nelements, nnodes, elements, points, mu, lambda, u, values);
            break;
        }
        case TET4: {
...
int linear_elasticity_apply_aos(const enum ElemType element_type,
    ...
    switch (element_type) {
        case TRI3: {
            tri3_linear_elasticity_apply_aos(
                    nelements, nnodes, elements, points, mu, lambda, u, values);
            break;
        }
        case TET4: {
        ...
        case MACRO_TET4: {
            macro_tet4_linear_elasticity_apply(nelements,
                                               nnodes,
                                               elements,
                                               points,
                                               mu,
        ...
        case TET10: {
            tet10_linear_elasticity_apply(nelements,
                                          nnodes,
                                          elements,
                                          points,
                                          mu,
