...
// FFF
static SFEM_INLINE void vtet4_laplacian_hessian_fff(const vec_t *const SFEM_RESTRICT fff,
...
static SFEM_INLINE void vtet4_laplacian_diag_fff(const vec_t *const SFEM_RESTRICT fff,
...
static SFEM_INLINE void vtet4_laplacian_diag_add_fff(const vec_t *const SFEM_RESTRICT fff,
                                                     vec_t *const SFEM_RESTRICT e0,
                                                     vec_t *const SFEM_RESTRICT e1,
                                                     vec_t *const SFEM_RESTRICT e2,
                                                     vec_t *const SFEM_RESTRICT e3) {
...
static SFEM_INLINE void vtet4_laplacian_apply_fff(const vec_t *const SFEM_RESTRICT fff,
                                                  const vec_t u0,
                                                  const vec_t u1,
                                                  const vec_t u2,
                                                  const vec_t u3,
...
static SFEM_INLINE void vtet4_laplacian_apply_add_fff(const vec_t *const SFEM_RESTRICT fff,
                                                      const vec_t u0,
                                                      const vec_t u1,
                                                      const vec_t u2,
                                                      const vec_t u3,
...
static SFEM_INLINE void vtet4_laplacian_apply_points(const vec_t px0,
                                                     const vec_t px1,
                                                     const vec_t px2,
                                                     const vec_t px3,
                                                     const vec_t py0,
                                                     ...
                                                     const vec_t pz2,
                                                     const vec_t pz3,
                                                     const vec_t *SFEM_RESTRICT u,
                                                     vec_t *SFEM_RESTRICT element_vector) {
    vec_t fff[6];
    ...
    const vec_t x1 = fff[1] + fff[3] + fff[4];
    const vec_t x2 = fff[2] + fff[4] + fff[5];
    const vec_t x3 = fff[1] * u[0];
    const vec_t x4 = fff[2] * u[0];
    const vec_t x5 = fff[4] * u[0];
...
// UNTESTED
static SFEM_INLINE void vtet4_laplacian_value_points(const vec_t px0,
                                                     const vec_t px1,
                                                     const vec_t px2,
                                                     const vec_t px3,
                                                     const vec_t py0,
                                                     ...
                                                     const vec_t pz3,
                                                     const vec_t *SFEM_RESTRICT u,
                                                     vec_t *SFEM_RESTRICT element_scalar) {
    vec_t fff[6];
    vtet4_fff(px0, px1, px2, px3, py0, py1, py2, py3, pz0, pz1, pz2, pz3, fff);
...
static SFEM_INLINE void vtet4_laplacian_hessian_points(const vec_t px0,
                                                       const vec_t px1,
                                                       const vec_t px2,
                                                       const vec_t px3,
                                                       const vec_t py0,
                                                       ...
                                                       const vec_t pz2,
                                                       const vec_t pz3,
                                                       vec_t *element_matrix) {
    vec_t fff[6];
    vtet4_fff(px0, px1, px2, px3, py0, py1, py2, py3, pz0, pz1, pz2, pz3, fff);
    vtet4_laplacian_hessian_fff(fff, element_matrix);
}

static SFEM_INLINE void vtet4_laplacian_diag_points(const vec_t px0,
                                                    const vec_t px1,
                                                    const vec_t px2,
                                                    const vec_t px3,
                                                    const vec_t py0,
