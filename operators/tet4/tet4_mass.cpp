...
static SFEM_INLINE void tet4_mass_kernel(const real_t x0, const real_t x1, const real_t x2, const real_t x3, const real_t y0,
                                         const real_t y1, const real_t y2, const real_t y3, const real_t z0, const real_t z1,
                                         const real_t z2, const real_t z3, real_t *element_matrix) {
    // FLOATING POINT OPS!
...
/**
 * @brief Assemble the mass matrix for smesh::TET4 elements
 *
 * @param nelements
 * @param nnodes
 * @param elems
...
/**
 * @brief Assemble the lumped mass matrix for smesh::TET4 elements
 *
 * @param nelements
 * @param nnodes
 * @param elems
...
void tet4_apply_inv_lumped_mass(const ptrdiff_t nelements, const ptrdiff_t nnodes, idx_t **const SFEM_RESTRICT elems,
                                geom_t **const SFEM_RESTRICT xyz, const real_t *const x, real_t *const values) {
    real_t *buff = 0;
    if (x == values) {
