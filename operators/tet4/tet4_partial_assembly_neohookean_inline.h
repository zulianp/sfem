...
static SFEM_INLINE void tet4_S_ikmn(const scalar_t *const SFEM_RESTRICT adjugate,
    ...
    S_ikmn[1]          = x3 * (adjugate[3] * x0 + adjugate[4] * x1 + adjugate[5] * x2);
    S_ikmn[2]          = x3 * (adjugate[6] * x0 + adjugate[7] * x1 + adjugate[8] * x2);
    S_ikmn[3]          = x3 * (adjugate[0] * x4 + adjugate[1] * x5 + adjugate[2] * x6);
    S_ikmn[4]          = x3 * (adjugate[3] * x4 + adjugate[4] * x5 + adjugate[5] * x6);
    S_ikmn[5]          = x3 * (adjugate[6] * x4 + adjugate[7] * x5 + adjugate[8] * x6);
    S_ikmn[6]          = x3 * (adjugate[0] * x7 + adjugate[1] * x8 + adjugate[2] * x9);
    S_ikmn[7]          = x3 * (adjugate[3] * x7 + adjugate[4] * x8 + adjugate[5] * x9);
    S_ikmn[8]          = x3 * (adjugate[6] * x7 + adjugate[7] * x8 + adjugate[8] * x9);
    S_ikmn[9]          = x3 * (adjugate[0] * x10 + adjugate[1] * x11 + adjugate[2] * x12);
    S_ikmn[10]         = x3 * (adjugate[3] * x10 + adjugate[4] * x11 + adjugate[5] * x12);
    S_ikmn[11]         = x3 * (adjugate[6] * x10 + adjugate[7] * x11 + adjugate[8] * x12);
    S_ikmn[12]         = x3 * (adjugate[0] * x13 + adjugate[1] * x14 + adjugate[2] * x15);
    S_ikmn[13]         = x3 * (adjugate[3] * x13 + adjugate[4] * x14 + adjugate[5] * x15);
    S_ikmn[14]         = x3 * (adjugate[6] * x13 + adjugate[7] * x14 + adjugate[8] * x15);
    S_ikmn[15]         = x3 * (adjugate[0] * x16 + adjugate[1] * x17 + adjugate[2] * x18);
    S_ikmn[16]         = x3 * (adjugate[3] * x16 + adjugate[4] * x17 + adjugate[5] * x18);
    S_ikmn[17]         = x3 * (adjugate[6] * x16 + adjugate[7] * x17 + adjugate[8] * x18);
    S_ikmn[18]         = x3 * (adjugate[0] * x19 + adjugate[1] * x20 + adjugate[2] * x21);
    S_ikmn[19]         = x3 * (adjugate[3] * x19 + adjugate[4] * x20 + adjugate[5] * x21);
    S_ikmn[20]         = x3 * (adjugate[6] * x19 + adjugate[7] * x20 + adjugate[8] * x21);
    S_ikmn[21]         = x3 * (adjugate[0] * x22 + adjugate[1] * x23 + adjugate[2] * x24);
    S_ikmn[22]         = x3 * (adjugate[3] * x22 + adjugate[4] * x23 + adjugate[5] * x24);
    S_ikmn[23]         = x3 * (adjugate[6] * x22 + adjugate[7] * x23 + adjugate[8] * x24);
    S_ikmn[24]         = x3 * (adjugate[0] * x25 + adjugate[1] * x26 + adjugate[2] * x27);
    S_ikmn[25]         = x3 * (adjugate[3] * x25 + adjugate[4] * x26 + adjugate[5] * x27);
    S_ikmn[26]         = x3 * (adjugate[6] * x25 + adjugate[7] * x26 + adjugate[8] * x27);
    S_ikmn[27]         = x3 * (adjugate[0] * x28 + adjugate[1] * x29 + adjugate[2] * x30);
    S_ikmn[28]         = x3 * (adjugate[3] * x28 + adjugate[4] * x29 + adjugate[5] * x30);
    S_ikmn[29]         = x3 * (adjugate[6] * x28 + adjugate[7] * x29 + adjugate[8] * x30);
    S_ikmn[30]         = x3 * (adjugate[0] * x31 + adjugate[1] * x32 + adjugate[2] * x33);
    S_ikmn[31]         = x3 * (adjugate[3] * x31 + adjugate[4] * x32 + adjugate[5] * x33);
    S_ikmn[32]         = x3 * (adjugate[6] * x31 + adjugate[7] * x32 + adjugate[8] * x33);
    S_ikmn[33]         = x3 * (adjugate[0] * x34 + adjugate[1] * x35 + adjugate[2] * x36);
    S_ikmn[34]         = x3 * (adjugate[3] * x34 + adjugate[4] * x35 + adjugate[5] * x36);
    S_ikmn[35]         = x3 * (adjugate[6] * x34 + adjugate[7] * x35 + adjugate[8] * x36);
    S_ikmn[36]         = x3 * (adjugate[0] * x37 + adjugate[1] * x38 + adjugate[2] * x39);
    S_ikmn[37]         = x3 * (adjugate[3] * x37 + adjugate[4] * x38 + adjugate[5] * x39);
    S_ikmn[38]         = x3 * (adjugate[6] * x37 + adjugate[7] * x38 + adjugate[8] * x39);
    S_ikmn[39]         = x3 * (adjugate[0] * x40 + adjugate[1] * x41 + adjugate[2] * x42);
    S_ikmn[40]         = x3 * (adjugate[3] * x40 + adjugate[4] * x41 + adjugate[5] * x42);
    S_ikmn[41]         = x3 * (adjugate[6] * x40 + adjugate[7] * x41 + adjugate[8] * x42);
    S_ikmn[42]         = x3 * (adjugate[0] * x43 + adjugate[1] * x44 + adjugate[2] * x45);
    S_ikmn[43]         = x3 * (adjugate[3] * x43 + adjugate[4] * x44 + adjugate[5] * x45);
    S_ikmn[44]         = x3 * (adjugate[6] * x43 + adjugate[7] * x44 + adjugate[8] * x45);
    S_ikmn[45]         = x3 * (adjugate[0] * x46 + adjugate[1] * x47 + adjugate[2] * x48);
    S_ikmn[46]         = x3 * (adjugate[3] * x46 + adjugate[4] * x47 + adjugate[5] * x48);
    S_ikmn[47]         = x3 * (adjugate[6] * x46 + adjugate[7] * x47 + adjugate[8] * x48);
    S_ikmn[48]         = x3 * (adjugate[0] * x49 + adjugate[1] * x50 + adjugate[2] * x51);
    S_ikmn[49]         = x3 * (adjugate[3] * x49 + adjugate[4] * x50 + adjugate[5] * x51);
    S_ikmn[50]         = x3 * (adjugate[6] * x49 + adjugate[7] * x50 + adjugate[8] * x51);
    S_ikmn[51]         = x3 * (adjugate[0] * x52 + adjugate[1] * x53 + adjugate[2] * x54);
    S_ikmn[52]         = x3 * (adjugate[3] * x52 + adjugate[4] * x53 + adjugate[5] * x54);
    S_ikmn[53]         = x3 * (adjugate[6] * x52 + adjugate[7] * x53 + adjugate[8] * x54);
    S_ikmn[54]         = x3 * (adjugate[0] * x55 + adjugate[1] * x56 + adjugate[2] * x57);
    S_ikmn[55]         = x3 * (adjugate[3] * x55 + adjugate[4] * x56 + adjugate[5] * x57);
    S_ikmn[56]         = x3 * (adjugate[6] * x55 + adjugate[7] * x56 + adjugate[8] * x57);
    S_ikmn[57]         = x3 * (adjugate[0] * x58 + adjugate[1] * x59 + adjugate[2] * x60);
    S_ikmn[58]         = x3 * (adjugate[3] * x58 + adjugate[4] * x59 + adjugate[5] * x60);
    S_ikmn[59]         = x3 * (adjugate[6] * x58 + adjugate[7] * x59 + adjugate[8] * x60);
    S_ikmn[60]         = x3 * (adjugate[0] * x61 + adjugate[1] * x62 + adjugate[2] * x63);
    S_ikmn[61]         = x3 * (adjugate[3] * x61 + adjugate[4] * x62 + adjugate[5] * x63);
    S_ikmn[62]         = x3 * (adjugate[6] * x61 + adjugate[7] * x62 + adjugate[8] * x63);
    S_ikmn[63]         = x3 * (adjugate[0] * x64 + adjugate[1] * x65 + adjugate[2] * x66);
    S_ikmn[64]         = x3 * (adjugate[3] * x64 + adjugate[4] * x65 + adjugate[5] * x66);
    S_ikmn[65]         = x3 * (adjugate[6] * x64 + adjugate[7] * x65 + adjugate[8] * x66);
    S_ikmn[66]         = x3 * (adjugate[0] * x67 + adjugate[1] * x68 + adjugate[2] * x69);
    S_ikmn[67]         = x3 * (adjugate[3] * x67 + adjugate[4] * x68 + adjugate[5] * x69);
    S_ikmn[68]         = x3 * (adjugate[6] * x67 + adjugate[7] * x68 + adjugate[8] * x69);
    S_ikmn[69]         = x3 * (adjugate[0] * x70 + adjugate[1] * x71 + adjugate[2] * x72);
    S_ikmn[70]         = x3 * (adjugate[3] * x70 + adjugate[4] * x71 + adjugate[5] * x72);
    S_ikmn[71]         = x3 * (adjugate[6] * x70 + adjugate[7] * x71 + adjugate[8] * x72);
    S_ikmn[72]         = x3 * (adjugate[0] * x73 + adjugate[1] * x74 + adjugate[2] * x75);
    S_ikmn[73]         = x3 * (adjugate[3] * x73 + adjugate[4] * x74 + adjugate[5] * x75);
    S_ikmn[74]         = x3 * (adjugate[6] * x73 + adjugate[7] * x74 + adjugate[8] * x75);
    S_ikmn[75]         = x3 * (adjugate[0] * x76 + adjugate[1] * x77 + adjugate[2] * x78);
    S_ikmn[76]         = x3 * (adjugate[3] * x76 + adjugate[4] * x77 + adjugate[5] * x78);
    S_ikmn[77]         = x3 * (adjugate[6] * x76 + adjugate[7] * x77 + adjugate[8] * x78);
    S_ikmn[78]         = x3 * (adjugate[0] * x79 + adjugate[1] * x80 + adjugate[2] * x81);
    S_ikmn[79]         = x3 * (adjugate[3] * x79 + adjugate[4] * x80 + adjugate[5] * x81);
