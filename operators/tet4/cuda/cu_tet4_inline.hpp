...
static inline __device__ __host__ void cu_tet4_adjugate_and_det(const geom_t                    px0,
                                                                const geom_t                    px1,
                                                                const geom_t                    px2,
                                                                const geom_t                    px3,
                                                                const geom_t                    py0,
                                                                ...
                                                                jacobian_determinant_t *const SFEM_RESTRICT
...
static inline __device__ __host__ void cu_tet4_fff(const geom_t    px0,
    ...
    const geom_t x20 = -(geom_t)(1.0 / 6.0) * x12 + (geom_t)(1.0 / 6.0) * x15 + (geom_t)(1.0 / 6.0) * x17 -
                       (geom_t)(1.0 / 6.0) * x19 + (geom_t)(1.0 / 6.0) * x4 - (geom_t)(1.0 / 6.0) * x8;
...
static inline __device__ __host__ idx_t cu_tet4_linear_search(const idx_t target, const idx_t *const arr, const int size) {
    idx_t i;
...
template <typename idx_t>
static inline __device__ __host__ idx_t cu_tet4_find_col(const idx_t key, const idx_t *const row, const int lenrow) {
...
static inline __device__ __host__ void cu_tet4_local_to_global(const idx_t *const SFEM_RESTRICT         ev,
