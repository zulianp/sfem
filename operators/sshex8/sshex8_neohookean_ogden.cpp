...
#pragma omp parallel
    {
        ...
        scalar_t *x = (scalar_t *)malloc(8 * sizeof(scalar_t));
        scalar_t *y = (scalar_t *)malloc(8 * sizeof(scalar_t));
        scalar_t *z = (scalar_t *)malloc(8 * sizeof(scalar_t));
        scalar_t *out_local = (scalar_t *)calloc(nsteps, sizeof(scalar_t));
        scalar_t *eu[3];
        scalar_t *einc[3];
        for (int d = 0; d < 3; d++) {
            eu[d]   = (scalar_t *)malloc(nxe * sizeof(scalar_t));
            einc[d] = (scalar_t *)malloc(nxe * sizeof(scalar_t));
        }
...
#pragma omp parallel
    {
        ...
        scalar_t *v[3];
        for (int d = 0; d < 3; d++) {
            eh[d] = (scalar_t *)malloc(nxe * sizeof(scalar_t));
            v[d]  = (accumulator_t *)malloc(nxe * sizeof(scalar_t));
        }
