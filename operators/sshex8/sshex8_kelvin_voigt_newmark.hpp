...
/// Per macro element: Jacobian adjugate (9) and determinant at reference hex center, from 8 macro corners.
...
/// Adjugate-based: uses precomputed macro-element adjugate / det (same layout as @c hex8_adjugate_and_det_fill).
int affine_sshex8_kelvin_voigt_newmark_apply_adjugate(
        const int                               level,
        const ptrdiff_t                         nelements,
...
int affine_sshex8_kelvin_voigt_newmark_gradient_adjugate(
        const int                               level,
        const ptrdiff_t                         nelements,
        const ptrdiff_t                         nnodes,
        idx_t **const SFEM_RESTRICT             elements,
...
/// Isoparametric: forms macro adjugate from nodal coordinates (reference-point evaluation).
