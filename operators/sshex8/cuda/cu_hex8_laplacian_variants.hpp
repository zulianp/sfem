...
__global__ void cu_affine_sshex8_laplacian_apply_volgen_kernel(
...
#define CU_SSHEX8_USE_ELEMENTAL_MATRIX
#ifdef CU_SSHEX8_USE_ELEMENTAL_MATRIX
    ...
    for (ptrdiff_t e = blockIdx.x * blockDim.x + threadIdx.x; e < nelements;
        ...
        // Scatter
        cu_sshex8_scatter_add<real_t, LEVEL>(
                nelements, stride, interior_start, e, elements, y_block, 1, y);
    }
}

template <typename T, int LEVEL>
static int cu_affine_sshex8_laplacian_apply_volgen_tpl(
        const ptrdiff_t nelements,
        const ptrdiff_t stride,  // Stride for elements and fff
...
#ifdef SFEM_USE_OCCUPANCY_MAX_POTENTIAL
    {
        ...
        cudaOccupancyMaxPotentialBlockSize(
                &min_grid_size,
                &block_size,
                cu_affine_sshex8_laplacian_apply_volgen_kernel<T, LEVEL>,
                0,
                0);
    }
