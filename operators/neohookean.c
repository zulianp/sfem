...
// static SFEM_INLINE void neohookean_principal_stresses()
// {
//     //FLOATING POINT OPS!
...
//     const real_t x29 = x11 - x16;
//     const real_t x30 = -x29;
//     const real_t x31 = u[3]*x17;
//     const real_t x32 = -x13 + x14;
//     const real_t x33 = u[6]*x17;
//     const real_t x34 = -x15 + x8;
//     const real_t x35 = -x34;
//     const real_t x36 = u[9]*x17;
//     const real_t x37 = x13 - x14 + x29 + x34;
//     const real_t x38 = u[0]*x17;
//     const real_t x39 = x30*x31 + x32*x33 + x35*x36 + x37*x38;
//     const real_t x40 = x1*x7 - x3*x9;
//     const real_t x41 = u[11]*x17;
//     const real_t x42 = -x1*x12 + x6*x9;
//     const real_t x43 = u[5]*x17;
//     const real_t x44 = x6*x7;
//     const real_t x45 = x12*x3;
...
//     const real_t x51 = x31*x42 + x33*x46 + x36*x40 + x38*x48;
//     const real_t x52 = x30*x43 + x32*x47 + x35*x41 + x37*x49 + 1;
//     const real_t x53 = x39*x50 - x51*x52;
//     const real_t x54 = x28*x50;
//     const real_t x55 = x18*x35 + x21*x30 + x25*x32 + x27*x37;
//     const real_t x56 = x20*x43 + x24*x47 + x26*x49 + x41*x5;
//     const real_t x57 = x55*x56;
//     const real_t x58 = x18*x40 + x21*x42 + x25*x46 + x27*x48 + 1;
//     const real_t x59 = x56*x58;
//     const real_t x60 = x28*x52;
//     const real_t x61 = x20*x31 + x24*x33 + x26*x38 + x36*x5 + 1;
//     const real_t x62 = x50*x55;
//     const real_t x63 = x39*x54 - x39*x59 + x51*x57 - x51*x60 + x52*x58*x61 - x61*x62;
//     const real_t x64 = 1.0/x63;
//     const real_t x65 = mu*x64;
//     const real_t x66 = lambda*x64*log(x63);
//     const real_t x67 = mu*x28 - x53*x65 + x53*x66;
//     const real_t x68 = -x50*x61 + x51*x56;
//     const real_t x69 = mu*x55 - x65*x68 + x66*x68;
//     const real_t x70 = -x39*x56 + x52*x61;
//     const real_t x71 = mu*x58 - x65*x70 + x66*x70;
//     const real_t x72 = x28*x67 + x55*x69 + x58*x71;
//     const real_t x73 = x57 - x60;
//     const real_t x74 = mu*x51 - x65*x73 + x66*x73;
//     const real_t x75 = x54 - x59;
//     const real_t x76 = mu*x39 - x65*x75 + x66*x75;
//     const real_t x77 = x52*x58 - x62;
//     const real_t x78 = mu*x61 - x65*x77 + x66*x77;
//     const real_t x79 = x50*x74 + x52*x76 + x56*x78;
//     const real_t x80 = x28*x39 - x55*x61;
//     const real_t x81 = mu*x50 - x65*x80 + x66*x80;
//     const real_t x82 = -x39*x58 + x51*x55;
//     const real_t x83 = mu*x56 - x65*x82 + x66*x82;
//     const real_t x84 = -x28*x51 + x58*x61;
//     const real_t x85 = mu*x52 - x65*x84 + x66*x84;
//     const real_t x86 = x39*x85 + x51*x81 + x61*x83;
//     const real_t x87 = x79*x86;
//     const real_t x88 = pow(x63, -3);
//     const real_t x89 = (27.0/2.0)*x88;
//     const real_t x90 = x28*x78 + x55*x76 + x58*x74;
//     const real_t x91 = x50*x71 + x52*x69 + x56*x67;
//     const real_t x92 = x86*x90*x91;
//     const real_t x93 = x50*x81 + x52*x85 + x56*x83;
//     const real_t x94 = x72*x93;
//     const real_t x95 = x39*x76 + x51*x74 + x61*x78;
//     const real_t x96 = x89*x95;
//     const real_t x97 = x39*x69 + x51*x71 + x61*x67;
//     const real_t x98 = x90*x97;
//     const real_t x99 = x28*x83 + x55*x85 + x58*x81;
//     const real_t x100 = x91*x99;
//     const real_t x101 = x79*x97*x99;
//     const real_t x102 = x64*x93;
//     const real_t x103 = x64*x72;
//     const real_t x104 = x64*x95;
//     const real_t x105 = -x102 - x103 - x104;
//     const real_t x106 = pow(x105, 3);
//     const real_t x107 = pow(x63, -2);
//     const real_t x108 = x107*x87;
//     const real_t x109 = x100*x107;
//     const real_t x110 = x107*x98;
//     const real_t x111 = (-9*x102 - 9*x103 - 9*x104)*(x107*x72*x93 + x107*x72*x95 + x107*x93*x95 - x108 - x109 - x110);
//     const real_t x112 = x107*x95;
//     const real_t x113 = pow(x105, 2) - 3*x107*x94 + 3*x108 + 3*x109 + 3*x110 - 3*x112*x72 - 3*x112*x93;
//     const real_t x114 = 27*x88;
//     const real_t x115 = cbrt(x100*x96 - x101*x89 + x106 - 1.0/2.0*x111 + x72*x87*x89 - x89*x92 + x89*x93*x98 - x94*x96 + (1.0/2.0)*sqrt(-4*pow(x113, 3) + pow(-x101*x114 + 2*x106 
//     - x111 - x114*x92 - x114*x94*x95 + 27*x72*x79*x86*x88 + 27*x88*x90*x93*x97 + 27*x88*x91*x95*x99, 2)));
//     const real_t x116 = (1.0/3.0)*x115;
//     const real_t x117 = (1.0/3.0)*x113/x115;
//     const real_t x118 = (1.0/3.0)*x102 + (1.0/3.0)*x103 + (1.0/3.0)*x104;
//     const real_t x119 = (1.0/2.0)*sqrt(3)*I;
//     const real_t x120 = x119 - 1.0/2.0;
//     const real_t x121 = -x119 - 1.0/2.0;
//     element_vector[0] = -x116 - x117 + x118;
//     element_vector[1] = -x116*x120 - x117/x120 + x118;
//     element_vector[2] = -x116*x121 - x117/x121 + x118;
// }
            ...
            for (int edof_j = 0; edof_j < 4; ++edof_j) {
                ...
                for (int bj = 0; bj < block_size; ++bj) {
                    ...
                    for (int bi = 0; bi < block_size; ++bi) {
                        const real_t val =
                            element_matrix[(edof_i * block_size + bi) * block_size * 4 + edof_j * block_size + bj];
