...
int neohookean_ogden_gradient_soa(const enum ElemType element_type,
    ...
    switch (element_type) {
        ...
        default: {
            fprintf(stderr,
                    "neohookean_ogden_gradient_soa not implemented for type %s\n",
...
int neohookean_ogden_apply_soa(const enum ElemType element_type,
    ...
    switch (element_type) {
        ...
        default: {
            fprintf(stderr,
                    "neohookean_ogden_apply_soa not implemented for type %s\n",
                    type_to_string(element_type));
            assert(0);
            MPI_Abort(MPI_COMM_WORLD, -1);
        }
...
int neohookean_ogden_apply_aos(const enum ElemType element_type,
    ...
    switch (element_type) {
        ...
        default: {
            fprintf(stderr,
                    "neohookean_ogden_apply_aos not implemented for type %s\n",
                    type_to_string(element_type));
            assert(0);
            MPI_Abort(MPI_COMM_WORLD, -1);
        }
...
int neohookean_ogden_gradient_aos(const enum ElemType element_type,
    ...
    switch (element_type) {
        ...
        default: {
            fprintf(stderr,
                    "neohookean_ogden_gradient_aos not implemented for type %s\n",
                    type_to_string(element_type));
            assert(0);
            MPI_Abort(MPI_COMM_WORLD, -1);
        }
