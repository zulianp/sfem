...
template <typename idx_t>
static inline __device__ __host__ idx_t cu_hex8_find_col(const idx_t key, const idx_t *const row, const int lenrow) {
...
static inline __host__ __device__ void cu_hex8_adjugate_and_det(const geom_t *const SFEM_RESTRICT x,
...
static __host__ __device__ void cu_hex8_sub_adj_0_in_place(const scalar_t                h,
