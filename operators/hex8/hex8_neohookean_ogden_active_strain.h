...
int hex8_neohookean_active_strain_ogden_objective(const ptrdiff_t                   nelements,
...
int hex8_neohookean_active_strain_ogden_objective_steps(const ptrdiff_t                   nelements,
                                                        const ptrdiff_t                   stride,
                                                        const ptrdiff_t                   nnodes,
                                                        idx_t **const SFEM_RESTRICT       elements,
                                                        geom_t **const SFEM_RESTRICT      points,
