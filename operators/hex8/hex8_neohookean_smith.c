// Smith Neo-Hookean (active strain) for HEX8
...
#include "hex8_neohookean_smith_local.h"
...
int hex8_neohookean_smith_active_strain_objective(const ptrdiff_t                    nelements,
        ...
        for (int kz = 0; kz < n_qp; kz++) {
            for (int ky = 0; ky < n_qp; ky++) {
                for (int kx = 0; kx < n_qp; kx++) {
                    ...
                    hex8_neohookean_smith_active_strain_objective_at_qp(jacobian_adjugate,
...
int hex8_neohookean_smith_active_strain_objective_steps(const ptrdiff_t                    nelements,
                                                        const ptrdiff_t                    stride,
                                                        const ptrdiff_t                    nnodes,
                                                        idx_t **const SFEM_RESTRICT        elements,
                                                        geom_t **const SFEM_RESTRICT       points,
...
int hex8_neohookean_smith_active_strain_gradient(const ptrdiff_t                    nelements,
                                                 const ptrdiff_t                    stride,
                                                 const ptrdiff_t                    nnodes,
                                                 idx_t **const SFEM_RESTRICT        elements,
                                                 geom_t **const SFEM_RESTRICT       points,
        ...
        for (int kz = 0; kz < n_qp; kz++) {
            for (int ky = 0; ky < n_qp; ky++) {
                for (int kx = 0; kx < n_qp; kx++) {
                    ...
                    hex8_neohookean_smith_active_strain_grad(jacobian_adjugate,
                                                             jacobian_determinant,
                                                             qx[kx],
                                                             qx[ky],
                                                             qx[kz],
...
int hex8_neohookean_smith_active_strain_hessian_partial_assembly(const ptrdiff_t                      nelements,
                                                                 const ptrdiff_t                      stride,
                                                                 idx_t **const SFEM_RESTRICT          elements,
                                                                 geom_t **const SFEM_RESTRICT         points,
                                                                 const real_t                         mu,
        ...
        for (int qz = 0; qz < n_qp; qz++) {
            for (int ky = 0; ky < n_qp; ky++) {
                for (int kx = 0; kx < n_qp; kx++) {
                    ...
                    hex8_S_ikmn_neohookean_smith_active_strain(jacobian_adjugate,
                                                               jacobian_determinant,
                                                               qx[kx],
                                                               qx[ky],
                                                               qx[qz],
...
int hex8_neohookean_smith_active_strain_partial_assembly_apply(const ptrdiff_t                            nelements,
                                                               const ptrdiff_t                            stride,
                                                               idx_t **const SFEM_RESTRICT                elements,
...
int hex8_neohookean_smith_active_strain_compressed_partial_assembly_apply(const ptrdiff_t                         nelements,
                                                                          const ptrdiff_t                         stride,
                                                                          idx_t **const SFEM_RESTRICT             elements,
...
int hex8_neohookean_smith_active_strain_partial_assembly_diag(const ptrdiff_t                   nelements,
                                                              const ptrdiff_t                   stride,
                                                              idx_t **const SFEM_RESTRICT       elements,
                                                              geom_t **const SFEM_RESTRICT      points,
                                                              const real_t                      mu,
...
#pragma omp parallel for
    for (ptrdiff_t i = 0; i < nelements; ++i) {
        ...
        hex8_neohookean_smith_active_strain_hessian_diag(jacobian_adjugate,
                                                         jacobian_determinant,
                                                         samplex,
                                                         sampley,
                                                         samplez,
...
int hex8_neohookean_smith_active_strain_elasticity_diag(const ptrdiff_t                   nelements,
                                                        const ptrdiff_t                   stride,
                                                        const ptrdiff_t                   nnodes,
                                                        idx_t **const SFEM_RESTRICT       elements,
                                                        geom_t **const SFEM_RESTRICT      points,
...
int hex8_neohookean_smith_active_strain_bsr(const ptrdiff_t                    nelements,
                                            const ptrdiff_t                    stride,
                                            idx_t **const SFEM_RESTRICT        elements,
                                            geom_t **const SFEM_RESTRICT       points,
                                            const real_t                       mu,
            ...
            for (int kz = 0; kz < n_qp; kz++) {
                for (int ky = 0; ky < n_qp; ky++) {
                    for (int kx = 0; kx < n_qp; kx++) {
                        ...
                        hex8_neohookean_smith_active_strain_hessian(jacobian_adjugate,
                                                                    jacobian_determinant,
                                                                    qx[kx],
                                                                    qx[ky],
                                                                    qx[kz],
...
int hex8_neohookean_smith_active_strain_bcrs_sym(const ptrdiff_t                    nelements,
                                                 const ptrdiff_t                    stride,
                                                 idx_t **const SFEM_RESTRICT        elements,
                                                 geom_t **const SFEM_RESTRICT       points,
                                                 const real_t                       mu,
