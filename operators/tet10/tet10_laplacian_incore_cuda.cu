...
#pragma unroll(10)
        ...
        {  // Numerical quadrature
            lapl_apply_micro_kernel(0, 0, 0, 0.025, nelements, &fff[e], ex, ey);
            lapl_apply_micro_kernel(1, 0, 0, 0.025, nelements, &fff[e], ex, ey);
            lapl_apply_micro_kernel(0, 1, 0, 0.025, nelements, &fff[e], ex, ey);
            lapl_apply_micro_kernel(0, 0, 1, 0.025, nelements, &fff[e], ex, ey);

            static const scalar_t athird = 1. / 3;
            lapl_apply_micro_kernel(athird, athird, 0., 0.225, nelements, &fff[e], ex, ey);
            lapl_apply_micro_kernel(athird, 0., athird, 0.225, nelements, &fff[e], ex, ey);
            lapl_apply_micro_kernel(0., athird, athird, 0.225, nelements, &fff[e], ex, ey);
            lapl_apply_micro_kernel(athird, athird, athird, 0.225, nelements, &fff[e], ex, ey);
        }
