...
static SFEM_INLINE void tet10_laplacian_hessian_fff(const jacobian_t *fff, accumulator_t *element_matrix) {
    const scalar_t x0 = 4 * qx;
    const scalar_t x1 = 4 * qy;
    const scalar_t x2 = 4 * qz;
    const scalar_t x3 = x1 + x2;
    const scalar_t x4 = x0 + x3 - 3;
    const scalar_t x5 = fff[0] * x4;
    const scalar_t x6 = fff[1] * x4;
    const scalar_t x7 = fff[2] * x4;
    const scalar_t x8 = x5 + x6 + x7;
    const scalar_t x9 = qw * x4;
    const scalar_t x10 = fff[3] * x4;
    const scalar_t x11 = fff[4] * x4;
    const scalar_t x12 = x10 + x11 + x6;
    const scalar_t x13 = fff[5] * x4;
    const scalar_t x14 = x11 + x13 + x7;
    const scalar_t x15 = x0 - 1;
    const scalar_t x16 = qw * x8;
    const scalar_t x17 = x1 - 1;
    const scalar_t x18 = qw * x12;
    const scalar_t x19 = x2 - 1;
    const scalar_t x20 = qw * x14;
    const scalar_t x21 = x0 * x18;
    const scalar_t x22 = x0 * x20;
    const scalar_t x23 = -8 * qx - x3 + 4;
    const scalar_t x24 = x1 * x16;
    const scalar_t x25 = x1 * x20;
    const scalar_t x26 = x0 - 4;
    const scalar_t x27 = -8 * qy - x2 - x26;
    const scalar_t x28 = x16 * x2;
    const scalar_t x29 = x18 * x2;
    const scalar_t x30 = -8 * qz - x1 - x26;
    const scalar_t x31 = qw * x15;
    const scalar_t x32 = fff[0] * qw;
    const scalar_t x33 = fff[1] * x17 * x31;
    const scalar_t x34 = fff[2] * x19 * x31;
    const scalar_t x35 = fff[1] * x0;
    const scalar_t x36 = x31 * x35;
    const scalar_t x37 = fff[2] * x0;
    const scalar_t x38 = x31 * x37;
    const scalar_t x39 = x15 * x32;
    const scalar_t x40 = x1 * x39;
    const scalar_t x41 = fff[2] * x1;
    const scalar_t x42 = x31 * x41;
    const scalar_t x43 = x2 * x39;
    const scalar_t x44 = fff[1] * x2;
    const scalar_t x45 = x31 * x44;
    const scalar_t x46 = qw * x17;
    const scalar_t x47 = fff[3] * qw;
    const scalar_t x48 = fff[4] * x19 * x46;
    const scalar_t x49 = x17 * x47;
    const scalar_t x50 = x0 * x49;
    const scalar_t x51 = fff[4] * x0;
    const scalar_t x52 = x46 * x51;
    const scalar_t x53 = fff[1] * x1;
    const scalar_t x54 = x46 * x53;
    const scalar_t x55 = fff[4] * x1;
    const scalar_t x56 = x46 * x55;
    const scalar_t x57 = x44 * x46;
    const scalar_t x58 = x2 * x49;
    const scalar_t x59 = qw * x19;
    const scalar_t x60 = fff[5] * qw;
    const scalar_t x61 = x51 * x59;
    const scalar_t x62 = x19 * x60;
    const scalar_t x63 = x0 * x62;
    const scalar_t x64 = x41 * x59;
    const scalar_t x65 = x1 * x62;
    const scalar_t x66 = fff[2] * x2;
    const scalar_t x67 = x59 * x66;
    const scalar_t x68 = fff[4] * x2;
    const scalar_t x69 = x59 * x68;
    const scalar_t x70 = fff[0] * x23 - x35 - x37;
    const scalar_t x71 = fff[3] * x0;
    const scalar_t x72 = fff[1] * x23 - x51 - x71;
    const scalar_t x73 = fff[5] * x0;
    const scalar_t x74 = fff[2] * x23 - x51 - x73;
    const scalar_t x75 = qw * x70;
    const scalar_t x76 = qw * x72;
    const scalar_t x77 = qw * x74;
    const scalar_t x78 = x0 * x76;
    const scalar_t x79 = x0 * x77;
    const scalar_t x80 = x1 * x75;
    const scalar_t x81 = x1 * x77;
    const scalar_t x82 = x2 * x75;
    const scalar_t x83 = x2 * x76;
    const scalar_t x84 = fff[0] * x1;
    const scalar_t x85 = x35 + x84;
    const scalar_t x86 = x53 + x71;
    const scalar_t x87 = x41 + x51;
    const scalar_t x88 = qw * x85;
    const scalar_t x89 = qw * x86;
    const scalar_t x90 = qw * x87;
    const scalar_t x91 = x0 * x89;
    const scalar_t x92 = x0 * x90;
    const scalar_t x93 = x1 * x88;
    const scalar_t x94 = x1 * x90;
    const scalar_t x95 = x2 * x88;
    const scalar_t x96 = x2 * x89;
    const scalar_t x97 = fff[1] * x27 - x41 - x84;
    const scalar_t x98 = fff[3] * x27 - x53 - x55;
    const scalar_t x99 = fff[5] * x1;
    const scalar_t x100 = fff[4] * x27 - x41 - x99;
    const scalar_t x101 = qw * x97;
    const scalar_t x102 = qw * x98;
    const scalar_t x103 = qw * x100;
    const scalar_t x104 = x0 * x102;
    const scalar_t x105 = x0 * x103;
    const scalar_t x106 = x1 * x101;
    const scalar_t x107 = x1 * x103;
    const scalar_t x108 = x101 * x2;
    const scalar_t x109 = x102 * x2;
    const scalar_t x110 = fff[0] * x2;
    const scalar_t x111 = fff[2] * x30 - x110 - x44;
    const scalar_t x112 = fff[3] * x2;
    const scalar_t x113 = fff[4] * x30 - x112 - x44;
    const scalar_t x114 = fff[5] * x30 - x66 - x68;
    const scalar_t x115 = qw * x111;
    const scalar_t x116 = qw * x113;
    const scalar_t x117 = qw * x114;
    const scalar_t x118 = x0 * x116;
    const scalar_t x119 = x0 * x117;
    const scalar_t x120 = x1 * x115;
    const scalar_t x121 = x1 * x117;
    const scalar_t x122 = x115 * x2;
    const scalar_t x123 = x116 * x2;
    const scalar_t x124 = x110 + x37;
    const scalar_t x125 = x44 + x51;
    const scalar_t x126 = x66 + x73;
    const scalar_t x127 = qw * x124;
    const scalar_t x128 = qw * x125;
    const scalar_t x129 = qw * x126;
    const scalar_t x130 = x0 * x128;
    const scalar_t x131 = x0 * x129;
    const scalar_t x132 = x1 * x127;
    const scalar_t x133 = x1 * x129;
    const scalar_t x134 = x127 * x2;
    const scalar_t x135 = x128 * x2;
    const scalar_t x136 = x41 + x44;
    const scalar_t x137 = x112 + x55;
    const scalar_t x138 = x68 + x99;
    const scalar_t x139 = qw * x136;
    const scalar_t x140 = qw * x137;
    const scalar_t x141 = qw * x138;
    const scalar_t x142 = x0 * x140;
    const scalar_t x143 = x0 * x141;
    const scalar_t x144 = x1 * x139;
    const scalar_t x145 = x1 * x141;
    const scalar_t x146 = x139 * x2;
    const scalar_t x147 = x140 * x2;
...
static SFEM_INLINE void tet10_laplacian_diag_add_fff(const jacobian_t *const SFEM_RESTRICT fff,
    ...
    const scalar_t x3 = x1 + x2;
    const scalar_t x4 = x0 + x3 - 3;
    const scalar_t x5 = fff[1] * x4;
    const scalar_t x6 = fff[2] * x4;
    const scalar_t x7 = qw * x4;
    const scalar_t x8 = fff[4] * x4;
    const scalar_t x9 = fff[3] * x0;
    const scalar_t x10 = fff[4] * x0;
    const scalar_t x11 = -8 * qx - x3 + 4;
    const scalar_t x12 = qw * x0;
    const scalar_t x13 = fff[5] * x0;
    const scalar_t x14 = fff[1] * x0;
    const scalar_t x15 = fff[2] * x0;
    const scalar_t x16 = fff[1] * x1;
    const scalar_t x17 = fff[0] * x1;
    const scalar_t x18 = qw * x1;
    const scalar_t x19 = fff[2] * x1;
    const scalar_t x20 = x0 - 4;
    const scalar_t x21 = -8 * qy - x2 - x20;
    const scalar_t x22 = fff[5] * x1;
    const scalar_t x23 = fff[4] * x1;
    const scalar_t x24 = fff[0] * x2;
    const scalar_t x25 = fff[1] * x2;
    const scalar_t x26 = -8 * qz - x1 - x20;
    const scalar_t x27 = qw * x2;
    const scalar_t x28 = fff[3] * x2;
    const scalar_t x29 = fff[2] * x2;
    const scalar_t x30 = fff[4] * x2;
...
static SFEM_INLINE void tet10_laplacian_energy_add_fff(const jacobian_t *const SFEM_RESTRICT fff,
    ...
    const scalar_t x5 = u[0]*(x0 + x3 - 3);
    const scalar_t x6 = -u[7]*x2 + x5;
    const scalar_t x7 = x0 - 4;
    const scalar_t x8 = -u[4]*x0;
