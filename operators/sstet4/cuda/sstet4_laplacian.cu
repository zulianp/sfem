...
static /*inline*/ __device__ __host__ void cu_sstet4_laplacian_apply_fff(
...
static inline __device__ __host__ void cu_sstet4_sub_fff_0(
        const int L,
        const fff_t *const SFEM_RESTRICT fff,
...
template <typename fff_t, typename scalar_t>
static inline __device__ __host__ void cu_sstet4_sub_fff_1(
        const int L,
        const fff_t *const SFEM_RESTRICT fff,
        scalar_t *const SFEM_RESTRICT sub_fff) {
...
template <typename fff_t, typename scalar_t>
static inline __device__ __host__ void cu_sstet4_sub_fff_2(
        const int L,
        const fff_t *const SFEM_RESTRICT fff,
        scalar_t *const SFEM_RESTRICT sub_fff) {
    const scalar_t x0 = 1. / POW3(L);
...
template <typename fff_t, typename scalar_t>
static inline __device__ __host__ void cu_sstet4_sub_fff_3(
        const int L,
        const fff_t *const SFEM_RESTRICT fff,
        scalar_t *const SFEM_RESTRICT sub_fff) {
    const scalar_t x0 = 1. / POW3(L);
...
template <typename fff_t, typename scalar_t>
static inline __device__ __host__ void cu_sstet4_sub_fff_4(
        const int L,
        const fff_t *const SFEM_RESTRICT fff,
        scalar_t *const SFEM_RESTRICT sub_fff) {
    const scalar_t x0 = 1.0 / L;
...
template <typename fff_t, typename scalar_t>
static inline __device__ __host__ void cu_sstet4_sub_fff_5(
        const int L,
        const fff_t *const SFEM_RESTRICT fff,
        scalar_t *const SFEM_RESTRICT sub_fff) {
    const scalar_t x0 = 1. / POW3(L);
...
static int cu_sstet4_laplacian_apply_tpl(const int level,
...
#ifdef SFEM_USE_OCCUPANCY_MAX_POTENTIAL
    {
        ...
        cudaOccupancyMaxPotentialBlockSize(
                &min_grid_size, &block_size, cu_sstet4_laplacian_apply_kernel<T>, 0, 0);
    }
    ...
    if (stream) {
        ...
        cu_sstet4_laplacian_apply_kernel<T>
...
extern int cu_sstet4_laplacian_apply(const int level,
    ...
    switch (real_type_xy) {
        case SFEM_REAL_DEFAULT: {
            return cu_sstet4_laplacian_apply_tpl(level,
                                                       nelements,
                                                       stride,
                                                       (cu_jacobian_t *)fff,
                                                       (real_t *)x,
