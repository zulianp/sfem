...
// =============================================================================
// FIXED VERSION DISPATCHERS (dt/g/tau interface)
// =============================================================================
    ...
    switch (element_type) {
        case HEX8: {
            return hex8_mooney_rivlin_visco_gradient(
                ...
                C10, C01, K, dt, num_prony_terms, g, tau, 
...
// =============================================================================
// FLEXIBLE VERSION DISPATCHERS (precomputed alpha/beta/gamma interface)
// Only stores H_i in history (not S_dev), supports arbitrary Prony terms
// =============================================================================
