...
Examples:
  ../../../venv/bin/python python/analyze_xctrace_export.py traces/cvfem_*.trace
  ../../../venv/bin/python python/analyze_xctrace_export.py traces/export/*_cpu-profile.xml
  ./scripts/profile_xctrace.sh --template 'CPU Profiler' --mode jacobian --analyze
"""
