...
| role | kernel | where |
|------|--------|-------|
| L0 operator / smoother apply | `sscvfem_apply_macro_local_hoisted` | `src/ss/cvfem_sshex8_ns.hpp` |
...
| coarse assembly | `galerkin_assemble`, `galerkin_hop` | `src/ss/cvfem_ss_galerkin.hpp` |
