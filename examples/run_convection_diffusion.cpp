...
int main(int argc, char *argv[]) {
    ...
    real_t *c = (real_t *)calloc(mesh.nnodes, sizeof(real_t));
    ...
    update = (real_t *)calloc(mesh.nnodes, sizeof(real_t));
    ...
    real_t *cv_volumes = (real_t *)calloc(mesh.nnodes, sizeof(real_t));
    cvfem_cv_volumes(
