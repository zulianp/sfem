...
set(SFEM_COUNT_TYPE         ${SFEM_IDX_TYPE}    CACHE STRING "Set SFEM count_t type")
set(SFEM_ELEMENT_IDX_TYPE   ${SFEM_IDX_TYPE}    CACHE STRING "Set SFEM element_idx_t type")
...
function(sfem_cusparse_type type cusparse_type)
    ...
    elseif("${type}" STREQUAL "int16" AND NOT SFEM_ENABLE_CUDA)
        set(${cusparse_type} "INT16_NOT_SUPPORTED" PARENT_SCOPE)
    elseif("${type}" STREQUAL "uint16" AND NOT SFEM_ENABLE_CUDA)
...
sfem_num_bytes(${SFEM_GEOM_TYPE} SFEM_GEOM_SIZE)
sfem_num_bytes(${SFEM_JACOBIAN_CPU_TYPE} SFEM_JACOBIAN_CPU_SIZE)
sfem_num_bytes(${SFEM_ACCUMULATOR_TYPE} SFEM_ACCUMULATOR_SIZE)
sfem_num_bytes(${SFEM_IDX_TYPE} SFEM_IDX_SIZE)
sfem_num_bytes(${SFEM_COUNT_TYPE} SFEM_COUNT_SIZE)
sfem_num_bytes(${SFEM_ELEMENT_IDX_TYPE} SFEM_ELEMENT_IDX_SIZE)
sfem_num_bytes(${SFEM_LOCAL_IDX_TYPE} SFEM_LOCAL_IDX_SIZE)
