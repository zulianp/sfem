...
def _build_system(dim):
    ...
    with gen.geometric_dimension_context(dim):
        water = gen.Function(W[0], "p_w", qualifier=gen.PRESSURE)
        co2 = gen.Function(W[1], "p_c", qualifier=gen.PRESSURE)
        q_w = gen.TestFunction(W[0], name="p_w_test")
        q_c = gen.TestFunction(W[1], name="p_c_test")
