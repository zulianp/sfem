...
| --- | --- | --- | --- | --- |
| Generated SFEM `laplace_proteus_hex64_residual_esoa_float` vs fused Metal local apply | 1 element, 64 shape functions, 64 quadrature points, identity geometry | max abs diff `2.85065539e-07` with tolerance `5e-4` | generated SFEM CPU `1.802928 us` avg over 4096 calls; Metal GPU `216.904298 us` avg over 64 dispatches in the comparison harness | `/private/tmp/sfem_laplace_proteus_hex64_host_wrapper_spirv/manifest.json`, `generated_sfem_comparison` |
