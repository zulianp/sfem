...
Use `--require-iree-metal` when missing `iree-compile` or a failed IREE Metal VMFB build from the whole-chain `.linalg_pipeline.mlir` artifact should fail the command instead of being recorded in the manifest.
