"""Closed-form energies and first Piola stresses for 2D affine modes."""
...
def deformation_gradients():
    return {
        "uniaxial_extension": np.diag((1.125, 1.0)),
        "simple_shear": np.asarray(((1.0, 0.125), (0.0, 1.0))),
        "uniform_dilation": np.diag((1.0625, 1.0625)),
    }
