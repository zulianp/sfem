...
def main():
    parser = argparse.ArgumentParser(description="Verify two-dimensional homogeneous hyperelastic modes")
    ...
    oracle = {"type": "analytical", "reference": "hyperelastic_modes_2d/oracle.py"}
