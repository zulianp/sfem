...
def main():
    parser = argparse.ArgumentParser(description="Verify the three-dimensional affine linear-elastic modes")
    ...
    oracle = {"type": "analytical", "reference": "linear_patch_3d/oracle.py"}
