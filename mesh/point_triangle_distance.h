...
static SFEM_INLINE geom_t dot3(const geom_t *const SFEM_RESTRICT a,
                               const geom_t *const SFEM_RESTRICT b) {
...
static SFEM_INLINE void point_triangle_distance(
    const geom_t *const SFEM_RESTRICT point,
    ...
    const geom_t edge0[3] = {x_triangle[1] - x_triangle[0],
                             ...
                             z_triangle[1] - z_triangle[0]};

    const geom_t edge1[3] = {x_triangle[2] - x_triangle[0],
                             y_triangle[2] - y_triangle[0],
                             z_triangle[2] - z_triangle[0]};
