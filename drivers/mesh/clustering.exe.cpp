...
int main(int argc, char *argv[]) {
    ...
    // int nsxe = elem_num_sides(side_type(mesh->element_type()));
    ...
    while (elements_assigned < n_elements) {
        ...
        for (ptrdiff_t i = 0; i < unassigned_elements.size(); i++) {
            ...
            if (elem2cluster_data[elem] == SFEM_IDX_INVALID) {
                ...
                if (connectivity > best_connectivity || (connectivity == best_connectivity && elem < best_elem)) {
                    best_elem         = elem;
