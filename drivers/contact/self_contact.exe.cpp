...
//         const int     nsxe = elem_num_sides(mesh->element_type(0));
...
//     const int           nsxe             = elem_num_sides(mesh->element_type(0));
//     const smesh::ElemType st               = side_type(mesh->element_type(0));
//     const int           nnxs             = elem_num_nodes(st);
//     auto                local_side_table = sfem::create_host_buffer<int>(nsxe * nnxs);
//     fill_local_side_table(mesh->element_type(0), local_side_table->data());
