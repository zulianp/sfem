...
void time_operator_cpu(const std::shared_ptr<sfem::Operator<real_t>> op,
                       ...
                       real_t* const                                 y);
void time_operator_gpu(const std::shared_ptr<sfem::Operator<real_t>> op,
                       const char* const                             name,
                       const real_t* const                           x,
                       real_t* const                                 y);
...
#pragma omp parallel for
        ...
        auto coo_sym_gpu = sfem::d_sym_coo_spmv(ndofs, offdiag_rowidx, offdiag_colidx, offdiag_values, diag_values, alpha);
        ...
        auto coo_sym_host =
                sfem::h_coosym(nullptr, offdiag_rowidx_host, offdiag_colidx_host, offdiag_values_host, diag_values_host);

        auto csr_sym_host = sfem::h_crs_sym(
                ndofs, ndofs, offdiag_rowptr_host, offdiag_colidx_host, diag_values_host, offdiag_values_host, alpha);
