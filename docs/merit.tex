...
terms to leave both loops.  Which axis should carry the second loop's lanes is
left to measurement: the arrangements are built as variants and timed.  What this is worth is bounded by the constitutive evaluation, which
...
Which axis should carry the second loop's lanes is not settled here.  Three
arrangements are available --- lanes over the trial steps, lanes over the
incident elements with the steps serial, and lanes over the flattened
element-by-step product --- and they trade differently: the step count is a
runtime value and may be shorter than the vector width, while the incident count
varies from node to node.  They are built as variants and timed against each
other, which is how a competing loop arrangement is settled in this framework.
