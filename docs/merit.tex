...
node, which the mesh fixes.  The alternatives are built and timed against it.  What this is worth is bounded by the constitutive evaluation, which
...
lanes over the flattened element-by-step product --- are still built and timed
against it rather than argued away, which is how a competing loop arrangement is
settled in this framework.
