...
SFEM_INLINE static void tet10_dual_basis_hrt_VV(const vec_real  qx,   //
    ...
    const vec_real x12 = qy * qz;
    const vec_real x13 = qx * x11 + (real_t)(10.0 / 9.0) * x12 + x6 + x9;
    const vec_real x14 = (real_t)(5.0 / 18.0) * qx;
    const vec_real x15 = x14 * x2;
    const vec_real x16 = (real_t)(10.0 / 9.0) * qx;
    const vec_real x17 = qy * x11 + qz * x16 + x15;
    const vec_real x18 = qy * x16 + qz * x11;
    const vec_real x19 = qx * x2;
    const vec_real x20 = (real_t)(5.0 / 18.0) * x3;
    const vec_real x21 = qy * x14 + x10 * x8 + x20;
    const vec_real x22 = qz * x14 + x10 * x5;
    const vec_real x23 = qy * x4;
    const vec_real x24 = qz * x5 + x10 * x14;
    const vec_real x25 = qz * x7;
    const vec_real x26 = (real_t)(40.0 / 27.0) * x23;
    const vec_real x27 = (real_t)(115.0 / 27.0) * x10;
    const vec_real x28 = (real_t)(110.0 / 27.0) * qx;
    const vec_real x29 = -qz * x28;
    const vec_real x30 = (real_t)(55.0 / 54.0) * x10;
    const vec_real x31 = -qy * x30;
    const vec_real x32 = (real_t)(10.0 / 27.0) * x19;
    const vec_real x33 = (real_t)(40.0 / 27.0) * x25;
    const vec_real x34 = x29 + x31 + x32 + x33;
    const vec_real x35 = -qy * x28;
    const vec_real x36 = -qz * x30;
    const vec_real x37 = (real_t)(10.0 / 27.0) * x3;
    const vec_real x38 = x35 + x36 + x37;
    const vec_real x39 = (real_t)(40.0 / 27.0) * x10;
    const vec_real x40 = qx * qy;
    const vec_real x41 = -qx * x30 - (real_t)(110.0 / 27.0) * x12;
    const vec_real x42 = (real_t)(10.0 / 27.0) * x23;
    const vec_real x43 = (real_t)(40.0 / 27.0) * x3;
    const vec_real x44 = x42 + x43;
    const vec_real x45 = qx * qz;
    const vec_real x46 = (real_t)(40.0 / 27.0) * x19;
    const vec_real x47 = x41 + x46;
    const vec_real x48 = (real_t)(10.0 / 27.0) * x25;
    const vec_real x49 = x26 + x48;
    const vec_real x50 = x29 + x31;
    const vec_real x51 = x35 + x36;

    f[0] = x13 + x17 + x18 + (real_t)(25.0 / 9.0) * x3;
    f[1] = x13 + (real_t)(25.0 / 9.0) * x19 + x21 + x22;
    f[2] = x17 + x21 + (real_t)(25.0 / 9.0) * x23 + x24 + x9;
    f[3] = x15 + x18 + x20 + x22 + x24 + (real_t)(25.0 / 9.0) * x25 + x6;
    f[4] = qx * x27 + (real_t)(160.0 / 27.0) * x12 + x26 + x34 + x38;
    f[5] = qz * x39 + x34 + (real_t)(460.0 / 27.0) * x40 + x41 + x44;
    f[6] = qy * x27 + x33 + x38 + x42 + (real_t)(160.0 / 27.0) * x45 + x47;
    f[7] = qz * x27 + x37 + (real_t)(160.0 / 27.0) * x40 + x47 + x49 + x50;
    f[8] = qy * x39 + x32 + x41 + x43 + (real_t)(460.0 / 27.0) * x45 + x49 + x51;
    f[9] = qx * x39 + (real_t)(460.0 / 27.0) * x12 + x44 + x46 + x48 + x50 + x51;
}
