...
///////////////////////////////////////////////////
int query_tet_cell_list_2d_3d_given_xy_test(const cell_list_3d_2d_map_t *map,        //
                                            const boxes_t               *boxes,      //
                                            const mesh_tet_geom_t       *mesh_geom,  //
                                            const int                    num_z,      //
                                            const int                    num_queries) {                 //

    printf("query_tet_cell_list_2d_3d_given_xy_test: Running %d random queries to test cell list...\n", num_queries);
    ...
    for (int q_xy_i = 0; q_xy_i < queries_per_xy; q_xy_i++) {
        ...
        {  // Begin block of queries
            ...
            for (int iz = 0; iz < num_z; iz++) {
                ...
                const int tet_index = query_cell_list_3d_2d_map_mesh_given_xy(map, boxes, mesh_geom, x, y, &z_array[iz], 1);
...
////////////////////////////////////////////////////////////////////////////
// query_tet_cell_list_2d_3d_given_xy_bench
////////////////////////////////////////////////////////////////////////////
int                                                                               //
query_tet_cell_list_2d_3d_given_xy_bench(const cell_list_3d_2d_map_t *map,        //
                                         ...
                                         const int                    num_z,      //
                                         const int                    num_queries) {
    printf("query_tet_cell_list_2d_3d_given_xy_bench: Running %d random queries to benchmark cell list...\n", num_queries);
    ...
    printf("file: %s:%d\n", __FILE__, __LINE__);
    printf("query_tet_cell_list_2d_3d_given_xy_bench with %d queries (each with %d z values)\n", effective_num_queries, num_z);
    ...
    return total_boxes_found;
}  // END Function: query_tet_cell_list_2d_3d_given_xy_bench