...
typedef scalar_t vec4_t
        __attribute__((vector_size(_VL4_ * sizeof(scalar_t)), aligned(sizeof(scalar_t))));

typedef ptrdiff_t vec4_int64
        __attribute__((vector_size(_VL4_ * sizeof(ptrdiff_t)), aligned(sizeof(ptrdiff_t))));

SFEM_INLINE vec4_int64 floor_V4(const vec4_t x) {
...
*/
        ...
        const vec4_t qz,
        // Output
        vec4_t* const SFEM_RESTRICT out_x,
        vec4_t* const SFEM_RESTRICT out_y,
...
SFEM_INLINE static void hex_aa_8_eval_fun_V4(
        ...
        // Output
        vec4_t* const SFEM_RESTRICT f0,
        vec4_t* const SFEM_RESTRICT f1,
        vec4_t* const SFEM_RESTRICT f2,
        vec4_t* const SFEM_RESTRICT f3,
        vec4_t* const SFEM_RESTRICT f4,
        vec4_t* const SFEM_RESTRICT f5,
        vec4_t* const SFEM_RESTRICT f6,
        vec4_t* const SFEM_RESTRICT f7) {
    //
...
SFEM_INLINE static void hex_aa_8_collect_coeffs_V4(
        ...
        //
        vec4_t* SFEM_RESTRICT out0,
        vec4_t* SFEM_RESTRICT out1,
        vec4_t* SFEM_RESTRICT out2,
        vec4_t* SFEM_RESTRICT out3,
        vec4_t* SFEM_RESTRICT out4,
        vec4_t* SFEM_RESTRICT out5,
        vec4_t* SFEM_RESTRICT out6,
        vec4_t* SFEM_RESTRICT out7) {
    //
...
int tet4_resample_field_local_V4_aligned(
    ...
    for (ptrdiff_t element_i = start_nelement; element_i < end_nelement; element_i += 4) {
        ...
        // real_t hex8_f[8];
        vec4_t hex8_f0 = zeros, hex8_f1 = zeros, hex8_f2 = zeros, hex8_f3 = zeros,
                    hex8_f4 = zeros, hex8_f5 = zeros, hex8_f6 = zeros, hex8_f7 = zeros;

        // real_t coeffs[8];
        vec4_t coeffs0 = zeros, coeffs1 = zeros, coeffs2 = zeros, coeffs3 = zeros,
