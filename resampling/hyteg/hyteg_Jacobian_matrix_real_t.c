...
void jacobian_matrix_real_t(const int category, const real_t x0, const real_t y0, const real_t z0, const real_t x1,
    ...
    switch (category) {
        case 0:
            ...
            break;
        case 1:
            jacobian_matrix_cat1_real_t(x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, L, J);
            break;
        case 2:
            jacobian_matrix_cat2_real_t(x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, L, J);
            break;
        case 3:
            jacobian_matrix_cat3_real_t(x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, L, J);
            break;
        case 4:
            jacobian_matrix_cat4_real_t(x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, L, J);
            break;
        case 5:
            jacobian_matrix_cat5_real_t(x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, L, J);
            break;
        default:
