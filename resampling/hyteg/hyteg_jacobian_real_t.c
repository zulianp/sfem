...
real_t det_jacobian_cat0_real(const real_t x0, const real_t y0, const real_t z0,  //
    ...
    real_t det = (-x0 * y1 * z2 + x0 * y1 * z3 + x0 * y2 * z1 - x0 * y2 * z3 - x0 * y3 * z1 + x0 * y3 * z2 + x1 * y0 * z2 -
...
real_t det_jacobian_cat1_real(const real_t x0, const real_t y0, const real_t z0,  //
                              const real_t x1, const real_t y1, const real_t z1,  //
                              const real_t x2, const real_t y2, const real_t z2,  //
                              const real_t x3, const real_t y3, const real_t z3,  //
                              const real_t L                                      //
...
real_t det_jacobian_cat2_real(const real_t x0, const real_t y0, const real_t z0,  //
                              const real_t x1, const real_t y1, const real_t z1,  //
                              const real_t x2, const real_t y2, const real_t z2,  //
                              const real_t x3, const real_t y3, const real_t z3,  //
                              const real_t L                                      //
...
real_t det_jacobian_cat3_real(const real_t x0, const real_t y0, const real_t z0,  //
                              const real_t x1, const real_t y1, const real_t z1,  //
                              const real_t x2, const real_t y2, const real_t z2,  //
                              const real_t x3, const real_t y3, const real_t z3,  //
                              const real_t L                                      //
...
real_t det_jacobian_cat4_real(const real_t x0, const real_t y0, const real_t z0,  //
                              const real_t x1, const real_t y1, const real_t z1,  //
                              const real_t x2, const real_t y2, const real_t z2,  //
                              const real_t x3, const real_t y3, const real_t z3,  //
                              const real_t L                                      //
...
real_t det_jacobian_cat5_real(const real_t x0, const real_t y0, const real_t z0,  //
                              const real_t x1, const real_t y1, const real_t z1,  //
                              const real_t x2, const real_t y2, const real_t z2,  //
                              const real_t x3, const real_t y3, const real_t z3,  //
                              const real_t L                                      //
