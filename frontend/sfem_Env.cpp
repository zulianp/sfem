...
//     template <>
//     struct FromString<smesh::ElemType> {
//         static smesh::ElemType parse(const std::string& str_value) { return type_from_string(str_value.c_str()); }
//     };
...
//     template smesh::ElemType from_string<smesh::ElemType>(const std::string& str_value);
