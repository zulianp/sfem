...
static SFEM_INLINE int saint_venant_kirchhoff_tri6_energy_egeometry_soa(
...
template <typename s_t, int VS>
static SFEM_INLINE int saint_venant_kirchhoff_tri6_energy_ecoords_soa(
        const ptrdiff_t nelements,
...
template <typename s_t, int VS>
static SFEM_INLINE int saint_venant_kirchhoff_tri6_energy_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static SFEM_INLINE int saint_venant_kirchhoff_tri6_gradient_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
...
template <typename s_t, int VS>
static SFEM_INLINE int saint_venant_kirchhoff_tri6_gradient_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static SFEM_INLINE int saint_venant_kirchhoff_tri6_gradient_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static SFEM_INLINE int saint_venant_kirchhoff_tri6_hessian_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
...
template <typename s_t, int VS>
static SFEM_INLINE int saint_venant_kirchhoff_tri6_hessian_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static SFEM_INLINE int saint_venant_kirchhoff_tri6_hessian_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
