...
struct saint_venant_kirchhoff_tri3_affine_reference_data {
...
template <typename scalar_t>
struct saint_venant_kirchhoff_tri3_isoparametric_reference_data {
    static const scalar_t *shape() {
        static const scalar_t data[3] = {scalar_t(0.33333333333333343), scalar_t(0.33333333333333331), scalar_t(0.33333333333333331)};
        return data;
    }
...
static SFEM_INLINE int saint_venant_kirchhoff_tri3_objective_steps_affine_mesh_soa_impl(
    ...
    (void)nnodes;
    const scalar_t *const affine_q_weight = sfem::codegen::saint_venant_kirchhoff_tri3_affine_reference_data<scalar_t>::q_weight();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        for (int step = 0; step < nsteps; ++step) {
            ...
            saint_venant_kirchhoff_d2_simplex_tri3_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, affine_q_weight, lmbda, mu, block_u_streams, block_value);
...
extern "C" int saint_venant_kirchhoff_tri3_objective_steps_packed_affine_mesh_soa(
    ...
    const scalar_t *const affine_grad_ref_x = sfem::codegen::saint_venant_kirchhoff_tri3_affine_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const affine_grad_ref_y = sfem::codegen::saint_venant_kirchhoff_tri3_affine_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const affine_q_weight = sfem::codegen::saint_venant_kirchhoff_tri3_affine_reference_data<scalar_t>::q_weight();
...
static SFEM_INLINE int saint_venant_kirchhoff_tri3_objective_steps_isoparametric_mesh_soa_impl(
    ...
    const scalar_t *const isoparametric_grad_ref_x = sfem::codegen::saint_venant_kirchhoff_tri3_isoparametric_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const isoparametric_grad_ref_y = sfem::codegen::saint_venant_kirchhoff_tri3_isoparametric_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const isoparametric_q_weight = sfem::codegen::saint_venant_kirchhoff_tri3_isoparametric_reference_data<scalar_t>::q_weight();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        for (int step = 0; step < nsteps; ++step) {
            ...
            saint_venant_kirchhoff_d2_simplex_tri3_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, isoparametric_q_weight, lmbda, mu, block_u_streams, block_value);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        saint_venant_kirchhoff_d2_simplex_tri3_gradient_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, affine_q_weight, lmbda, mu, block_u_streams, block_out_streams);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        saint_venant_kirchhoff_d2_simplex_tri3_gradient_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, isoparametric_q_weight, lmbda, mu, block_u_streams, block_out_streams);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        saint_venant_kirchhoff_d2_simplex_tri3_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, affine_q_weight, lmbda, mu, block_u_streams, block_h_streams, block_out_streams);
...
template <typename scalar_t>
static SFEM_INLINE void saint_venant_kirchhoff_tri3_hessian_isoparametric_mesh_soa_scatter_bsr(
    ...
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        for (int trial_component = 0; trial_component < N_FIELD_COMPONENTS; ++trial_component) {
            for (int trial_shape = 0; trial_shape < N_SHAPE; ++trial_shape) {
                ...
                saint_venant_kirchhoff_d2_simplex_tri3_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(1, 1, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, isoparametric_q_weight, lmbda, mu, block_u_streams, block_h_streams, block_out_streams);
        ...
        if constexpr (FORMAT == 1) {
            saint_venant_kirchhoff_tri3_hessian_isoparametric_mesh_soa_scatter_bsr(ev, element_matrix, rowptr, colidx, values);
        } else {
