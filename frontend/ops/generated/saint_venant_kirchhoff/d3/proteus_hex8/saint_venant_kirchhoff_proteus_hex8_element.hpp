#ifndef SAINT_VENANT_KIRCHHOFF_PROTEUS_HEX8_ELEMENT_API_HPP
#define SAINT_VENANT_KIRCHHOFF_PROTEUS_HEX8_ELEMENT_API_HPP
...
struct saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data {
...
static SFEM_INLINE int saint_venant_kirchhoff_proteus_hex8_energy_element_geometry_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        saint_venant_kirchhoff_d3_tensor_product_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::grad_1d(), sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::q_weight_1d(), lmbda, mu, block_u_streams, block_value);
    }
    return SFEM_SUCCESS;
}

template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_proteus_hex8_energy_element_coords_soa(
        const ptrdiff_t nelements,
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        tensor_gradient_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE, 3>(nelems, sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::grad_1d(), block_coordinate_data, 0, coordinate_grad_ref + 0 * N_QP * SPATIAL_DIM * VECTOR_SIZE);
        tensor_gradient_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE, 3>(nelems, sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::grad_1d(), block_coordinate_data, 1, coordinate_grad_ref + 1 * N_QP * SPATIAL_DIM * VECTOR_SIZE);
        tensor_gradient_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE, 3>(nelems, sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::grad_1d(), block_coordinate_data, 2, coordinate_grad_ref + 2 * N_QP * SPATIAL_DIM * VECTOR_SIZE);
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_proteus_hex8_energy_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_proteus_hex8_gradient_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t lmbda,
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        saint_venant_kirchhoff_d3_tensor_product_gradient_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::grad_1d(), sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::q_weight_1d(), lmbda, mu, block_u_streams, block_out_streams);
    }
    return SFEM_SUCCESS;
}

template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_proteus_hex8_gradient_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_proteus_hex8_gradient_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_proteus_hex8_hessian_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t lmbda,
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        for (int col = 0; col < NDOFS; ++col) {
            ...
            saint_venant_kirchhoff_d3_tensor_product_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::grad_1d(), sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::q_weight_1d(), lmbda, mu, block_u_streams, block_h_streams, block_out_streams);
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_proteus_hex8_hessian_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_proteus_hex8_hessian_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
