...
struct saint_venant_kirchhoff_proteus_hex8_affine_reference_data {
...
static SFEM_INLINE int saint_venant_kirchhoff_proteus_hex8_objective_steps_affine_mesh_soa_impl(
    ...
    (void)nnodes;
    const scalar_t *const affine_shape_1d = sfem::codegen::saint_venant_kirchhoff_proteus_hex8_affine_reference_data<scalar_t>::shape_1d();
    const scalar_t *const affine_grad_1d = sfem::codegen::saint_venant_kirchhoff_proteus_hex8_affine_reference_data<scalar_t>::grad_1d();
    const scalar_t *const affine_q_weight_1d = sfem::codegen::saint_venant_kirchhoff_proteus_hex8_affine_reference_data<scalar_t>::q_weight_1d();
...
static SFEM_INLINE int saint_venant_kirchhoff_proteus_hex8_objective_steps_isoparametric_mesh_soa_impl(
    ...
    const scalar_t *const isoparametric_shape_1d = sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::shape_1d();
    const scalar_t *const isoparametric_grad_1d = sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::grad_1d();
    const scalar_t *const isoparametric_q_weight_1d = sfem::codegen::saint_venant_kirchhoff_proteus_hex8_isoparametric_reference_data<scalar_t>::q_weight_1d();
    static constexpr int N_QP_1D = 2;
    static constexpr int N_SHAPE_1D = 2;
...
template <typename scalar_t>
static SFEM_INLINE void saint_venant_kirchhoff_proteus_hex8_hessian_isoparametric_mesh_soa_scatter_bsr(
...
#pragma omp parallel for schedule(static) reduction(|:unsupported_matrix_format)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        if constexpr (FORMAT == 1) {
            saint_venant_kirchhoff_proteus_hex8_hessian_isoparametric_mesh_soa_scatter_bsr(ev, element_matrix, rowptr, colidx, values);
        } else {
