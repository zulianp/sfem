#ifndef SAINT_VENANT_KIRCHHOFF_TET4_ELEMENT_API_HPP
#define SAINT_VENANT_KIRCHHOFF_TET4_ELEMENT_API_HPP
...
static SFEM_INLINE int saint_venant_kirchhoff_tet4_energy_element_geometry_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        saint_venant_kirchhoff_d3_simplex_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, sfem::codegen::saint_venant_kirchhoff_tet4_isoparametric_reference_data<scalar_t>::grad_ref_x(), sfem::codegen::saint_venant_kirchhoff_tet4_isoparametric_reference_data<scalar_t>::grad_ref_y(), sfem::codegen::saint_venant_kirchhoff_tet4_isoparametric_reference_data<scalar_t>::grad_ref_z(), sfem::codegen::saint_venant_kirchhoff_tet4_isoparametric_reference_data<scalar_t>::q_weight(), lmbda, mu, block_u_streams, block_value);
    }
    return SFEM_SUCCESS;
}

template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_tet4_energy_element_coords_soa(
        const ptrdiff_t nelements,
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        scalar_t block_jacobian_adjugate8[N_QP * VECTOR_SIZE];
        scalar_t block_jacobian_determinant0[N_QP * VECTOR_SIZE];
        const scalar_t *const grad_ref_x = sfem::codegen::saint_venant_kirchhoff_tet4_isoparametric_reference_data<scalar_t>::grad_ref_x();
        const scalar_t *const grad_ref_y = sfem::codegen::saint_venant_kirchhoff_tet4_isoparametric_reference_data<scalar_t>::grad_ref_y();
        const scalar_t *const grad_ref_z = sfem::codegen::saint_venant_kirchhoff_tet4_isoparametric_reference_data<scalar_t>::grad_ref_z();
        {
            const int q = 0;  // TET4 evaluates in closed form
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_tet4_energy_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_tet4_gradient_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t lmbda,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_tet4_gradient_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_tet4_gradient_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_tet4_hessian_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t lmbda,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_tet4_hessian_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int saint_venant_kirchhoff_tet4_hessian_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
