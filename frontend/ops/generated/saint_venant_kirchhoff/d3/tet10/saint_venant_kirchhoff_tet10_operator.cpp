...
struct saint_venant_kirchhoff_tet10_affine_reference_data {
...
template <typename scalar_t>
struct saint_venant_kirchhoff_tet10_isoparametric_reference_data {
    static const scalar_t *shape() {
...
static const KernelDiagnostics saint_venant_kirchhoff_tet10_tet10_objective_soa_diagnostics_data = {
    "saint_venant_kirchhoff_tet10_tet10_objective_soa",
    "TET10",
    3,
    11,
    10,
...
extern "C" const sfem::codegen::KernelDiagnostics *saint_venant_kirchhoff_tet10_tet10_objective_soa_diagnostics(void) {
    return &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_soa_diagnostics_data;
}
...
extern "C" double saint_venant_kirchhoff_tet10_tet10_objective_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_objective_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_tet10_objective_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_soa_diagnostics_data,
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_objective_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_tet10_objective_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_objective_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "saint_venant_kirchhoff_tet10_tet10_objective_affine_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_objective_isoparametric_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_tet10_objective_isoparametric_mesh_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_objective_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_tet10_objective_isoparametric_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static SFEM_INLINE int saint_venant_kirchhoff_tet10_tet10_objective_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const affine_grad_ref_x = sfem::codegen::saint_venant_kirchhoff_tet10_affine_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const affine_grad_ref_y = sfem::codegen::saint_venant_kirchhoff_tet10_affine_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const affine_grad_ref_z = sfem::codegen::saint_venant_kirchhoff_tet10_affine_reference_data<scalar_t>::grad_ref_z();
    const scalar_t *const affine_q_weight = sfem::codegen::saint_venant_kirchhoff_tet10_affine_reference_data<scalar_t>::q_weight();
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_objective_affine_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_objective_affine_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_tet10_objective_steps_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_objective_steps_affine_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_steps_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_objective_steps_affine_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_steps_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
static SFEM_INLINE int saint_venant_kirchhoff_tet10_tet10_objective_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    const scalar_t *const isoparametric_grad_ref_x = sfem::codegen::saint_venant_kirchhoff_tet10_isoparametric_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const isoparametric_grad_ref_y = sfem::codegen::saint_venant_kirchhoff_tet10_isoparametric_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const isoparametric_grad_ref_z = sfem::codegen::saint_venant_kirchhoff_tet10_isoparametric_reference_data<scalar_t>::grad_ref_z();
    const scalar_t *const isoparametric_q_weight = sfem::codegen::saint_venant_kirchhoff_tet10_isoparametric_reference_data<scalar_t>::q_weight();
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_objective_isoparametric_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_objective_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_tet10_objective_steps_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_objective_steps_isoparametric_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_steps_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_objective_steps_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_objective_steps_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
static const KernelDiagnostics saint_venant_kirchhoff_tet10_tet10_gradient_soa_diagnostics_data = {
    "saint_venant_kirchhoff_tet10_tet10_gradient_soa",
    "TET10",
    3,
    11,
    10,
...
extern "C" const sfem::codegen::KernelDiagnostics *saint_venant_kirchhoff_tet10_tet10_gradient_soa_diagnostics(void) {
    return &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_soa_diagnostics_data;
}
...
extern "C" double saint_venant_kirchhoff_tet10_tet10_gradient_soa_arithmetic_intensity(
        ...
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_gradient_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_tet10_gradient_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_gradient_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_tet10_gradient_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_gradient_affine_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "saint_venant_kirchhoff_tet10_tet10_gradient_affine_mesh_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_gradient_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "saint_venant_kirchhoff_tet10_tet10_gradient_affine_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_gradient_isoparametric_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_tet10_gradient_isoparametric_mesh_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_gradient_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_tet10_gradient_isoparametric_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_tet10_gradient_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_gradient_affine_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_gradient_affine_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_tet10_gradient_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_gradient_isoparametric_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_gradient_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_gradient_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
static const KernelDiagnostics saint_venant_kirchhoff_tet10_tet10_apply_soa_diagnostics_data = {
    "saint_venant_kirchhoff_tet10_tet10_apply_soa",
    "TET10",
    3,
    11,
    10,
...
extern "C" const sfem::codegen::KernelDiagnostics *saint_venant_kirchhoff_tet10_tet10_apply_soa_diagnostics(void) {
    return &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_apply_soa_diagnostics_data;
}
...
extern "C" double saint_venant_kirchhoff_tet10_tet10_apply_soa_arithmetic_intensity(
        ...
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::saint_venant_kirchhoff_tet10_tet10_apply_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_apply_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_tet10_apply_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_apply_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_tet10_apply_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_apply_affine_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "saint_venant_kirchhoff_tet10_tet10_apply_affine_mesh_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_apply_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "saint_venant_kirchhoff_tet10_tet10_apply_affine_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_apply_isoparametric_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_tet10_apply_isoparametric_mesh_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_tet10_apply_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_tet10_apply_isoparametric_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_tet10_apply_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        saint_venant_kirchhoff_d3_simplex_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, affine_grad_ref_x, affine_grad_ref_y, affine_grad_ref_z, affine_q_weight, lmbda, mu, block_u_streams, block_h_streams, block_out_streams);
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_apply_affine_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_apply_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_tet10_apply_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        saint_venant_kirchhoff_d3_simplex_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, isoparametric_grad_ref_x, isoparametric_grad_ref_y, isoparametric_grad_ref_z, isoparametric_q_weight, lmbda, mu, block_u_streams, block_h_streams, block_out_streams);
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_apply_isoparametric_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_apply_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_apply_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_apply_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
static SFEM_INLINE void saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_find_cols(
...
template <typename scalar_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_scatter_bsr(
    ...
    for (int i = 0; i < N_SHAPE; ++i) {
        ...
        saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_find_cols(ev, cols, lenrow, ks);
        for (int j = 0; j < N_SHAPE; ++j) {
            if (ks[j] < 0 || ks[j] >= lenrow || cols[ks[j]] != ev[j]) {
                if (valid_block_graph) {
                    std::fprintf(stderr, "saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_scatter_bsr missing block graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
...
static int saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_assemble_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static) reduction(|:invalid_matrix_graph)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        if constexpr (FORMAT == 1) {
            invalid_matrix_graph |= (saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_scatter_bsr(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 0) {
            invalid_matrix_graph |= (saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_scatter_crs(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 2) {
            invalid_matrix_graph |= (saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_scatter_dia(ev, element_matrix, nnodes, diag_offsets, ndiag, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 3) {
            invalid_matrix_graph |= (saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_scatter_coo(ev, element_matrix, coo_nnz, coo_rows, coo_cols, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 5) {
            saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_scatter_coo_triplets(ev, element_matrix, element, coo_triplet_rows, coo_triplet_cols, values);
        } else {
            invalid_matrix_graph |= (saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_scatter_patch(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
        }
    }
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_hessian_bsr_isoparametric_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 1>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr);
}
...
extern "C" int saint_venant_kirchhoff_tet10_tet10_hessian_bsr_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_tet10_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 1>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr);
}
