...
extern "C" double saint_venant_kirchhoff_tet10_objective_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::saint_venant_kirchhoff_tet10_objective_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void saint_venant_kirchhoff_tet10_objective_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_objective_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_objective_soa_diagnostics_data,
...
extern "C" void saint_venant_kirchhoff_tet10_objective_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_objective_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs,
...
extern "C" void saint_venant_kirchhoff_tet10_objective_affine_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "saint_venant_kirchhoff_tet10_objective_affine_mesh_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_objective_affine_mesh_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "saint_venant_kirchhoff_tet10_objective_affine_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void saint_venant_kirchhoff_tet10_objective_isoparametric_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_objective_isoparametric_mesh_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_objective_isoparametric_mesh_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_objective_isoparametric_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static SFEM_INLINE int saint_venant_kirchhoff_tet10_objective_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_objective_steps_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int saint_venant_kirchhoff_tet10_objective_steps_affine_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_objective_steps_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int saint_venant_kirchhoff_tet10_objective_steps_affine_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_objective_steps_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
static SFEM_INLINE int saint_venant_kirchhoff_tet10_objective_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
...
extern "C" int saint_venant_kirchhoff_tet10_objective_isoparametric_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_objective_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
extern "C" int saint_venant_kirchhoff_tet10_objective_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_objective_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_objective_steps_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int saint_venant_kirchhoff_tet10_objective_steps_isoparametric_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_objective_steps_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int saint_venant_kirchhoff_tet10_objective_steps_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_objective_steps_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" double saint_venant_kirchhoff_tet10_gradient_soa_arithmetic_intensity(
        ...
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::saint_venant_kirchhoff_tet10_gradient_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void saint_venant_kirchhoff_tet10_gradient_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_gradient_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_gradient_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_gradient_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void saint_venant_kirchhoff_tet10_gradient_affine_mesh_soa_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "saint_venant_kirchhoff_tet10_gradient_affine_mesh_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_gradient_affine_mesh_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "saint_venant_kirchhoff_tet10_gradient_affine_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void saint_venant_kirchhoff_tet10_gradient_isoparametric_mesh_soa_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_gradient_isoparametric_mesh_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_gradient_isoparametric_mesh_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_gradient_isoparametric_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_gradient_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int saint_venant_kirchhoff_tet10_gradient_affine_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_gradient_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int saint_venant_kirchhoff_tet10_gradient_affine_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_gradient_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_gradient_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int saint_venant_kirchhoff_tet10_gradient_isoparametric_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_gradient_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int saint_venant_kirchhoff_tet10_gradient_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_gradient_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" double saint_venant_kirchhoff_tet10_apply_soa_arithmetic_intensity(
        ...
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::saint_venant_kirchhoff_tet10_apply_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void saint_venant_kirchhoff_tet10_apply_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_apply_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_apply_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "saint_venant_kirchhoff_tet10_apply_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void saint_venant_kirchhoff_tet10_apply_affine_mesh_soa_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "saint_venant_kirchhoff_tet10_apply_affine_mesh_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_apply_affine_mesh_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "saint_venant_kirchhoff_tet10_apply_affine_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void saint_venant_kirchhoff_tet10_apply_isoparametric_mesh_soa_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_apply_isoparametric_mesh_soa",
            &sfem::codegen::saint_venant_kirchhoff_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void saint_venant_kirchhoff_tet10_apply_isoparametric_mesh_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "saint_venant_kirchhoff_tet10_apply_isoparametric_mesh_soa_float",
            &sfem::codegen::saint_venant_kirchhoff_tet10_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_apply_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int saint_venant_kirchhoff_tet10_apply_affine_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_apply_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int saint_venant_kirchhoff_tet10_apply_affine_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_apply_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_apply_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int saint_venant_kirchhoff_tet10_apply_isoparametric_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_apply_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int saint_venant_kirchhoff_tet10_apply_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_apply_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
static SFEM_INLINE void saint_venant_kirchhoff_tet10_hessian_isoparametric_mesh_soa_find_cols(
...
template <typename scalar_t>
static SFEM_INLINE int saint_venant_kirchhoff_tet10_hessian_isoparametric_mesh_soa_scatter_bsr(
    ...
    for (int i = 0; i < N_SHAPE; ++i) {
        ...
        saint_venant_kirchhoff_tet10_hessian_isoparametric_mesh_soa_find_cols(ev, cols, lenrow, ks);
        for (int j = 0; j < N_SHAPE; ++j) {
            if (ks[j] < 0 || ks[j] >= lenrow || cols[ks[j]] != ev[j]) {
                if (valid_block_graph) {
                    std::fprintf(stderr, "saint_venant_kirchhoff_tet10_hessian_isoparametric_mesh_soa_scatter_bsr missing block graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
...
static int saint_venant_kirchhoff_tet10_hessian_isoparametric_mesh_soa_assemble_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static) reduction(|:invalid_matrix_graph)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        if constexpr (FORMAT == 1) {
            invalid_matrix_graph |= (saint_venant_kirchhoff_tet10_hessian_isoparametric_mesh_soa_scatter_bsr(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
        } else {
...
extern "C" int saint_venant_kirchhoff_tet10_hessian_bsr_isoparametric_mesh_soa(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 1>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr);
}
...
extern "C" int saint_venant_kirchhoff_tet10_hessian_bsr_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::saint_venant_kirchhoff_tet10_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 1>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr);
}
