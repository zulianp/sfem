#ifndef SAINT_VENANT_KIRCHHOFF_PROTEUS_HEX64_ELEMENT_API_CUH
#define SAINT_VENANT_KIRCHHOFF_PROTEUS_HEX64_ELEMENT_API_CUH
...
static __host__ __device__ __forceinline__ int saint_venant_kirchhoff_proteus_hex64_energy_egeometry_soa(
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    saint_venant_kirchhoff_d3_tensor_product_objective_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::ref_line_p3_q5<s_t>::shape_1d(), sfem::codegen::ref_line_p3_q5<s_t>::grad_1d(), sfem::codegen::quad_line_q5<s_t>::q_weight_1d(), lmbda, mu, bu_streams, bu_streams, 1, &objective_step, 0, bvalue);
  }
  return SFEM_SUCCESS;
}

template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int saint_venant_kirchhoff_proteus_hex64_energy_ecoords_soa(
        const ptrdiff_t nelements,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int saint_venant_kirchhoff_proteus_hex64_energy_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int saint_venant_kirchhoff_proteus_hex64_gradient_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    saint_venant_kirchhoff_d3_tensor_product_gradient_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::ref_line_p3_q5<s_t>::shape_1d(), sfem::codegen::ref_line_p3_q5<s_t>::grad_1d(), sfem::codegen::quad_line_q5<s_t>::q_weight_1d(), lmbda, mu, bu_streams, bout_streams);
  }
  return SFEM_SUCCESS;
}

template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int saint_venant_kirchhoff_proteus_hex64_gradient_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int saint_venant_kirchhoff_proteus_hex64_gradient_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int saint_venant_kirchhoff_proteus_hex64_hessian_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    for (int col = 0; col < NDOFS; ++col) {
      ...
      saint_venant_kirchhoff_d3_tensor_product_apply_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::ref_line_p3_q5<s_t>::shape_1d(), sfem::codegen::ref_line_p3_q5<s_t>::grad_1d(), sfem::codegen::quad_line_q5<s_t>::q_weight_1d(), lmbda, mu, bu_streams, bh_streams, bout_streams);
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int saint_venant_kirchhoff_proteus_hex64_hessian_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int saint_venant_kirchhoff_proteus_hex64_hessian_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
