...
static const MatrixAssemblyDiagnostics *const linear_elasticity_proteus_hex27_matrix_assembly_variants[1] = {
...
const MatrixAssemblyDiagnostics *linear_elasticity_proteus_hex27_matrix_assembly_variant(const int variant) {
    return (variant >= 0 && variant < 1) ? linear_elasticity_proteus_hex27_matrix_assembly_variants[variant] : nullptr;
}
