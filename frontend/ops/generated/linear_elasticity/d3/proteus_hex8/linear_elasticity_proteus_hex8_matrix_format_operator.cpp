...
static const MatrixAssemblyDiagnostics linear_elasticity_proteus_hex8_bsr_standard_matrix_assembly_diagnostics_data = {
    "bsr",
    "standard",
    "none",
...
void linear_elasticity_proteus_hex8_matrix_assembly_print_variant(const int variant, const ptrdiff_t nelements) {
    const MatrixAssemblyDiagnostics *const d = linear_elasticity_proteus_hex8_matrix_assembly_variant(variant);
    if (d) {
        MatrixAssemblyDiagnostics_print("linear_elasticity_proteus_hex8", d, nelements);
    }
}
...
extern "C" int linear_elasticity_proteus_hex8_matrix_assembly_variant_count() {
    return sfem::codegen::linear_elasticity_proteus_hex8_matrix_assembly_variant_count();
}

extern "C" const sfem_MatrixAssemblyDiagnostics *linear_elasticity_proteus_hex8_matrix_assembly_variant(const int variant) {
    return sfem::codegen::linear_elasticity_proteus_hex8_matrix_assembly_variant(variant);
}

extern "C" void linear_elasticity_proteus_hex8_matrix_assembly_print_variant(const int variant, const ptrdiff_t nelements) {
    sfem::codegen::linear_elasticity_proteus_hex8_matrix_assembly_print_variant(variant, nelements);
}
