...
static SFEM_INLINE int linear_elasticity_proteus_hex8_objective_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
...
extern "C" int linear_elasticity_proteus_hex8_objective_affine_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_proteus_hex8_objective_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
extern "C" int linear_elasticity_proteus_hex8_objective_affine_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_proteus_hex8_objective_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
static SFEM_INLINE int linear_elasticity_proteus_hex8_objective_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
...
extern "C" int linear_elasticity_proteus_hex8_objective_isoparametric_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_proteus_hex8_objective_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
extern "C" int linear_elasticity_proteus_hex8_objective_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_proteus_hex8_objective_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
template <typename scalar_t>
static SFEM_INLINE int linear_elasticity_proteus_hex8_hessian_isoparametric_mesh_soa_scatter_bsr(
        ...
        for (int j = 0; j < N_SHAPE; ++j) {
            if (ks[j] < 0 || ks[j] >= lenrow || cols[ks[j]] != ev[j]) {
                if (valid_block_graph) {
                    std::fprintf(stderr, "linear_elasticity_proteus_hex8_hessian_isoparametric_mesh_soa_scatter_bsr missing block graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
...
#pragma omp parallel for schedule(static) reduction(|:invalid_matrix_graph)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        if constexpr (FORMAT == 1) {
            invalid_matrix_graph |= (linear_elasticity_proteus_hex8_hessian_isoparametric_mesh_soa_scatter_bsr(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
