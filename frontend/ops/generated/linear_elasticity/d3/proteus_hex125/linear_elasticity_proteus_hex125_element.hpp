#ifndef LINEAR_ELASTICITY_PROTEUS_HEX125_ELEMENT_API_HPP
#define LINEAR_ELASTICITY_PROTEUS_HEX125_ELEMENT_API_HPP
        ...
        struct linear_elasticity_proteus_hex125_isoparametric_reference_data {
            static const scalar_t *shape_1d() {
                static const scalar_t data[30] = {
                        scalar_t(0.74421243257482506),   scalar_t(0.46483764017848167),   scalar_t(-0.3233801835384143),
                        scalar_t(0.14033674464838758),   scalar_t(-0.02600663386327997),  scalar_t(0.1370796510851644),
                        scalar_t(1.1523224574482651),    scalar_t(-0.42142141395480076),  scalar_t(0.15997562415667735),
                        scalar_t(-0.027956318735306136), scalar_t(-0.038040498051401792), scalar_t(0.44323536887287845),
                        scalar_t(0.72827267187338052),   scalar_t(-0.15685108599339564),  scalar_t(0.02338354329853843),
                        scalar_t(0.023383543298538433),  scalar_t(-0.1568510859933957),   scalar_t(0.7282726718733803),
                        scalar_t(0.44323536887287873),   scalar_t(-0.038040498051401805), scalar_t(-0.02795631873530614),
                        scalar_t(0.15997562415667732),   scalar_t(-0.42142141395480076),  scalar_t(1.1523224574482653),
                        scalar_t(0.1370796510851644),    scalar_t(-0.02600663386327997),  scalar_t(0.14033674464838758),
                        scalar_t(-0.3233801835384143),   scalar_t(0.46483764017848161),   scalar_t(0.74421243257482506)};
                return data;
            }
            static const scalar_t *grad_1d() {
                static const scalar_t data[30] = {
                        scalar_t(-6.847186854894237),    scalar_t(11.639662813272302),    scalar_t(-7.2956234240766964),
                        scalar_t(3.0610058279134376),    scalar_t(-0.55785836221480534),  scalar_t(-2.5164082145971007),
                        scalar_t(-0.054958388683796322), scalar_t(3.9736493619038797),    scalar_t(-1.716790699367966),
                        scalar_t(0.31450794074498367),   scalar_t(0.19219357747626689),   scalar_t(-4.4665740596400347),
                        scalar_t(4.3376072253969262),    scalar_t(-0.044266581778818759), scalar_t(-0.01896016145434104),
                        scalar_t(0.018960161454340804),  scalar_t(0.044266581778820424),  scalar_t(-4.3376072253969298),
                        scalar_t(4.4665740596400356),    scalar_t(-0.19219357747626675),  scalar_t(-0.31450794074498367),
                        scalar_t(1.716790699367966),     scalar_t(-3.9736493619038806),   scalar_t(0.05495838868379721),
                        scalar_t(2.5164082145971007),    scalar_t(0.55785836221480523),   scalar_t(-3.0610058279134367),
                        scalar_t(7.2956234240766964),    scalar_t(-11.639662813272302),   scalar_t(6.8471868548942378)};
                return data;
            }
            static const scalar_t *q_weight_1d() {
                static const scalar_t data[6] = {scalar_t(0.085662246189585178),
                                                 scalar_t(0.18038078652406936),
                                                 scalar_t(0.23395696728634555),
                                                 scalar_t(0.23395696728634555),
                                                 scalar_t(0.18038078652406936),
                                                 scalar_t(0.085662246189585178)};
                return data;
            }
        };

        template <typename scalar_t, int VECTOR_SIZE = 16>
        static SFEM_INLINE int linear_elasticity_proteus_hex125_energy_element_geometry_soa(
...
#pragma omp simd
                    for (int lane = 0; lane < nelems; ++lane) {
                        ...
                        block_jacobian_determinant0[q * VECTOR_SIZE + lane] =
                                jacobian_determinant[q * nelements + evbegin + lane];
                    }
                }
                linear_elasticity_d3_tensor_product_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(
                        ...
                        sfem::codegen::linear_elasticity_proteus_hex125_isoparametric_reference_data<scalar_t>::shape_1d(),
                        sfem::codegen::linear_elasticity_proteus_hex125_isoparametric_reference_data<scalar_t>::grad_1d(),
                        sfem::codegen::linear_elasticity_proteus_hex125_isoparametric_reference_data<scalar_t>::q_weight_1d(),
                        lmbda,
                        mu,
                        block_u_streams,
                        block_value);
        ...
        template <typename scalar_t, int VECTOR_SIZE = 16>
        static SFEM_INLINE int linear_elasticity_proteus_hex125_energy_element_coords_soa(
                const ptrdiff_t                            nelements,
...
#pragma omp simd
        ...
        template <typename scalar_t, int VECTOR_SIZE = 16>
        static SFEM_INLINE int linear_elasticity_proteus_hex125_energy_element_soa(
                const ptrdiff_t                            nelements,
                const scalar_t *const *const SFEM_RESTRICT coords,
                const scalar_t                             lmbda,
                const scalar_t                             mu,
...
#pragma omp simd
        ...
        template <typename scalar_t, int VECTOR_SIZE = 16>
        static SFEM_INLINE int linear_elasticity_proteus_hex125_gradient_element_geometry_soa(
                const ptrdiff_t                            nelements,
                const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
                const scalar_t *const SFEM_RESTRICT        jacobian_determinant,
                const scalar_t                             lmbda,
...
#pragma omp simd
        ...
        template <typename scalar_t, int VECTOR_SIZE = 16>
        static SFEM_INLINE int linear_elasticity_proteus_hex125_gradient_element_coords_soa(
                const ptrdiff_t                            nelements,
                const scalar_t *const *const SFEM_RESTRICT coords,
                const scalar_t                             lmbda,
                const scalar_t                             mu,
...
#pragma omp simd
        ...
        template <typename scalar_t, int VECTOR_SIZE = 16>
        static SFEM_INLINE int linear_elasticity_proteus_hex125_gradient_element_soa(
                const ptrdiff_t                            nelements,
                const scalar_t *const *const SFEM_RESTRICT coords,
                const scalar_t                             lmbda,
                const scalar_t                             mu,
...
#pragma omp simd
        ...
        template <typename scalar_t, int VECTOR_SIZE = 16>
        static SFEM_INLINE int linear_elasticity_proteus_hex125_hessian_element_geometry_soa(
                const ptrdiff_t                            nelements,
                const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
                const scalar_t *const SFEM_RESTRICT        jacobian_determinant,
                const scalar_t                             lmbda,
...
#pragma omp simd
        ...
        template <typename scalar_t, int VECTOR_SIZE = 16>
        static SFEM_INLINE int linear_elasticity_proteus_hex125_hessian_element_coords_soa(
                const ptrdiff_t                            nelements,
                const scalar_t *const *const SFEM_RESTRICT coords,
                const scalar_t                             lmbda,
                const scalar_t                             mu,
...
#pragma omp simd
        ...
        template <typename scalar_t, int VECTOR_SIZE = 16>
        static SFEM_INLINE int linear_elasticity_proteus_hex125_hessian_element_soa(
                const ptrdiff_t                            nelements,
                const scalar_t *const *const SFEM_RESTRICT coords,
                const scalar_t                             lmbda,
                const scalar_t                             mu,
