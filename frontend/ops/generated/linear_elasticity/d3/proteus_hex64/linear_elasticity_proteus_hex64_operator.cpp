...
static SFEM_INLINE void linear_elasticity_proteus_hex64_hessian_isoparametric_mesh_soa_find_cols(
...
template <typename scalar_t>
static SFEM_INLINE void linear_elasticity_proteus_hex64_hessian_isoparametric_mesh_soa_scatter_bsr(
    ...
    for (int i = 0; i < N_SHAPE; ++i) {
        ...
        linear_elasticity_proteus_hex64_hessian_isoparametric_mesh_soa_find_cols(ev, cols, lenrow, ks);
...
#pragma omp parallel for schedule(static) reduction(|:unsupported_matrix_format)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        if constexpr (FORMAT == 1) {
            linear_elasticity_proteus_hex64_hessian_isoparametric_mesh_soa_scatter_bsr(ev, element_matrix, rowptr, colidx, values);
...
extern "C" int linear_elasticity_proteus_hex64_hessian_bsr_isoparametric_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_proteus_hex64_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 1>(nelements, nnodes, elements, points, lmbda, mu, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr);
}
