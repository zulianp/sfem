...
extern "C" int linear_elasticity_tet10_inexact_apply_tangent_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("linear_elasticity_tet10_inexact_apply_tangent_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int linear_elasticity_tet10_inexact_apply_stored_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("linear_elasticity_tet10_inexact_apply_stored_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int linear_elasticity_tet10_inexact_apply_stored_packed_two_pass_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
      return sfem::codegen::linear_elasticity_tet10_inexact_apply_stored_packed_two_pass_a_msoa_impl<double, metric_tensor_t, 16>(
    ...
    case (int)sizeof(float): {
      return sfem::codegen::linear_elasticity_tet10_inexact_apply_stored_packed_two_pass_a_msoa_impl<float, metric_tensor_t, 16>(
  ...
  return sfem::codegen::unsupported_dispatch("linear_elasticity_tet10_inexact_apply_stored_packed_two_pass_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int linear_elasticity_tet10_inexact_apply_compressed_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("linear_elasticity_tet10_inexact_apply_compressed_a_msoa", -1, (int)scalar_bytes);
}
