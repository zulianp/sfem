...
static SFEM_INLINE int linear_elasticity_tet10_gradient_element_geometry_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        linear_elasticity_d3_simplex_gradient_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::linear_elasticity_tet10_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::linear_elasticity_tet10_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::linear_elasticity_tet10_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::linear_elasticity_tet10_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bout_streams);
    }
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int linear_elasticity_tet10_hessian_element_geometry_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        for (int col = 0; col < NDOFS; ++col) {
            ...
            linear_elasticity_d3_simplex_apply_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::linear_elasticity_tet10_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::linear_elasticity_tet10_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::linear_elasticity_tet10_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::linear_elasticity_tet10_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bh_streams, bout_streams);
