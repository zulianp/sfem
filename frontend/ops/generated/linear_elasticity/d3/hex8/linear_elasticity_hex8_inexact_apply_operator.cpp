...
extern "C" int linear_elasticity_hex8_inexact_apply_compressed_a_msoa(
    ...
    return linear_elasticity_proteus_hex8_inexact_apply_compressed_a_msoa(scalar_bytes, nelements, proteus_elements, tangent_component_stride, tangent, scaling, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int linear_elasticity_hex8_inexact_apply_stored_a_msoa(
    ...
    return linear_elasticity_proteus_hex8_inexact_apply_stored_a_msoa(scalar_bytes, nelements, proteus_elements, tangent_component_stride, tangent, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int linear_elasticity_hex8_inexact_apply_tangent_a_msoa(
    ...
    return linear_elasticity_proteus_hex8_inexact_apply_tangent_a_msoa(scalar_bytes, nelements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, tangent_component_stride, tangent);
}
