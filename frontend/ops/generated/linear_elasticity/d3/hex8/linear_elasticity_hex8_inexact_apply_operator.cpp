...
#include "linear_elasticity_hex8_inexact_apply_inline.hpp"

namespace sfem {
namespace codegen {

static const KernelDiagnostics linear_elasticity_hex8_inexact_apply_tangent_a_msoa_diagnostics_data = {
  "linear_elasticity_hex8_inexact_apply_tangent_a_msoa",
  "HEX8",
  3,
  8,
  8,
...
static const KernelDiagnostics linear_elasticity_hex8_inexact_apply_stored_a_msoa_diagnostics_data = {
  "linear_elasticity_hex8_inexact_apply_stored_a_msoa",
  "HEX8",
  3,
  0,
  8,
...
static const KernelDiagnostics linear_elasticity_hex8_inexact_apply_compressed_a_msoa_diagnostics_data = {
  "linear_elasticity_hex8_inexact_apply_compressed_a_msoa",
  "HEX8",
  3,
  0,
  8,
...
extern "C" const sfem::codegen::KernelDiagnostics *linear_elasticity_hex8_inexact_apply_tangent_a_msoa_diagnostics(void) {
  return &sfem::codegen::linear_elasticity_hex8_inexact_apply_tangent_a_msoa_diagnostics_data;
}
extern "C" const sfem::codegen::KernelDiagnostics *linear_elasticity_hex8_inexact_apply_stored_a_msoa_diagnostics(void) {
  return &sfem::codegen::linear_elasticity_hex8_inexact_apply_stored_a_msoa_diagnostics_data;
}
extern "C" const sfem::codegen::KernelDiagnostics *linear_elasticity_hex8_inexact_apply_compressed_a_msoa_diagnostics(void) {
  return &sfem::codegen::linear_elasticity_hex8_inexact_apply_compressed_a_msoa_diagnostics_data;
}
...
extern "C" int linear_elasticity_hex8_inexact_apply_tangent_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
      return sfem::codegen::linear_elasticity_hex8_inexact_apply_tangent_a_msoa_impl<double, geom_t, metric_tensor_t, 16>(
    ...
    case (int)sizeof(float): {
      return sfem::codegen::linear_elasticity_hex8_inexact_apply_tangent_a_msoa_impl<float, geom_t, metric_tensor_t, 16>(
          nelements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, tangent_component_stride, tangent);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("linear_elasticity_hex8_inexact_apply_tangent_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int linear_elasticity_hex8_inexact_apply_stored_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("linear_elasticity_hex8_inexact_apply_stored_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int linear_elasticity_hex8_inexact_apply_stored_packed_two_pass_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
      return sfem::codegen::linear_elasticity_hex8_inexact_apply_stored_packed_two_pass_a_msoa_impl<double, metric_tensor_t, 16>(
    ...
    case (int)sizeof(float): {
      return sfem::codegen::linear_elasticity_hex8_inexact_apply_stored_packed_two_pass_a_msoa_impl<float, metric_tensor_t, 16>(
  ...
  return sfem::codegen::unsupported_dispatch("linear_elasticity_hex8_inexact_apply_stored_packed_two_pass_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int linear_elasticity_hex8_inexact_apply_compressed_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
      return sfem::codegen::linear_elasticity_hex8_inexact_apply_compressed_a_msoa_impl<double, compressed_t, scaling_t>(
    ...
    case (int)sizeof(float): {
      return sfem::codegen::linear_elasticity_hex8_inexact_apply_compressed_a_msoa_impl<float, compressed_t, scaling_t>(
  ...
  return sfem::codegen::unsupported_dispatch("linear_elasticity_hex8_inexact_apply_compressed_a_msoa", -1, (int)scalar_bytes);
}
