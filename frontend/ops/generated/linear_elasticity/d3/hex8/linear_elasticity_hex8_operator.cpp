...
struct linear_elasticity_hex8_affine_reference_data {
...
template <typename scalar_t>
struct linear_elasticity_hex8_isoparametric_reference_data {
    static const scalar_t *shape_1d() {
        static const scalar_t data[4] = {scalar_t(0.78867513459481287), scalar_t(0.21132486540518708), scalar_t(0.21132486540518713), scalar_t(0.78867513459481287)};
        return data;
    }
...
static const KernelDiagnostics linear_elasticity_hex8_hex8_objective_soa_diagnostics_data = {
    "linear_elasticity_hex8_hex8_objective_soa",
    "HEX8",
    3,
    8,
    8,
...
extern "C" const sfem::codegen::KernelDiagnostics *linear_elasticity_hex8_hex8_objective_soa_diagnostics(void) {
    return &sfem::codegen::linear_elasticity_hex8_hex8_objective_soa_diagnostics_data;
}
...
extern "C" double linear_elasticity_hex8_hex8_objective_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::linear_elasticity_hex8_hex8_objective_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void linear_elasticity_hex8_hex8_objective_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "linear_elasticity_hex8_hex8_objective_soa_float",
            &sfem::codegen::linear_elasticity_hex8_hex8_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
static SFEM_INLINE int linear_elasticity_hex8_hex8_objective_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const affine_shape_1d = sfem::codegen::linear_elasticity_hex8_affine_reference_data<scalar_t>::shape_1d();
    const scalar_t *const affine_grad_1d = sfem::codegen::linear_elasticity_hex8_affine_reference_data<scalar_t>::grad_1d();
    const scalar_t *const affine_q_weight_1d = sfem::codegen::linear_elasticity_hex8_affine_reference_data<scalar_t>::q_weight_1d();
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int linear_elasticity_hex8_hex8_objective_steps_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int linear_elasticity_hex8_hex8_objective_steps_affine_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_objective_steps_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
static SFEM_INLINE int linear_elasticity_hex8_hex8_objective_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    const scalar_t *const isoparametric_shape_1d = sfem::codegen::linear_elasticity_hex8_isoparametric_reference_data<scalar_t>::shape_1d();
    const scalar_t *const isoparametric_grad_1d = sfem::codegen::linear_elasticity_hex8_isoparametric_reference_data<scalar_t>::grad_1d();
    const scalar_t *const isoparametric_q_weight_1d = sfem::codegen::linear_elasticity_hex8_isoparametric_reference_data<scalar_t>::q_weight_1d();
    static constexpr int N_QP_1D = 2;
    static constexpr int N_SHAPE_1D = 2;
...
extern "C" int linear_elasticity_hex8_hex8_objective_isoparametric_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_objective_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, value);
}
...
extern "C" int linear_elasticity_hex8_hex8_objective_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_objective_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, value);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int linear_elasticity_hex8_hex8_objective_steps_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int linear_elasticity_hex8_hex8_objective_steps_isoparametric_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_objective_steps_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int linear_elasticity_hex8_hex8_objective_steps_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_objective_steps_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
static const KernelDiagnostics linear_elasticity_hex8_hex8_gradient_soa_diagnostics_data = {
    "linear_elasticity_hex8_hex8_gradient_soa",
    "HEX8",
    3,
    8,
    8,
...
extern "C" const sfem::codegen::KernelDiagnostics *linear_elasticity_hex8_hex8_gradient_soa_diagnostics(void) {
    return &sfem::codegen::linear_elasticity_hex8_hex8_gradient_soa_diagnostics_data;
}
...
extern "C" double linear_elasticity_hex8_hex8_gradient_soa_arithmetic_intensity(
        ...
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::linear_elasticity_hex8_hex8_gradient_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void linear_elasticity_hex8_hex8_gradient_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "linear_elasticity_hex8_hex8_gradient_soa_float",
            &sfem::codegen::linear_elasticity_hex8_hex8_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int linear_elasticity_hex8_hex8_gradient_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int linear_elasticity_hex8_hex8_gradient_affine_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_gradient_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int linear_elasticity_hex8_hex8_gradient_affine_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_gradient_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int linear_elasticity_hex8_hex8_gradient_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int linear_elasticity_hex8_hex8_gradient_isoparametric_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_gradient_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int linear_elasticity_hex8_hex8_gradient_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_gradient_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
static const KernelDiagnostics linear_elasticity_hex8_hex8_apply_soa_diagnostics_data = {
    "linear_elasticity_hex8_hex8_apply_soa",
    "HEX8",
    3,
    8,
    8,
...
extern "C" const sfem::codegen::KernelDiagnostics *linear_elasticity_hex8_hex8_apply_soa_diagnostics(void) {
    return &sfem::codegen::linear_elasticity_hex8_hex8_apply_soa_diagnostics_data;
}
...
extern "C" double linear_elasticity_hex8_hex8_apply_soa_arithmetic_intensity(
        ...
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::linear_elasticity_hex8_hex8_apply_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void linear_elasticity_hex8_hex8_apply_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "linear_elasticity_hex8_hex8_apply_soa_float",
            &sfem::codegen::linear_elasticity_hex8_hex8_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int linear_elasticity_hex8_hex8_apply_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int linear_elasticity_hex8_hex8_apply_affine_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_apply_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int linear_elasticity_hex8_hex8_apply_affine_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_apply_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int linear_elasticity_hex8_hex8_apply_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int linear_elasticity_hex8_hex8_apply_isoparametric_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_apply_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int linear_elasticity_hex8_hex8_apply_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_hex8_hex8_apply_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
