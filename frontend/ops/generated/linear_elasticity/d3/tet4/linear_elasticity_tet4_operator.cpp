...
extern "C" int linear_elasticity_tet4_tet4_objective_isoparametric_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_tet4_tet4_objective_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, value);
}
...
extern "C" int linear_elasticity_tet4_tet4_objective_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_tet4_tet4_objective_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, value);
}
...
extern "C" int linear_elasticity_tet4_tet4_objective_steps_isoparametric_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_tet4_tet4_objective_steps_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int linear_elasticity_tet4_tet4_objective_steps_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_tet4_tet4_objective_steps_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int linear_elasticity_tet4_tet4_gradient_isoparametric_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_tet4_tet4_gradient_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int linear_elasticity_tet4_tet4_gradient_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_tet4_tet4_gradient_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int linear_elasticity_tet4_tet4_apply_isoparametric_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_tet4_tet4_apply_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int linear_elasticity_tet4_tet4_apply_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_tet4_tet4_apply_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
