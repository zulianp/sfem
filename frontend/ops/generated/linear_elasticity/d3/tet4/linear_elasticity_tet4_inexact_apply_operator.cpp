...
static const KernelDiagnostics linear_elasticity_tet4_inexact_apply_tangent_a_msoa_diagnostics_data = {
  "linear_elasticity_tet4_inexact_apply_tangent_a_msoa",
  "TET4",
  3,
  1,
  4,
...
static const KernelDiagnostics linear_elasticity_tet4_inexact_apply_stored_a_msoa_diagnostics_data = {
  "linear_elasticity_tet4_inexact_apply_stored_a_msoa",
  "TET4",
  3,
  0,
  4,
...
static const KernelDiagnostics linear_elasticity_tet4_inexact_apply_compressed_a_msoa_diagnostics_data = {
  "linear_elasticity_tet4_inexact_apply_compressed_a_msoa",
  "TET4",
  3,
  0,
  4,
...
extern "C" const sfem::codegen::KernelDiagnostics *linear_elasticity_tet4_inexact_apply_tangent_a_msoa_diagnostics(void) {
  return &sfem::codegen::linear_elasticity_tet4_inexact_apply_tangent_a_msoa_diagnostics_data;
}
extern "C" const sfem::codegen::KernelDiagnostics *linear_elasticity_tet4_inexact_apply_stored_a_msoa_diagnostics(void) {
  return &sfem::codegen::linear_elasticity_tet4_inexact_apply_stored_a_msoa_diagnostics_data;
}
extern "C" const sfem::codegen::KernelDiagnostics *linear_elasticity_tet4_inexact_apply_compressed_a_msoa_diagnostics(void) {
  return &sfem::codegen::linear_elasticity_tet4_inexact_apply_compressed_a_msoa_diagnostics_data;
}
