...
static SFEM_INLINE int linear_elasticity_tet4_energy_element_geometry_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        linear_elasticity_d3_simplex_objective_block<s_t, NQ, NS, VS>(nelems, VS, bjacobian_adjugate0, bjacobian_adjugate1, bjacobian_adjugate2, bjacobian_adjugate3, bjacobian_adjugate4, bjacobian_adjugate5, bjacobian_adjugate6, bjacobian_adjugate7, bjacobian_adjugate8, bjacobian_determinant0, sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bvalue);
    }
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int linear_elasticity_tet4_energy_element_coords_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        s_t bjacobian_adjugate8[NQ * VS];
        s_t bjacobian_determinant0[NQ * VS];
        const s_t *const grad_ref_x = sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_x();
        const s_t *const grad_ref_y = sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_y();
        const s_t *const grad_ref_z = sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_z();
        {
            const int q = 0;  // TET4 evaluates in closed form
...
static SFEM_INLINE int linear_elasticity_tet4_gradient_element_geometry_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        linear_elasticity_d3_simplex_gradient_block<s_t, NQ, NS, VS>(nelems, VS, bjacobian_adjugate0, bjacobian_adjugate1, bjacobian_adjugate2, bjacobian_adjugate3, bjacobian_adjugate4, bjacobian_adjugate5, bjacobian_adjugate6, bjacobian_adjugate7, bjacobian_adjugate8, bjacobian_determinant0, sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bout_streams);
    }
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int linear_elasticity_tet4_hessian_element_geometry_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        for (int col = 0; col < NDOFS; ++col) {
            ...
            linear_elasticity_d3_simplex_apply_block<s_t, NQ, NS, VS>(nelems, VS, bjacobian_adjugate0, bjacobian_adjugate1, bjacobian_adjugate2, bjacobian_adjugate3, bjacobian_adjugate4, bjacobian_adjugate5, bjacobian_adjugate6, bjacobian_adjugate7, bjacobian_adjugate8, bjacobian_determinant0, sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::linear_elasticity_tet4_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bh_streams, bout_streams);
