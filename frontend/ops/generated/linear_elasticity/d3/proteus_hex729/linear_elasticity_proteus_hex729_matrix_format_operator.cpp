...
static const MatrixAssemblyDiagnostics linear_elasticity_proteus_hex729_block_diag_sym_standard_matrix_assembly_diagnostics_data = {
    "block_diag_sym",
    "standard",
    "none",
    "unspecified",
...
static const MatrixAssemblyDiagnostics *const linear_elasticity_proteus_hex729_matrix_assembly_variants[2] = {
    &linear_elasticity_proteus_hex729_bsr_standard_matrix_assembly_diagnostics_data,
    &linear_elasticity_proteus_hex729_block_diag_sym_standard_matrix_assembly_diagnostics_data,
};
...
const MatrixAssemblyDiagnostics *linear_elasticity_proteus_hex729_matrix_assembly_variant(const int variant) {
    return (variant >= 0 && variant < 2) ? linear_elasticity_proteus_hex729_matrix_assembly_variants[variant] : nullptr;
}
