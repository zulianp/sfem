...
extern "C" int linear_elasticity_proteus_hex729_proteus_hex729_apply_affine_mesh_soa(
    ...
    return sfem::codegen::linear_elasticity_proteus_hex729_proteus_hex729_apply_affine_mesh_soa_impl<double>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int linear_elasticity_proteus_hex729_proteus_hex729_apply_affine_mesh_soa_float(
    ...
    return sfem::codegen::linear_elasticity_proteus_hex729_proteus_hex729_apply_affine_mesh_soa_impl<float>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
