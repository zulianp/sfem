...
namespace sfem {
  ...
  int GPUGeneratedLinearElasticity::hessian_crs(const real_t *const,
  ...
  int GPUGeneratedLinearElasticity::hessian_bsr(const real_t *const,
              const count_t *const rowptr,
              const idx_t *const colidx,
              real_t *const values) {
  ...
  int GPUGeneratedLinearElasticity::hessian_block_diag_sym(const real_t *const,
                                       real_t *const values) {
