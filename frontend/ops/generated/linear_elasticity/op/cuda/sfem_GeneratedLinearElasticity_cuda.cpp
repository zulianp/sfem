  ...
  int GPUGeneratedLinearElasticity::value_steps(const real_t *x,
    ...
    return impl_->domains->iterate([&](const OpDomain &domain) {
      ...
      if (status == SFEM_FAILURE) {
        ...
        if (dim == 2) {
          if (impl_->objective_uses_affine) {
            SFEM_ERROR("linear_elasticity affine objective_steps 2d dispatch was not generated\n");
            return SFEM_FAILURE;
          } else {
            SFEM_ERROR("linear_elasticity isoparametric objective_steps 2d dispatch was not generated\n");
            return SFEM_FAILURE;
          }
        }
        else if (dim == 3) {
          if (impl_->objective_uses_affine) {
            SFEM_ERROR("linear_elasticity affine objective_steps 3d dispatch was not generated\n");
            return SFEM_FAILURE;
          } else {
            SFEM_ERROR("linear_elasticity isoparametric objective_steps 3d dispatch was not generated\n");
            return SFEM_FAILURE;
          }
        }
        if (dim != 2 && dim != 3) {
