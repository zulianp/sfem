...
extern "C" int cu_linear_elasticity_apply_2d_a_msoa(
...
extern "C" int cu_linear_elasticity_apply_2d_i_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_linear_elasticity_apply_2d_soa_diagnostics(
    const smesh::ElemType element_type);

extern "C" int cu_linear_elasticity_apply_3d_a_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_linear_elasticity_apply_3d_a_msoa_aos_unit(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_linear_elasticity_apply_3d_i_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_linear_elasticity_apply_3d_soa_diagnostics(
    const smesh::ElemType element_type);

extern "C" int cu_linear_elasticity_gradient_2d_a_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_linear_elasticity_gradient_2d_i_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_linear_elasticity_gradient_2d_soa_diagnostics(
    const smesh::ElemType element_type);

extern "C" int cu_linear_elasticity_gradient_3d_a_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_linear_elasticity_gradient_3d_a_msoa_aos_unit(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_linear_elasticity_gradient_3d_i_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_linear_elasticity_gradient_3d_soa_diagnostics(
    const smesh::ElemType element_type);
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_linear_elasticity_objective_2d_soa_diagnostics(
    const smesh::ElemType element_type);

extern "C" const sfem::codegen::KernelDiagnostics *cu_linear_elasticity_objective_3d_soa_diagnostics(
    const smesh::ElemType element_type);

extern "C" int cu_linear_elasticity_objective_steps_2d_a_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_linear_elasticity_objective_steps_2d_i_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_linear_elasticity_objective_steps_3d_a_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_linear_elasticity_objective_steps_3d_i_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
