...
static SFEM_INLINE int linear_elasticity_tri3_inexact_apply_tangent_a_msoa_impl(
...
static SFEM_INLINE int linear_elasticity_tri3_inexact_apply_compressed_a_msoa_impl(
    const ptrdiff_t nelements,
    idx_t **const RSTR elements,
    const ptrdiff_t tangent_element_stride,
    const ptrdiff_t tangent_component_stride,
