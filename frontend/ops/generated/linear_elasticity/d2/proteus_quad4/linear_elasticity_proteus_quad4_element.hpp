#ifndef LINEAR_ELASTICITY_PROTEUS_QUAD4_ELEMENT_API_HPP
#define LINEAR_ELASTICITY_PROTEUS_QUAD4_ELEMENT_API_HPP
...
static SFEM_INLINE int linear_elasticity_proteus_quad4_energy_element_geometry_soa(
...
static SFEM_INLINE int linear_elasticity_proteus_quad4_energy_element_coords_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        tensor_gradient_contiguous<s_t, NQ, NS, VS, 2>(nelems, sfem::codegen::linear_elasticity_proteus_quad4_isoparametric_reference_data<s_t>::shape_1d(), sfem::codegen::linear_elasticity_proteus_quad4_isoparametric_reference_data<s_t>::grad_1d(), block_coordinate_data, 0, coordinate_grad_ref + 0 * NQ * ND * VS);
        tensor_gradient_contiguous<s_t, NQ, NS, VS, 2>(nelems, sfem::codegen::linear_elasticity_proteus_quad4_isoparametric_reference_data<s_t>::shape_1d(), sfem::codegen::linear_elasticity_proteus_quad4_isoparametric_reference_data<s_t>::grad_1d(), block_coordinate_data, 1, coordinate_grad_ref + 1 * NQ * ND * VS);
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int linear_elasticity_proteus_quad4_energy_element_soa(
        const ptrdiff_t nelements,
        const s_t *const *const SFEM_RESTRICT coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int linear_elasticity_proteus_quad4_gradient_element_geometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const s_t *const SFEM_RESTRICT jacobian_determinant,
        const s_t lmbda,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int linear_elasticity_proteus_quad4_gradient_element_coords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const SFEM_RESTRICT coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int linear_elasticity_proteus_quad4_gradient_element_soa(
        const ptrdiff_t nelements,
        const s_t *const *const SFEM_RESTRICT coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int linear_elasticity_proteus_quad4_hessian_element_geometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const s_t *const SFEM_RESTRICT jacobian_determinant,
        const s_t lmbda,
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        for (int col = 0; col < NDOFS; ++col) {
            ...
            linear_elasticity_d2_tensor_product_apply_block<s_t, NQ, NS, VS>(nelems, VS, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, sfem::codegen::linear_elasticity_proteus_quad4_isoparametric_reference_data<s_t>::shape_1d(), sfem::codegen::linear_elasticity_proteus_quad4_isoparametric_reference_data<s_t>::grad_1d(), sfem::codegen::linear_elasticity_proteus_quad4_isoparametric_reference_data<s_t>::q_weight_1d(), lmbda, mu, block_h_streams, block_out_streams);
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int linear_elasticity_proteus_quad4_hessian_element_coords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const SFEM_RESTRICT coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int linear_elasticity_proteus_quad4_hessian_element_soa(
        const ptrdiff_t nelements,
        const s_t *const *const SFEM_RESTRICT coords,
        const s_t lmbda,
        const s_t mu,
