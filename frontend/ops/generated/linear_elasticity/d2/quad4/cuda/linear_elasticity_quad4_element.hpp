#ifndef LINEAR_ELASTICITY_QUAD4_ELEMENT_API_CUH
#define LINEAR_ELASTICITY_QUAD4_ELEMENT_API_CUH

#include "../../proteus_quad4/cuda/linear_elasticity_proteus_quad4_element.hpp"

namespace sfem {
namespace codegen {

template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int linear_elasticity_quad4_energy_egeometry_soa(
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int linear_elasticity_quad4_energy_ecoords_soa(
        const ptrdiff_t nelements,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int linear_elasticity_quad4_energy_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int linear_elasticity_quad4_gradient_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int linear_elasticity_quad4_gradient_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int linear_elasticity_quad4_gradient_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int linear_elasticity_quad4_hessian_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int linear_elasticity_quad4_hessian_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int linear_elasticity_quad4_hessian_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
