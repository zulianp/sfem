...
extern "C" int linear_elasticity_quad4_inexact_apply_tangent_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("linear_elasticity_quad4_inexact_apply_tangent_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int linear_elasticity_quad4_inexact_apply_stored_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("linear_elasticity_quad4_inexact_apply_stored_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int linear_elasticity_quad4_inexact_apply_compressed_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("linear_elasticity_quad4_inexact_apply_compressed_a_msoa", -1, (int)scalar_bytes);
}
