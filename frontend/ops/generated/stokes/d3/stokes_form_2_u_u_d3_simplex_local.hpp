#ifndef STOKES_FORM_2_U_U_D3_SIMPLEX_LOCAL_HPP
#define STOKES_FORM_2_U_U_D3_SIMPLEX_LOCAL_HPP
...
static SFEM_INLINE void stokes_form_2_u_u_d3_simplex_residual_block(
        const int nelems,
...
template <typename scalar_t, int N_QP, int CELL_N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void stokes_form_2_u_u_d3_simplex_residual_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT field_shape[1],
...
template <typename scalar_t, int N_QP, int CELL_N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void stokes_form_2_u_u_d3_simplex_jacobian_action_block(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
    ...
    for (int q = 0; q < N_QP; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            const scalar_t residual_tmp0 = scalar_t(2)*mu;
            const scalar_t residual_tmp1 = mu*u0_direction_grad_1 + mu*u1_direction_grad_0;
            const scalar_t residual_tmp2 = mu*u0_direction_grad_2 + mu*u2_direction_grad_0;
            const scalar_t residual_tmp3 = mu*u1_direction_grad_2 + mu*u2_direction_grad_1;
            const scalar_t grad_coeff0_0 = residual_tmp0*u0_direction_grad_0;
            const scalar_t grad_coeff0_1 = residual_tmp1;
            const scalar_t grad_coeff0_2 = residual_tmp2;
            const scalar_t grad_coeff1_0 = residual_tmp1;
            const scalar_t grad_coeff1_1 = residual_tmp0*u1_direction_grad_1;
            const scalar_t grad_coeff1_2 = residual_tmp3;
            const scalar_t grad_coeff2_0 = residual_tmp2;
            const scalar_t grad_coeff2_1 = residual_tmp3;
            const scalar_t grad_coeff2_2 = residual_tmp0*u2_direction_grad_2;
            ...
            output[0][lane] += q_weight[q] * det * (grad_coeff0_0 * test_grad0_u0_0 + grad_coeff0_1 * test_grad1_u0_0 + grad_coeff0_2 * test_grad2_u0_0);
            ...
            output[1][lane] += q_weight[q] * det * (grad_coeff0_0 * test_grad0_u0_1 + grad_coeff0_1 * test_grad1_u0_1 + grad_coeff0_2 * test_grad2_u0_1);
            ...
            output[2][lane] += q_weight[q] * det * (grad_coeff0_0 * test_grad0_u0_2 + grad_coeff0_1 * test_grad1_u0_2 + grad_coeff0_2 * test_grad2_u0_2);
            ...
            output[3][lane] += q_weight[q] * det * (grad_coeff0_0 * test_grad0_u0_3 + grad_coeff0_1 * test_grad1_u0_3 + grad_coeff0_2 * test_grad2_u0_3);
            ...
            output[4][lane] += q_weight[q] * det * (grad_coeff0_0 * test_grad0_u0_4 + grad_coeff0_1 * test_grad1_u0_4 + grad_coeff0_2 * test_grad2_u0_4);
            ...
            output[5][lane] += q_weight[q] * det * (grad_coeff0_0 * test_grad0_u0_5 + grad_coeff0_1 * test_grad1_u0_5 + grad_coeff0_2 * test_grad2_u0_5);
            ...
            output[6][lane] += q_weight[q] * det * (grad_coeff0_0 * test_grad0_u0_6 + grad_coeff0_1 * test_grad1_u0_6 + grad_coeff0_2 * test_grad2_u0_6);
            ...
            output[7][lane] += q_weight[q] * det * (grad_coeff0_0 * test_grad0_u0_7 + grad_coeff0_1 * test_grad1_u0_7 + grad_coeff0_2 * test_grad2_u0_7);
            ...
            output[8][lane] += q_weight[q] * det * (grad_coeff0_0 * test_grad0_u0_8 + grad_coeff0_1 * test_grad1_u0_8 + grad_coeff0_2 * test_grad2_u0_8);
            ...
            output[9][lane] += q_weight[q] * det * (grad_coeff0_0 * test_grad0_u0_9 + grad_coeff0_1 * test_grad1_u0_9 + grad_coeff0_2 * test_grad2_u0_9);
            ...
            output[10][lane] += q_weight[q] * det * (grad_coeff1_0 * test_grad0_u1_0 + grad_coeff1_1 * test_grad1_u1_0 + grad_coeff1_2 * test_grad2_u1_0);
            ...
            output[11][lane] += q_weight[q] * det * (grad_coeff1_0 * test_grad0_u1_1 + grad_coeff1_1 * test_grad1_u1_1 + grad_coeff1_2 * test_grad2_u1_1);
            ...
            output[12][lane] += q_weight[q] * det * (grad_coeff1_0 * test_grad0_u1_2 + grad_coeff1_1 * test_grad1_u1_2 + grad_coeff1_2 * test_grad2_u1_2);
            ...
            output[13][lane] += q_weight[q] * det * (grad_coeff1_0 * test_grad0_u1_3 + grad_coeff1_1 * test_grad1_u1_3 + grad_coeff1_2 * test_grad2_u1_3);
            ...
            output[14][lane] += q_weight[q] * det * (grad_coeff1_0 * test_grad0_u1_4 + grad_coeff1_1 * test_grad1_u1_4 + grad_coeff1_2 * test_grad2_u1_4);
            ...
            output[15][lane] += q_weight[q] * det * (grad_coeff1_0 * test_grad0_u1_5 + grad_coeff1_1 * test_grad1_u1_5 + grad_coeff1_2 * test_grad2_u1_5);
            ...
            output[16][lane] += q_weight[q] * det * (grad_coeff1_0 * test_grad0_u1_6 + grad_coeff1_1 * test_grad1_u1_6 + grad_coeff1_2 * test_grad2_u1_6);
            ...
            output[17][lane] += q_weight[q] * det * (grad_coeff1_0 * test_grad0_u1_7 + grad_coeff1_1 * test_grad1_u1_7 + grad_coeff1_2 * test_grad2_u1_7);
            ...
            output[18][lane] += q_weight[q] * det * (grad_coeff1_0 * test_grad0_u1_8 + grad_coeff1_1 * test_grad1_u1_8 + grad_coeff1_2 * test_grad2_u1_8);
            ...
            output[19][lane] += q_weight[q] * det * (grad_coeff1_0 * test_grad0_u1_9 + grad_coeff1_1 * test_grad1_u1_9 + grad_coeff1_2 * test_grad2_u1_9);
            ...
            output[20][lane] += q_weight[q] * det * (grad_coeff2_0 * test_grad0_u2_0 + grad_coeff2_1 * test_grad1_u2_0 + grad_coeff2_2 * test_grad2_u2_0);
            ...
            output[21][lane] += q_weight[q] * det * (grad_coeff2_0 * test_grad0_u2_1 + grad_coeff2_1 * test_grad1_u2_1 + grad_coeff2_2 * test_grad2_u2_1);
            ...
            output[22][lane] += q_weight[q] * det * (grad_coeff2_0 * test_grad0_u2_2 + grad_coeff2_1 * test_grad1_u2_2 + grad_coeff2_2 * test_grad2_u2_2);
            ...
            output[23][lane] += q_weight[q] * det * (grad_coeff2_0 * test_grad0_u2_3 + grad_coeff2_1 * test_grad1_u2_3 + grad_coeff2_2 * test_grad2_u2_3);
            ...
            output[24][lane] += q_weight[q] * det * (grad_coeff2_0 * test_grad0_u2_4 + grad_coeff2_1 * test_grad1_u2_4 + grad_coeff2_2 * test_grad2_u2_4);
            ...
            output[25][lane] += q_weight[q] * det * (grad_coeff2_0 * test_grad0_u2_5 + grad_coeff2_1 * test_grad1_u2_5 + grad_coeff2_2 * test_grad2_u2_5);
            ...
            output[26][lane] += q_weight[q] * det * (grad_coeff2_0 * test_grad0_u2_6 + grad_coeff2_1 * test_grad1_u2_6 + grad_coeff2_2 * test_grad2_u2_6);
            ...
            output[27][lane] += q_weight[q] * det * (grad_coeff2_0 * test_grad0_u2_7 + grad_coeff2_1 * test_grad1_u2_7 + grad_coeff2_2 * test_grad2_u2_7);
            ...
            output[28][lane] += q_weight[q] * det * (grad_coeff2_0 * test_grad0_u2_8 + grad_coeff2_1 * test_grad1_u2_8 + grad_coeff2_2 * test_grad2_u2_8);
            ...
            output[29][lane] += q_weight[q] * det * (grad_coeff2_0 * test_grad0_u2_9 + grad_coeff2_1 * test_grad1_u2_9 + grad_coeff2_2 * test_grad2_u2_9);
        }
    }
}

template <typename scalar_t, int N_QP, int CELL_N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void stokes_form_2_u_u_d3_simplex_jacobian_action_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT adjugate[9],
