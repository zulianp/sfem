#ifndef STOKES_FORM_1_U_D3_SIMPLEX_MIXED_LOCAL_HPP
#define STOKES_FORM_1_U_D3_SIMPLEX_MIXED_LOCAL_HPP
...
static SFEM_INLINE void stokes_form_1_u_d3_simplex_mixed_residual_block(
        const int nelems,
    ...
    for (int q = 0; q < N_QP; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            const scalar_t residual_tmp3 = mu*(u0_grad_2 + u2_grad_0);
            const scalar_t residual_tmp4 = mu*(u1_grad_2 + u2_grad_1);
            const scalar_t grad_coeff0_0 = residual_tmp0 + residual_tmp1*u0_grad_0;
            const scalar_t grad_coeff0_1 = residual_tmp2;
            const scalar_t grad_coeff0_2 = residual_tmp3;
            const scalar_t grad_coeff1_0 = residual_tmp2;
            const scalar_t grad_coeff1_1 = residual_tmp0 + residual_tmp1*u1_grad_1;
            const scalar_t grad_coeff1_2 = residual_tmp4;
            const scalar_t grad_coeff2_0 = residual_tmp3;
            const scalar_t grad_coeff2_1 = residual_tmp4;
            const scalar_t grad_coeff2_2 = residual_tmp0 + residual_tmp1*u2_grad_2;
...
template <typename scalar_t, int N_QP, int CELL_N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void stokes_form_1_u_d3_simplex_mixed_residual_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT adjugate[9],
...
template <typename scalar_t, int N_QP, int CELL_N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void stokes_form_1_u_d3_simplex_mixed_jacobian_action_block(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT field_shape[2],
...
template <typename scalar_t, int N_QP, int CELL_N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void stokes_form_1_u_d3_simplex_mixed_jacobian_action_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT field_shape[2],
