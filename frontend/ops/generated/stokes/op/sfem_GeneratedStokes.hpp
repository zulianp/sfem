...
namespace sfem {
    class GeneratedStokes final : public Op {
    public:
        static std::unique_ptr<Op> create(const std::shared_ptr<FunctionSpace> &space);

        explicit GeneratedStokes(const std::shared_ptr<FunctionSpace> &space);
        ~GeneratedStokes() override;

        const char *name() const override { return "GeneratedStokes"; }
