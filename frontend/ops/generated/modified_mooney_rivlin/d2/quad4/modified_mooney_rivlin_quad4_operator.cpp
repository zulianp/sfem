...
extern "C" int modified_mooney_rivlin_quad4_apply_i_msoa(
    ...
    return modified_mooney_rivlin_proteus_quad4_apply_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, c1, c2, kappa, u_stride, ux, uy, h_stride, hx, hy, out_stride, outx, outy);
}
...
extern "C" int modified_mooney_rivlin_quad4_gradient_i_msoa(
    ...
    return modified_mooney_rivlin_proteus_quad4_gradient_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, c1, c2, kappa, u_stride, ux, uy, out_stride, outx, outy);
}
...
extern "C" int modified_mooney_rivlin_quad4_hessian_bsr_i_msoa(
    ...
    return modified_mooney_rivlin_proteus_quad4_hessian_bsr_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, c1, c2, kappa, u_stride, ux, uy, rowptr, colidx, values);
}
...
extern "C" int modified_mooney_rivlin_quad4_objective_steps_i_msoa(
    ...
    return modified_mooney_rivlin_proteus_quad4_objective_steps_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, c1, c2, kappa, u_stride, ux, uy, h_stride, hx, hy, nsteps, steps, value);
}
