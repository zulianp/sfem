...
static SFEM_INLINE void modified_mooney_rivlin_d2_simplex_objective_block(
    ...
    static_assert(VECTOR_SIZE > 0, "VECTOR_SIZE must be positive");
        ...
        const scalar_t weak_obj_tmp3 = pow_2(grad_u1) + pow_2(weak_obj_tmp1);
        const scalar_t weak_obj_tmp4 = pow_2(grad_u2) + pow_2(weak_obj_tmp0);
        const scalar_t weak_obj_tmp5 = weak_obj_tmp3 + weak_obj_tmp4;
        value[lane] += qw * jacobian_determinant_lane0 * (c1*(scalar_t(-3) + (weak_obj_tmp5 + scalar_t(1))/pow(weak_obj_tmp2, (scalar_t(2) / scalar_t(3)))) + c2*(scalar_t(-3) + (-(scalar_t(1) / scalar_t(2))*pow_2(weak_obj_tmp3) - (scalar_t(1) / scalar_t(2))*pow_2(weak_obj_tmp4) + ((scalar_t(1) / scalar_t(2)))*pow_2(weak_obj_tmp5) + weak_obj_tmp5 - pow_2(grad_u1*weak_obj_tmp0 + grad_u2*weak_obj_tmp1))/pow(weak_obj_tmp2, (scalar_t(4) / scalar_t(3)))) + ((scalar_t(1) / scalar_t(2)))*kappa*pow_2(log(weak_obj_tmp2)));
            }
        }
}
...
static SFEM_INLINE void modified_mooney_rivlin_d2_simplex_gradient_block(
    ...
    static_assert(VECTOR_SIZE > 0, "VECTOR_SIZE must be positive");
        ...
        const scalar_t weak_mat_tmp6 = pow_2(grad_u2) + pow_2(weak_mat_tmp1);
        const scalar_t weak_mat_tmp7 = pow_2(grad_u1) + pow_2(weak_mat_tmp0);
        const scalar_t weak_mat_tmp8 = weak_mat_tmp6 + weak_mat_tmp7;
        const scalar_t weak_mat_tmp9 = ((scalar_t(2) / scalar_t(3)))*(weak_mat_tmp8 + scalar_t(1))/pow(weak_mat_tmp2, (scalar_t(5) / scalar_t(3)));
        const scalar_t weak_mat_tmp10 = pow(weak_mat_tmp2, (scalar_t(-4) / scalar_t(3)));
        const scalar_t weak_mat_tmp11 = grad_u1*weak_mat_tmp1 + grad_u2*weak_mat_tmp0;
        const scalar_t weak_mat_tmp12 = scalar_t(2)*grad_u1;
        const scalar_t weak_mat_tmp13 = ((scalar_t(4) / scalar_t(3)))*(-pow_2(weak_mat_tmp11) - (scalar_t(1) / scalar_t(2))*pow_2(weak_mat_tmp6) - (scalar_t(1) / scalar_t(2))*pow_2(weak_mat_tmp7) + ((scalar_t(1) / scalar_t(2)))*pow_2(weak_mat_tmp8) + weak_mat_tmp8)/pow(weak_mat_tmp2, (scalar_t(7) / scalar_t(3)));
        const scalar_t weak_mat_tmp14 = scalar_t(2)*grad_u2;
        const scalar_t weak_mat_tmp15 = scalar_t(2)*weak_mat_tmp0;
        const scalar_t material0 = c1*(-weak_mat_tmp0*weak_mat_tmp9 + weak_mat_tmp4*weak_mat_tmp5) + c2*(-weak_mat_tmp0*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*grad_u0 - weak_mat_tmp11*weak_mat_tmp12 - weak_mat_tmp5*weak_mat_tmp6 + weak_mat_tmp5*weak_mat_tmp8 + scalar_t(2))) + weak_mat_tmp0*weak_mat_tmp3;
        const scalar_t material1 = c1*(grad_u2*weak_mat_tmp9 + weak_mat_tmp12*weak_mat_tmp4) + c2*(grad_u2*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*grad_u1*weak_mat_tmp8 + scalar_t(2)*grad_u1 - weak_mat_tmp11*weak_mat_tmp5 - weak_mat_tmp12*weak_mat_tmp7)) - grad_u2*weak_mat_tmp3;
        const scalar_t material2 = c1*(grad_u1*weak_mat_tmp9 + weak_mat_tmp14*weak_mat_tmp4) + c2*(grad_u1*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*grad_u2*weak_mat_tmp8 + scalar_t(2)*grad_u2 - weak_mat_tmp11*weak_mat_tmp15 - weak_mat_tmp14*weak_mat_tmp6)) - grad_u1*weak_mat_tmp3;
        const scalar_t material3 = c1*(scalar_t(2)*weak_mat_tmp0*weak_mat_tmp4 - weak_mat_tmp1*weak_mat_tmp9) + c2*(-weak_mat_tmp1*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*grad_u3 - weak_mat_tmp11*weak_mat_tmp14 - weak_mat_tmp15*weak_mat_tmp7 + weak_mat_tmp15*weak_mat_tmp8 + scalar_t(2))) + weak_mat_tmp1*weak_mat_tmp3;
...
static SFEM_INLINE void modified_mooney_rivlin_d2_simplex_apply_block(
    ...
    static_assert(VECTOR_SIZE > 0, "VECTOR_SIZE must be positive");
        ...
        const scalar_t weak_mat_tmp8 = pow_2(grad_u2);
        const scalar_t weak_mat_tmp9 = pow_2(weak_mat_tmp3);
        const scalar_t weak_mat_tmp10 = weak_mat_tmp8 + weak_mat_tmp9;
        const scalar_t weak_mat_tmp11 = pow_2(grad_u1);
        const scalar_t weak_mat_tmp12 = weak_mat_tmp1 + weak_mat_tmp11;
        const scalar_t weak_mat_tmp13 = weak_mat_tmp10 + weak_mat_tmp12;
        const scalar_t weak_mat_tmp14 = weak_mat_tmp13 + scalar_t(1);
        const scalar_t weak_mat_tmp15 = pow(weak_mat_tmp4, (scalar_t(-8) / scalar_t(3)));
        const scalar_t weak_mat_tmp16 = ((scalar_t(10) / scalar_t(9)))*weak_mat_tmp14*weak_mat_tmp15;
        const scalar_t weak_mat_tmp17 = scalar_t(2)/pow(weak_mat_tmp4, (scalar_t(2) / scalar_t(3)));
        const scalar_t weak_mat_tmp18 = weak_mat_tmp0*weak_mat_tmp3;
        const scalar_t weak_mat_tmp19 = pow(weak_mat_tmp4, (scalar_t(-5) / scalar_t(3)));
        const scalar_t weak_mat_tmp20 = ((scalar_t(8) / scalar_t(3)))*weak_mat_tmp19;
        const scalar_t weak_mat_tmp21 = weak_mat_tmp17 - weak_mat_tmp18*weak_mat_tmp20;
        const scalar_t weak_mat_tmp22 = pow(weak_mat_tmp4, (scalar_t(-4) / scalar_t(3)));
        const scalar_t weak_mat_tmp23 = grad_u1*weak_mat_tmp3;
        const scalar_t weak_mat_tmp24 = grad_u2*weak_mat_tmp0;
        const scalar_t weak_mat_tmp25 = weak_mat_tmp23 + weak_mat_tmp24;
        const scalar_t weak_mat_tmp26 = scalar_t(2)*grad_u1;
        const scalar_t weak_mat_tmp27 = scalar_t(2)*weak_mat_tmp3;
        const scalar_t weak_mat_tmp28 = scalar_t(2)*grad_u0 - weak_mat_tmp10*weak_mat_tmp27 + weak_mat_tmp13*weak_mat_tmp27 - weak_mat_tmp25*weak_mat_tmp26 + scalar_t(2);
        ...
        const scalar_t weak_mat_tmp31 = -(scalar_t(1) / scalar_t(2))*pow_2(weak_mat_tmp10) - (scalar_t(1) / scalar_t(2))*pow_2(weak_mat_tmp12) + ((scalar_t(1) / scalar_t(2)))*pow_2(weak_mat_tmp13) + weak_mat_tmp13 - pow_2(weak_mat_tmp25);
        ...
        const scalar_t weak_mat_tmp35 = ((scalar_t(4) / scalar_t(3)))*weak_mat_tmp19;
        const scalar_t weak_mat_tmp36 = grad_u1*weak_mat_tmp0;
        const scalar_t weak_mat_tmp37 = weak_mat_tmp35*weak_mat_tmp36;
        const scalar_t weak_mat_tmp38 = grad_u2*weak_mat_tmp3;
        const scalar_t weak_mat_tmp39 = weak_mat_tmp35*weak_mat_tmp38;
        const scalar_t weak_mat_tmp40 = scalar_t(2)*weak_mat_tmp22;
        const scalar_t weak_mat_tmp41 = scalar_t(2)*grad_u1*weak_mat_tmp13 + scalar_t(2)*grad_u1 - weak_mat_tmp12*weak_mat_tmp26 - weak_mat_tmp25*weak_mat_tmp27;
        const scalar_t weak_mat_tmp42 = ((scalar_t(4) / scalar_t(3)))*weak_mat_tmp29;
        const scalar_t weak_mat_tmp43 = weak_mat_tmp0*weak_mat_tmp42;
        const scalar_t weak_mat_tmp44 = c1*(-weak_mat_tmp16*weak_mat_tmp24 - weak_mat_tmp37 + weak_mat_tmp39) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u2*weak_mat_tmp28*weak_mat_tmp29 - weak_mat_tmp24*weak_mat_tmp33 - weak_mat_tmp24*weak_mat_tmp40 - weak_mat_tmp41*weak_mat_tmp43) + weak_mat_tmp34*weak_mat_tmp7 - weak_mat_tmp34;
        const scalar_t weak_mat_tmp45 = weak_mat_tmp36*weak_mat_tmp5;
        const scalar_t weak_mat_tmp46 = weak_mat_tmp23*weak_mat_tmp35;
        const scalar_t weak_mat_tmp47 = weak_mat_tmp24*weak_mat_tmp35;
        const scalar_t weak_mat_tmp48 = scalar_t(2)*grad_u2;
        const scalar_t weak_mat_tmp49 = scalar_t(2)*weak_mat_tmp0;
        const scalar_t weak_mat_tmp50 = scalar_t(2)*grad_u2*weak_mat_tmp13 + scalar_t(2)*grad_u2 - weak_mat_tmp10*weak_mat_tmp48 - weak_mat_tmp25*weak_mat_tmp49;
        const scalar_t weak_mat_tmp51 = c1*(-weak_mat_tmp16*weak_mat_tmp36 + weak_mat_tmp46 - weak_mat_tmp47) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u1*weak_mat_tmp28*weak_mat_tmp29 - weak_mat_tmp0*weak_mat_tmp22*weak_mat_tmp26 - weak_mat_tmp33*weak_mat_tmp36 - weak_mat_tmp43*weak_mat_tmp50) + weak_mat_tmp45*weak_mat_tmp7 - weak_mat_tmp45;
        const scalar_t weak_mat_tmp52 = weak_mat_tmp18*weak_mat_tmp5;
        const scalar_t weak_mat_tmp53 = kappa*weak_mat_tmp7/weak_mat_tmp4;
        const scalar_t weak_mat_tmp54 = ((scalar_t(2) / scalar_t(3)))*weak_mat_tmp14*weak_mat_tmp19;
        const scalar_t weak_mat_tmp55 = scalar_t(2)*grad_u3 - weak_mat_tmp12*weak_mat_tmp49 + weak_mat_tmp13*weak_mat_tmp49 - weak_mat_tmp25*weak_mat_tmp48 + scalar_t(2);
        const scalar_t weak_mat_tmp56 = weak_mat_tmp31*weak_mat_tmp42;
        const scalar_t weak_mat_tmp57 = c1*(((scalar_t(10) / scalar_t(9)))*weak_mat_tmp0*weak_mat_tmp14*weak_mat_tmp15*weak_mat_tmp3 - weak_mat_tmp1*weak_mat_tmp35 - weak_mat_tmp35*weak_mat_tmp9 - weak_mat_tmp54) + c2*(((scalar_t(28) / scalar_t(9)))*weak_mat_tmp0*weak_mat_tmp3*weak_mat_tmp31*weak_mat_tmp32 + weak_mat_tmp22*(scalar_t(4)*weak_mat_tmp0*weak_mat_tmp3 - scalar_t(2)*weak_mat_tmp2) - weak_mat_tmp28*weak_mat_tmp3*weak_mat_tmp42 - weak_mat_tmp43*weak_mat_tmp55 - weak_mat_tmp56) - weak_mat_tmp52*weak_mat_tmp7 + weak_mat_tmp52 + weak_mat_tmp53;
        const scalar_t weak_mat_tmp58 = weak_mat_tmp5*weak_mat_tmp8;
        const scalar_t weak_mat_tmp59 = weak_mat_tmp17 + weak_mat_tmp2*weak_mat_tmp20;
        const scalar_t weak_mat_tmp60 = weak_mat_tmp38*weak_mat_tmp5;
        const scalar_t weak_mat_tmp61 = weak_mat_tmp41*weak_mat_tmp42;
        const scalar_t weak_mat_tmp62 = c1*(-weak_mat_tmp16*weak_mat_tmp38 - weak_mat_tmp46 + weak_mat_tmp47) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u2*weak_mat_tmp29*weak_mat_tmp55 - weak_mat_tmp22*weak_mat_tmp3*weak_mat_tmp48 - weak_mat_tmp3*weak_mat_tmp61 - weak_mat_tmp33*weak_mat_tmp38) + weak_mat_tmp60*weak_mat_tmp7 - weak_mat_tmp60;
        const scalar_t weak_mat_tmp63 = weak_mat_tmp2*weak_mat_tmp5;
        const scalar_t weak_mat_tmp64 = c1*(weak_mat_tmp11*weak_mat_tmp35 + weak_mat_tmp16*weak_mat_tmp2 + weak_mat_tmp35*weak_mat_tmp8 + weak_mat_tmp54) + c2*(grad_u1*weak_mat_tmp61 + grad_u2*weak_mat_tmp42*weak_mat_tmp50 + weak_mat_tmp2*weak_mat_tmp33 + weak_mat_tmp22*(-scalar_t(2)*weak_mat_tmp18 + scalar_t(4)*weak_mat_tmp2) + weak_mat_tmp56) - weak_mat_tmp53 - weak_mat_tmp63*weak_mat_tmp7 + weak_mat_tmp63;
        const scalar_t weak_mat_tmp65 = weak_mat_tmp11*weak_mat_tmp5;
        const scalar_t weak_mat_tmp66 = weak_mat_tmp23*weak_mat_tmp5;
        const scalar_t weak_mat_tmp67 = c1*(-weak_mat_tmp16*weak_mat_tmp23 + weak_mat_tmp37 - weak_mat_tmp39) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u1*weak_mat_tmp29*weak_mat_tmp55 - weak_mat_tmp23*weak_mat_tmp33 - weak_mat_tmp23*weak_mat_tmp40 - weak_mat_tmp3*weak_mat_tmp42*weak_mat_tmp50) + weak_mat_tmp66*weak_mat_tmp7 - weak_mat_tmp66;
        const scalar_t weak_mat_tmp68 = weak_mat_tmp5*weak_mat_tmp9;
        const scalar_t material0 = trial_grad0*(c1*(weak_mat_tmp1*weak_mat_tmp16 + weak_mat_tmp21) + c2*(-weak_mat_tmp0*weak_mat_tmp28*weak_mat_tmp30 + weak_mat_tmp1*weak_mat_tmp33 + weak_mat_tmp22*(scalar_t(2)*weak_mat_tmp1 + scalar_t(2))) - weak_mat_tmp6*weak_mat_tmp7 + weak_mat_tmp6) + trial_grad1*weak_mat_tmp44 + trial_grad2*weak_mat_tmp51 + trial_grad3*weak_mat_tmp57;
        const scalar_t material1 = trial_grad0*weak_mat_tmp44 + trial_grad1*(c1*(weak_mat_tmp16*weak_mat_tmp8 + weak_mat_tmp59) + c2*(grad_u2*weak_mat_tmp30*weak_mat_tmp41 + weak_mat_tmp22*(scalar_t(2)*weak_mat_tmp8 + scalar_t(2)) + weak_mat_tmp33*weak_mat_tmp8) - weak_mat_tmp58*weak_mat_tmp7 + weak_mat_tmp58) + trial_grad2*weak_mat_tmp64 + trial_grad3*weak_mat_tmp62;
        const scalar_t material2 = trial_grad0*weak_mat_tmp51 + trial_grad1*weak_mat_tmp64 + trial_grad2*(c1*(weak_mat_tmp11*weak_mat_tmp16 + weak_mat_tmp59) + c2*(grad_u1*weak_mat_tmp30*weak_mat_tmp50 + weak_mat_tmp11*weak_mat_tmp33 + weak_mat_tmp22*(scalar_t(2)*weak_mat_tmp11 + scalar_t(2))) - weak_mat_tmp65*weak_mat_tmp7 + weak_mat_tmp65) + trial_grad3*weak_mat_tmp67;
        const scalar_t material3 = trial_grad0*weak_mat_tmp57 + trial_grad1*weak_mat_tmp62 + trial_grad2*weak_mat_tmp67 + trial_grad3*(c1*(weak_mat_tmp16*weak_mat_tmp9 + weak_mat_tmp21) + c2*(weak_mat_tmp22*(scalar_t(2)*weak_mat_tmp9 + scalar_t(2)) - weak_mat_tmp3*weak_mat_tmp30*weak_mat_tmp55 + weak_mat_tmp33*weak_mat_tmp9) - weak_mat_tmp68*weak_mat_tmp7 + weak_mat_tmp68);
        const scalar_t loperand0 = qw * (material0 * jacobian_adjugate_lane0 + material1 * jacobian_adjugate_lane1);
        const scalar_t loperand1 = qw * (material0 * jacobian_adjugate_lane2 + material1 * jacobian_adjugate_lane3);
        const scalar_t loperand2 = qw * (material2 * jacobian_adjugate_lane0 + material3 * jacobian_adjugate_lane1);
        const scalar_t loperand3 = qw * (material2 * jacobian_adjugate_lane2 + material3 * jacobian_adjugate_lane3);
