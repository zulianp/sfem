...
static SFEM_INLINE void modified_mooney_rivlin_d2_simplex_gradient_block(
    ...
    static_assert(VECTOR_SIZE > 0, "VECTOR_SIZE must be positive");
        ...
        const scalar_t material0 = c1*(-weak_mat_tmp0*weak_mat_tmp9 + weak_mat_tmp4*weak_mat_tmp5) + c2*(-weak_mat_tmp0*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*weak_mat_tmp1*weak_mat_tmp8 - weak_mat_tmp11*weak_mat_tmp12 - weak_mat_tmp5*weak_mat_tmp6)) + weak_mat_tmp0*weak_mat_tmp3;
        const scalar_t material1 = c1*(grad_u2*weak_mat_tmp9 + weak_mat_tmp12*weak_mat_tmp4) + c2*(grad_u2*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*grad_u1*weak_mat_tmp8 - weak_mat_tmp11*weak_mat_tmp5 - weak_mat_tmp12*weak_mat_tmp7)) - grad_u2*weak_mat_tmp3;
        const scalar_t material2 = c1*(grad_u1*weak_mat_tmp9 + weak_mat_tmp14*weak_mat_tmp4) + c2*(grad_u1*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*grad_u2*weak_mat_tmp8 - weak_mat_tmp11*weak_mat_tmp15 - weak_mat_tmp14*weak_mat_tmp6)) - grad_u1*weak_mat_tmp3;
        const scalar_t material3 = c1*(scalar_t(2)*weak_mat_tmp0*weak_mat_tmp4 - weak_mat_tmp1*weak_mat_tmp9) + c2*(-weak_mat_tmp1*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*weak_mat_tmp0*weak_mat_tmp8 - weak_mat_tmp11*weak_mat_tmp14 - weak_mat_tmp15*weak_mat_tmp7)) + weak_mat_tmp1*weak_mat_tmp3;
...
static SFEM_INLINE void modified_mooney_rivlin_d2_simplex_apply_block(
    ...
    static_assert(VECTOR_SIZE > 0, "VECTOR_SIZE must be positive");
        ...
        const scalar_t weak_mat_tmp40 = scalar_t(2)*grad_u1*weak_mat_tmp13 - weak_mat_tmp12*weak_mat_tmp26 - weak_mat_tmp25*weak_mat_tmp27;
        ...
        const scalar_t weak_mat_tmp43 = c1*(-weak_mat_tmp15*weak_mat_tmp24 - weak_mat_tmp37 + weak_mat_tmp39) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u2*weak_mat_tmp28*weak_mat_tmp29 - weak_mat_tmp22*weak_mat_tmp24 - weak_mat_tmp24*weak_mat_tmp33 - weak_mat_tmp40*weak_mat_tmp42) + weak_mat_tmp34*weak_mat_tmp7 - weak_mat_tmp34;
        ...
        const scalar_t weak_mat_tmp47 = scalar_t(2)*grad_u2;
        const scalar_t weak_mat_tmp48 = scalar_t(2)*weak_mat_tmp0;
        const scalar_t weak_mat_tmp49 = scalar_t(2)*grad_u2*weak_mat_tmp13 - weak_mat_tmp10*weak_mat_tmp47 - weak_mat_tmp25*weak_mat_tmp48;
        const scalar_t weak_mat_tmp50 = c1*(-weak_mat_tmp15*weak_mat_tmp36 + weak_mat_tmp45 - weak_mat_tmp46) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u1*weak_mat_tmp28*weak_mat_tmp29 - weak_mat_tmp22*weak_mat_tmp36 - weak_mat_tmp33*weak_mat_tmp36 - weak_mat_tmp42*weak_mat_tmp49) + weak_mat_tmp44*weak_mat_tmp7 - weak_mat_tmp44;
        ...
        const scalar_t weak_mat_tmp61 = c1*(-weak_mat_tmp15*weak_mat_tmp38 - weak_mat_tmp45 + weak_mat_tmp46) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u2*weak_mat_tmp29*weak_mat_tmp54 - weak_mat_tmp22*weak_mat_tmp38 - weak_mat_tmp3*weak_mat_tmp60 - weak_mat_tmp33*weak_mat_tmp38) + weak_mat_tmp59*weak_mat_tmp7 - weak_mat_tmp59;
        const scalar_t weak_mat_tmp62 = weak_mat_tmp2*weak_mat_tmp5;
        const scalar_t weak_mat_tmp63 = c1*(weak_mat_tmp11*weak_mat_tmp35 + weak_mat_tmp15*weak_mat_tmp2 + weak_mat_tmp35*weak_mat_tmp8 + weak_mat_tmp53) + c2*(grad_u1*weak_mat_tmp60 + grad_u2*weak_mat_tmp41*weak_mat_tmp49 + weak_mat_tmp2*weak_mat_tmp33 + weak_mat_tmp21*(-scalar_t(2)*weak_mat_tmp17 + scalar_t(4)*weak_mat_tmp2) + weak_mat_tmp55) - weak_mat_tmp52 - weak_mat_tmp62*weak_mat_tmp7 + weak_mat_tmp62;
        const scalar_t weak_mat_tmp64 = weak_mat_tmp11*weak_mat_tmp5;
        const scalar_t weak_mat_tmp65 = weak_mat_tmp23*weak_mat_tmp5;
        const scalar_t weak_mat_tmp66 = c1*(-weak_mat_tmp15*weak_mat_tmp23 + weak_mat_tmp37 - weak_mat_tmp39) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u1*weak_mat_tmp29*weak_mat_tmp54 - weak_mat_tmp22*weak_mat_tmp23 - weak_mat_tmp23*weak_mat_tmp33 - weak_mat_tmp3*weak_mat_tmp41*weak_mat_tmp49) + weak_mat_tmp65*weak_mat_tmp7 - weak_mat_tmp65;
        const scalar_t weak_mat_tmp67 = weak_mat_tmp5*weak_mat_tmp9;
        const scalar_t material0 = trial_grad0*(c1*(weak_mat_tmp1*weak_mat_tmp15 + weak_mat_tmp20) + c2*(-weak_mat_tmp0*weak_mat_tmp28*weak_mat_tmp30 + weak_mat_tmp1*weak_mat_tmp22 + weak_mat_tmp1*weak_mat_tmp33) - weak_mat_tmp6*weak_mat_tmp7 + weak_mat_tmp6) + trial_grad1*weak_mat_tmp43 + trial_grad2*weak_mat_tmp50 + trial_grad3*weak_mat_tmp56;
        const scalar_t material1 = trial_grad0*weak_mat_tmp43 + trial_grad1*(c1*(weak_mat_tmp15*weak_mat_tmp8 + weak_mat_tmp58) + c2*(grad_u2*weak_mat_tmp30*weak_mat_tmp40 + weak_mat_tmp22*weak_mat_tmp8 + weak_mat_tmp33*weak_mat_tmp8) - weak_mat_tmp57*weak_mat_tmp7 + weak_mat_tmp57) + trial_grad2*weak_mat_tmp63 + trial_grad3*weak_mat_tmp61;
        const scalar_t material2 = trial_grad0*weak_mat_tmp50 + trial_grad1*weak_mat_tmp63 + trial_grad2*(c1*(weak_mat_tmp11*weak_mat_tmp15 + weak_mat_tmp58) + c2*(grad_u1*weak_mat_tmp30*weak_mat_tmp49 + weak_mat_tmp11*weak_mat_tmp22 + weak_mat_tmp11*weak_mat_tmp33) - weak_mat_tmp64*weak_mat_tmp7 + weak_mat_tmp64) + trial_grad3*weak_mat_tmp66;
        const scalar_t material3 = trial_grad0*weak_mat_tmp56 + trial_grad1*weak_mat_tmp61 + trial_grad2*weak_mat_tmp66 + trial_grad3*(c1*(weak_mat_tmp15*weak_mat_tmp9 + weak_mat_tmp20) + c2*(weak_mat_tmp22*weak_mat_tmp9 - weak_mat_tmp3*weak_mat_tmp30*weak_mat_tmp54 + weak_mat_tmp33*weak_mat_tmp9) - weak_mat_tmp67*weak_mat_tmp7 + weak_mat_tmp67);
        const scalar_t loperand0 = qw * (material0 * jacobian_adjugate_lane0 + material1 * jacobian_adjugate_lane1);
        const scalar_t loperand1 = qw * (material0 * jacobian_adjugate_lane2 + material1 * jacobian_adjugate_lane3);
        const scalar_t loperand2 = qw * (material2 * jacobian_adjugate_lane0 + material3 * jacobian_adjugate_lane1);
        const scalar_t loperand3 = qw * (material2 * jacobian_adjugate_lane2 + material3 * jacobian_adjugate_lane3);
