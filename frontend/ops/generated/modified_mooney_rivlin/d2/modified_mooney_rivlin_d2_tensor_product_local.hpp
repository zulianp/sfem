...
static SFEM_INLINE void modified_mooney_rivlin_d2_tensor_product_gradient_block(
    ...
    for (int q = 0; q < N_QP; ++q) {
        ...
        material[0] = c1*(-weak_mat_tmp0*weak_mat_tmp9 + weak_mat_tmp4*weak_mat_tmp5) + c2*(-weak_mat_tmp0*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*grad_u[0] - weak_mat_tmp11*weak_mat_tmp12 - weak_mat_tmp5*weak_mat_tmp6 + weak_mat_tmp5*weak_mat_tmp8 + scalar_t(2))) + weak_mat_tmp0*weak_mat_tmp3;
        material[1] = c1*(grad_u[2]*weak_mat_tmp9 + weak_mat_tmp12*weak_mat_tmp4) + c2*(grad_u[2]*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*grad_u[1]*weak_mat_tmp8 + scalar_t(2)*grad_u[1] - weak_mat_tmp11*weak_mat_tmp5 - weak_mat_tmp12*weak_mat_tmp7)) - grad_u[2]*weak_mat_tmp3;
        material[2] = c1*(grad_u[1]*weak_mat_tmp9 + weak_mat_tmp14*weak_mat_tmp4) + c2*(grad_u[1]*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*grad_u[2]*weak_mat_tmp8 + scalar_t(2)*grad_u[2] - weak_mat_tmp11*weak_mat_tmp15 - weak_mat_tmp14*weak_mat_tmp6)) - grad_u[1]*weak_mat_tmp3;
        material[3] = c1*(scalar_t(2)*weak_mat_tmp0*weak_mat_tmp4 - weak_mat_tmp1*weak_mat_tmp9) + c2*(-weak_mat_tmp1*weak_mat_tmp13 + weak_mat_tmp10*(scalar_t(2)*grad_u[3] - weak_mat_tmp11*weak_mat_tmp14 - weak_mat_tmp15*weak_mat_tmp7 + weak_mat_tmp15*weak_mat_tmp8 + scalar_t(2))) + weak_mat_tmp1*weak_mat_tmp3;
...
static SFEM_INLINE void modified_mooney_rivlin_d2_tensor_product_apply_block(
    ...
    for (int q = 0; q < N_QP; ++q) {
        ...
        const scalar_t weak_mat_tmp28 = scalar_t(2)*grad_u[0] - weak_mat_tmp10*weak_mat_tmp27 + weak_mat_tmp13*weak_mat_tmp27 - weak_mat_tmp25*weak_mat_tmp26 + scalar_t(2);
        ...
        const scalar_t weak_mat_tmp41 = scalar_t(2)*grad_u[1]*weak_mat_tmp13 + scalar_t(2)*grad_u[1] - weak_mat_tmp12*weak_mat_tmp26 - weak_mat_tmp25*weak_mat_tmp27;
        ...
        const scalar_t weak_mat_tmp44 = c1*(-weak_mat_tmp16*weak_mat_tmp24 - weak_mat_tmp37 + weak_mat_tmp39) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u[2]*weak_mat_tmp28*weak_mat_tmp29 - weak_mat_tmp24*weak_mat_tmp33 - weak_mat_tmp24*weak_mat_tmp40 - weak_mat_tmp41*weak_mat_tmp43) + weak_mat_tmp34*weak_mat_tmp7 - weak_mat_tmp34;
        ...
        const scalar_t weak_mat_tmp48 = scalar_t(2)*grad_u[2];
        const scalar_t weak_mat_tmp49 = scalar_t(2)*weak_mat_tmp0;
        const scalar_t weak_mat_tmp50 = scalar_t(2)*grad_u[2]*weak_mat_tmp13 + scalar_t(2)*grad_u[2] - weak_mat_tmp10*weak_mat_tmp48 - weak_mat_tmp25*weak_mat_tmp49;
        const scalar_t weak_mat_tmp51 = c1*(-weak_mat_tmp16*weak_mat_tmp36 + weak_mat_tmp46 - weak_mat_tmp47) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u[1]*weak_mat_tmp28*weak_mat_tmp29 - weak_mat_tmp0*weak_mat_tmp22*weak_mat_tmp26 - weak_mat_tmp33*weak_mat_tmp36 - weak_mat_tmp43*weak_mat_tmp50) + weak_mat_tmp45*weak_mat_tmp7 - weak_mat_tmp45;
        ...
        const scalar_t weak_mat_tmp55 = scalar_t(2)*grad_u[3] - weak_mat_tmp12*weak_mat_tmp49 + weak_mat_tmp13*weak_mat_tmp49 - weak_mat_tmp25*weak_mat_tmp48 + scalar_t(2);
        ...
        const scalar_t weak_mat_tmp62 = c1*(-weak_mat_tmp16*weak_mat_tmp38 - weak_mat_tmp46 + weak_mat_tmp47) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u[2]*weak_mat_tmp29*weak_mat_tmp55 - weak_mat_tmp22*weak_mat_tmp3*weak_mat_tmp48 - weak_mat_tmp3*weak_mat_tmp61 - weak_mat_tmp33*weak_mat_tmp38) + weak_mat_tmp60*weak_mat_tmp7 - weak_mat_tmp60;
        const scalar_t weak_mat_tmp63 = weak_mat_tmp2*weak_mat_tmp5;
        const scalar_t weak_mat_tmp64 = c1*(weak_mat_tmp11*weak_mat_tmp35 + weak_mat_tmp16*weak_mat_tmp2 + weak_mat_tmp35*weak_mat_tmp8 + weak_mat_tmp54) + c2*(grad_u[1]*weak_mat_tmp61 + grad_u[2]*weak_mat_tmp42*weak_mat_tmp50 + weak_mat_tmp2*weak_mat_tmp33 + weak_mat_tmp22*(-scalar_t(2)*weak_mat_tmp18 + scalar_t(4)*weak_mat_tmp2) + weak_mat_tmp56) - weak_mat_tmp53 - weak_mat_tmp63*weak_mat_tmp7 + weak_mat_tmp63;
        const scalar_t weak_mat_tmp65 = weak_mat_tmp11*weak_mat_tmp5;
        const scalar_t weak_mat_tmp66 = weak_mat_tmp23*weak_mat_tmp5;
        const scalar_t weak_mat_tmp67 = c1*(-weak_mat_tmp16*weak_mat_tmp23 + weak_mat_tmp37 - weak_mat_tmp39) + c2*(((scalar_t(4) / scalar_t(3)))*grad_u[1]*weak_mat_tmp29*weak_mat_tmp55 - weak_mat_tmp23*weak_mat_tmp33 - weak_mat_tmp23*weak_mat_tmp40 - weak_mat_tmp3*weak_mat_tmp42*weak_mat_tmp50) + weak_mat_tmp66*weak_mat_tmp7 - weak_mat_tmp66;
        const scalar_t weak_mat_tmp68 = weak_mat_tmp5*weak_mat_tmp9;
        material[0] = trial_grad[0]*(c1*(weak_mat_tmp1*weak_mat_tmp16 + weak_mat_tmp21) + c2*(-weak_mat_tmp0*weak_mat_tmp28*weak_mat_tmp30 + weak_mat_tmp1*weak_mat_tmp33 + weak_mat_tmp22*(scalar_t(2)*weak_mat_tmp1 + scalar_t(2))) - weak_mat_tmp6*weak_mat_tmp7 + weak_mat_tmp6) + trial_grad[1]*weak_mat_tmp44 + trial_grad[2]*weak_mat_tmp51 + trial_grad[3]*weak_mat_tmp57;
        material[1] = trial_grad[0]*weak_mat_tmp44 + trial_grad[1]*(c1*(weak_mat_tmp16*weak_mat_tmp8 + weak_mat_tmp59) + c2*(grad_u[2]*weak_mat_tmp30*weak_mat_tmp41 + weak_mat_tmp22*(scalar_t(2)*weak_mat_tmp8 + scalar_t(2)) + weak_mat_tmp33*weak_mat_tmp8) - weak_mat_tmp58*weak_mat_tmp7 + weak_mat_tmp58) + trial_grad[2]*weak_mat_tmp64 + trial_grad[3]*weak_mat_tmp62;
        material[2] = trial_grad[0]*weak_mat_tmp51 + trial_grad[1]*weak_mat_tmp64 + trial_grad[2]*(c1*(weak_mat_tmp11*weak_mat_tmp16 + weak_mat_tmp59) + c2*(grad_u[1]*weak_mat_tmp30*weak_mat_tmp50 + weak_mat_tmp11*weak_mat_tmp33 + weak_mat_tmp22*(scalar_t(2)*weak_mat_tmp11 + scalar_t(2))) - weak_mat_tmp65*weak_mat_tmp7 + weak_mat_tmp65) + trial_grad[3]*weak_mat_tmp67;
