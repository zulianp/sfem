...
namespace sfem {
  class GeneratedModifiedMooneyRivlin final : public Op, public TimeSteppable {
  public:
    static std::unique_ptr<Op> create(const std::shared_ptr<FunctionSpace> &space);

    explicit GeneratedModifiedMooneyRivlin(const std::shared_ptr<FunctionSpace> &space);
    ~GeneratedModifiedMooneyRivlin() override;

    const char *name() const override { return "GeneratedModifiedMooneyRivlin"; }
