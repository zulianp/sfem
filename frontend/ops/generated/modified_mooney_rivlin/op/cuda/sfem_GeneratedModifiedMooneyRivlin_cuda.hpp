...
namespace sfem {
  class GPUGeneratedModifiedMooneyRivlin final : public Op, public TimeSteppable {
  public:
    static std::unique_ptr<Op> create(const std::shared_ptr<FunctionSpace> &space);

    explicit GPUGeneratedModifiedMooneyRivlin(const std::shared_ptr<FunctionSpace> &space);
    ~GPUGeneratedModifiedMooneyRivlin() override;

    const char *name() const override { return "GPUGeneratedModifiedMooneyRivlin"; }
