...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int modified_mooney_rivlin_total_merit_patch_2d_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch(
      "modified_mooney_rivlin_total_merit_patch_2d_a_msoa", (int)element_type, (int)real_type);
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int modified_mooney_rivlin_total_merit_patch_3d_a_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t n_owned_nodes,
        const count_t *const RSTR n2e_ptr,
  ...
  return sfem::codegen::unsupported_dispatch(
      "modified_mooney_rivlin_total_merit_patch_3d_a_msoa", (int)element_type, (int)real_type);
}
