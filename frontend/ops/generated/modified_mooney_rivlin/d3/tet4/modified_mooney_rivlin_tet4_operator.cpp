...
struct modified_mooney_rivlin_tet4_affine_reference_data {
...
static SFEM_INLINE int modified_mooney_rivlin_tet4_objective_steps_affine_mesh_soa_impl(
    ...
    (void)nnodes;
    const scalar_t *const affine_q_weight = sfem::codegen::modified_mooney_rivlin_tet4_affine_reference_data<scalar_t>::q_weight();
...
extern "C" int modified_mooney_rivlin_tet4_objective_steps_packed_affine_mesh_soa(
    ...
    const scalar_t *const affine_grad_ref_x = sfem::codegen::modified_mooney_rivlin_tet4_affine_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const affine_grad_ref_y = sfem::codegen::modified_mooney_rivlin_tet4_affine_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const affine_grad_ref_z = sfem::codegen::modified_mooney_rivlin_tet4_affine_reference_data<scalar_t>::grad_ref_z();
    const scalar_t *const affine_q_weight = sfem::codegen::modified_mooney_rivlin_tet4_affine_reference_data<scalar_t>::q_weight();
...
static SFEM_INLINE int modified_mooney_rivlin_tet4_objective_steps_isoparametric_mesh_soa_impl(
    ...
    const scalar_t *const isoparametric_grad_ref_x = sfem::codegen::modified_mooney_rivlin_tet4_isoparametric_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const isoparametric_grad_ref_y = sfem::codegen::modified_mooney_rivlin_tet4_isoparametric_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const isoparametric_grad_ref_z = sfem::codegen::modified_mooney_rivlin_tet4_isoparametric_reference_data<scalar_t>::grad_ref_z();
    const scalar_t *const isoparametric_q_weight = sfem::codegen::modified_mooney_rivlin_tet4_isoparametric_reference_data<scalar_t>::q_weight();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        for (int step = 0; step < nsteps; ++step) {
            ...
            modified_mooney_rivlin_d3_simplex_tet4_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, isoparametric_q_weight, c1, c2, kappa, block_u_streams, block_value);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        modified_mooney_rivlin_d3_simplex_tet4_gradient_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, affine_q_weight, c1, c2, kappa, block_u_streams, block_out_streams);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        modified_mooney_rivlin_d3_simplex_tet4_gradient_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, isoparametric_q_weight, c1, c2, kappa, block_u_streams, block_out_streams);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        modified_mooney_rivlin_d3_simplex_tet4_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, affine_q_weight, c1, c2, kappa, block_u_streams, block_h_streams, block_out_streams);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        modified_mooney_rivlin_d3_simplex_tet4_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, isoparametric_q_weight, c1, c2, kappa, block_u_streams, block_h_streams, block_out_streams);
...
template <typename scalar_t>
static SFEM_INLINE void modified_mooney_rivlin_tet4_hessian_isoparametric_mesh_soa_scatter_bsr(
...
#pragma omp parallel for schedule(static) reduction(|:unsupported_matrix_format)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        if constexpr (FORMAT == 1) {
            modified_mooney_rivlin_tet4_hessian_isoparametric_mesh_soa_scatter_bsr(ev, element_matrix, rowptr, colidx, values);
        } else {
