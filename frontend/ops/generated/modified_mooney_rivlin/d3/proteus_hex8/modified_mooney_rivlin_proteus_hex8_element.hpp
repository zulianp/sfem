...
static SFEM_INLINE int modified_mooney_rivlin_proteus_hex8_energy_egeometry_soa(
...
template <typename s_t, int VS>
static SFEM_INLINE int modified_mooney_rivlin_proteus_hex8_energy_ecoords_soa(
        const ptrdiff_t nelements,
...
template <typename s_t, int VS>
static SFEM_INLINE int modified_mooney_rivlin_proteus_hex8_energy_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t c1,
        const s_t c2,
...
template <typename s_t, int VS>
static SFEM_INLINE int modified_mooney_rivlin_proteus_hex8_gradient_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t c1,
...
template <typename s_t, int VS>
static SFEM_INLINE int modified_mooney_rivlin_proteus_hex8_gradient_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t c1,
        const s_t c2,
...
template <typename s_t, int VS>
static SFEM_INLINE int modified_mooney_rivlin_proteus_hex8_gradient_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t c1,
        const s_t c2,
...
template <typename s_t, int VS>
static SFEM_INLINE int modified_mooney_rivlin_proteus_hex8_hessian_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t c1,
...
template <typename s_t, int VS>
static SFEM_INLINE int modified_mooney_rivlin_proteus_hex8_hessian_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t c1,
        const s_t c2,
...
template <typename s_t, int VS>
static SFEM_INLINE int modified_mooney_rivlin_proteus_hex8_hessian_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t c1,
        const s_t c2,
