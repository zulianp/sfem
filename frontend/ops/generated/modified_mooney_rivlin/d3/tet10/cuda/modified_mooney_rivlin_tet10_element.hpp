#ifndef MODIFIED_MOONEY_RIVLIN_TET10_ELEMENT_API_CUH
#define MODIFIED_MOONEY_RIVLIN_TET10_ELEMENT_API_CUH
...
static __host__ __device__ __forceinline__ int modified_mooney_rivlin_tet10_energy_egeometry_soa(
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    modified_mooney_rivlin_d3_simplex_objective_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::ref_tet10_q11<s_t>::grad_ref_x(), sfem::codegen::ref_tet10_q11<s_t>::grad_ref_y(), sfem::codegen::ref_tet10_q11<s_t>::grad_ref_z(), sfem::codegen::quad_tet_q11<s_t>::q_weight(), c1, c2, kappa, bu_streams, bu_streams, 1, &objective_step, 0, bvalue);
  }
  return SFEM_SUCCESS;
}

template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int modified_mooney_rivlin_tet10_energy_ecoords_soa(
        const ptrdiff_t nelements,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int modified_mooney_rivlin_tet10_energy_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t c1,
        const s_t c2,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int modified_mooney_rivlin_tet10_gradient_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t c1,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    modified_mooney_rivlin_d3_simplex_gradient_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::ref_tet10_q11<s_t>::grad_ref_x(), sfem::codegen::ref_tet10_q11<s_t>::grad_ref_y(), sfem::codegen::ref_tet10_q11<s_t>::grad_ref_z(), sfem::codegen::quad_tet_q11<s_t>::q_weight(), c1, c2, kappa, bu_streams, bout_streams);
  }
  return SFEM_SUCCESS;
}

template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int modified_mooney_rivlin_tet10_gradient_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t c1,
        const s_t c2,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int modified_mooney_rivlin_tet10_gradient_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t c1,
        const s_t c2,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int modified_mooney_rivlin_tet10_hessian_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t c1,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    for (int col = 0; col < NDOFS; ++col) {
      ...
      modified_mooney_rivlin_d3_simplex_apply_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::ref_tet10_q11<s_t>::grad_ref_x(), sfem::codegen::ref_tet10_q11<s_t>::grad_ref_y(), sfem::codegen::ref_tet10_q11<s_t>::grad_ref_z(), sfem::codegen::quad_tet_q11<s_t>::q_weight(), c1, c2, kappa, bu_streams, bh_streams, bout_streams);
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int modified_mooney_rivlin_tet10_hessian_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t c1,
        const s_t c2,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int modified_mooney_rivlin_tet10_hessian_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t c1,
        const s_t c2,
