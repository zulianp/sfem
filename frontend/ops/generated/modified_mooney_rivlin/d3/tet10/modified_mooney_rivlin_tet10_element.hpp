#ifndef MODIFIED_MOONEY_RIVLIN_TET10_ELEMENT_API_HPP
#define MODIFIED_MOONEY_RIVLIN_TET10_ELEMENT_API_HPP
...
static SFEM_INLINE int modified_mooney_rivlin_tet10_energy_element_geometry_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        modified_mooney_rivlin_d3_simplex_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::grad_ref_x(), sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::grad_ref_y(), sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::grad_ref_z(), sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::q_weight(), c1, c2, kappa, block_u_streams, block_value);
    }
    return SFEM_SUCCESS;
}

template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int modified_mooney_rivlin_tet10_energy_element_coords_soa(
        const ptrdiff_t nelements,
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        scalar_t block_jacobian_adjugate8[N_QP * VECTOR_SIZE];
        scalar_t block_jacobian_determinant0[N_QP * VECTOR_SIZE];
        const scalar_t *const grad_ref_x = sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::grad_ref_x();
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int modified_mooney_rivlin_tet10_energy_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t c1,
        const scalar_t c2,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int modified_mooney_rivlin_tet10_gradient_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t c1,
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        modified_mooney_rivlin_d3_simplex_gradient_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::grad_ref_x(), sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::grad_ref_y(), sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::grad_ref_z(), sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::q_weight(), c1, c2, kappa, block_u_streams, block_out_streams);
    }
    return SFEM_SUCCESS;
}

template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int modified_mooney_rivlin_tet10_gradient_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t c1,
        const scalar_t c2,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int modified_mooney_rivlin_tet10_gradient_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t c1,
        const scalar_t c2,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int modified_mooney_rivlin_tet10_hessian_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t c1,
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        for (int col = 0; col < NDOFS; ++col) {
            ...
            modified_mooney_rivlin_d3_simplex_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::grad_ref_x(), sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::grad_ref_y(), sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::grad_ref_z(), sfem::codegen::modified_mooney_rivlin_tet10_isoparametric_reference_data<scalar_t>::q_weight(), c1, c2, kappa, block_u_streams, block_h_streams, block_out_streams);
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int modified_mooney_rivlin_tet10_hessian_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t c1,
        const scalar_t c2,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int modified_mooney_rivlin_tet10_hessian_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t c1,
        const scalar_t c2,
