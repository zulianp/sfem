#ifndef MOONEY_RIVLIN_KELVIN_VOIGT_ELASTIC_D3_TENSOR_PRODUCT_LOCAL_CUH
#define MOONEY_RIVLIN_KELVIN_VOIGT_ELASTIC_D3_TENSOR_PRODUCT_LOCAL_CUH
#include <math.h>
#include <stddef.h>
...
static __host__ __device__ __forceinline__ void mooney_rivlin_kelvin_voigt_elastic_d3_tensor_product_objective_block(
        const int ne,
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    const s_t weak_obj_tmp4 = gu[1]*gu[5]*gu[6];
    const s_t weak_obj_tmp5 = gu[2]*gu[3]*gu[7];
    const s_t weak_obj_tmp6 = gu[4] + s_t(1);
    const s_t weak_obj_tmp7 = pow_2(gu[1]) + pow_2(gu[7]) + pow_2(weak_obj_tmp6);
    const s_t weak_obj_tmp8 = gu[8] + s_t(1);
    const s_t weak_obj_tmp9 = pow_2(gu[2]) + pow_2(gu[5]) + pow_2(weak_obj_tmp8);
    const s_t weak_obj_tmp10 = gu[0] + s_t(1);
    const s_t weak_obj_tmp11 = pow_2(gu[3]) + pow_2(gu[6]) + pow_2(weak_obj_tmp10);
    const s_t weak_obj_tmp12 = weak_obj_tmp11 + weak_obj_tmp7 + weak_obj_tmp9;
    const s_t weak_obj_tmp13 = s_t(6)*weak_obj_tmp8;
    value[step * value_stride + 0] += qw * det_value0 * (((s_t(1) / s_t(2)))*lmbda*pow_2(gu[0]*gu[8] - gu[0]*weak_obj_tmp3 + gu[0] + gu[4]*gu[8] - gu[4]*weak_obj_tmp2 + gu[4] + gu[8]*weak_obj_tmp0 - gu[8]*weak_obj_tmp1 + gu[8] + weak_obj_tmp0 - weak_obj_tmp1 - weak_obj_tmp2 - weak_obj_tmp3 + weak_obj_tmp4 + weak_obj_tmp5) + mu*(weak_obj_tmp1*weak_obj_tmp13 - weak_obj_tmp10*weak_obj_tmp13*weak_obj_tmp6 + s_t(6)*weak_obj_tmp10*weak_obj_tmp3 - (s_t(1) / s_t(2))*pow_2(weak_obj_tmp11) + ((s_t(1) / s_t(2)))*pow_2(weak_obj_tmp12) + weak_obj_tmp12 + s_t(6)*weak_obj_tmp2*weak_obj_tmp6 - s_t(6)*weak_obj_tmp4 - s_t(6)*weak_obj_tmp5 - (s_t(1) / s_t(2))*pow_2(weak_obj_tmp7) - (s_t(1) / s_t(2))*pow_2(weak_obj_tmp9) - pow_2(gu[1]*gu[2] + gu[5]*weak_obj_tmp6 + gu[7]*weak_obj_tmp8) - pow_2(gu[1]*weak_obj_tmp10 + gu[3]*weak_obj_tmp6 + gu[6]*gu[7]) - pow_2(gu[2]*weak_obj_tmp10 + gu[3]*gu[5] + gu[6]*weak_obj_tmp8)));
      }
    }
  }
}
...
template <typename s_t, int NQ, int NS, int VS>
static __host__ __device__ __forceinline__ void mooney_rivlin_kelvin_voigt_elastic_d3_tensor_product_gradient_block(
        const int ne,
        const ptrdiff_t geometry_stride,
        const s_t *const RSTR adj0,
        const s_t *const RSTR adj1,
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    const s_t weak_mat_tmp4 = gu[0]*gu[4];
    const s_t weak_mat_tmp5 = gu[0]*gu[8];
    const s_t weak_mat_tmp6 = gu[4]*gu[8];
    const s_t weak_mat_tmp7 = gu[1]*gu[3];
    const s_t weak_mat_tmp8 = gu[2]*gu[6];
    const s_t weak_mat_tmp9 = gu[5]*gu[6];
    const s_t weak_mat_tmp10 = gu[3]*gu[7];
    const s_t weak_mat_tmp11 = ((s_t(1) / s_t(2)))*lmbda*(-gu[0]*weak_mat_tmp0 + gu[0] + gu[1]*weak_mat_tmp9 + gu[2]*weak_mat_tmp10 - gu[4]*weak_mat_tmp8 + gu[4] + gu[8]*weak_mat_tmp4 - gu[8]*weak_mat_tmp7 + gu[8] - weak_mat_tmp0 + weak_mat_tmp4 + weak_mat_tmp5 + weak_mat_tmp6 - weak_mat_tmp7 - weak_mat_tmp8);
    const s_t weak_mat_tmp12 = pow_2(gu[5]);
    const s_t weak_mat_tmp13 = s_t(2)*weak_mat_tmp12;
    const s_t weak_mat_tmp14 = pow_2(gu[7]);
    const s_t weak_mat_tmp15 = s_t(2)*weak_mat_tmp14;
    const s_t weak_mat_tmp16 = s_t(6)*gu[0];
    const s_t weak_mat_tmp17 = pow_2(gu[4]);
    const s_t weak_mat_tmp18 = s_t(2)*weak_mat_tmp17;
    const s_t weak_mat_tmp19 = pow_2(gu[8]);
    const s_t weak_mat_tmp20 = s_t(2)*weak_mat_tmp19;
    const s_t weak_mat_tmp21 = s_t(2)*gu[4];
    const s_t weak_mat_tmp22 = s_t(2)*gu[1];
    const s_t weak_mat_tmp23 = gu[6]*gu[7];
    const s_t weak_mat_tmp24 = s_t(2)*gu[2];
    const s_t weak_mat_tmp25 = gu[3]*gu[5];
    const s_t weak_mat_tmp26 = s_t(2)*gu[8];
    ...
    const s_t weak_mat_tmp31 = s_t(2)*gu[3];
    const s_t weak_mat_tmp32 = pow_2(gu[1]);
    const s_t weak_mat_tmp33 = weak_mat_tmp14 + pow_2(weak_mat_tmp2) + weak_mat_tmp32;
    const s_t weak_mat_tmp34 = gu[1]*gu[2] + gu[5]*weak_mat_tmp2 + gu[7]*weak_mat_tmp3;
    const s_t weak_mat_tmp35 = gu[0] + s_t(1);
    const s_t weak_mat_tmp36 = gu[1]*weak_mat_tmp35 + gu[3]*weak_mat_tmp2 + weak_mat_tmp23;
    const s_t weak_mat_tmp37 = s_t(2)*weak_mat_tmp35;
    const s_t weak_mat_tmp38 = pow_2(gu[2]);
    const s_t weak_mat_tmp39 = weak_mat_tmp12 + pow_2(weak_mat_tmp3) + weak_mat_tmp38;
    const s_t weak_mat_tmp40 = pow_2(gu[3]);
    const s_t weak_mat_tmp41 = pow_2(gu[6]);
    ...
    const s_t weak_mat_tmp44 = s_t(2)*gu[6];
    const s_t weak_mat_tmp45 = gu[2]*weak_mat_tmp35 + gu[6]*weak_mat_tmp3 + weak_mat_tmp25;
    const s_t weak_mat_tmp46 = s_t(2)*gu[5];
    const s_t weak_mat_tmp47 = s_t(2)*weak_mat_tmp2;
    const s_t weak_mat_tmp48 = pow_2(gu[0]);
    const s_t weak_mat_tmp49 = s_t(2)*gu[0];
    const s_t weak_mat_tmp50 = gu[5]*weak_mat_tmp22;
    const s_t weak_mat_tmp51 = -weak_mat_tmp1 + s_t(2)*weak_mat_tmp48 - weak_mat_tmp49 + s_t(4)*weak_mat_tmp6;
    const s_t weak_mat_tmp52 = s_t(2)*gu[7];
    const s_t weak_mat_tmp53 = s_t(2)*weak_mat_tmp3;
    material[0] = mu*(gu[0]*weak_mat_tmp13 + gu[0]*weak_mat_tmp15 + gu[0]*weak_mat_tmp18 + gu[0]*weak_mat_tmp20 + s_t(6)*weak_mat_tmp0 + weak_mat_tmp13 + weak_mat_tmp15 + weak_mat_tmp16 - weak_mat_tmp21*weak_mat_tmp7 - weak_mat_tmp22*weak_mat_tmp23 - weak_mat_tmp24*weak_mat_tmp25 - weak_mat_tmp26*weak_mat_tmp8 + weak_mat_tmp28 + weak_mat_tmp30 - s_t(6)*weak_mat_tmp6) + weak_mat_tmp11*(-weak_mat_tmp1 + s_t(2)*weak_mat_tmp2*weak_mat_tmp3);
    material[1] = mu*(s_t(2)*gu[1]*weak_mat_tmp43 + s_t(2)*gu[1] + s_t(6)*gu[3]*weak_mat_tmp3 - weak_mat_tmp22*weak_mat_tmp33 - weak_mat_tmp24*weak_mat_tmp34 - weak_mat_tmp36*weak_mat_tmp37 - s_t(6)*weak_mat_tmp9) + weak_mat_tmp11*(s_t(2)*gu[5]*gu[6] - weak_mat_tmp3*weak_mat_tmp31);
    material[2] = mu*(s_t(2)*gu[2]*weak_mat_tmp43 + s_t(2)*gu[2] + s_t(6)*gu[6]*weak_mat_tmp2 - s_t(6)*weak_mat_tmp10 - weak_mat_tmp22*weak_mat_tmp34 - weak_mat_tmp24*weak_mat_tmp39 - weak_mat_tmp37*weak_mat_tmp45) + weak_mat_tmp11*(gu[7]*weak_mat_tmp31 - weak_mat_tmp2*weak_mat_tmp44);
    material[3] = mu*(s_t(6)*gu[1]*weak_mat_tmp3 - s_t(6)*gu[2]*gu[7] + s_t(2)*gu[3]*weak_mat_tmp43 + s_t(2)*gu[3] - weak_mat_tmp31*weak_mat_tmp42 - weak_mat_tmp36*weak_mat_tmp47 - weak_mat_tmp45*weak_mat_tmp46) + weak_mat_tmp11*(s_t(2)*gu[2]*gu[7] - weak_mat_tmp22*weak_mat_tmp3);
    material[4] = mu*(-gu[2]*weak_mat_tmp50 + s_t(6)*gu[4] - gu[8]*weak_mat_tmp16 - weak_mat_tmp0*weak_mat_tmp26 + weak_mat_tmp19*weak_mat_tmp21 + weak_mat_tmp21*weak_mat_tmp38 + weak_mat_tmp21*weak_mat_tmp41 + weak_mat_tmp21*weak_mat_tmp48 - weak_mat_tmp23*weak_mat_tmp31 + weak_mat_tmp28 + s_t(2)*weak_mat_tmp38 + s_t(2)*weak_mat_tmp41 - weak_mat_tmp49*weak_mat_tmp7 + weak_mat_tmp51 + s_t(6)*weak_mat_tmp8) + weak_mat_tmp11*(-weak_mat_tmp29 + s_t(2)*weak_mat_tmp3*weak_mat_tmp35);
    material[5] = mu*(-s_t(6)*gu[1]*gu[6] + s_t(2)*gu[5]*weak_mat_tmp43 + s_t(2)*gu[5] + s_t(6)*gu[7]*weak_mat_tmp35 - weak_mat_tmp31*weak_mat_tmp45 - weak_mat_tmp34*weak_mat_tmp47 - weak_mat_tmp39*weak_mat_tmp46) + weak_mat_tmp11*(gu[6]*weak_mat_tmp22 - weak_mat_tmp35*weak_mat_tmp52);
    material[6] = mu*(-s_t(6)*gu[1]*gu[5] + s_t(6)*gu[2]*weak_mat_tmp2 + s_t(2)*gu[6]*weak_mat_tmp43 + s_t(2)*gu[6] - weak_mat_tmp36*weak_mat_tmp52 - weak_mat_tmp42*weak_mat_tmp44 - weak_mat_tmp45*weak_mat_tmp53) + weak_mat_tmp11*(-weak_mat_tmp2*weak_mat_tmp24 + weak_mat_tmp50);
    material[7] = mu*(-s_t(6)*gu[2]*gu[3] + s_t(6)*gu[5]*weak_mat_tmp35 + s_t(2)*gu[7]*weak_mat_tmp43 + s_t(2)*gu[7] - weak_mat_tmp33*weak_mat_tmp52 - weak_mat_tmp34*weak_mat_tmp53 - weak_mat_tmp36*weak_mat_tmp44) + weak_mat_tmp11*(gu[3]*weak_mat_tmp24 - weak_mat_tmp35*weak_mat_tmp46);
    material[8] = mu*(-gu[2]*gu[7]*weak_mat_tmp22 - gu[4]*weak_mat_tmp16 + s_t(6)*gu[8] - weak_mat_tmp0*weak_mat_tmp21 + weak_mat_tmp17*weak_mat_tmp26 - weak_mat_tmp25*weak_mat_tmp44 + weak_mat_tmp26*weak_mat_tmp32 + weak_mat_tmp26*weak_mat_tmp40 + weak_mat_tmp26*weak_mat_tmp48 + weak_mat_tmp30 + s_t(2)*weak_mat_tmp32 + s_t(2)*weak_mat_tmp40 - weak_mat_tmp49*weak_mat_tmp8 + weak_mat_tmp51 + s_t(6)*weak_mat_tmp7) + weak_mat_tmp11*(s_t(2)*weak_mat_tmp2*weak_mat_tmp35 - weak_mat_tmp27);
...
template <typename s_t, int NQ, int NS, int VS>
static __host__ __device__ __forceinline__ void mooney_rivlin_kelvin_voigt_elastic_d3_tensor_product_apply_block(
        const int ne,
        const ptrdiff_t geometry_stride,
        const s_t *const RSTR adj0,
        const s_t *const RSTR adj1,
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    const s_t weak_mat_tmp13 = gu[5]*weak_mat_tmp3;
    const s_t weak_mat_tmp14 = weak_mat_tmp0*weak_mat_tmp6;
    const s_t weak_mat_tmp15 = mu*(-weak_mat_tmp13 - weak_mat_tmp14);
    const s_t weak_mat_tmp16 = gu[3]*gu[7];
    const s_t weak_mat_tmp17 = gu[6]*weak_mat_tmp2;
    const s_t weak_mat_tmp18 = weak_mat_tmp16 - weak_mat_tmp17;
    const s_t weak_mat_tmp19 = s_t(2)*gu[2];
    const s_t weak_mat_tmp20 = gu[5]*weak_mat_tmp19;
    ...
    const s_t weak_mat_tmp24 = gu[1]*weak_mat_tmp6;
    const s_t weak_mat_tmp25 = gu[2]*gu[7] - weak_mat_tmp24;
    const s_t weak_mat_tmp26 = gu[7]*weak_mat_tmp21;
    const s_t weak_mat_tmp27 = weak_mat_tmp19*weak_mat_tmp6;
    const s_t weak_mat_tmp28 = mu*(-weak_mat_tmp26 - weak_mat_tmp27);
    const s_t weak_mat_tmp29 = gu[1]*gu[5];
    const s_t weak_mat_tmp30 = gu[2]*weak_mat_tmp2;
    const s_t weak_mat_tmp31 = weak_mat_tmp29 - weak_mat_tmp30;
    const s_t weak_mat_tmp32 = s_t(2)*pow_2(gu[5]);
    const s_t weak_mat_tmp33 = s_t(2)*pow_2(weak_mat_tmp6) + s_t(2);
    const s_t weak_mat_tmp34 = weak_mat_tmp32 + weak_mat_tmp33;
    const s_t weak_mat_tmp35 = s_t(2)*pow_2(gu[7]);
    ...
    const s_t weak_mat_tmp39 = gu[1]*gu[6];
    const s_t weak_mat_tmp40 = gu[0] + s_t(1);
    const s_t weak_mat_tmp41 = gu[7]*weak_mat_tmp40;
    const s_t weak_mat_tmp42 = weak_mat_tmp39 - weak_mat_tmp41;
    const s_t weak_mat_tmp43 = s_t(6)*gu[7];
    const s_t weak_mat_tmp44 = gu[2]*gu[3];
    const s_t weak_mat_tmp45 = s_t(2)*weak_mat_tmp44;
    const s_t weak_mat_tmp46 = gu[5]*weak_mat_tmp40;
    const s_t weak_mat_tmp47 = gu[0]*gu[4];
    const s_t weak_mat_tmp48 = gu[0]*gu[8];
    const s_t weak_mat_tmp49 = gu[4]*gu[8];
    const s_t weak_mat_tmp50 = gu[1]*gu[3];
    const s_t weak_mat_tmp51 = gu[2]*gu[6];
    const s_t weak_mat_tmp52 = gu[5]*gu[6];
    const s_t weak_mat_tmp53 = lmbda*(-gu[0]*weak_mat_tmp9 + gu[0] + gu[1]*weak_mat_tmp52 + gu[2]*weak_mat_tmp16 - gu[4]*weak_mat_tmp51 + gu[4] + gu[8]*weak_mat_tmp47 - gu[8]*weak_mat_tmp50 + gu[8] + weak_mat_tmp47 + weak_mat_tmp48 + weak_mat_tmp49 - weak_mat_tmp50 - weak_mat_tmp51 - weak_mat_tmp9);
    const s_t weak_mat_tmp54 = gu[7]*weak_mat_tmp53;
    ...
    const s_t weak_mat_tmp57 = s_t(6)*gu[5];
    const s_t weak_mat_tmp58 = s_t(2)*weak_mat_tmp39;
    const s_t weak_mat_tmp59 = gu[5]*weak_mat_tmp53;
    ...
    const s_t weak_mat_tmp62 = -s_t(6)*gu[8];
    const s_t weak_mat_tmp63 = s_t(2)*weak_mat_tmp50;
    const s_t weak_mat_tmp64 = s_t(4)*gu[0];
    const s_t weak_mat_tmp65 = weak_mat_tmp64 + s_t(-2);
    const s_t weak_mat_tmp66 = weak_mat_tmp53*weak_mat_tmp6;
    const s_t weak_mat_tmp67 = mu*(gu[4]*weak_mat_tmp64 + s_t(4)*gu[4] + weak_mat_tmp62 - weak_mat_tmp63 + weak_mat_tmp65) + weak_mat_tmp66;
    const s_t weak_mat_tmp68 = weak_mat_tmp2*weak_mat_tmp40 - weak_mat_tmp50;
    const s_t weak_mat_tmp69 = -s_t(6)*gu[4];
    const s_t weak_mat_tmp70 = s_t(2)*weak_mat_tmp51;
    const s_t weak_mat_tmp71 = weak_mat_tmp2*weak_mat_tmp53;
    const s_t weak_mat_tmp72 = mu*(gu[8]*weak_mat_tmp64 + s_t(4)*gu[8] + weak_mat_tmp65 + weak_mat_tmp69 - weak_mat_tmp70) + weak_mat_tmp71;
    ...
    const s_t weak_mat_tmp76 = s_t(2)*gu[5];
    const s_t weak_mat_tmp77 = weak_mat_tmp2*weak_mat_tmp76;
    const s_t weak_mat_tmp78 = s_t(2)*gu[7];
    ...
    const s_t weak_mat_tmp85 = s_t(2)*pow_2(gu[3]);
    const s_t weak_mat_tmp86 = s_t(2)*pow_2(gu[6]);
    const s_t weak_mat_tmp87 = weak_mat_tmp85 + weak_mat_tmp86;
    const s_t weak_mat_tmp88 = s_t(6)*gu[6];
    const s_t weak_mat_tmp89 = s_t(2)*weak_mat_tmp30;
    const s_t weak_mat_tmp90 = gu[6]*weak_mat_tmp53;
    const s_t weak_mat_tmp91 = mu*(s_t(4)*gu[1]*gu[5] - weak_mat_tmp88 - weak_mat_tmp89) + weak_mat_tmp90;
    const s_t weak_mat_tmp92 = s_t(2)*weak_mat_tmp41;
    const s_t weak_mat_tmp93 = mu*(s_t(4)*gu[1]*gu[6] - weak_mat_tmp57 - weak_mat_tmp92) + weak_mat_tmp59;
    const s_t weak_mat_tmp94 = s_t(6)*gu[3];
    const s_t weak_mat_tmp95 = -s_t(2)*gu[2]*gu[7];
    const s_t weak_mat_tmp96 = gu[3]*weak_mat_tmp53;
    const s_t weak_mat_tmp97 = mu*(s_t(4)*weak_mat_tmp24 + weak_mat_tmp94 + weak_mat_tmp95) - weak_mat_tmp96;
    const s_t weak_mat_tmp98 = s_t(2)*gu[4];
    const s_t weak_mat_tmp99 = s_t(2)*gu[0] + s_t(-4);
    const s_t weak_mat_tmp100 = mu*(s_t(4)*gu[1]*gu[3] - s_t(2)*weak_mat_tmp47 - weak_mat_tmp62 - weak_mat_tmp98 - weak_mat_tmp99) - weak_mat_tmp66;
    ...
    const s_t weak_mat_tmp107 = mu*(s_t(4)*gu[2]*gu[3] - weak_mat_tmp106 - weak_mat_tmp43) + weak_mat_tmp54;
    const s_t weak_mat_tmp108 = s_t(2)*weak_mat_tmp24;
    const s_t weak_mat_tmp109 = mu*(s_t(4)*gu[2]*gu[7] - weak_mat_tmp108 - weak_mat_tmp94) + weak_mat_tmp96;
    ...
    const s_t weak_mat_tmp112 = s_t(2)*gu[8];
    const s_t weak_mat_tmp113 = mu*(s_t(4)*gu[2]*gu[6] - weak_mat_tmp112 - s_t(2)*weak_mat_tmp48 - weak_mat_tmp69 - weak_mat_tmp99) - weak_mat_tmp71;
    ...
    const s_t weak_mat_tmp122 = s_t(2)*pow_2(gu[2]);
    const s_t weak_mat_tmp123 = weak_mat_tmp122 + weak_mat_tmp33;
    const s_t weak_mat_tmp124 = s_t(2)*pow_2(gu[1]);
    const s_t weak_mat_tmp125 = weak_mat_tmp124 + weak_mat_tmp35;
    const s_t weak_mat_tmp126 = s_t(6)*gu[2];
    const s_t weak_mat_tmp127 = gu[2]*weak_mat_tmp53;
    const s_t weak_mat_tmp128 = mu*(s_t(4)*gu[3]*gu[7] - weak_mat_tmp102 - weak_mat_tmp126) + weak_mat_tmp127;
    const s_t weak_mat_tmp129 = s_t(6)*gu[1];
    const s_t weak_mat_tmp130 = gu[1]*weak_mat_tmp53;
    ...
    const s_t weak_mat_tmp133 = gu[2]*weak_mat_tmp21;
    const s_t weak_mat_tmp134 = mu*(-weak_mat_tmp133 - weak_mat_tmp79);
    const s_t weak_mat_tmp135 = gu[6]*weak_mat_tmp3;
    ...
    const s_t weak_mat_tmp140 = s_t(6)*gu[0];
    const s_t weak_mat_tmp141 = weak_mat_tmp40*weak_mat_tmp53;
    const s_t weak_mat_tmp142 = mu*(s_t(4)*gu[4]*gu[8] + s_t(4)*gu[4] + s_t(4)*gu[8] - weak_mat_tmp10 - weak_mat_tmp140 + s_t(-2)) + weak_mat_tmp141;
    ...
    const s_t weak_mat_tmp145 = mu*(s_t(4)*gu[5]*gu[6] - weak_mat_tmp129 - weak_mat_tmp74) + weak_mat_tmp130;
    ...
    material[0] = trial_grad[0]*(mu*(weak_mat_tmp34 + weak_mat_tmp37) + weak_mat_tmp12*weak_mat_tmp38) + trial_grad[1]*(weak_mat_tmp12*weak_mat_tmp8 + weak_mat_tmp5) + trial_grad[2]*(weak_mat_tmp12*weak_mat_tmp18 + weak_mat_tmp15) + trial_grad[3]*(weak_mat_tmp12*weak_mat_tmp25 + weak_mat_tmp23) + trial_grad[4]*(weak_mat_tmp12*weak_mat_tmp61 + weak_mat_tmp67) + trial_grad[5]*(weak_mat_tmp12*weak_mat_tmp42 + weak_mat_tmp55) + trial_grad[6]*(weak_mat_tmp12*weak_mat_tmp31 + weak_mat_tmp28) + trial_grad[7]*(weak_mat_tmp12*weak_mat_tmp56 + weak_mat_tmp60) + trial_grad[8]*(weak_mat_tmp12*weak_mat_tmp68 + weak_mat_tmp72);
    material[1] = trial_grad[0]*(weak_mat_tmp38*weak_mat_tmp75 + weak_mat_tmp5) + trial_grad[1]*(mu*(weak_mat_tmp34 + weak_mat_tmp87) + weak_mat_tmp75*weak_mat_tmp8) + trial_grad[2]*(weak_mat_tmp18*weak_mat_tmp75 + weak_mat_tmp80) + trial_grad[3]*(weak_mat_tmp100 + weak_mat_tmp25*weak_mat_tmp75) + trial_grad[4]*(weak_mat_tmp61*weak_mat_tmp75 + weak_mat_tmp82) + trial_grad[5]*(weak_mat_tmp42*weak_mat_tmp75 + weak_mat_tmp91) + trial_grad[6]*(weak_mat_tmp31*weak_mat_tmp75 + weak_mat_tmp93) + trial_grad[7]*(weak_mat_tmp56*weak_mat_tmp75 + weak_mat_tmp84) + trial_grad[8]*(weak_mat_tmp68*weak_mat_tmp75 + weak_mat_tmp97);
    material[2] = trial_grad[0]*(weak_mat_tmp103*weak_mat_tmp38 + weak_mat_tmp15) + trial_grad[1]*(weak_mat_tmp103*weak_mat_tmp8 + weak_mat_tmp80) + trial_grad[2]*(mu*(weak_mat_tmp37 + weak_mat_tmp87 + s_t(2)) + weak_mat_tmp103*weak_mat_tmp18) + trial_grad[3]*(weak_mat_tmp103*weak_mat_tmp25 + weak_mat_tmp107) + trial_grad[4]*(weak_mat_tmp103*weak_mat_tmp61 + weak_mat_tmp111) + trial_grad[5]*(weak_mat_tmp103*weak_mat_tmp42 + weak_mat_tmp104) + trial_grad[6]*(weak_mat_tmp103*weak_mat_tmp31 + weak_mat_tmp113) + trial_grad[7]*(weak_mat_tmp103*weak_mat_tmp56 + weak_mat_tmp109) + trial_grad[8]*(weak_mat_tmp103*weak_mat_tmp68 + weak_mat_tmp105);
    material[3] = trial_grad[0]*(weak_mat_tmp114*weak_mat_tmp38 + weak_mat_tmp23) + trial_grad[1]*(weak_mat_tmp100 + weak_mat_tmp114*weak_mat_tmp8) + trial_grad[2]*(weak_mat_tmp107 + weak_mat_tmp114*weak_mat_tmp18) + trial_grad[3]*(mu*(weak_mat_tmp123 + weak_mat_tmp125) + weak_mat_tmp114*weak_mat_tmp25) + trial_grad[4]*(weak_mat_tmp114*weak_mat_tmp61 + weak_mat_tmp116) + trial_grad[5]*(weak_mat_tmp114*weak_mat_tmp42 + weak_mat_tmp118) + trial_grad[6]*(weak_mat_tmp114*weak_mat_tmp31 + weak_mat_tmp121) + trial_grad[7]*(weak_mat_tmp114*weak_mat_tmp56 + weak_mat_tmp128) + trial_grad[8]*(weak_mat_tmp114*weak_mat_tmp68 + weak_mat_tmp131);
    material[4] = trial_grad[0]*(weak_mat_tmp132*weak_mat_tmp38 + weak_mat_tmp67) + trial_grad[1]*(weak_mat_tmp132*weak_mat_tmp8 + weak_mat_tmp82) + trial_grad[2]*(weak_mat_tmp111 + weak_mat_tmp132*weak_mat_tmp18) + trial_grad[3]*(weak_mat_tmp116 + weak_mat_tmp132*weak_mat_tmp25) + trial_grad[4]*(mu*(weak_mat_tmp123 + weak_mat_tmp138) + weak_mat_tmp132*weak_mat_tmp61) + trial_grad[5]*(weak_mat_tmp132*weak_mat_tmp42 + weak_mat_tmp134) + trial_grad[6]*(weak_mat_tmp132*weak_mat_tmp31 + weak_mat_tmp139) + trial_grad[7]*(weak_mat_tmp132*weak_mat_tmp56 + weak_mat_tmp136) + trial_grad[8]*(weak_mat_tmp132*weak_mat_tmp68 + weak_mat_tmp142);
    material[5] = trial_grad[0]*(weak_mat_tmp143*weak_mat_tmp38 + weak_mat_tmp55) + trial_grad[1]*(weak_mat_tmp143*weak_mat_tmp8 + weak_mat_tmp91) + trial_grad[2]*(weak_mat_tmp104 + weak_mat_tmp143*weak_mat_tmp18) + trial_grad[3]*(weak_mat_tmp118 + weak_mat_tmp143*weak_mat_tmp25) + trial_grad[4]*(weak_mat_tmp134 + weak_mat_tmp143*weak_mat_tmp61) + trial_grad[5]*(mu*(weak_mat_tmp125 + weak_mat_tmp138 + s_t(2)) + weak_mat_tmp143*weak_mat_tmp42) + trial_grad[6]*(weak_mat_tmp143*weak_mat_tmp31 + weak_mat_tmp145) + trial_grad[7]*(weak_mat_tmp143*weak_mat_tmp56 + weak_mat_tmp146) + trial_grad[8]*(weak_mat_tmp143*weak_mat_tmp68 + weak_mat_tmp144);
    material[6] = trial_grad[0]*(weak_mat_tmp147*weak_mat_tmp38 + weak_mat_tmp28) + trial_grad[1]*(weak_mat_tmp147*weak_mat_tmp8 + weak_mat_tmp93) + trial_grad[2]*(weak_mat_tmp113 + weak_mat_tmp147*weak_mat_tmp18) + trial_grad[3]*(weak_mat_tmp121 + weak_mat_tmp147*weak_mat_tmp25) + trial_grad[4]*(weak_mat_tmp139 + weak_mat_tmp147*weak_mat_tmp61) + trial_grad[5]*(weak_mat_tmp145 + weak_mat_tmp147*weak_mat_tmp42) + trial_grad[6]*(mu*(weak_mat_tmp150 + weak_mat_tmp151) + weak_mat_tmp147*weak_mat_tmp31) + trial_grad[7]*(weak_mat_tmp147*weak_mat_tmp56 + weak_mat_tmp148) + trial_grad[8]*(weak_mat_tmp147*weak_mat_tmp68 + weak_mat_tmp149);
    material[7] = trial_grad[0]*(weak_mat_tmp152*weak_mat_tmp38 + weak_mat_tmp60) + trial_grad[1]*(weak_mat_tmp152*weak_mat_tmp8 + weak_mat_tmp84) + trial_grad[2]*(weak_mat_tmp109 + weak_mat_tmp152*weak_mat_tmp18) + trial_grad[3]*(weak_mat_tmp128 + weak_mat_tmp152*weak_mat_tmp25) + trial_grad[4]*(weak_mat_tmp136 + weak_mat_tmp152*weak_mat_tmp61) + trial_grad[5]*(weak_mat_tmp146 + weak_mat_tmp152*weak_mat_tmp42) + trial_grad[6]*(weak_mat_tmp148 + weak_mat_tmp152*weak_mat_tmp31) + trial_grad[7]*(mu*(weak_mat_tmp150 + weak_mat_tmp154) + weak_mat_tmp152*weak_mat_tmp56) + trial_grad[8]*(weak_mat_tmp152*weak_mat_tmp68 + weak_mat_tmp153);
    material[8] = trial_grad[0]*(weak_mat_tmp155*weak_mat_tmp38 + weak_mat_tmp72) + trial_grad[1]*(weak_mat_tmp155*weak_mat_tmp8 + weak_mat_tmp97) + trial_grad[2]*(weak_mat_tmp105 + weak_mat_tmp155*weak_mat_tmp18) + trial_grad[3]*(weak_mat_tmp131 + weak_mat_tmp155*weak_mat_tmp25) + trial_grad[4]*(weak_mat_tmp142 + weak_mat_tmp155*weak_mat_tmp61) + trial_grad[5]*(weak_mat_tmp144 + weak_mat_tmp155*weak_mat_tmp42) + trial_grad[6]*(weak_mat_tmp149 + weak_mat_tmp155*weak_mat_tmp31) + trial_grad[7]*(weak_mat_tmp153 + weak_mat_tmp155*weak_mat_tmp56) + trial_grad[8]*(mu*(weak_mat_tmp151 + weak_mat_tmp154 + s_t(2)) + weak_mat_tmp155*weak_mat_tmp68);
    loperand[0] = qw * (material[0] * adj_value0 + material[1] * adj_value1 + material[2] * adj_value2);
    loperand[1] = qw * (material[0] * adj_value3 + material[1] * adj_value4 + material[2] * adj_value5);
    loperand[2] = qw * (material[0] * adj_value6 + material[1] * adj_value7 + material[2] * adj_value8);
    loperand[3] = qw * (material[3] * adj_value0 + material[4] * adj_value1 + material[5] * adj_value2);
