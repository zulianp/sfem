...
extern "C" int mooney_rivlin_kelvin_voigt_residual_merit_tet4_residual_esoa(
...
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_residual_merit_tet4_residual_a_msoa_impl(
...
extern "C" int mooney_rivlin_kelvin_voigt_residual_merit_tet4_residual_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("mooney_rivlin_kelvin_voigt_residual_merit_tet4_residual_a_msoa", -1, (int)scalar_bytes);
}

extern "C" int mooney_rivlin_kelvin_voigt_residual_merit_tet4_jacobian_action_esoa(
    const int scalar_bytes,
    const int ne,
    const ptrdiff_t geometry_stride,
    const void *const RSTR determinant,
  ...
  return sfem::codegen::unsupported_dispatch("mooney_rivlin_kelvin_voigt_residual_merit_tet4_jacobian_action_esoa", -1, (int)scalar_bytes);
}
...
template <typename s_t, typename g_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_residual_merit_tet4_jacobian_action_a_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t,
    idx_t **const RSTR elements,
    const g_t *const RSTR g_adj0,
...
extern "C" int mooney_rivlin_kelvin_voigt_residual_merit_tet4_jacobian_action_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("mooney_rivlin_kelvin_voigt_residual_merit_tet4_jacobian_action_a_msoa", -1, (int)scalar_bytes);
}
...
static int mooney_rivlin_kelvin_voigt_residual_merit_tet4_merit_patch(
