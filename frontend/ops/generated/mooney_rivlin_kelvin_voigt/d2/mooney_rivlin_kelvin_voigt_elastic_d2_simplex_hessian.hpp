#ifndef MOONEY_RIVLIN_KELVIN_VOIGT_ELASTIC_D2_SIMPLEX_HESSIAN_HPP
#define MOONEY_RIVLIN_KELVIN_VOIGT_ELASTIC_D2_SIMPLEX_HESSIAN_HPP
#include <math.h>
#include <stddef.h>
...
static SFEM_INLINE void mooney_rivlin_kelvin_voigt_elastic_d2_simplex_direct_hessian_reference_element_matrix(
...
template <typename s_t, int NQ, int NS, int VS>
static SFEM_INLINE void mooney_rivlin_kelvin_voigt_elastic_d2_simplex_tri3_direct_hessian_element_matrix(
    const s_t *const RSTR badj0,
    const s_t *const RSTR badj1,
    const s_t *const RSTR badj2,
    const s_t *const RSTR badj3,
  ...
  const s_t hessian_tmp18 = gu0*gu3;
  const s_t hessian_tmp19 = lmbda*(gu0 + gu3 - hessian_tmp17 + hessian_tmp18);
  const s_t hessian_tmp20 = s_t(2)*gu0;
  const s_t hessian_tmp21 = hessian_tmp17*lmbda - hessian_tmp19 + mu*(s_t(4)*gu1*gu2 - gu3*hessian_tmp20 - s_t(2)*gu3 - hessian_tmp20 + s_t(4));
  const s_t hessian_tmp22 = ((s_t(1) / s_t(2)))*hessian_tmp16 + ((s_t(1) / s_t(2)))*hessian_tmp21*hessian_tmp8;
  const s_t hessian_tmp23 = gu0 + s_t(1);
  const s_t hessian_tmp24 = hessian_tmp23*lmbda;
  const s_t hessian_tmp25 = hessian_tmp2*hessian_tmp23;
  const s_t hessian_tmp26 = -gu2*hessian_tmp24 - gu2*hessian_tmp25;
  const s_t hessian_tmp27 = hessian_tmp26*hessian_tmp8;
  const s_t hessian_tmp28 = hessian_tmp1*hessian_tmp23 + hessian_tmp19 + mu*(s_t(4)*gu0 + s_t(4)*gu3 - s_t(2)*hessian_tmp17 + s_t(4)*hessian_tmp18 + s_t(-2));
  const s_t hessian_tmp29 = ((s_t(1) / s_t(2)))*hessian_tmp27 + ((s_t(1) / s_t(2)))*hessian_tmp28*hessian_tmp5;
  const s_t hessian_tmp30 = adj_lane0*hessian_tmp22 + adj_lane1*hessian_tmp29;
  const s_t hessian_tmp31 = adj_lane2*hessian_tmp22 + adj_lane3*hessian_tmp29;
  const s_t hessian_tmp32 = adj_lane0*idet;
  const s_t hessian_tmp33 = adj_lane1*idet;
  const s_t hessian_tmp34 = ((s_t(1) / s_t(2)))*hessian_tmp32*hessian_tmp4 + ((s_t(1) / s_t(2)))*hessian_tmp33*hessian_tmp7;
  const s_t hessian_tmp35 = ((s_t(1) / s_t(2)))*hessian_tmp11*hessian_tmp32 + ((s_t(1) / s_t(2)))*hessian_tmp33*hessian_tmp4;
  const s_t hessian_tmp36 = adj_lane0*hessian_tmp35 + adj_lane1*hessian_tmp34;
  const s_t hessian_tmp37 = adj_lane2*hessian_tmp35 + adj_lane3*hessian_tmp34;
  const s_t hessian_tmp38 = hessian_tmp15*hessian_tmp32;
  const s_t hessian_tmp39 = ((s_t(1) / s_t(2)))*hessian_tmp21*hessian_tmp33 + ((s_t(1) / s_t(2)))*hessian_tmp38;
  const s_t hessian_tmp40 = hessian_tmp26*hessian_tmp33;
  const s_t hessian_tmp41 = ((s_t(1) / s_t(2)))*hessian_tmp28*hessian_tmp32 + ((s_t(1) / s_t(2)))*hessian_tmp40;
  const s_t hessian_tmp42 = adj_lane0*hessian_tmp39 + adj_lane1*hessian_tmp41;
  const s_t hessian_tmp43 = adj_lane2*hessian_tmp39 + adj_lane3*hessian_tmp41;
  const s_t hessian_tmp44 = adj_lane2*idet;
  const s_t hessian_tmp45 = adj_lane3*idet;
  const s_t hessian_tmp46 = ((s_t(1) / s_t(2)))*hessian_tmp4*hessian_tmp44 + ((s_t(1) / s_t(2)))*hessian_tmp45*hessian_tmp7;
  const s_t hessian_tmp47 = ((s_t(1) / s_t(2)))*hessian_tmp11*hessian_tmp44 + ((s_t(1) / s_t(2)))*hessian_tmp4*hessian_tmp45;
  const s_t hessian_tmp48 = adj_lane0*hessian_tmp47 + adj_lane1*hessian_tmp46;
  const s_t hessian_tmp49 = adj_lane2*hessian_tmp47 + adj_lane3*hessian_tmp46;
  const s_t hessian_tmp50 = hessian_tmp15*hessian_tmp44;
  const s_t hessian_tmp51 = ((s_t(1) / s_t(2)))*hessian_tmp21*hessian_tmp45 + ((s_t(1) / s_t(2)))*hessian_tmp50;
  const s_t hessian_tmp52 = hessian_tmp26*hessian_tmp45;
  const s_t hessian_tmp53 = ((s_t(1) / s_t(2)))*hessian_tmp28*hessian_tmp44 + ((s_t(1) / s_t(2)))*hessian_tmp52;
  const s_t hessian_tmp54 = adj_lane0*hessian_tmp51 + adj_lane1*hessian_tmp53;
  const s_t hessian_tmp55 = adj_lane2*hessian_tmp51 + adj_lane3*hessian_tmp53;
  const s_t hessian_tmp56 = ((s_t(1) / s_t(2)))*hessian_tmp21*hessian_tmp5 + ((s_t(1) / s_t(2)))*hessian_tmp27;
  const s_t hessian_tmp57 = ((s_t(1) / s_t(2)))*hessian_tmp16 + ((s_t(1) / s_t(2)))*hessian_tmp28*hessian_tmp8;
  const s_t hessian_tmp58 = adj_lane0*hessian_tmp57 + adj_lane1*hessian_tmp56;
  const s_t hessian_tmp59 = adj_lane2*hessian_tmp57 + adj_lane3*hessian_tmp56;
  const s_t hessian_tmp60 = pow_2(gu1);
  const s_t hessian_tmp61 = hessian_tmp60*lmbda + mu*(s_t(2)*hessian_tmp60 + s_t(4));
  const s_t hessian_tmp62 = -gu1*hessian_tmp24 - gu1*hessian_tmp25;
  const s_t hessian_tmp63 = ((s_t(1) / s_t(2)))*hessian_tmp5*hessian_tmp61 + ((s_t(1) / s_t(2)))*hessian_tmp62*hessian_tmp8;
  const s_t hessian_tmp64 = pow_2(hessian_tmp23);
  const s_t hessian_tmp65 = hessian_tmp64*lmbda + mu*(s_t(2)*hessian_tmp64 + s_t(4));
  const s_t hessian_tmp66 = ((s_t(1) / s_t(2)))*hessian_tmp5*hessian_tmp62 + ((s_t(1) / s_t(2)))*hessian_tmp65*hessian_tmp8;
  const s_t hessian_tmp67 = adj_lane0*hessian_tmp63 + adj_lane1*hessian_tmp66;
  const s_t hessian_tmp68 = adj_lane2*hessian_tmp63 + adj_lane3*hessian_tmp66;
  const s_t hessian_tmp69 = ((s_t(1) / s_t(2)))*hessian_tmp21*hessian_tmp32 + ((s_t(1) / s_t(2)))*hessian_tmp40;
  const s_t hessian_tmp70 = ((s_t(1) / s_t(2)))*hessian_tmp28*hessian_tmp33 + ((s_t(1) / s_t(2)))*hessian_tmp38;
  const s_t hessian_tmp71 = adj_lane0*hessian_tmp70 + adj_lane1*hessian_tmp69;
  const s_t hessian_tmp72 = adj_lane2*hessian_tmp70 + adj_lane3*hessian_tmp69;
  const s_t hessian_tmp73 = ((s_t(1) / s_t(2)))*hessian_tmp32*hessian_tmp61 + ((s_t(1) / s_t(2)))*hessian_tmp33*hessian_tmp62;
  const s_t hessian_tmp74 = ((s_t(1) / s_t(2)))*hessian_tmp32*hessian_tmp62 + ((s_t(1) / s_t(2)))*hessian_tmp33*hessian_tmp65;
  ...
  const s_t hessian_tmp77 = ((s_t(1) / s_t(2)))*hessian_tmp21*hessian_tmp44 + ((s_t(1) / s_t(2)))*hessian_tmp52;
  const s_t hessian_tmp78 = ((s_t(1) / s_t(2)))*hessian_tmp28*hessian_tmp45 + ((s_t(1) / s_t(2)))*hessian_tmp50;
  const s_t hessian_tmp79 = adj_lane0*hessian_tmp78 + adj_lane1*hessian_tmp77;
  const s_t hessian_tmp80 = adj_lane2*hessian_tmp78 + adj_lane3*hessian_tmp77;
  const s_t hessian_tmp81 = ((s_t(1) / s_t(2)))*hessian_tmp44*hessian_tmp61 + ((s_t(1) / s_t(2)))*hessian_tmp45*hessian_tmp62;
  const s_t hessian_tmp82 = ((s_t(1) / s_t(2)))*hessian_tmp44*hessian_tmp62 + ((s_t(1) / s_t(2)))*hessian_tmp45*hessian_tmp65;
  ...
  element_matrix[18] = -hessian_tmp30 - hessian_tmp31;
  element_matrix[24] = hessian_tmp30;
  element_matrix[30] = hessian_tmp31;
  element_matrix[1] = -hessian_tmp36 - hessian_tmp37;
  element_matrix[7] = hessian_tmp36;
  element_matrix[13] = hessian_tmp37;
  element_matrix[19] = -hessian_tmp42 - hessian_tmp43;
  element_matrix[25] = hessian_tmp42;
  element_matrix[31] = hessian_tmp43;
  element_matrix[2] = -hessian_tmp48 - hessian_tmp49;
  element_matrix[8] = hessian_tmp48;
  element_matrix[14] = hessian_tmp49;
  element_matrix[20] = -hessian_tmp54 - hessian_tmp55;
  element_matrix[26] = hessian_tmp54;
  element_matrix[32] = hessian_tmp55;
  element_matrix[3] = -hessian_tmp58 - hessian_tmp59;
  element_matrix[9] = hessian_tmp58;
  element_matrix[15] = hessian_tmp59;
