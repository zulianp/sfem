...
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_elastic_tri3_energy_egeometry_soa(
...
template <typename s_t, int VS>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_elastic_tri3_energy_ecoords_soa(
        const ptrdiff_t nelements,
...
template <typename s_t, int VS>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_elastic_tri3_energy_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
