...
#include <cstdlib>
#include <string.h>
#include "../../cuda/mooney_rivlin_kelvin_voigt_residual_merit_d2_simplex_local.cuh"
...
extern "C" int cu_mooney_rivlin_kelvin_voigt_residual_merit_tri3_residual_esoa(
...
__global__ void mooney_rivlin_kelvin_voigt_residual_merit_tri3_residual_a_msoa_impl(
...
extern "C" int cu_mooney_rivlin_kelvin_voigt_residual_merit_tri3_jacobian_action_esoa(
    const int scalar_bytes,
    const int ne,
    const ptrdiff_t geometry_stride,
    const void *const RSTR determinant,
...
template <typename s_t, typename g_t>
__global__ void mooney_rivlin_kelvin_voigt_residual_merit_tri3_jacobian_action_a_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t,
    idx_t **const RSTR elements,
    const g_t *const RSTR g_adj0,
