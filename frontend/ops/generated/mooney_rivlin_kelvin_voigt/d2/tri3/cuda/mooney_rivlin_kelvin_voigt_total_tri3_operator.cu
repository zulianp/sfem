...
#include <cstdlib>
#include <string.h>
#include "../../cuda/mooney_rivlin_kelvin_voigt_total_d2_simplex_local.cuh"
...
__global__ void mooney_rivlin_kelvin_voigt_total_tri3_residual_a_msoa_impl(
...
template <typename s_t, typename g_t>
__global__ void mooney_rivlin_kelvin_voigt_total_tri3_jacobian_action_a_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t,
    idx_t **const RSTR elements,
    const g_t *const RSTR g_adj0,
