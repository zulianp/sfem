...
namespace sfem {
  class GPUGeneratedMooneyRivlinKelvinVoigt final : public Op, public TimeSteppable {
  public:
    static std::unique_ptr<Op> create(const std::shared_ptr<FunctionSpace> &space);

    explicit GPUGeneratedMooneyRivlinKelvinVoigt(const std::shared_ptr<FunctionSpace> &space);
    ~GPUGeneratedMooneyRivlinKelvinVoigt() override;

    const char *name() const override { return "GPUGeneratedMooneyRivlinKelvinVoigt"; }
