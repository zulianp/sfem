...
namespace sfem {
  class GeneratedMooneyRivlinKelvinVoigt final : public Op, public TimeSteppable {
  public:
    static std::unique_ptr<Op> create(const std::shared_ptr<FunctionSpace> &space);

    explicit GeneratedMooneyRivlinKelvinVoigt(const std::shared_ptr<FunctionSpace> &space);
    ~GeneratedMooneyRivlinKelvinVoigt() override;

    const char *name() const override { return "GeneratedMooneyRivlinKelvinVoigt"; }
