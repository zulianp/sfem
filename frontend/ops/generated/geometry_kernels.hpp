  ...
  static SFEM_INLINE void eval(
    ...
    for (int q = 0; q < NQ; ++q) {
      ...
      for (int lane = 0; lane < ne; ++lane) {
        ...
        const s_t J00 = J00_q[lane];
        const s_t J01 = J01_q[lane];
        const s_t J10 = J10_q[lane];
        const s_t J11 = J11_q[lane];
  ...
  static SFEM_INLINE void eval(
    ...
    for (int q = 0; q < NQ; ++q) {
      ...
      for (int lane = 0; lane < ne; ++lane) {
        ...
        const s_t J00 = J00_q[lane];
        const s_t J01 = J01_q[lane];
        const s_t J02 = J02_q[lane];
        const s_t J10 = J10_q[lane];
        const s_t J11 = J11_q[lane];
        const s_t J12 = J12_q[lane];
        const s_t J20 = J20_q[lane];
        const s_t J21 = J21_q[lane];
        const s_t J22 = J22_q[lane];
