#ifndef LAPLACE_PROTEUS_HEX125_ELEMENT_API_HPP
#define LAPLACE_PROTEUS_HEX125_ELEMENT_API_HPP
...
static SFEM_INLINE int laplace_proteus_hex125_energy_element_geometry_soa(
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int laplace_proteus_hex125_energy_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t kappa,
        const scalar_t *const *const SFEM_RESTRICT u_streams,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int laplace_proteus_hex125_gradient_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t kappa,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int laplace_proteus_hex125_gradient_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t kappa,
        const scalar_t *const *const SFEM_RESTRICT u_streams,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int laplace_proteus_hex125_gradient_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t kappa,
        const scalar_t *const *const SFEM_RESTRICT u_streams,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int laplace_proteus_hex125_hessian_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t kappa,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int laplace_proteus_hex125_hessian_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t kappa,
        scalar_t *const *const SFEM_RESTRICT matrix_streams
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int laplace_proteus_hex125_hessian_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t kappa,
        scalar_t *const *const SFEM_RESTRICT matrix_streams
