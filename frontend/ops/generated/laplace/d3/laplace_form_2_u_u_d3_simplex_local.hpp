#ifndef LAPLACE_FORM_2_U_U_D3_SIMPLEX_LOCAL_HPP
#define LAPLACE_FORM_2_U_U_D3_SIMPLEX_LOCAL_HPP
...
static SFEM_INLINE void laplace_form_2_u_u_d3_simplex_residual_block(
        const int nelems,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void laplace_form_2_u_u_d3_simplex_jacobian_action_block(
        const int nelems,
        const ptrdiff_t geometry_stride,
