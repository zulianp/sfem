#include <type_traits>
#include "../laplace_form_1_u_d3_simplex_local.hpp"
...
struct laplace_form_1_u_tet4_affine_reference_data {
...
template <typename scalar_t>
struct laplace_form_1_u_tet4_isoparametric_reference_data {
    static const scalar_t *shape() {
        static const scalar_t data[4] = {scalar_t(0.25), scalar_t(0.25), scalar_t(0.25), scalar_t(0.25)};
        return data;
    }
...
static const KernelDiagnostics laplace_form_1_u_tet4_residual_element_soa_diagnostics_data = {
    "laplace_form_1_u_tet4_residual_element_soa",
    "TET4",
    3,
    1,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *laplace_form_1_u_tet4_residual_element_soa_diagnostics(void) {
    return &sfem::codegen::laplace_form_1_u_tet4_residual_element_soa_diagnostics_data;
}

extern "C" double laplace_form_1_u_tet4_residual_element_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::laplace_form_1_u_tet4_residual_element_soa_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void laplace_form_1_u_tet4_residual_element_soa_print_rate(
...
extern "C" void laplace_form_1_u_tet4_residual_element_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "laplace_form_1_u_tet4_residual_element_soa_float",
            &sfem::codegen::laplace_form_1_u_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void laplace_form_1_u_tet4_residual_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "laplace_form_1_u_tet4_residual_affine_mesh_soa",
            &sfem::codegen::laplace_form_1_u_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void laplace_form_1_u_tet4_residual_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "laplace_form_1_u_tet4_residual_affine_mesh_soa_float",
            &sfem::codegen::laplace_form_1_u_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void laplace_form_1_u_tet4_residual_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "laplace_form_1_u_tet4_residual_isoparametric_mesh_soa",
            &sfem::codegen::laplace_form_1_u_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void laplace_form_1_u_tet4_residual_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "laplace_form_1_u_tet4_residual_isoparametric_mesh_soa_float",
            &sfem::codegen::laplace_form_1_u_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics laplace_form_1_u_tet4_jacobian_u_u_diagnostics_data = {
    "laplace_form_1_u_tet4_jacobian_u_u",
    "TET4",
    3,
    1,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *laplace_form_1_u_tet4_jacobian_u_u_diagnostics(void) {
    return &sfem::codegen::laplace_form_1_u_tet4_jacobian_u_u_diagnostics_data;
}

extern "C" double laplace_form_1_u_tet4_jacobian_u_u_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::laplace_form_1_u_tet4_jacobian_u_u_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void laplace_form_1_u_tet4_jacobian_u_u_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
...
extern "C" void laplace_form_1_u_tet4_jacobian_u_u_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "laplace_form_1_u_tet4_jacobian_u_u_float",
            &sfem::codegen::laplace_form_1_u_tet4_jacobian_u_u_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics laplace_form_1_u_tet4_jacobian_action_element_soa_diagnostics_data = {
    "laplace_form_1_u_tet4_jacobian_action_element_soa",
    "TET4",
    3,
    1,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *laplace_form_1_u_tet4_jacobian_action_element_soa_diagnostics(void) {
    return &sfem::codegen::laplace_form_1_u_tet4_jacobian_action_element_soa_diagnostics_data;
}

extern "C" double laplace_form_1_u_tet4_jacobian_action_element_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::laplace_form_1_u_tet4_jacobian_action_element_soa_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void laplace_form_1_u_tet4_jacobian_action_element_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
...
extern "C" void laplace_form_1_u_tet4_jacobian_action_element_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "laplace_form_1_u_tet4_jacobian_action_element_soa_float",
            &sfem::codegen::laplace_form_1_u_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void laplace_form_1_u_tet4_jacobian_action_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "laplace_form_1_u_tet4_jacobian_action_affine_mesh_soa",
            &sfem::codegen::laplace_form_1_u_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void laplace_form_1_u_tet4_jacobian_action_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "laplace_form_1_u_tet4_jacobian_action_affine_mesh_soa_float",
            &sfem::codegen::laplace_form_1_u_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_soa",
            &sfem::codegen::laplace_form_1_u_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs,
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_soa_float",
            &sfem::codegen::laplace_form_1_u_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}

extern "C" int laplace_form_1_u_tet4_residual_element_soa(
        const int nelems,
    ...
    sfem::codegen::laplace_form_1_u_d3_simplex_residual_block<double, 1, 4, 16>(nelems, geometry_stride, geom_metric, sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<double>::shape(), sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<double>::grad_ref_x(), sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<double>::grad_ref_y(), sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<double>::grad_ref_z(), sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<double>::q_weight(), current, kappa, output);
    return SFEM_SUCCESS;
}

extern "C" int laplace_form_1_u_tet4_residual_element_soa_float(
        const int nelems,
        const ptrdiff_t geometry_stride,
    ...
    sfem::codegen::laplace_form_1_u_d3_simplex_residual_block<float, 1, 4, 16>(nelems, geometry_stride, geom_metric, sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<float>::shape(), sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<float>::grad_ref_x(), sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<float>::grad_ref_y(), sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<float>::grad_ref_z(), sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<float>::q_weight(), current, kappa, output);
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int laplace_form_1_u_tet4_residual_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const affine_shape = sfem::codegen::laplace_form_1_u_tet4_affine_reference_data<scalar_t>::shape();
    const scalar_t *const affine_grad_ref_x = sfem::codegen::laplace_form_1_u_tet4_affine_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const affine_grad_ref_y = sfem::codegen::laplace_form_1_u_tet4_affine_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const affine_grad_ref_z = sfem::codegen::laplace_form_1_u_tet4_affine_reference_data<scalar_t>::grad_ref_z();
    const scalar_t *const affine_q_weight = sfem::codegen::laplace_form_1_u_tet4_affine_reference_data<scalar_t>::q_weight();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        laplace_form_1_u_d3_simplex_residual_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_geom_metric, affine_shape, affine_grad_ref_x, affine_grad_ref_y, affine_grad_ref_z, affine_q_weight, block_current_streams, kappa, block_output_streams);
...
extern "C" int laplace_form_1_u_tet4_residual_affine_mesh_soa(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    return sfem::codegen::laplace_form_1_u_tet4_residual_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, current_stride, u, out_stride, u_out);
}

extern "C" int laplace_form_1_u_tet4_residual_affine_mesh_soa_float(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const SFEM_RESTRICT g_jacobian_adjugate0,
    ...
    return sfem::codegen::laplace_form_1_u_tet4_residual_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, current_stride, u, out_stride, u_out);
}
...
template <typename scalar_t>
static SFEM_INLINE int laplace_form_1_u_tet4_residual_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_shape = sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<scalar_t>::shape();
    const scalar_t *const isoparametric_grad_ref_x = sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const isoparametric_grad_ref_y = sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const isoparametric_grad_ref_z = sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<scalar_t>::grad_ref_z();
    const scalar_t *const isoparametric_q_weight = sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<scalar_t>::q_weight();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        laplace_form_1_u_d3_simplex_residual_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_geom_metric, isoparametric_shape, isoparametric_grad_ref_x, isoparametric_grad_ref_y, isoparametric_grad_ref_z, isoparametric_q_weight, block_current_streams, kappa, block_output_streams);
...
extern "C" int laplace_form_1_u_tet4_residual_isoparametric_mesh_soa(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
    ...
    return sfem::codegen::laplace_form_1_u_tet4_residual_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, kappa, current_stride, u, out_stride, u_out);
}

extern "C" int laplace_form_1_u_tet4_residual_isoparametric_mesh_soa_float(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
    ...
    return sfem::codegen::laplace_form_1_u_tet4_residual_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, kappa, current_stride, u, out_stride, u_out);
}

extern "C" int laplace_form_1_u_tet4_residual_isoparametric_mesh_aos(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
    ...
    return laplace_form_1_u_tet4_residual_isoparametric_mesh_soa(nelements, nnodes, elements, points, parameters[0], 1, current + 0, 1, output + 0);
}

extern "C" int laplace_form_1_u_tet4_residual_isoparametric_mesh_aos_float(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
    ...
    return laplace_form_1_u_tet4_residual_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, parameters[0], 1, current + 0, 1, output + 0);
}

extern "C" int laplace_form_1_u_tet4_jacobian_action_element_soa(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const double *const SFEM_RESTRICT determinant,
        double *const SFEM_RESTRICT output[4]
) {
    sfem::codegen::laplace_form_1_u_d3_simplex_jacobian_action_block<double, 1, 4, 16>(nelems, geometry_stride, determinant, sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<double>::shape(), sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<double>::q_weight(), output);
    return SFEM_SUCCESS;
}

extern "C" int laplace_form_1_u_tet4_jacobian_action_element_soa_float(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const float *const SFEM_RESTRICT determinant,
        float *const SFEM_RESTRICT output[4]
) {
    sfem::codegen::laplace_form_1_u_d3_simplex_jacobian_action_block<float, 1, 4, 16>(nelems, geometry_stride, determinant, sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<float>::shape(), sfem::codegen::laplace_form_1_u_tet4_isoparametric_reference_data<float>::q_weight(), output);
    return SFEM_SUCCESS;
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int laplace_form_1_u_tet4_jacobian_action_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_determinant0,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        laplace_form_1_u_d3_simplex_jacobian_action_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_determinant0, affine_shape, affine_q_weight, block_output_streams);
...
extern "C" int laplace_form_1_u_tet4_jacobian_action_affine_mesh_soa(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const SFEM_RESTRICT g_jacobian_determinant0,
    ...
    return sfem::codegen::laplace_form_1_u_tet4_jacobian_action_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, u_out);
}

extern "C" int laplace_form_1_u_tet4_jacobian_action_affine_mesh_soa_float(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const SFEM_RESTRICT g_jacobian_determinant0,
    ...
    return sfem::codegen::laplace_form_1_u_tet4_jacobian_action_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, u_out);
}
...
template <typename scalar_t>
static SFEM_INLINE int laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        laplace_form_1_u_d3_simplex_jacobian_action_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_determinant, isoparametric_shape, isoparametric_q_weight, block_output_streams);
...
extern "C" int laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_soa(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
    ...
    return sfem::codegen::laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, out_stride, u_out);
}

extern "C" int laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_soa_float(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
    ...
    return sfem::codegen::laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, out_stride, u_out);
}

extern "C" int laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_aos(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
    ...
    return laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_soa(nelements, nnodes, elements, points, 1, output + 0);
}

extern "C" int laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_aos_float(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
    ...
    return laplace_form_1_u_tet4_jacobian_action_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, 1, output + 0);
}
