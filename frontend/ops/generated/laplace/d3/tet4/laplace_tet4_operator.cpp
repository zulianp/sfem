...
static SFEM_INLINE int laplace_tet4_objective_steps_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
...
extern "C" int laplace_tet4_objective_steps_isoparametric_mesh_soa(
    ...
    return sfem::codegen::laplace_tet4_objective_steps_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, kappa, u_stride, ux, h_stride, hx, nsteps, steps, value);
}
...
extern "C" int laplace_tet4_objective_steps_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::laplace_tet4_objective_steps_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, kappa, u_stride, ux, h_stride, hx, nsteps, steps, value);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int laplace_tet4_gradient_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int laplace_tet4_gradient_isoparametric_mesh_soa(
    ...
    return sfem::codegen::laplace_tet4_gradient_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, kappa, u_stride, ux, out_stride, outx);
}
...
extern "C" int laplace_tet4_gradient_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::laplace_tet4_gradient_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, kappa, u_stride, ux, out_stride, outx);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int laplace_tet4_apply_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int laplace_tet4_apply_isoparametric_mesh_soa(
    ...
    return sfem::codegen::laplace_tet4_apply_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, kappa, h_stride, hx, out_stride, outx);
}
...
extern "C" int laplace_tet4_apply_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::laplace_tet4_apply_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, kappa, h_stride, hx, out_stride, outx);
}
...
template <typename scalar_t>
static SFEM_INLINE void laplace_tet4_hessian_isoparametric_mesh_soa_scatter_dia(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
        const ptrdiff_t nnodes,
...
#pragma omp parallel for schedule(static) reduction(|:unsupported_matrix_format)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        if constexpr (FORMAT == 1) {
            ...
            laplace_tet4_hessian_isoparametric_mesh_soa_scatter_dia(ev, element_matrix, nnodes, diag_offsets, ndiag, values);
        } else {
...
extern "C" int laplace_tet4_hessian_dia_isoparametric_mesh_soa(
    ...
    return sfem::codegen::laplace_tet4_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 2>(nelements, nnodes, elements, points, kappa, nullptr, nullptr, values, diag_offsets, ndiag, 0, nullptr, nullptr, nullptr, nullptr);
}
...
extern "C" int laplace_tet4_hessian_dia_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::laplace_tet4_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 2>(nelements, nnodes, elements, points, kappa, nullptr, nullptr, values, diag_offsets, ndiag, 0, nullptr, nullptr, nullptr, nullptr);
}
