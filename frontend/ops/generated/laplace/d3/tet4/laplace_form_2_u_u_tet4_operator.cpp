...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        laplace_form_2_u_u_d3_simplex_jacobian_action_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_geom_metric, affine_shape, affine_grad_ref_x, affine_grad_ref_y, affine_grad_ref_z, cached_affine_metric_q_weight, block_direction_streams, kappa, block_output_streams);
...
extern "C" int laplace_form_2_u_u_tet4_jacobian_action_affine_mesh_soa(
    ...
    return sfem::codegen::laplace_form_2_u_u_tet4_jacobian_action_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, g_geom_metric3, g_geom_metric4, g_geom_metric5, kappa, direction_stride, u_direction, out_stride, u_out);
}
...
extern "C" int laplace_form_2_u_u_tet4_jacobian_action_affine_mesh_soa_float(
    ...
    return sfem::codegen::laplace_form_2_u_u_tet4_jacobian_action_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, g_geom_metric3, g_geom_metric4, g_geom_metric5, kappa, direction_stride, u_direction, out_stride, u_out);
}
