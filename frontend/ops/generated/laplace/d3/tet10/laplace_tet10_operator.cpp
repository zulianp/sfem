...
#pragma omp for schedule(static)
        for (ptrdiff_t pack = 0; pack < n_packs; ++pack) {
            ...
            for (ptrdiff_t element = e_start; element < e_end; ++element) {
                ...
                for (int q = 0; q < N_QP; ++q) {
                    const int lane = 0;
                    const scalar_t J00 = block_coordinates[0][0] * isoparametric_grad_ref_x[q * N_SHAPE + 0] + block_coordinates[3][0] * isoparametric_grad_ref_x[q * N_SHAPE + 1] + block_coordinates[6][0] * isoparametric_grad_ref_x[q * N_SHAPE + 2] + block_coordinates[9][0] * isoparametric_grad_ref_x[q * N_SHAPE + 3] + block_coordinates[12][0] * isoparametric_grad_ref_x[q * N_SHAPE + 4] + block_coordinates[15][0] * isoparametric_grad_ref_x[q * N_SHAPE + 5] + block_coordinates[18][0] * isoparametric_grad_ref_x[q * N_SHAPE + 6] + block_coordinates[21][0] * isoparametric_grad_ref_x[q * N_SHAPE + 7] + block_coordinates[24][0] * isoparametric_grad_ref_x[q * N_SHAPE + 8] + block_coordinates[27][0] * isoparametric_grad_ref_x[q * N_SHAPE + 9];
                    const scalar_t J01 = block_coordinates[0][0] * isoparametric_grad_ref_y[q * N_SHAPE + 0] + block_coordinates[3][0] * isoparametric_grad_ref_y[q * N_SHAPE + 1] + block_coordinates[6][0] * isoparametric_grad_ref_y[q * N_SHAPE + 2] + block_coordinates[9][0] * isoparametric_grad_ref_y[q * N_SHAPE + 3] + block_coordinates[12][0] * isoparametric_grad_ref_y[q * N_SHAPE + 4] + block_coordinates[15][0] * isoparametric_grad_ref_y[q * N_SHAPE + 5] + block_coordinates[18][0] * isoparametric_grad_ref_y[q * N_SHAPE + 6] + block_coordinates[21][0] * isoparametric_grad_ref_y[q * N_SHAPE + 7] + block_coordinates[24][0] * isoparametric_grad_ref_y[q * N_SHAPE + 8] + block_coordinates[27][0] * isoparametric_grad_ref_y[q * N_SHAPE + 9];
                    const scalar_t J02 = block_coordinates[0][0] * isoparametric_grad_ref_z[q * N_SHAPE + 0] + block_coordinates[3][0] * isoparametric_grad_ref_z[q * N_SHAPE + 1] + block_coordinates[6][0] * isoparametric_grad_ref_z[q * N_SHAPE + 2] + block_coordinates[9][0] * isoparametric_grad_ref_z[q * N_SHAPE + 3] + block_coordinates[12][0] * isoparametric_grad_ref_z[q * N_SHAPE + 4] + block_coordinates[15][0] * isoparametric_grad_ref_z[q * N_SHAPE + 5] + block_coordinates[18][0] * isoparametric_grad_ref_z[q * N_SHAPE + 6] + block_coordinates[21][0] * isoparametric_grad_ref_z[q * N_SHAPE + 7] + block_coordinates[24][0] * isoparametric_grad_ref_z[q * N_SHAPE + 8] + block_coordinates[27][0] * isoparametric_grad_ref_z[q * N_SHAPE + 9];
                    const scalar_t J10 = block_coordinates[1][0] * isoparametric_grad_ref_x[q * N_SHAPE + 0] + block_coordinates[4][0] * isoparametric_grad_ref_x[q * N_SHAPE + 1] + block_coordinates[7][0] * isoparametric_grad_ref_x[q * N_SHAPE + 2] + block_coordinates[10][0] * isoparametric_grad_ref_x[q * N_SHAPE + 3] + block_coordinates[13][0] * isoparametric_grad_ref_x[q * N_SHAPE + 4] + block_coordinates[16][0] * isoparametric_grad_ref_x[q * N_SHAPE + 5] + block_coordinates[19][0] * isoparametric_grad_ref_x[q * N_SHAPE + 6] + block_coordinates[22][0] * isoparametric_grad_ref_x[q * N_SHAPE + 7] + block_coordinates[25][0] * isoparametric_grad_ref_x[q * N_SHAPE + 8] + block_coordinates[28][0] * isoparametric_grad_ref_x[q * N_SHAPE + 9];
                    const scalar_t J11 = block_coordinates[1][0] * isoparametric_grad_ref_y[q * N_SHAPE + 0] + block_coordinates[4][0] * isoparametric_grad_ref_y[q * N_SHAPE + 1] + block_coordinates[7][0] * isoparametric_grad_ref_y[q * N_SHAPE + 2] + block_coordinates[10][0] * isoparametric_grad_ref_y[q * N_SHAPE + 3] + block_coordinates[13][0] * isoparametric_grad_ref_y[q * N_SHAPE + 4] + block_coordinates[16][0] * isoparametric_grad_ref_y[q * N_SHAPE + 5] + block_coordinates[19][0] * isoparametric_grad_ref_y[q * N_SHAPE + 6] + block_coordinates[22][0] * isoparametric_grad_ref_y[q * N_SHAPE + 7] + block_coordinates[25][0] * isoparametric_grad_ref_y[q * N_SHAPE + 8] + block_coordinates[28][0] * isoparametric_grad_ref_y[q * N_SHAPE + 9];
                    const scalar_t J12 = block_coordinates[1][0] * isoparametric_grad_ref_z[q * N_SHAPE + 0] + block_coordinates[4][0] * isoparametric_grad_ref_z[q * N_SHAPE + 1] + block_coordinates[7][0] * isoparametric_grad_ref_z[q * N_SHAPE + 2] + block_coordinates[10][0] * isoparametric_grad_ref_z[q * N_SHAPE + 3] + block_coordinates[13][0] * isoparametric_grad_ref_z[q * N_SHAPE + 4] + block_coordinates[16][0] * isoparametric_grad_ref_z[q * N_SHAPE + 5] + block_coordinates[19][0] * isoparametric_grad_ref_z[q * N_SHAPE + 6] + block_coordinates[22][0] * isoparametric_grad_ref_z[q * N_SHAPE + 7] + block_coordinates[25][0] * isoparametric_grad_ref_z[q * N_SHAPE + 8] + block_coordinates[28][0] * isoparametric_grad_ref_z[q * N_SHAPE + 9];
                    const scalar_t J20 = block_coordinates[2][0] * isoparametric_grad_ref_x[q * N_SHAPE + 0] + block_coordinates[5][0] * isoparametric_grad_ref_x[q * N_SHAPE + 1] + block_coordinates[8][0] * isoparametric_grad_ref_x[q * N_SHAPE + 2] + block_coordinates[11][0] * isoparametric_grad_ref_x[q * N_SHAPE + 3] + block_coordinates[14][0] * isoparametric_grad_ref_x[q * N_SHAPE + 4] + block_coordinates[17][0] * isoparametric_grad_ref_x[q * N_SHAPE + 5] + block_coordinates[20][0] * isoparametric_grad_ref_x[q * N_SHAPE + 6] + block_coordinates[23][0] * isoparametric_grad_ref_x[q * N_SHAPE + 7] + block_coordinates[26][0] * isoparametric_grad_ref_x[q * N_SHAPE + 8] + block_coordinates[29][0] * isoparametric_grad_ref_x[q * N_SHAPE + 9];
                    const scalar_t J21 = block_coordinates[2][0] * isoparametric_grad_ref_y[q * N_SHAPE + 0] + block_coordinates[5][0] * isoparametric_grad_ref_y[q * N_SHAPE + 1] + block_coordinates[8][0] * isoparametric_grad_ref_y[q * N_SHAPE + 2] + block_coordinates[11][0] * isoparametric_grad_ref_y[q * N_SHAPE + 3] + block_coordinates[14][0] * isoparametric_grad_ref_y[q * N_SHAPE + 4] + block_coordinates[17][0] * isoparametric_grad_ref_y[q * N_SHAPE + 5] + block_coordinates[20][0] * isoparametric_grad_ref_y[q * N_SHAPE + 6] + block_coordinates[23][0] * isoparametric_grad_ref_y[q * N_SHAPE + 7] + block_coordinates[26][0] * isoparametric_grad_ref_y[q * N_SHAPE + 8] + block_coordinates[29][0] * isoparametric_grad_ref_y[q * N_SHAPE + 9];
                    const scalar_t J22 = block_coordinates[2][0] * isoparametric_grad_ref_z[q * N_SHAPE + 0] + block_coordinates[5][0] * isoparametric_grad_ref_z[q * N_SHAPE + 1] + block_coordinates[8][0] * isoparametric_grad_ref_z[q * N_SHAPE + 2] + block_coordinates[11][0] * isoparametric_grad_ref_z[q * N_SHAPE + 3] + block_coordinates[14][0] * isoparametric_grad_ref_z[q * N_SHAPE + 4] + block_coordinates[17][0] * isoparametric_grad_ref_z[q * N_SHAPE + 5] + block_coordinates[20][0] * isoparametric_grad_ref_z[q * N_SHAPE + 6] + block_coordinates[23][0] * isoparametric_grad_ref_z[q * N_SHAPE + 7] + block_coordinates[26][0] * isoparametric_grad_ref_z[q * N_SHAPE + 8] + block_coordinates[29][0] * isoparametric_grad_ref_z[q * N_SHAPE + 9];
                    geometry_jacobian_adjugate_and_determinant_3<scalar_t>(
                            J00, J01, J02, J10, J11, J12, J20, J21, J22,
                            block_adjugate_streams, block_determinant, q * VECTOR_SIZE + lane);
                }
