...
static SFEM_INLINE int laplace_tet10_energy_element_geometry_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        laplace_d3_simplex_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_x(), sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_y(), sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_z(), sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::q_weight(), kappa, block_u_streams, block_value);
    }
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int laplace_tet10_energy_element_coords_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        scalar_t block_jacobian_adjugate8[N_QP * VECTOR_SIZE];
        scalar_t block_jacobian_determinant0[N_QP * VECTOR_SIZE];
        const scalar_t *const grad_ref_x = sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_x();
        const scalar_t *const grad_ref_y = sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_y();
        const scalar_t *const grad_ref_z = sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_z();
        for (int q = 0; q < N_QP; ++q) {
...
static SFEM_INLINE int laplace_tet10_gradient_element_geometry_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        laplace_d3_simplex_gradient_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_x(), sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_y(), sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_z(), sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::q_weight(), kappa, block_u_streams, block_out_streams);
    }
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int laplace_tet10_hessian_element_geometry_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        for (int col = 0; col < NDOFS; ++col) {
            ...
            laplace_d3_simplex_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_x(), sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_y(), sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::grad_ref_z(), sfem::codegen::laplace_tet10_isoparametric_reference_data<scalar_t>::q_weight(), kappa, block_h_streams, block_out_streams);
