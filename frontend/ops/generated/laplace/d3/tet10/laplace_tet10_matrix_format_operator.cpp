...
static const MatrixAssemblyDiagnostics *const laplace_tet10_matrix_assembly_variants[3] = {
...
const MatrixAssemblyDiagnostics *laplace_tet10_matrix_assembly_variant(const int variant) {
    return (variant >= 0 && variant < 3) ? laplace_tet10_matrix_assembly_variants[variant] : nullptr;
}
