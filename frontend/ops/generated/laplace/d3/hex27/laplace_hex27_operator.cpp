...
extern "C" void laplace_proteus_hex27_matrix_assembly_print_variant(
        const int variant,
        const ptrdiff_t nelements
);
extern "C" const sfem_MatrixAssemblyDiagnostics * laplace_proteus_hex27_matrix_assembly_variant(
        const int variant
);
