...
static SFEM_INLINE int laplace_proteus_hex8_energy_element_geometry_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        laplace_d3_tensor_product_objective_block<s_t, NQ, NS, VS>(nelems, VS, bjacobian_adjugate0, bjacobian_adjugate1, bjacobian_adjugate2, bjacobian_adjugate3, bjacobian_adjugate4, bjacobian_adjugate5, bjacobian_adjugate6, bjacobian_adjugate7, bjacobian_adjugate8, bjacobian_determinant0, sfem::codegen::laplace_proteus_hex8_isoparametric_reference_data<s_t>::shape_1d(), sfem::codegen::laplace_proteus_hex8_isoparametric_reference_data<s_t>::grad_1d(), sfem::codegen::laplace_proteus_hex8_isoparametric_reference_data<s_t>::q_weight_1d(), kappa, bu_streams, bvalue);
    }
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int laplace_proteus_hex8_gradient_element_geometry_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        laplace_d3_tensor_product_gradient_block<s_t, NQ, NS, VS>(nelems, VS, bjacobian_adjugate0, bjacobian_adjugate1, bjacobian_adjugate2, bjacobian_adjugate3, bjacobian_adjugate4, bjacobian_adjugate5, bjacobian_adjugate6, bjacobian_adjugate7, bjacobian_adjugate8, bjacobian_determinant0, sfem::codegen::laplace_proteus_hex8_isoparametric_reference_data<s_t>::shape_1d(), sfem::codegen::laplace_proteus_hex8_isoparametric_reference_data<s_t>::grad_1d(), sfem::codegen::laplace_proteus_hex8_isoparametric_reference_data<s_t>::q_weight_1d(), kappa, bu_streams, bout_streams);
    }
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int laplace_proteus_hex8_hessian_element_geometry_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        for (int col = 0; col < NDOFS; ++col) {
            ...
            laplace_d3_tensor_product_apply_block<s_t, NQ, NS, VS>(nelems, VS, bjacobian_adjugate0, bjacobian_adjugate1, bjacobian_adjugate2, bjacobian_adjugate3, bjacobian_adjugate4, bjacobian_adjugate5, bjacobian_adjugate6, bjacobian_adjugate7, bjacobian_adjugate8, bjacobian_determinant0, sfem::codegen::laplace_proteus_hex8_isoparametric_reference_data<s_t>::shape_1d(), sfem::codegen::laplace_proteus_hex8_isoparametric_reference_data<s_t>::grad_1d(), sfem::codegen::laplace_proteus_hex8_isoparametric_reference_data<s_t>::q_weight_1d(), kappa, bh_streams, bout_streams);
