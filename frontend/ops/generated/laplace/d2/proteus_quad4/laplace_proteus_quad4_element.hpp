...
static SFEM_INLINE int laplace_proteus_quad4_energy_element_coords_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        tensor_gradient_contiguous<s_t, NQ, NS, VS, 2>(nelems, sfem::codegen::laplace_proteus_quad4_isoparametric_reference_data<s_t>::shape_1d(), sfem::codegen::laplace_proteus_quad4_isoparametric_reference_data<s_t>::grad_1d(), block_coordinate_data, 0, coordinate_grad_ref + 0 * NQ * ND * VS);
        tensor_gradient_contiguous<s_t, NQ, NS, VS, 2>(nelems, sfem::codegen::laplace_proteus_quad4_isoparametric_reference_data<s_t>::shape_1d(), sfem::codegen::laplace_proteus_quad4_isoparametric_reference_data<s_t>::grad_1d(), block_coordinate_data, 1, coordinate_grad_ref + 1 * NQ * ND * VS);
