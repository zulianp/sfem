...
#include "../laplace_d2_tensor_product_hessian.hpp"
...
static const KernelDiagnostics laplace_proteus_quad4_objective_soa_diagnostics_data = {
    "laplace_proteus_quad4_objective_soa",
    "PROTEUS_QUAD4",
    2,
    4,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *laplace_proteus_quad4_objective_soa_diagnostics(void) {
    return &sfem::codegen::laplace_proteus_quad4_objective_soa_diagnostics_data;
}

extern "C" double laplace_proteus_quad4_objective_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::laplace_proteus_quad4_objective_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void laplace_proteus_quad4_objective_soa_print_rate(
...
extern "C" void laplace_proteus_quad4_objective_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "laplace_proteus_quad4_objective_soa_float",
            &sfem::codegen::laplace_proteus_quad4_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs,
...
static SFEM_INLINE int laplace_proteus_quad4_objective_steps_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        for (int step = 0; step < nsteps; ++step) {
            ...
            laplace_d2_tensor_product_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, affine_shape_1d, affine_grad_1d, affine_q_weight_1d, kappa, block_u_streams, block_value);
...
extern "C" int laplace_proteus_quad4_objective_steps_affine_mesh_soa(
    ...
    return sfem::codegen::laplace_proteus_quad4_objective_steps_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, kappa, u_stride, ux, h_stride, hx, nsteps, steps, value);
}
...
extern "C" int laplace_proteus_quad4_objective_steps_affine_mesh_soa_float(
    ...
    return sfem::codegen::laplace_proteus_quad4_objective_steps_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, kappa, u_stride, ux, h_stride, hx, nsteps, steps, value);
}
...
static const KernelDiagnostics laplace_proteus_quad4_gradient_soa_diagnostics_data = {
    "laplace_proteus_quad4_gradient_soa",
    "PROTEUS_QUAD4",
    2,
    4,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *laplace_proteus_quad4_gradient_soa_diagnostics(void) {
    return &sfem::codegen::laplace_proteus_quad4_gradient_soa_diagnostics_data;
}

extern "C" double laplace_proteus_quad4_gradient_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::laplace_proteus_quad4_gradient_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void laplace_proteus_quad4_gradient_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate(
...
extern "C" void laplace_proteus_quad4_gradient_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "laplace_proteus_quad4_gradient_soa_float",
            &sfem::codegen::laplace_proteus_quad4_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int laplace_proteus_quad4_gradient_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int laplace_proteus_quad4_gradient_affine_mesh_soa(
    ...
    return sfem::codegen::laplace_proteus_quad4_gradient_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, kappa, u_stride, ux, out_stride, outx);
}
...
extern "C" int laplace_proteus_quad4_gradient_affine_mesh_soa_float(
    ...
    return sfem::codegen::laplace_proteus_quad4_gradient_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, kappa, u_stride, ux, out_stride, outx);
}
...
static const KernelDiagnostics laplace_proteus_quad4_apply_soa_diagnostics_data = {
    "laplace_proteus_quad4_apply_soa",
    "PROTEUS_QUAD4",
    2,
    4,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *laplace_proteus_quad4_apply_soa_diagnostics(void) {
    return &sfem::codegen::laplace_proteus_quad4_apply_soa_diagnostics_data;
}

extern "C" double laplace_proteus_quad4_apply_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::laplace_proteus_quad4_apply_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void laplace_proteus_quad4_apply_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate(
...
extern "C" void laplace_proteus_quad4_apply_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "laplace_proteus_quad4_apply_soa_float",
            &sfem::codegen::laplace_proteus_quad4_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int laplace_proteus_quad4_apply_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        laplace_d2_tensor_product_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, affine_shape_1d, affine_grad_1d, affine_q_weight_1d, kappa, block_h_streams, block_out_streams);
...
extern "C" int laplace_proteus_quad4_apply_affine_mesh_soa(
    ...
    return sfem::codegen::laplace_proteus_quad4_apply_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, kappa, h_stride, hx, out_stride, outx);
}
...
extern "C" int laplace_proteus_quad4_apply_affine_mesh_soa_float(
    ...
    return sfem::codegen::laplace_proteus_quad4_apply_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, kappa, h_stride, hx, out_stride, outx);
}
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        laplace_d2_tensor_product_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, isoparametric_shape_1d, isoparametric_grad_1d, isoparametric_q_weight_1d, kappa, block_h_streams, block_out_streams);
...
template <typename scalar_t>
static SFEM_INLINE void laplace_proteus_quad4_hessian_isoparametric_mesh_soa_scatter_dia(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
        const ptrdiff_t nnodes,
...
#pragma omp parallel for schedule(static) reduction(|:unsupported_matrix_format)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        laplace_d2_tensor_product_direct_hessian_tensor_product_element_matrix<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, isoparametric_shape_1d, isoparametric_grad_1d, isoparametric_q_weight_1d, kappa, element_matrix);
        ...
        if constexpr (FORMAT == 1) {
            ...
            laplace_proteus_quad4_hessian_isoparametric_mesh_soa_scatter_dia(ev, element_matrix, nnodes, diag_offsets, ndiag, values);
        } else {
...
extern "C" int laplace_proteus_quad4_hessian_dia_isoparametric_mesh_soa(
    ...
    return sfem::codegen::laplace_proteus_quad4_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 2>(nelements, nnodes, elements, points, kappa, nullptr, nullptr, values, diag_offsets, ndiag, 0, nullptr, nullptr, nullptr, nullptr);
}
...
extern "C" int laplace_proteus_quad4_hessian_dia_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::laplace_proteus_quad4_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 2>(nelements, nnodes, elements, points, kappa, nullptr, nullptr, values, diag_offsets, ndiag, 0, nullptr, nullptr, nullptr, nullptr);
}
