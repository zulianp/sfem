#ifndef LAPLACE_PROTEUS_QUAD4_ELEMENT_API_CUH
#define LAPLACE_PROTEUS_QUAD4_ELEMENT_API_CUH
...
static __host__ __device__ __forceinline__ int laplace_proteus_quad4_energy_egeometry_soa(
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int laplace_proteus_quad4_energy_ecoords_soa(
        const ptrdiff_t nelements,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int laplace_proteus_quad4_energy_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t kappa,
        const s_t *const *const RSTR u_streams,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int laplace_proteus_quad4_gradient_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t kappa,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    laplace_d2_tensor_product_gradient_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, bdet0, sfem::codegen::ref_line_p1_q2<s_t>::shape_1d(), sfem::codegen::ref_line_p1_q2<s_t>::grad_1d(), sfem::codegen::quad_line_q2<s_t>::q_weight_1d(), kappa, bu_streams, bout_streams);
  }
  return SFEM_SUCCESS;
}

template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int laplace_proteus_quad4_gradient_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t kappa,
        const s_t *const *const RSTR u_streams,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int laplace_proteus_quad4_gradient_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t kappa,
        const s_t *const *const RSTR u_streams,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int laplace_proteus_quad4_hessian_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t kappa,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    for (int col = 0; col < NDOFS; ++col) {
      ...
      laplace_d2_tensor_product_apply_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, bdet0, sfem::codegen::ref_line_p1_q2<s_t>::shape_1d(), sfem::codegen::ref_line_p1_q2<s_t>::grad_1d(), sfem::codegen::quad_line_q2<s_t>::q_weight_1d(), kappa, bh_streams, bout_streams);
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int laplace_proteus_quad4_hessian_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t kappa,
        s_t *const *const RSTR matrix_streams
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int laplace_proteus_quad4_hessian_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t kappa,
        s_t *const *const RSTR matrix_streams
