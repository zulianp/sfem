...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int laplace_tri6_jacobian_action_packed_affine_mesh_soa_impl(
...
extern "C" int laplace_tri6_jacobian_action_packed_affine_mesh_soa(
    ...
    return sfem::codegen::laplace_tri6_jacobian_action_packed_affine_mesh_soa_impl<double, geom_t>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, kappa, direction_stride, u_direction, out_stride, u_out);
}
...
extern "C" int laplace_tri6_jacobian_action_packed_affine_mesh_soa_float(
    ...
    return sfem::codegen::laplace_tri6_jacobian_action_packed_affine_mesh_soa_impl<float, geom_t>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, kappa, direction_stride, u_direction, out_stride, u_out);
}
