...
extern "C" int laplace_quad4_hessian_coo_triplet_isoparametric_mesh_soa(
    ...
    return laplace_proteus_quad4_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, proteus_elements, points, kappa, rows, cols, values);
}
...
extern "C" int laplace_quad4_hessian_coo_triplet_isoparametric_mesh_soa_float(
    ...
    return laplace_proteus_quad4_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, proteus_elements, points, kappa, rows, cols, values);
}
...
extern "C" int laplace_quad4_hessian_crs_packed_one_pass_isoparametric_mesh_soa(
    ...
    return laplace_proteus_quad4_hessian_crs_packed_one_pass_isoparametric_mesh_soa(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, points, kappa, packed_element_entries, values);
}
...
extern "C" int laplace_quad4_hessian_crs_packed_one_pass_isoparametric_mesh_soa_float(
    ...
    return laplace_proteus_quad4_hessian_crs_packed_one_pass_isoparametric_mesh_soa_float(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, points, kappa, packed_element_entries, values);
}
...
extern "C" int laplace_quad4_hessian_crs_packed_two_pass_isoparametric_mesh_soa(
    ...
    return laplace_proteus_quad4_hessian_crs_packed_two_pass_isoparametric_mesh_soa(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, points, kappa, rowptr, colidx, packed_element_entries, values);
}
...
extern "C" int laplace_quad4_hessian_crs_packed_two_pass_isoparametric_mesh_soa_float(
    ...
    return laplace_proteus_quad4_hessian_crs_packed_two_pass_isoparametric_mesh_soa_float(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, points, kappa, rowptr, colidx, packed_element_entries, values);
}
...
extern "C" void laplace_quad4_jacobian_action_affine_mesh_soa_float_print_rate(
    ...
    laplace_proteus_quad4_jacobian_action_affine_mesh_soa_float_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" void laplace_quad4_jacobian_action_affine_mesh_soa_print_rate(
    ...
    laplace_proteus_quad4_jacobian_action_affine_mesh_soa_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" int laplace_quad4_jacobian_action_element_soa(
    ...
    return laplace_proteus_quad4_jacobian_action_element_soa(nelems, geometry_stride, determinant, adjugate, direction, kappa, output);
}
...
extern "C" int laplace_quad4_jacobian_action_element_soa_float(
    ...
    return laplace_proteus_quad4_jacobian_action_element_soa_float(nelems, geometry_stride, determinant, adjugate, direction, kappa, output);
}
...
extern "C" void laplace_quad4_jacobian_action_element_soa_float_print_rate(
    ...
    laplace_proteus_quad4_jacobian_action_element_soa_float_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" void laplace_quad4_jacobian_action_element_soa_print_rate(
    ...
    laplace_proteus_quad4_jacobian_action_element_soa_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" void laplace_quad4_jacobian_action_isoparametric_mesh_soa_float_print_rate(
    ...
    laplace_proteus_quad4_jacobian_action_isoparametric_mesh_soa_float_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" void laplace_quad4_jacobian_action_isoparametric_mesh_soa_print_rate(
    ...
    laplace_proteus_quad4_jacobian_action_isoparametric_mesh_soa_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" void laplace_quad4_jacobian_u_u_float_print_rate(
    ...
    laplace_proteus_quad4_jacobian_u_u_float_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" void laplace_quad4_jacobian_u_u_print_rate(
    ...
    laplace_proteus_quad4_jacobian_u_u_print_rate(elapsed, nelements, ndofs, repeat);
}

extern "C" void laplace_quad4_matrix_assembly_print_variant(
        const int variant,
        const ptrdiff_t nelements
) {
    laplace_proteus_quad4_matrix_assembly_print_variant(variant, nelements);
}

extern "C" const sfem_MatrixAssemblyDiagnostics * laplace_quad4_matrix_assembly_variant(
        const int variant
) {
    return laplace_proteus_quad4_matrix_assembly_variant(variant);
}

extern "C" int laplace_quad4_matrix_assembly_variant_count(
        void
) {
    return laplace_proteus_quad4_matrix_assembly_variant_count();
}
...
extern "C" void laplace_quad4_residual_affine_mesh_soa_float_print_rate(
    ...
    laplace_proteus_quad4_residual_affine_mesh_soa_float_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" void laplace_quad4_residual_affine_mesh_soa_print_rate(
    ...
    laplace_proteus_quad4_residual_affine_mesh_soa_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" int laplace_quad4_residual_element_soa(
    ...
    return laplace_proteus_quad4_residual_element_soa(nelems, geometry_stride, determinant, adjugate, current, kappa, output);
}
...
extern "C" int laplace_quad4_residual_element_soa_float(
    ...
    return laplace_proteus_quad4_residual_element_soa_float(nelems, geometry_stride, determinant, adjugate, current, kappa, output);
}
...
extern "C" void laplace_quad4_residual_element_soa_float_print_rate(
    ...
    laplace_proteus_quad4_residual_element_soa_float_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" void laplace_quad4_residual_element_soa_print_rate(
    ...
    laplace_proteus_quad4_residual_element_soa_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" void laplace_quad4_residual_isoparametric_mesh_soa_float_print_rate(
    ...
    laplace_proteus_quad4_residual_isoparametric_mesh_soa_float_print_rate(elapsed, nelements, ndofs, repeat);
}
...
extern "C" void laplace_quad4_residual_isoparametric_mesh_soa_print_rate(
    ...
    laplace_proteus_quad4_residual_isoparametric_mesh_soa_print_rate(elapsed, nelements, ndofs, repeat);
}
