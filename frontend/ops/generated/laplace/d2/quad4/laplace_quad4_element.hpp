...
static SFEM_INLINE int laplace_quad4_energy_element_geometry_soa(
    ...
    return laplace_proteus_quad4_energy_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, ordered_u_streams, values);
}
...
static SFEM_INLINE int laplace_quad4_energy_element_coords_soa(
    ...
    return laplace_proteus_quad4_energy_element_coords_soa<s_t, VS>(nelements, ordered_coords, kappa, ordered_u_streams, values);
}
...
static SFEM_INLINE int laplace_quad4_energy_element_soa(
    ...
    return laplace_proteus_quad4_energy_element_soa<s_t, VS>(nelements, ordered_coords, kappa, ordered_u_streams, values);
}
...
static SFEM_INLINE int laplace_quad4_gradient_element_geometry_soa(
    ...
    return laplace_proteus_quad4_gradient_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, ordered_u_streams, ordered_out_streams);
}
...
static SFEM_INLINE int laplace_quad4_gradient_element_coords_soa(
    ...
    return laplace_proteus_quad4_gradient_element_coords_soa<s_t, VS>(nelements, ordered_coords, kappa, ordered_u_streams, ordered_out_streams);
}
...
static SFEM_INLINE int laplace_quad4_gradient_element_soa(
    ...
    return laplace_proteus_quad4_gradient_element_soa<s_t, VS>(nelements, ordered_coords, kappa, ordered_u_streams, ordered_out_streams);
}
...
static SFEM_INLINE int laplace_quad4_hessian_element_geometry_soa(
    ...
    return laplace_proteus_quad4_hessian_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, ordered_matrix_streams);
}
...
static SFEM_INLINE int laplace_quad4_hessian_element_coords_soa(
    ...
    return laplace_proteus_quad4_hessian_element_coords_soa<s_t, VS>(nelements, ordered_coords, kappa, ordered_matrix_streams);
}
...
static SFEM_INLINE int laplace_quad4_hessian_element_soa(
    ...
    return laplace_proteus_quad4_hessian_element_soa<s_t, VS>(nelements, ordered_coords, kappa, ordered_matrix_streams);
}
