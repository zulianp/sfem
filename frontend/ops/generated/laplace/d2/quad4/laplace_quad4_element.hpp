...
static SFEM_INLINE int laplace_quad4_energy_element_geometry_soa(
    ...
    return laplace_proteus_quad4_energy_element_geometry_soa<s_t, VS>(nelements, adj, det, kappa, ordered_u_streams, values);
}
...
static SFEM_INLINE int laplace_quad4_gradient_element_geometry_soa(
    ...
    return laplace_proteus_quad4_gradient_element_geometry_soa<s_t, VS>(nelements, adj, det, kappa, ordered_u_streams, ordered_out_streams);
}
...
static SFEM_INLINE int laplace_quad4_hessian_element_geometry_soa(
    ...
    return laplace_proteus_quad4_hessian_element_geometry_soa<s_t, VS>(nelements, adj, det, kappa, ordered_matrix_streams);
}
