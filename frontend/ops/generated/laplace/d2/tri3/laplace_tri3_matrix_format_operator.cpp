...
static const MatrixAssemblyDiagnostics laplace_tri3_crs_standard_matrix_assembly_diagnostics_data = {
    "crs",
    "standard",
    "none",
...
static const MatrixAssemblyDiagnostics laplace_tri3_bsr_standard_matrix_assembly_diagnostics_data = {
    "bsr",
    "standard",
    "none",
    "standard_block_elements",
...
void laplace_tri3_matrix_assembly_print_variant(const int variant, const ptrdiff_t nelements) {
    const MatrixAssemblyDiagnostics *const d = laplace_tri3_matrix_assembly_variant(variant);
    if (d) {
        MatrixAssemblyDiagnostics_print("laplace_tri3", d, nelements);
    }
}
