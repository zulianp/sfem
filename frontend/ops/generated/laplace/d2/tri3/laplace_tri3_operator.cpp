...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int laplace_tri3_jacobian_action_packed_affine_mesh_soa_impl(
...
#pragma omp simd
                ...
                const jacobian_t *const affine_geometry_sources[3] = {g_geom_metric0 + evbegin, g_geom_metric1 + evbegin, g_geom_metric2 + evbegin};
                scalar_t block_affine_geometry_data[3][VECTOR_SIZE];
                const scalar_t *block_affine_geometry_streams[3];
                for (int geometry_stream = 0; geometry_stream < 3; ++geometry_stream) {
                ...
                const scalar_t *const block_geom_metric[3] = {block_affine_geometry_streams[0], block_affine_geometry_streams[1], block_affine_geometry_streams[2]};
                static const scalar_t cached_affine_metric_q_weight[1] = {scalar_t(1)};

                laplace_d2_simplex_tri3_jacobian_action_block_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_geom_metric, cached_affine_metric_q_weight, block_direction, kappa, block_output);
...
extern "C" int laplace_tri3_jacobian_action_packed_affine_mesh_soa(
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
    ...
    return sfem::codegen::laplace_tri3_jacobian_action_packed_affine_mesh_soa_impl<double, geom_t>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, g_geom_metric0, g_geom_metric1, g_geom_metric2, kappa, direction_stride, u_direction, out_stride, u_out);
}

extern "C" int laplace_tri3_jacobian_action_packed_affine_mesh_soa_float(
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
    ...
    return sfem::codegen::laplace_tri3_jacobian_action_packed_affine_mesh_soa_impl<float, geom_t>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, g_geom_metric0, g_geom_metric1, g_geom_metric2, kappa, direction_stride, u_direction, out_stride, u_out);
}
