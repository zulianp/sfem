...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int laplace_apply_2d_affine_metric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::TRI3: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_tri3_apply_affine_mesh_soa(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, kappa, h_stride, (const double *)hx, out_stride, (double *)outx);
                case smesh::SMESH_FLOAT32:
                    return laplace_tri3_apply_affine_mesh_soa_float(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, kappa, h_stride, (const float *)hx, out_stride, (float *)outx);
                default:
                    break;
            }
            break;
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int laplace_apply_3d_affine_mesh_soa(
    ...
    switch (element_type) {
        ...
        case smesh::PROTEUS_HEX8: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_proteus_hex8_apply_affine_mesh_soa(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, h_stride, (const double *)hx, out_stride, (double *)outx);
                case smesh::SMESH_FLOAT32:
                    return laplace_proteus_hex8_apply_affine_mesh_soa_float(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, h_stride, (const float *)hx, out_stride, (float *)outx);
                default:
                    break;
            }
            break;
        ...
        case smesh::TET10: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_tet10_apply_affine_mesh_soa(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, h_stride, (const double *)hx, out_stride, (double *)outx);
                case smesh::SMESH_FLOAT32:
                    return laplace_tet10_apply_affine_mesh_soa_float(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, h_stride, (const float *)hx, out_stride, (float *)outx);
                default:
                    break;
            }
            break;
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int laplace_apply_3d_affine_metric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::TET4: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_tet4_apply_affine_mesh_soa(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, g_geom_metric3, g_geom_metric4, g_geom_metric5, kappa, h_stride, (const double *)hx, out_stride, (double *)outx);
                case smesh::SMESH_FLOAT32:
                    return laplace_tet4_apply_affine_mesh_soa_float(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, g_geom_metric3, g_geom_metric4, g_geom_metric5, kappa, h_stride, (const float *)hx, out_stride, (float *)outx);
                default:
                    break;
            }
            break;
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int laplace_gradient_2d_affine_metric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::TRI3: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_tri3_gradient_affine_mesh_soa(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, kappa, u_stride, (const double *)ux, out_stride, (double *)outx);
                case smesh::SMESH_FLOAT32:
                    return laplace_tri3_gradient_affine_mesh_soa_float(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, kappa, u_stride, (const float *)ux, out_stride, (float *)outx);
                default:
                    break;
            }
            break;
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int laplace_gradient_3d_affine_mesh_soa(
    ...
    switch (element_type) {
        ...
        case smesh::PROTEUS_HEX8: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_proteus_hex8_gradient_affine_mesh_soa(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, u_stride, (const double *)ux, out_stride, (double *)outx);
                case smesh::SMESH_FLOAT32:
                    return laplace_proteus_hex8_gradient_affine_mesh_soa_float(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, u_stride, (const float *)ux, out_stride, (float *)outx);
                default:
                    break;
            }
            break;
        ...
        case smesh::TET10: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_tet10_gradient_affine_mesh_soa(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, u_stride, (const double *)ux, out_stride, (double *)outx);
                case smesh::SMESH_FLOAT32:
                    return laplace_tet10_gradient_affine_mesh_soa_float(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, u_stride, (const float *)ux, out_stride, (float *)outx);
                default:
                    break;
            }
            break;
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int laplace_gradient_3d_affine_metric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::TET4: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_tet4_gradient_affine_mesh_soa(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, g_geom_metric3, g_geom_metric4, g_geom_metric5, kappa, u_stride, (const double *)ux, out_stride, (double *)outx);
                case smesh::SMESH_FLOAT32:
                    return laplace_tet4_gradient_affine_mesh_soa_float(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, g_geom_metric3, g_geom_metric4, g_geom_metric5, kappa, u_stride, (const float *)ux, out_stride, (float *)outx);
                default:
                    break;
            }
            break;
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int laplace_objective_steps_2d_affine_metric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::TRI3: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_tri3_objective_steps_affine_mesh_soa(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, kappa, u_stride, (const double *)ux, h_stride, (const double *)hx, nsteps, (const double *)steps, (double *)value);
                case smesh::SMESH_FLOAT32:
                    return laplace_tri3_objective_steps_affine_mesh_soa_float(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, kappa, u_stride, (const float *)ux, h_stride, (const float *)hx, nsteps, (const float *)steps, (float *)value);
                default:
                    break;
            }
            break;
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int laplace_objective_steps_3d_affine_mesh_soa(
    ...
    switch (element_type) {
        ...
        case smesh::PROTEUS_HEX8: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_proteus_hex8_objective_steps_affine_mesh_soa(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, u_stride, (const double *)ux, h_stride, (const double *)hx, nsteps, (const double *)steps, (double *)value);
                case smesh::SMESH_FLOAT32:
                    return laplace_proteus_hex8_objective_steps_affine_mesh_soa_float(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, u_stride, (const float *)ux, h_stride, (const float *)hx, nsteps, (const float *)steps, (float *)value);
                default:
                    break;
            }
            break;
        ...
        case smesh::TET10: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_tet10_objective_steps_affine_mesh_soa(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, u_stride, (const double *)ux, h_stride, (const double *)hx, nsteps, (const double *)steps, (double *)value);
                case smesh::SMESH_FLOAT32:
                    return laplace_tet10_objective_steps_affine_mesh_soa_float(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, kappa, u_stride, (const float *)ux, h_stride, (const float *)hx, nsteps, (const float *)steps, (float *)value);
                default:
                    break;
            }
            break;
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int laplace_objective_steps_3d_affine_metric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::TET4: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return laplace_tet4_objective_steps_affine_mesh_soa(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, g_geom_metric3, g_geom_metric4, g_geom_metric5, kappa, u_stride, (const double *)ux, h_stride, (const double *)hx, nsteps, (const double *)steps, (double *)value);
                case smesh::SMESH_FLOAT32:
                    return laplace_tet4_objective_steps_affine_mesh_soa_float(nelements, nnodes, elements, g_geom_metric0, g_geom_metric1, g_geom_metric2, g_geom_metric3, g_geom_metric4, g_geom_metric5, kappa, u_stride, (const float *)ux, h_stride, (const float *)hx, nsteps, (const float *)steps, (float *)value);
                default:
                    break;
            }
            break;
