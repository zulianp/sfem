...
extern "C" int cu_laplace_apply_2d_a_msoa(
...
extern "C" int cu_laplace_apply_2d_i_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_laplace_apply_2d_soa_diagnostics(
    const smesh::ElemType element_type);

extern "C" int cu_laplace_apply_3d_a_met_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_laplace_apply_3d_a_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_laplace_apply_3d_i_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_laplace_apply_3d_soa_diagnostics(
    const smesh::ElemType element_type);

extern "C" int cu_laplace_gradient_2d_a_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_laplace_gradient_2d_i_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_laplace_gradient_2d_soa_diagnostics(
    const smesh::ElemType element_type);

extern "C" int cu_laplace_gradient_3d_a_met_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_laplace_gradient_3d_a_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" int cu_laplace_gradient_3d_i_msoa(
        const smesh::ElemType element_type,
        const enum smesh::PrimitiveType real_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_laplace_gradient_3d_soa_diagnostics(
    const smesh::ElemType element_type);
