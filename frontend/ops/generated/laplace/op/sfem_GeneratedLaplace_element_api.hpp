...
static SFEM_INLINE int laplace_energy_2d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        case 3:
            return laplace_tri3_energy_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, values);
        case 40:
            return laplace_quad4_energy_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, values);
        case 400000:
            return laplace_proteus_quad4_energy_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, values);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_energy_3d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_energy_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, values);
        case 10:
            return laplace_tet10_energy_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, values);
        case 8:
            return laplace_hex8_energy_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, values);
        case 100008:
            return laplace_proteus_hex8_energy_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, values);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_gradient_2d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        case 3:
            return laplace_tri3_gradient_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, out_streams);
        case 40:
            return laplace_quad4_gradient_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, out_streams);
        case 400000:
            return laplace_proteus_quad4_gradient_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, out_streams);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_gradient_3d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_gradient_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, out_streams);
        case 10:
            return laplace_tet10_gradient_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, out_streams);
        case 8:
            return laplace_hex8_gradient_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, out_streams);
        case 100008:
            return laplace_proteus_hex8_gradient_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, out_streams);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_hessian_2d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        case 3:
            return laplace_tri3_hessian_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, matrix_streams);
        case 40:
            return laplace_quad4_hessian_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, matrix_streams);
        case 400000:
            return laplace_proteus_quad4_hessian_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, matrix_streams);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_hessian_3d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_hessian_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, matrix_streams);
        case 10:
            return laplace_tet10_hessian_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, matrix_streams);
        case 8:
            return laplace_hex8_hessian_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, matrix_streams);
        case 100008:
            return laplace_proteus_hex8_hessian_element_geometry_soa<s_t, VS>(nelements, jacobian_adjugate, jacobian_determinant, kappa, matrix_streams);
        default:
            return SFEM_FAILURE;
    }
}
