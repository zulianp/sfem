...
static SFEM_INLINE int laplace_energy_2d_element_soa(
    ...
    switch ((int)element_type) {
        ...
        case 400000:
            return laplace_proteus_quad4_energy_element_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, u_streams, values);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_energy_3d_element_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_energy_element_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, u_streams, values);
        case 10:
...
static SFEM_INLINE int laplace_energy_2d_element_coords_soa(
    ...
    switch ((int)element_type) {
        ...
        case 400000:
            return laplace_proteus_quad4_energy_element_coords_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, u_streams, values);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_energy_3d_element_coords_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_energy_element_coords_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, u_streams, values);
        case 10:
...
static SFEM_INLINE int laplace_energy_2d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        ...
        case 400000:
            return laplace_proteus_quad4_energy_element_geometry_soa<scalar_t, VECTOR_SIZE>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, values);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_energy_3d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_energy_element_geometry_soa<scalar_t, VECTOR_SIZE>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, values);
        case 10:
...
static SFEM_INLINE int laplace_gradient_2d_element_soa(
    ...
    switch ((int)element_type) {
        ...
        case 400000:
            return laplace_proteus_quad4_gradient_element_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, u_streams, out_streams);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_gradient_3d_element_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_gradient_element_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, u_streams, out_streams);
        case 10:
...
static SFEM_INLINE int laplace_gradient_2d_element_coords_soa(
    ...
    switch ((int)element_type) {
        ...
        case 400000:
            return laplace_proteus_quad4_gradient_element_coords_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, u_streams, out_streams);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_gradient_3d_element_coords_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_gradient_element_coords_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, u_streams, out_streams);
        case 10:
...
static SFEM_INLINE int laplace_gradient_2d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        ...
        case 400000:
            return laplace_proteus_quad4_gradient_element_geometry_soa<scalar_t, VECTOR_SIZE>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, out_streams);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_gradient_3d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_gradient_element_geometry_soa<scalar_t, VECTOR_SIZE>(nelements, jacobian_adjugate, jacobian_determinant, kappa, u_streams, out_streams);
        case 10:
...
static SFEM_INLINE int laplace_hessian_2d_element_soa(
    ...
    switch ((int)element_type) {
        ...
        case 400000:
            return laplace_proteus_quad4_hessian_element_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, matrix_streams);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_hessian_3d_element_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_hessian_element_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, matrix_streams);
        case 10:
...
static SFEM_INLINE int laplace_hessian_2d_element_coords_soa(
    ...
    switch ((int)element_type) {
        ...
        case 400000:
            return laplace_proteus_quad4_hessian_element_coords_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, matrix_streams);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_hessian_3d_element_coords_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_hessian_element_coords_soa<scalar_t, VECTOR_SIZE>(nelements, coords, kappa, matrix_streams);
        case 10:
...
static SFEM_INLINE int laplace_hessian_2d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        ...
        case 400000:
            return laplace_proteus_quad4_hessian_element_geometry_soa<scalar_t, VECTOR_SIZE>(nelements, jacobian_adjugate, jacobian_determinant, kappa, matrix_streams);
        default:
            return SFEM_FAILURE;
    }
}
...
static SFEM_INLINE int laplace_hessian_3d_element_geometry_soa(
    ...
    switch ((int)element_type) {
        case 4:
            return laplace_tet4_hessian_element_geometry_soa<scalar_t, VECTOR_SIZE>(nelements, jacobian_adjugate, jacobian_determinant, kappa, matrix_streams);
        case 10:
