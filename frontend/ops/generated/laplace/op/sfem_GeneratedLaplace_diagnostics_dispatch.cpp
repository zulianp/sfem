...
extern "C" const sfem::codegen::KernelDiagnostics *laplace_hex27_apply_soa_diagnostics(void);
...
extern "C" const sfem::codegen::KernelDiagnostics *laplace_hex27_gradient_soa_diagnostics(void);
...
extern "C" const sfem::codegen::KernelDiagnostics *laplace_hex27_objective_soa_diagnostics(void);
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *laplace_apply_2d_soa_diagnostics(
    ...
    switch (element_type) {
        ...
        case smesh::TRI6:
            return laplace_tri6_apply_soa_diagnostics();
        default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *laplace_apply_3d_soa_diagnostics(
    ...
    switch (element_type) {
        case smesh::HEX27:
            return laplace_hex27_apply_soa_diagnostics();
        case smesh::HEX8:
            return laplace_hex8_apply_soa_diagnostics();
        case smesh::PROTEUS_HEX125:
            return laplace_proteus_hex125_apply_soa_diagnostics();
        case smesh::PROTEUS_HEX27:
            return laplace_proteus_hex27_apply_soa_diagnostics();
        case smesh::PROTEUS_HEX64:
            return laplace_proteus_hex64_apply_soa_diagnostics();
        case smesh::PROTEUS_HEX729:
            return laplace_proteus_hex729_apply_soa_diagnostics();
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *laplace_gradient_2d_soa_diagnostics(
    ...
    switch (element_type) {
        ...
        case smesh::TRI6:
            return laplace_tri6_gradient_soa_diagnostics();
        default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *laplace_gradient_3d_soa_diagnostics(
    ...
    switch (element_type) {
        case smesh::HEX27:
            return laplace_hex27_gradient_soa_diagnostics();
        case smesh::HEX8:
            return laplace_hex8_gradient_soa_diagnostics();
        case smesh::PROTEUS_HEX125:
            return laplace_proteus_hex125_gradient_soa_diagnostics();
        case smesh::PROTEUS_HEX27:
            return laplace_proteus_hex27_gradient_soa_diagnostics();
        case smesh::PROTEUS_HEX64:
            return laplace_proteus_hex64_gradient_soa_diagnostics();
        case smesh::PROTEUS_HEX729:
            return laplace_proteus_hex729_gradient_soa_diagnostics();
        case smesh::PROTEUS_HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *laplace_objective_2d_soa_diagnostics(
    ...
    switch (element_type) {
        ...
        case smesh::TRI6:
            return laplace_tri6_objective_soa_diagnostics();
        default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *laplace_objective_3d_soa_diagnostics(
    ...
    switch (element_type) {
        case smesh::HEX27:
            return laplace_hex27_objective_soa_diagnostics();
        case smesh::HEX8:
            return laplace_hex8_objective_soa_diagnostics();
        case smesh::PROTEUS_HEX125:
            return laplace_proteus_hex125_objective_soa_diagnostics();
        case smesh::PROTEUS_HEX27:
            return laplace_proteus_hex27_objective_soa_diagnostics();
        case smesh::PROTEUS_HEX64:
            return laplace_proteus_hex64_objective_soa_diagnostics();
        case smesh::PROTEUS_HEX729:
            return laplace_proteus_hex729_objective_soa_diagnostics();
        case smesh::PROTEUS_HEX8:
