...
extern "C" int cu_body_force_tri3_residual_esoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        sfem::codegen::body_force_d2_simplex_residual_block<double, 1, 3, 1>(ne, geometry_stride, (const double *)determinant, sfem::codegen::ref_tri3_q1<double>::shape(), sfem::codegen::quad_tri_q1<double>::q_weight(), density, g0, g1, (double *const *)output);
        return SFEM_SUCCESS;
    }
    case (int)sizeof(float): {
        sfem::codegen::body_force_d2_simplex_residual_block<float, 1, 3, 1>(ne, geometry_stride, (const float *)determinant, sfem::codegen::ref_tri3_q1<float>::shape(), sfem::codegen::quad_tri_q1<float>::q_weight(), density, g0, g1, (float *const *)output);
        return SFEM_SUCCESS;
    }
    default:
      break;
