...
extern "C" int body_force_tet4_residual_esoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        sfem::codegen::body_force_d3_simplex_residual_block<double, 1, 4, 16>(ne, geometry_stride, (const double *)determinant, sfem::codegen::ref_tet4_q1<double>::shape(), sfem::codegen::quad_tet_q1<double>::q_weight(), density, g0, g1, g2, (double *const *)output);
        return SFEM_SUCCESS;
    }
    case (int)sizeof(float): {
        sfem::codegen::body_force_d3_simplex_residual_block<float, 1, 4, 16>(ne, geometry_stride, (const float *)determinant, sfem::codegen::ref_tet4_q1<float>::shape(), sfem::codegen::quad_tet_q1<float>::q_weight(), density, g0, g1, g2, (float *const *)output);
        return SFEM_SUCCESS;
    }
    default:
      break;
...
static SFEM_INLINE int body_force_tet4_residual_a_msoa_impl(
...
extern "C" int body_force_tet4_residual_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::body_force_tet4_residual_a_msoa_impl<double, geom_t>(nelements, nnodes, elements, g_det0, density, g0, g1, g2, out_stride, (double *)u0_out, (double *)u1_out, (double *)u2_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::body_force_tet4_residual_a_msoa_impl<float, geom_t>(nelements, nnodes, elements, g_det0, density, g0, g1, g2, out_stride, (float *)u0_out, (float *)u1_out, (float *)u2_out);
    }
    default:
      break;
  }
