...
static SFEM_INLINE int two_phase_flow_proteus_quad4_residual_affine_mesh_soa_impl(
    ...
    (void)nnodes;
    const s_t *const affine_shape_1d = sfem::codegen::two_phase_flow_proteus_quad4_affine_reference_data<s_t>::shape_1d();
    const s_t *const affine_grad_1d = sfem::codegen::two_phase_flow_proteus_quad4_affine_reference_data<s_t>::grad_1d();
    const s_t *const affine_q_weight_1d = sfem::codegen::two_phase_flow_proteus_quad4_affine_reference_data<s_t>::q_weight_1d();
...
static SFEM_INLINE int two_phase_flow_proteus_quad4_residual_isoparametric_mesh_soa_impl(
    ...
    static constexpr int VS = 16;
    (void)nnodes;
    const s_t *const isoparametric_shape_1d = sfem::codegen::two_phase_flow_proteus_quad4_isoparametric_reference_data<s_t>::shape_1d();
    const s_t *const isoparametric_grad_1d = sfem::codegen::two_phase_flow_proteus_quad4_isoparametric_reference_data<s_t>::grad_1d();
    const s_t *const isoparametric_q_weight_1d = sfem::codegen::two_phase_flow_proteus_quad4_isoparametric_reference_data<s_t>::q_weight_1d();
    const idx_t *const SFEM_RESTRICT field_elements[4] = {elements[0], elements[1], elements[3], elements[2]};
