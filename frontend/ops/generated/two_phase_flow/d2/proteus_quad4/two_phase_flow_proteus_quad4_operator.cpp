...
extern "C" int two_phase_flow_proteus_quad4_residual_esoa_float(
  ...
  sfem::codegen::two_phase_flow_d2_tensor_product_residual_block<float, 16, 4, 16>(ne, geometry_stride, determinant, adjugate, sfem::codegen::ref_line_p1_q4<float>::shape_1d(), sfem::codegen::ref_line_p1_q4<float>::grad_1d(), sfem::codegen::quad_line_q4<float>::q_weight_1d(), current, previous, C_ka1, C_ka2, C_kw1, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, kappa_T, m, mu_c, mu_w, p_wr, porosity, rho_w0, output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_proteus_quad4_jacobian_action_esoa_float(
  ...
  sfem::codegen::two_phase_flow_d2_tensor_product_jacobian_action_block<float, 16, 4, 16>(ne, geometry_stride, determinant, adjugate, sfem::codegen::ref_line_p1_q4<float>::shape_1d(), sfem::codegen::ref_line_p1_q4<float>::grad_1d(), sfem::codegen::quad_line_q4<float>::q_weight_1d(), current, direction, C_ka1, C_ka2, C_kw1, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, kappa_T, m, mu_c, mu_w, p_wr, porosity, rho_w0, output);
  return SFEM_SUCCESS;
}
