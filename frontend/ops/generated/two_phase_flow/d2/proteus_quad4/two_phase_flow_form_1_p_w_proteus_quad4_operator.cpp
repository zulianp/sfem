...
extern "C" int two_phase_flow_form_1_p_w_proteus_quad4_residual_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d2_tensor_product_residual_block<double, 16, 4, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_isoparametric_reference_data<double>::shape_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_isoparametric_reference_data<double>::grad_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_isoparametric_reference_data<double>::q_weight_1d(), current, previous, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_quad4_residual_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d2_tensor_product_residual_block<float, 16, 4, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_isoparametric_reference_data<float>::shape_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_isoparametric_reference_data<float>::grad_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_isoparametric_reference_data<float>::q_weight_1d(), current, previous, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
    return SFEM_SUCCESS;
}
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_1_p_w_d2_tensor_product_residual_block_contiguous<s_t, NQ, NS, VS>(nelems, 0, bageom_streams[4], badjugate, affine_shape_1d, affine_grad_1d, affine_q_weight_1d, bcurrent, bprevious, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, boutput);
...
extern "C" int two_phase_flow_form_1_p_w_proteus_quad4_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_residual_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, previous_stride, p_w_old, p_c_old, out_stride, p_w_out, p_c_out);
}
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_1_p_w_d2_tensor_product_residual_block_contiguous<s_t, NQ, NS, VS>(nelems, VS, bdeterminant, badjugate, isoparametric_shape_1d, isoparametric_grad_1d, isoparametric_q_weight_1d, bcurrent, bprevious, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, boutput);
...
extern "C" int two_phase_flow_form_1_p_w_proteus_quad4_jacobian_action_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d2_tensor_product_jacobian_action_block<double, 16, 4, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_isoparametric_reference_data<double>::shape_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_isoparametric_reference_data<double>::q_weight_1d(), output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_quad4_jacobian_action_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d2_tensor_product_jacobian_action_block<float, 16, 4, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_isoparametric_reference_data<float>::shape_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_isoparametric_reference_data<float>::q_weight_1d(), output);
    return SFEM_SUCCESS;
}
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_1_p_w_d2_tensor_product_jacobian_action_block_contiguous<s_t, NQ, NS, VS>(nelems, 0, bageom_streams[0], affine_shape_1d, affine_q_weight_1d, boutput);
...
extern "C" int two_phase_flow_form_1_p_w_proteus_quad4_jacobian_action_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_jacobian_action_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_quad4_jacobian_action_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_proteus_quad4_jacobian_action_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_1_p_w_d2_tensor_product_jacobian_action_block_contiguous<s_t, NQ, NS, VS>(nelems, VS, bdeterminant, isoparametric_shape_1d, isoparametric_q_weight_1d, boutput);
