...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_2_p_w_p_w_d2_tensor_product_residual_block_contiguous<s_t, NQ, NS, VS>(nelems, 0, bageom_streams[0], affine_shape_1d, affine_q_weight_1d, block_output);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_2_p_w_p_w_d2_tensor_product_residual_block_contiguous<s_t, NQ, NS, VS>(nelems, VS, block_determinant, isoparametric_shape_1d, isoparametric_q_weight_1d, block_output);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_2_p_w_p_w_d2_tensor_product_jacobian_action_block_contiguous<s_t, NQ, NS, VS>(nelems, 0, bageom_streams[4], block_adjugate, affine_shape_1d, affine_grad_1d, affine_q_weight_1d, block_current, block_direction, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, block_output);
