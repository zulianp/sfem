...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_diagnostics_data = {
  "two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa",
  "PROTEUS_QUAD4",
  2,
  16,
  4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_diagnostics(void) {
  return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_diagnostics_data;
}

extern "C" double two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_arithmetic_intensity(
    const ptrdiff_t nelements,
    const size_t scalar_bytes,
    const size_t real_bytes,
    const size_t accumulator_bytes) {
  return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_diagnostics_data,
      nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_print_rate(
...
extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
      "two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_a_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_a_msoa",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_a_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_a_msoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_msoa",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_msoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_diagnostics_data = {
  "two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa",
  "PROTEUS_QUAD4",
  2,
  16,
  4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_diagnostics(void) {
  return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_diagnostics_data;
}

extern "C" double two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_arithmetic_intensity(
    const ptrdiff_t nelements,
    const size_t scalar_bytes,
    const size_t real_bytes,
    const size_t accumulator_bytes) {
  return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_diagnostics_data,
      nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
...
extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
      "two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_a_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_a_msoa",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_a_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_a_msoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_i_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_i_msoa",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_i_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_i_msoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa(
    const int ne,
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_float(
    const int ne,
    const ptrdiff_t geometry_stride,
...
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_a_msoa_impl(
    const ptrdiff_t nelements,
...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    two_phase_flow_form_2_p_c_p_c_d2_tensor_product_residual_block_contiguous<s_t, NQ, NS, VS>(ne, 0, bageom_streams[0], affine_shape_1d, affine_q_weight_1d, boutput);
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_a_msoa(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_a_msoa_impl<double, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_a_msoa_float(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_a_msoa_impl<float, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
...
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t nnodes,
    idx_t **const RSTR elements,
...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    two_phase_flow_form_2_p_c_p_c_d2_tensor_product_residual_block_contiguous<s_t, NQ, NS, VS>(ne, VS, bdeterminant, isoparametric_shape_1d, isoparametric_q_weight_1d, boutput);
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_msoa(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_msoa_impl<double>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_msoa_float(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_msoa_impl<float>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_maos(
  ...
  return two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_msoa(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_maos_float(
  ...
  return two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_i_msoa_float(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}

extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa(
    const int ne,
    const ptrdiff_t geometry_stride,
    const double *const RSTR determinant,
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_float(
    const int ne,
    const ptrdiff_t geometry_stride,
    const float *const RSTR determinant,
...
template <typename s_t, typename g_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_a_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t nnodes,
    idx_t **const RSTR elements,
...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    two_phase_flow_form_2_p_c_p_c_d2_tensor_product_jacobian_action_block_contiguous<s_t, NQ, NS, VS>(ne, 0, bageom_streams[4], badjugate, affine_shape_1d, affine_grad_1d, affine_q_weight_1d, bcurrent, bdirection, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, boutput);
...
template <typename s_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_i_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t nnodes,
    idx_t **const RSTR elements,
    const geom_t *const *const RSTR points,
...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    two_phase_flow_form_2_p_c_p_c_d2_tensor_product_jacobian_action_block_contiguous<s_t, NQ, NS, VS>(ne, VS, bdeterminant, badjugate, isoparametric_shape_1d, isoparametric_grad_1d, isoparametric_q_weight_1d, bcurrent, bdirection, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, boutput);
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_i_msoa(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_i_msoa_impl<double>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_i_msoa_float(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_i_msoa_impl<float>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
