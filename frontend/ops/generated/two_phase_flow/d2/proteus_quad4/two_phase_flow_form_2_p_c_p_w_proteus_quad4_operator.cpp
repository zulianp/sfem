...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_esoa(
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_w_d2_tensor_product_residual_block<double, 16, 4, 16>(ne, geometry_stride, determinant, sfem::codegen::ref_line_p1_q4<double>::shape_1d(), sfem::codegen::quad_line_q4<double>::q_weight_1d(), output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_esoa_float(
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_w_d2_tensor_product_residual_block<float, 16, 4, 16>(ne, geometry_stride, determinant, sfem::codegen::ref_line_p1_q4<float>::shape_1d(), sfem::codegen::quad_line_q4<float>::q_weight_1d(), output);
  return SFEM_SUCCESS;
}
