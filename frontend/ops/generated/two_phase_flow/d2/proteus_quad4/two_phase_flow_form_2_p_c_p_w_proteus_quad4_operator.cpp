...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_esoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        sfem::codegen::two_phase_flow_form_2_p_c_p_w_d2_tensor_product_residual_block<double, 16, 4, 16>(ne, geometry_stride, (const double *)determinant, sfem::codegen::ref_line_p1_q4<double>::shape_1d(), sfem::codegen::quad_line_q4<double>::q_weight_1d(), (double *const *)output);
        return SFEM_SUCCESS;
    }
    case (int)sizeof(float): {
        sfem::codegen::two_phase_flow_form_2_p_c_p_w_d2_tensor_product_residual_block<float, 16, 4, 16>(ne, geometry_stride, (const float *)determinant, sfem::codegen::ref_line_p1_q4<float>::shape_1d(), sfem::codegen::quad_line_q4<float>::q_weight_1d(), (float *const *)output);
        return SFEM_SUCCESS;
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_esoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_a_msoa_impl<double, geom_t>(nelements, nnodes, elements, g_det0, out_stride, (double *)p_w_out, (double *)p_c_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_a_msoa_impl<float, geom_t>(nelements, nnodes, elements, g_det0, out_stride, (float *)p_w_out, (float *)p_c_out);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_i_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_i_msoa_impl<double>(nelements, nnodes, elements, points, out_stride, (double *)p_w_out, (double *)p_c_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_i_msoa_impl<float>(nelements, nnodes, elements, points, out_stride, (float *)p_w_out, (float *)p_c_out);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_i_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_i_maos(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_i_msoa(scalar_bytes, nelements, nnodes, elements, points, 2, (double *)output + 0, (double *)output + 1);
    }
    case (int)sizeof(float): {
        return two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_i_msoa(scalar_bytes, nelements, nnodes, elements, points, 2, (float *)output + 0, (float *)output + 1);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_i_maos", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_quad4_jacobian_action_i_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::two_phase_flow_form_2_p_c_p_w_proteus_quad4_jacobian_action_i_msoa_impl<double>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, (const double *)p_w, (const double *)p_c, direction_stride, (const double *)p_w_direction, (const double *)p_c_direction, out_stride, (double *)p_w_out, (double *)p_c_out);
    }
    case (int)sizeof(float): {
