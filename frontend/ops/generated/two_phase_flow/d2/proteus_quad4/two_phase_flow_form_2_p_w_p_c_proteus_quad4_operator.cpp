...
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_c_proteus_quad4_residual_affine_mesh_soa_impl(
    ...
    (void)nnodes;
    const s_t *const affine_shape_1d = sfem::codegen::two_phase_flow_form_2_p_w_p_c_proteus_quad4_affine_reference_data<s_t>::shape_1d();
    const s_t *const affine_grad_1d = sfem::codegen::two_phase_flow_form_2_p_w_p_c_proteus_quad4_affine_reference_data<s_t>::grad_1d();
    const s_t *const affine_q_weight_1d = sfem::codegen::two_phase_flow_form_2_p_w_p_c_proteus_quad4_affine_reference_data<s_t>::q_weight_1d();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_2_p_w_p_c_d2_tensor_product_residual_block_contiguous<s_t, NQ, NS, VS>(nelems, 0, bageom_streams[0], affine_shape_1d, affine_q_weight_1d, boutput);
...
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_c_proteus_quad4_residual_isoparametric_mesh_soa_impl(
    ...
    static constexpr int VS = 16;
    (void)nnodes;
    const s_t *const isoparametric_shape_1d = sfem::codegen::two_phase_flow_form_2_p_w_p_c_proteus_quad4_isoparametric_reference_data<s_t>::shape_1d();
    const s_t *const isoparametric_grad_1d = sfem::codegen::two_phase_flow_form_2_p_w_p_c_proteus_quad4_isoparametric_reference_data<s_t>::grad_1d();
    const s_t *const isoparametric_q_weight_1d = sfem::codegen::two_phase_flow_form_2_p_w_p_c_proteus_quad4_isoparametric_reference_data<s_t>::q_weight_1d();
    const idx_t *const RSTR field_elements[4] = {elements[0], elements[1], elements[3], elements[2]};
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_2_p_w_p_c_d2_tensor_product_residual_block_contiguous<s_t, NQ, NS, VS>(nelems, VS, bdeterminant, isoparametric_shape_1d, isoparametric_q_weight_1d, boutput);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_2_p_w_p_c_d2_tensor_product_jacobian_action_block_contiguous<s_t, NQ, NS, VS>(nelems, 0, bageom_streams[4], badjugate, affine_shape_1d, affine_grad_1d, affine_q_weight_1d, bcurrent, bdirection, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, boutput);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_2_p_w_p_c_d2_tensor_product_jacobian_action_block_contiguous<s_t, NQ, NS, VS>(nelems, VS, bdeterminant, badjugate, isoparametric_shape_1d, isoparametric_grad_1d, isoparametric_q_weight_1d, bcurrent, bdirection, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, boutput);
