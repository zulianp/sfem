#include <type_traits>
#include "../two_phase_flow_form_2_p_c_p_c_d2_tensor_product_local.hpp"
...
struct two_phase_flow_form_2_p_c_p_c_quad4_affine_reference_data {
...
template <typename scalar_t>
struct two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data {
    static const scalar_t *shape_1d() {
        static const scalar_t data[8] = {scalar_t(0.93056815579702623), scalar_t(0.069431844202973714), scalar_t(0.66999052179242813), scalar_t(0.33000947820757187), scalar_t(0.33000947820757187), scalar_t(0.66999052179242813), scalar_t(0.069431844202973769), scalar_t(0.93056815579702623)};
        return data;
    }
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_diagnostics_data,
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_residual_affine_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_c_p_c_quad4_residual_affine_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_residual_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_c_p_c_quad4_residual_affine_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_w_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_w",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_w_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_w_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_w_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_w_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_w_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_w_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_w_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_c_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_c",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_c_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_c_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_c_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_c_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_c_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_c_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_w_p_c_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_w_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_w",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_w_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_w_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_w_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_w_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_w_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_w_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_w_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_c_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_c",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_c_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_c_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_c_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_c_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_c_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_c_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_p_c_p_c_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_affine_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_affine_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_affine_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_2_p_c_p_c_d2_tensor_product_residual_block<double, 16, 4, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<double>::shape_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<double>::q_weight_1d(), output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_residual_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_2_p_c_p_c_d2_tensor_product_residual_block<float, 16, 4, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<float>::shape_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<float>::q_weight_1d(), output);
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_quad4_residual_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const affine_shape_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_affine_reference_data<scalar_t>::shape_1d();
    const scalar_t *const affine_grad_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_affine_reference_data<scalar_t>::grad_1d();
    const scalar_t *const affine_q_weight_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_affine_reference_data<scalar_t>::q_weight_1d();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        scalar_t *const block_output_streams[8] = {block_output[0], block_output[1], block_output[2], block_output[3], block_output[6], block_output[7], block_output[4], block_output[5]};
        ...
        two_phase_flow_form_2_p_c_p_c_d2_tensor_product_residual_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_affine_geometry_streams[0], affine_shape_1d, affine_q_weight_1d, block_output_streams);
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_residual_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_residual_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_residual_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_shape_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<scalar_t>::shape_1d();
    const scalar_t *const isoparametric_grad_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<scalar_t>::grad_1d();
    const scalar_t *const isoparametric_q_weight_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<scalar_t>::q_weight_1d();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        two_phase_flow_form_2_p_c_p_c_d2_tensor_product_residual_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_determinant, isoparametric_shape_1d, isoparametric_q_weight_1d, block_output_streams);
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_aos(
    ...
    return two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_soa(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_aos_float(
    ...
    return two_phase_flow_form_2_p_c_p_c_quad4_residual_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_2_p_c_p_c_d2_tensor_product_jacobian_action_block<double, 16, 4, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<double>::shape_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<double>::grad_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<double>::q_weight_1d(), current, direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_2_p_c_p_c_d2_tensor_product_jacobian_action_block<float, 16, 4, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<float>::shape_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<float>::grad_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_isoparametric_reference_data<float>::q_weight_1d(), current, direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, output);
    return SFEM_SUCCESS;
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        const scalar_t *const block_current_streams[8] = {block_current[0], block_current[1], block_current[2], block_current[3], block_current[6], block_current[7], block_current[4], block_current[5]};
        const scalar_t *const block_direction_streams[8] = {block_direction[0], block_direction[1], block_direction[2], block_direction[3], block_direction[6], block_direction[7], block_direction[4], block_direction[5]};
        scalar_t *const block_output_streams[8] = {block_output[0], block_output[1], block_output[2], block_output[3], block_output[6], block_output[7], block_output[4], block_output[5]};
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_aos(
    ...
    return two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_soa(nelements, nnodes, elements, points, parameters[0], parameters[1], parameters[3], parameters[4], parameters[5], parameters[6], parameters[7], parameters[8], parameters[9], parameters[10], parameters[11], parameters[12], parameters[13], parameters[15], parameters[16], parameters[19], 2, current + 0, current + 1, 2, direction + 0, direction + 1, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_aos_float(
    ...
    return two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, parameters[0], parameters[1], parameters[3], parameters[4], parameters[5], parameters[6], parameters[7], parameters[8], parameters[9], parameters[10], parameters[11], parameters[12], parameters[13], parameters[15], parameters[16], parameters[19], 2, current + 0, current + 1, 2, direction + 0, direction + 1, 2, output + 0, output + 1);
}
...
template <typename scalar_t>
static SFEM_INLINE count_t two_phase_flow_form_2_p_c_p_c_quad4_hessian_crs_isoparametric_mesh_soa_find_col(
        const idx_t row,
        const idx_t col,
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_quad4_hessian_crs_isoparametric_mesh_soa_scatter_crs(
    ...
    for (int i = 0; i < N_SHAPE; ++i) {
        ...
        for (int j = 0; j < N_SHAPE; ++j) {
            const count_t entry = two_phase_flow_form_2_p_c_p_c_quad4_hessian_crs_isoparametric_mesh_soa_find_col<scalar_t>(ev[i], ev[j], rowptr, colidx);
            if (entry == row_end) {
                if (valid_graph) {
                    std::fprintf(stderr, "two_phase_flow_form_2_p_c_p_c_quad4_hessian_crs_isoparametric_mesh_soa_scatter_crs missing graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_quad4_hessian_crs_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static) reduction(|:invalid_matrix_graph)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        invalid_matrix_graph |= (two_phase_flow_form_2_p_c_p_c_quad4_hessian_crs_isoparametric_mesh_soa_scatter_crs(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
    }
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_hessian_crs_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_hessian_crs_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, rowptr, colidx, values);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_hessian_crs_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_hessian_crs_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, rowptr, colidx, values);
}
...
template <typename scalar_t>
static SFEM_INLINE void two_phase_flow_form_2_p_c_p_c_quad4_hessian_coo_triplet_isoparametric_mesh_soa_scatter_coo_triplets(
        const idx_t *const SFEM_RESTRICT ev,
        const ptrdiff_t out_stride,
        const scalar_t *const SFEM_RESTRICT element_matrix,
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_quad4_hessian_coo_triplet_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        two_phase_flow_form_2_p_c_p_c_quad4_hessian_coo_triplet_isoparametric_mesh_soa_scatter_coo_triplets(ev, out_stride, element_matrix, element, rows, cols, values);
    }
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_hessian_coo_triplet_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_hessian_coo_triplet_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, out_stride, rows, cols, values);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_quad4_hessian_coo_triplet_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_quad4_hessian_coo_triplet_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, out_stride, rows, cols, values);
}
