...
struct two_phase_flow_form_1_p_w_quad4_affine_reference_data {
...
template <typename scalar_t>
struct two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data {
    static const scalar_t *shape_1d() {
        static const scalar_t data[8] = {scalar_t(0.93056815579702623), scalar_t(0.069431844202973714), scalar_t(0.66999052179242813), scalar_t(0.33000947820757187), scalar_t(0.33000947820757187), scalar_t(0.66999052179242813), scalar_t(0.069431844202973769), scalar_t(0.93056815579702623)};
        return data;
    }
...
static const KernelDiagnostics two_phase_flow_form_1_p_w_quad4_residual_element_soa_diagnostics_data = {
    "two_phase_flow_form_1_p_w_quad4_residual_element_soa",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_w_quad4_residual_element_soa_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_1_p_w_quad4_residual_element_soa_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_1_p_w_quad4_residual_element_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_residual_element_soa_diagnostics_data,
...
extern "C" void two_phase_flow_form_1_p_w_quad4_residual_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_1_p_w_quad4_residual_element_soa_float",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
extern "C" void two_phase_flow_form_1_p_w_quad4_residual_affine_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_1_p_w_quad4_residual_affine_mesh_soa",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_residual_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_1_p_w_quad4_residual_affine_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_residual_isoparametric_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_1_p_w_quad4_residual_isoparametric_mesh_soa",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_residual_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_1_p_w_quad4_residual_isoparametric_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_w_diagnostics_data = {
    "two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_w",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_w_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_w_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_w_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_w_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_w_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_w_float",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_w_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_c_diagnostics_data = {
    "two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_c",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_c_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_c_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_c_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_c_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_c_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_c_float",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_w_p_c_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_w_diagnostics_data = {
    "two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_w",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_w_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_w_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_w_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_w_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_w_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_w_float",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_w_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_c_diagnostics_data = {
    "two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_c",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_c_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_c_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_c_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_c_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_c_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_c_float",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_p_c_p_c_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_diagnostics_data = {
    "two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa",
    "QUAD4",
    2,
    16,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_float",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_jacobian_action_affine_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_1_p_w_quad4_jacobian_action_affine_mesh_soa",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_jacobian_action_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_1_p_w_quad4_jacobian_action_affine_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_soa",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" int two_phase_flow_form_1_p_w_quad4_residual_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d2_tensor_product_residual_block<double, 16, 4, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data<double>::shape_1d(), sfem::codegen::two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data<double>::grad_1d(), sfem::codegen::two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data<double>::q_weight_1d(), current, previous, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_1_p_w_quad4_residual_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d2_tensor_product_residual_block<float, 16, 4, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data<float>::shape_1d(), sfem::codegen::two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data<float>::grad_1d(), sfem::codegen::two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data<float>::q_weight_1d(), current, previous, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int two_phase_flow_form_1_p_w_quad4_residual_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const affine_shape_1d = sfem::codegen::two_phase_flow_form_1_p_w_quad4_affine_reference_data<scalar_t>::shape_1d();
    const scalar_t *const affine_grad_1d = sfem::codegen::two_phase_flow_form_1_p_w_quad4_affine_reference_data<scalar_t>::grad_1d();
    const scalar_t *const affine_q_weight_1d = sfem::codegen::two_phase_flow_form_1_p_w_quad4_affine_reference_data<scalar_t>::q_weight_1d();
...
extern "C" int two_phase_flow_form_1_p_w_quad4_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_quad4_residual_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, previous_stride, p_w_old, p_c_old, out_stride, p_w_out, p_c_out);
}
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_1_p_w_quad4_residual_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_shape_1d = sfem::codegen::two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data<scalar_t>::shape_1d();
    const scalar_t *const isoparametric_grad_1d = sfem::codegen::two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data<scalar_t>::grad_1d();
    const scalar_t *const isoparametric_q_weight_1d = sfem::codegen::two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data<scalar_t>::q_weight_1d();
...
extern "C" int two_phase_flow_form_1_p_w_quad4_residual_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_quad4_residual_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, previous_stride, p_w_old, p_c_old, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_quad4_residual_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_quad4_residual_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, previous_stride, p_w_old, p_c_old, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_quad4_residual_isoparametric_mesh_aos_float(
    ...
    return two_phase_flow_form_1_p_w_quad4_residual_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, parameters[2], parameters[3], parameters[4], parameters[5], parameters[6], parameters[8], parameters[10], parameters[13], parameters[14], parameters[15], parameters[17], parameters[18], parameters[19], parameters[20], 2, current + 0, current + 1, 2, previous + 0, previous + 1, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_1_p_w_quad4_jacobian_action_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d2_tensor_product_jacobian_action_block<float, 16, 4, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data<float>::shape_1d(), sfem::codegen::two_phase_flow_form_1_p_w_quad4_isoparametric_reference_data<float>::q_weight_1d(), output);
    return SFEM_SUCCESS;
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int two_phase_flow_form_1_p_w_quad4_jacobian_action_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_determinant0,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        two_phase_flow_form_1_p_w_d2_tensor_product_jacobian_action_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_determinant0, affine_shape_1d, affine_q_weight_1d, block_output_streams);
...
extern "C" int two_phase_flow_form_1_p_w_quad4_jacobian_action_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_action_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_quad4_jacobian_action_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_action_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        two_phase_flow_form_1_p_w_d2_tensor_product_jacobian_action_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_determinant, isoparametric_shape_1d, isoparametric_q_weight_1d, block_output_streams);
...
extern "C" int two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_aos(
    ...
    return two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_soa(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_aos_float(
    ...
    return two_phase_flow_form_1_p_w_quad4_jacobian_action_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
