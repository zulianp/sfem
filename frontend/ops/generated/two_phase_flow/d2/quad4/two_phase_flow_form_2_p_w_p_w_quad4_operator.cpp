...
#pragma omp simd
        ...
        two_phase_flow_form_2_p_w_p_w_d2_tensor_product_residual_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, g_jacobian_determinant0 + evbegin, affine_shape_1d, affine_q_weight_1d, block_output_streams);
...
extern "C" int two_phase_flow_form_2_p_w_p_w_quad4_residual_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_quad4_residual_affine_mesh_soa_impl<double>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_quad4_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_quad4_residual_affine_mesh_soa_impl<float>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_quad4_jacobian_action_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_quad4_jacobian_action_affine_mesh_soa_impl<float>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
