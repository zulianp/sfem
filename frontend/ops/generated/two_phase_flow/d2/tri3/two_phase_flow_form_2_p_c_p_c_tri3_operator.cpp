...
extern "C" int two_phase_flow_form_2_p_c_p_c_tri3_residual_esoa(
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_c_d2_simplex_residual_block<double, 6, 3, 16>(ne, geometry_stride, determinant, sfem::codegen::ref_tri3_q6<double>::shape(), sfem::codegen::quad_tri_q6<double>::q_weight(), output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tri3_residual_esoa_float(
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_c_d2_simplex_residual_block<float, 6, 3, 16>(ne, geometry_stride, determinant, sfem::codegen::ref_tri3_q6<float>::shape(), sfem::codegen::quad_tri_q6<float>::q_weight(), output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tri3_jacobian_action_esoa(
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_c_d2_simplex_jacobian_action_block<double, 6, 3, 16>(ne, geometry_stride, determinant, adjugate, sfem::codegen::ref_tri3_q6<double>::shape(), sfem::codegen::ref_tri3_q6<double>::grad_ref_x(), sfem::codegen::ref_tri3_q6<double>::grad_ref_y(), sfem::codegen::quad_tri_q6<double>::q_weight(), current, direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tri3_jacobian_action_esoa_float(
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_c_d2_simplex_jacobian_action_block<float, 6, 3, 16>(ne, geometry_stride, determinant, adjugate, sfem::codegen::ref_tri3_q6<float>::shape(), sfem::codegen::ref_tri3_q6<float>::grad_ref_x(), sfem::codegen::ref_tri3_q6<float>::grad_ref_y(), sfem::codegen::quad_tri_q6<float>::q_weight(), current, direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, output);
  return SFEM_SUCCESS;
}
