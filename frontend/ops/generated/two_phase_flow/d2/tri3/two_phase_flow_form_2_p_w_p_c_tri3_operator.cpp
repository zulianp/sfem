...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VS) {
        ...
        two_phase_flow_form_2_p_w_p_c_d2_simplex_residual_block_contiguous<s_t, NQ, NS, VS>(nelems, 0, block_affine_geometry_streams[0], affine_shape, affine_q_weight, block_output);
