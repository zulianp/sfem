...
extern "C" int two_phase_flow_form_1_p_w_tri3_jacobian_action_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d2_simplex_jacobian_action_block<double, 6, 3, 16>(ne, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_1_p_w_tri3_isoparametric_reference_data<double>::shape(), sfem::codegen::two_phase_flow_form_1_p_w_tri3_isoparametric_reference_data<double>::q_weight(), output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_1_p_w_tri3_jacobian_action_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d2_simplex_jacobian_action_block<float, 6, 3, 16>(ne, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_1_p_w_tri3_isoparametric_reference_data<float>::shape(), sfem::codegen::two_phase_flow_form_1_p_w_tri3_isoparametric_reference_data<float>::q_weight(), output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_1_p_w_tri3_jacobian_action_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_tri3_jacobian_action_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_tri3_jacobian_action_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_tri3_jacobian_action_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
