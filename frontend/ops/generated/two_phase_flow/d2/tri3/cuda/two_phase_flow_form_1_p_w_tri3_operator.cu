...
#include <cstdlib>
#include <string.h>
#include "../../cuda/two_phase_flow_form_1_p_w_d2_simplex_local.cuh"
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_1_p_w_tri3_jacobian_p_w_p_w_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_1_p_w_tri3_jacobian_p_w_p_c_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_1_p_w_tri3_jacobian_p_c_p_w_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_1_p_w_tri3_jacobian_p_c_p_c_diagnostics(void) {
...
extern "C" int cu_two_phase_flow_form_1_p_w_tri3_residual_esoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        sfem::codegen::two_phase_flow_form_1_p_w_d2_simplex_residual_block<double, 6, 3, 1>(ne, geometry_stride, (const double *)determinant, (const double *const *)adjugate, sfem::codegen::ref_tri3_q6<double>::shape(), sfem::codegen::ref_tri3_q6<double>::grad_ref_x(), sfem::codegen::ref_tri3_q6<double>::grad_ref_y(), sfem::codegen::quad_tri_q6<double>::q_weight(), (const double *const *)current, (const double *const *)previous, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, (double *const *)output);
        return SFEM_SUCCESS;
    }
    case (int)sizeof(float): {
        sfem::codegen::two_phase_flow_form_1_p_w_d2_simplex_residual_block<float, 6, 3, 1>(ne, geometry_stride, (const float *)determinant, (const float *const *)adjugate, sfem::codegen::ref_tri3_q6<float>::shape(), sfem::codegen::ref_tri3_q6<float>::grad_ref_x(), sfem::codegen::ref_tri3_q6<float>::grad_ref_y(), sfem::codegen::quad_tri_q6<float>::q_weight(), (const float *const *)current, (const float *const *)previous, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, (float *const *)output);
        return SFEM_SUCCESS;
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_1_p_w_tri3_residual_esoa", -1, (int)scalar_bytes);
}
...
__global__ void two_phase_flow_form_1_p_w_tri3_residual_a_msoa_impl(
...
extern "C" int cu_two_phase_flow_form_1_p_w_tri3_residual_a_msoa(
    const int scalar_bytes,
    const ptrdiff_t nelements,
  ...
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_1_p_w_tri3_residual_a_msoa", -1, (int)scalar_bytes);
}
