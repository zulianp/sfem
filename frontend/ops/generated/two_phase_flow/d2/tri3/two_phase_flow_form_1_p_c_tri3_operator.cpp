...
extern "C" int two_phase_flow_form_1_p_c_tri3_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_c_tri3_residual_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_det0, C_ka1, C_ka2, K_0, K_1, K_2, K_3, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, previous_stride, p_w_old, p_c_old, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_c_tri3_jacobian_action_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_c_tri3_jacobian_action_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_c_tri3_jacobian_action_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_c_tri3_jacobian_action_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
