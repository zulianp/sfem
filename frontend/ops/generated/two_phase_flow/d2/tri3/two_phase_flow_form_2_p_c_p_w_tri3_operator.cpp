...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        two_phase_flow_form_2_p_c_p_w_d2_simplex_residual_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, g_jacobian_determinant0 + evbegin, affine_shape, affine_q_weight, block_output_streams);
...
extern "C" int two_phase_flow_form_2_p_c_p_w_tri3_residual_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_w_tri3_residual_affine_mesh_soa_impl<double>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_tri3_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_w_tri3_residual_affine_mesh_soa_impl<float>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
