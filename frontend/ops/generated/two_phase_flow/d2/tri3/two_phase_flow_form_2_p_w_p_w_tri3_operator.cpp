#include <type_traits>
#include "../two_phase_flow_form_2_p_w_p_w_d2_simplex_local.hpp"
...
struct two_phase_flow_form_2_p_w_p_w_tri3_affine_reference_data {
...
template <typename scalar_t>
struct two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data {
    static const scalar_t *shape() {
        static const scalar_t data[18] = {scalar_t(0.10810301816807022), scalar_t(0.44594849091596489), scalar_t(0.44594849091596489), scalar_t(0.44594849091596489), scalar_t(0.10810301816807021), scalar_t(0.44594849091596489), scalar_t(0.44594849091596489), scalar_t(0.44594849091596489), scalar_t(0.10810301816807021), scalar_t(0.81684757298045851), scalar_t(0.091576213509770743), scalar_t(0.091576213509770743), scalar_t(0.091576213509770743), scalar_t(0.81684757298045851), scalar_t(0.091576213509770743), scalar_t(0.091576213509770743), scalar_t(0.091576213509770743), scalar_t(0.81684757298045851)};
        return data;
    }
...
static const KernelDiagnostics two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_diagnostics_data = {
    "two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa",
    "TRI3",
    2,
    6,
    3,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_diagnostics_data,
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_residual_affine_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_w_p_w_tri3_residual_affine_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_residual_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_w_p_w_tri3_residual_affine_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_w_diagnostics_data = {
    "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_w",
    "TRI3",
    2,
    6,
    3,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_w_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_w_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_w_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_w_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_w_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_w_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_w_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_c_diagnostics_data = {
    "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_c",
    "TRI3",
    2,
    6,
    3,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_c_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_c_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_c_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_c_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_c_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_c_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_w_p_c_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_w_diagnostics_data = {
    "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_w",
    "TRI3",
    2,
    6,
    3,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_w_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_w_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_w_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_w_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_w_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_w_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_w_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_c_diagnostics_data = {
    "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_c",
    "TRI3",
    2,
    6,
    3,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_c_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_c_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_c_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_c_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_c_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_c_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_p_c_p_c_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_diagnostics_data = {
    "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa",
    "TRI3",
    2,
    6,
    3,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_affine_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_affine_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_affine_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_isoparametric_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_isoparametric_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_isoparametric_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_2_p_w_p_w_d2_simplex_residual_block<double, 6, 3, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<double>::shape(), sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<double>::q_weight(), output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_residual_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_2_p_w_p_w_d2_simplex_residual_block<float, 6, 3, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<float>::shape(), sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<float>::q_weight(), output);
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_w_tri3_residual_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const affine_shape = sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_affine_reference_data<scalar_t>::shape();
    const scalar_t *const affine_grad_ref_x = sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_affine_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const affine_grad_ref_y = sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_affine_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const affine_q_weight = sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_affine_reference_data<scalar_t>::q_weight();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        two_phase_flow_form_2_p_w_p_w_d2_simplex_residual_block_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_affine_geometry_streams[0], affine_shape, affine_q_weight, block_output);
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_residual_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_shape = sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<scalar_t>::shape();
    const scalar_t *const isoparametric_grad_ref_x = sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const isoparametric_grad_ref_y = sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const isoparametric_q_weight = sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<scalar_t>::q_weight();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        two_phase_flow_form_2_p_w_p_w_d2_simplex_residual_block_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_determinant, isoparametric_shape, isoparametric_q_weight, block_output);
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_aos(
    ...
    return two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_soa(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_aos_float(
    ...
    return two_phase_flow_form_2_p_w_p_w_tri3_residual_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_2_p_w_p_w_d2_simplex_jacobian_action_block<double, 6, 3, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<double>::shape(), sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<double>::grad_ref_x(), sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<double>::grad_ref_y(), sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<double>::q_weight(), current, direction, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_2_p_w_p_w_d2_simplex_jacobian_action_block<float, 6, 3, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<float>::shape(), sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<float>::grad_ref_x(), sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<float>::grad_ref_y(), sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_isoparametric_reference_data<float>::q_weight(), current, direction, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
    return SFEM_SUCCESS;
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_isoparametric_mesh_aos_float(
    ...
    return two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, parameters[2], parameters[3], parameters[4], parameters[5], parameters[6], parameters[8], parameters[10], parameters[13], parameters[14], parameters[15], parameters[17], parameters[18], parameters[19], parameters[20], 2, current + 0, current + 1, 2, direction + 0, direction + 1, 2, output + 0, output + 1);
}
...
template <typename scalar_t>
static SFEM_INLINE count_t two_phase_flow_form_2_p_w_p_w_tri3_hessian_crs_isoparametric_mesh_soa_find_col(
        const idx_t row,
        const idx_t col,
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_w_tri3_hessian_crs_isoparametric_mesh_soa_scatter_crs(
    ...
    static constexpr int ROW_COMPONENT[3] = {0, 0, 0};
    static constexpr int ROW_SHAPE[3] = {0, 1, 2};
    static constexpr int COL_COMPONENT[3] = {0, 0, 0};
    static constexpr int COL_SHAPE[3] = {0, 1, 2};
    count_t entries[N_SHAPE * N_SHAPE];
    bool valid_graph = true;
    for (int i = 0; i < N_SHAPE; ++i) {
        const count_t row_end = rowptr[ev[i] + 1];
        for (int j = 0; j < N_SHAPE; ++j) {
            const count_t entry = two_phase_flow_form_2_p_w_p_w_tri3_hessian_crs_isoparametric_mesh_soa_find_col<scalar_t>(ev[i], ev[j], rowptr, colidx);
            if (entry == row_end) {
                if (valid_graph) {
                    std::fprintf(stderr, "two_phase_flow_form_2_p_w_p_w_tri3_hessian_crs_isoparametric_mesh_soa_scatter_crs missing graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_w_tri3_hessian_crs_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static) reduction(|:invalid_matrix_graph)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        for (int trial_local = 0; trial_local < 3; ++trial_local) {
            ...
            two_phase_flow_form_2_p_w_p_w_d2_simplex_jacobian_action_block_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(1, 1, block_determinant, block_adjugate, isoparametric_shape, isoparametric_grad_ref_x, isoparametric_grad_ref_y, isoparametric_q_weight, block_current, block_direction, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, block_output);
        ...
        invalid_matrix_graph |= (two_phase_flow_form_2_p_w_p_w_tri3_hessian_crs_isoparametric_mesh_soa_scatter_crs(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
    }
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_hessian_crs_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_hessian_crs_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, rowptr, colidx, values);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_hessian_crs_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_hessian_crs_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, rowptr, colidx, values);
}
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_w_tri3_hessian_coo_triplet_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        two_phase_flow_form_2_p_w_p_w_tri3_hessian_coo_triplet_isoparametric_mesh_soa_scatter_coo_triplets(ev, out_stride, element_matrix, element, rows, cols, values);
    }
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_hessian_coo_triplet_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_hessian_coo_triplet_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, out_stride, rows, cols, values);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_hessian_coo_triplet_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_hessian_coo_triplet_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, out_stride, rows, cols, values);
}
