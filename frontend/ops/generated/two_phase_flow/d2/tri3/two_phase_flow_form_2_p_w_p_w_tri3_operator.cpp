...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_residual_esoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        sfem::codegen::two_phase_flow_form_2_p_w_p_w_d2_simplex_residual_block<double, 6, 3, 16>(ne, geometry_stride, (const double *)determinant, sfem::codegen::ref_tri3_q6<double>::shape(), sfem::codegen::quad_tri_q6<double>::q_weight(), (double *const *)output);
        return SFEM_SUCCESS;
    }
    case (int)sizeof(float): {
        sfem::codegen::two_phase_flow_form_2_p_w_p_w_d2_simplex_residual_block<float, 6, 3, 16>(ne, geometry_stride, (const float *)determinant, sfem::codegen::ref_tri3_q6<float>::shape(), sfem::codegen::quad_tri_q6<float>::q_weight(), (float *const *)output);
        return SFEM_SUCCESS;
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_w_p_w_tri3_residual_esoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_residual_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_a_msoa_impl<double, geom_t>(nelements, nnodes, elements, g_det0, out_stride, (double *)p_w_out, (double *)p_c_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::two_phase_flow_form_2_p_w_p_w_tri3_residual_a_msoa_impl<float, geom_t>(nelements, nnodes, elements, g_det0, out_stride, (float *)p_w_out, (float *)p_c_out);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_w_p_w_tri3_residual_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_esoa(
  ...
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_esoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_a_msoa", -1, (int)scalar_bytes);
}
