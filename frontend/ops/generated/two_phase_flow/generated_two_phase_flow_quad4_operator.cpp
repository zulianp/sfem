...
template <typename scalar_t>
struct generated_two_phase_flow_quad4_isoparametric_reference_data {
    static const scalar_t *shape_1d() {
        static const scalar_t data[8] = {scalar_t(0.93056815579702623), scalar_t(0.069431844202973714), scalar_t(0.66999052179242813), scalar_t(0.33000947820757187), scalar_t(0.33000947820757187), scalar_t(0.66999052179242813), scalar_t(0.069431844202973769), scalar_t(0.93056815579702623)};
        return data;
    }
...
static SFEM_INLINE int generated_two_phase_flow_quad4_residual_affine_mesh_soa_impl(
    ...
    (void)nnodes;
    const scalar_t *const affine_shape_1d = sfem::codegen::generated_two_phase_flow_quad4_affine_reference_data<scalar_t>::shape_1d();
    const scalar_t *const affine_grad_1d = sfem::codegen::generated_two_phase_flow_quad4_affine_reference_data<scalar_t>::grad_1d();
    const scalar_t *const affine_q_weight_1d = sfem::codegen::generated_two_phase_flow_quad4_affine_reference_data<scalar_t>::q_weight_1d();
...
static SFEM_INLINE int generated_two_phase_flow_quad4_residual_isoparametric_mesh_soa_impl(
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_shape_1d = sfem::codegen::generated_two_phase_flow_quad4_isoparametric_reference_data<scalar_t>::shape_1d();
    const scalar_t *const isoparametric_grad_1d = sfem::codegen::generated_two_phase_flow_quad4_isoparametric_reference_data<scalar_t>::grad_1d();
    const scalar_t *const isoparametric_q_weight_1d = sfem::codegen::generated_two_phase_flow_quad4_isoparametric_reference_data<scalar_t>::q_weight_1d();
