...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_esoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        sfem::codegen::two_phase_flow_form_2_p_c_p_w_d3_tensor_product_residual_block<double, 27, 8, 16>(ne, geometry_stride, (const double *)determinant, sfem::codegen::ref_line_p1_q3<double>::shape_1d(), sfem::codegen::quad_line_q3<double>::q_weight_1d(), (double *const *)output);
        return SFEM_SUCCESS;
    }
    case (int)sizeof(float): {
        sfem::codegen::two_phase_flow_form_2_p_c_p_w_d3_tensor_product_residual_block<float, 27, 8, 16>(ne, geometry_stride, (const float *)determinant, sfem::codegen::ref_line_p1_q3<float>::shape_1d(), sfem::codegen::quad_line_q3<float>::q_weight_1d(), (float *const *)output);
        return SFEM_SUCCESS;
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_esoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_a_msoa_impl<double, geom_t>(nelements, nnodes, elements, g_det0, out_stride, (double *)p_w_out, (double *)p_c_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_a_msoa_impl<float, geom_t>(nelements, nnodes, elements, g_det0, out_stride, (float *)p_w_out, (float *)p_c_out);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_i_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_i_msoa_impl<double>(nelements, nnodes, elements, points, out_stride, (double *)p_w_out, (double *)p_c_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_i_msoa_impl<float>(nelements, nnodes, elements, points, out_stride, (float *)p_w_out, (float *)p_c_out);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_i_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_i_maos(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_i_msoa(scalar_bytes, nelements, nnodes, elements, points, 2, (double *)output + 0, (double *)output + 1);
    }
    case (int)sizeof(float): {
        return two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_i_msoa(scalar_bytes, nelements, nnodes, elements, points, 2, (float *)output + 0, (float *)output + 1);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_hex8_residual_i_maos", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_hex8_jacobian_action_esoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        sfem::codegen::two_phase_flow_form_2_p_c_p_w_d3_tensor_product_jacobian_action_block<double, 27, 8, 16>(ne, geometry_stride, (const double *)determinant, (const double *const *)adjugate, sfem::codegen::ref_line_p1_q3<double>::shape_1d(), sfem::codegen::ref_line_p1_q3<double>::grad_1d(), sfem::codegen::quad_line_q3<double>::q_weight_1d(), (const double *const *)current, (const double *const *)direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, (double *const *)output);
        return SFEM_SUCCESS;
    }
    case (int)sizeof(float): {
        sfem::codegen::two_phase_flow_form_2_p_c_p_w_d3_tensor_product_jacobian_action_block<float, 27, 8, 16>(ne, geometry_stride, (const float *)determinant, (const float *const *)adjugate, sfem::codegen::ref_line_p1_q3<float>::shape_1d(), sfem::codegen::ref_line_p1_q3<float>::grad_1d(), sfem::codegen::quad_line_q3<float>::q_weight_1d(), (const float *const *)current, (const float *const *)direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, (float *const *)output);
        return SFEM_SUCCESS;
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_hex8_jacobian_action_esoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_hex8_jacobian_action_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_hex8_jacobian_action_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_hex8_jacobian_action_i_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_hex8_jacobian_action_i_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_proteus_hex8_jacobian_action_i_maos(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return two_phase_flow_form_2_p_c_p_w_proteus_hex8_jacobian_action_i_msoa(scalar_bytes, nelements, nnodes, elements, points, ((const double *)parameters)[0], ((const double *)parameters)[1], ((const double *)parameters)[3], ((const double *)parameters)[4], ((const double *)parameters)[5], ((const double *)parameters)[6], ((const double *)parameters)[7], ((const double *)parameters)[8], ((const double *)parameters)[9], ((const double *)parameters)[10], ((const double *)parameters)[11], ((const double *)parameters)[12], ((const double *)parameters)[13], ((const double *)parameters)[14], ((const double *)parameters)[15], ((const double *)parameters)[16], ((const double *)parameters)[17], ((const double *)parameters)[18], ((const double *)parameters)[20], ((const double *)parameters)[21], ((const double *)parameters)[24], 2, (const double *)current + 0, (const double *)current + 1, 2, (const double *)direction + 0, (const double *)direction + 1, 2, (double *)output + 0, (double *)output + 1);
    }
    case (int)sizeof(float): {
        return two_phase_flow_form_2_p_c_p_w_proteus_hex8_jacobian_action_i_msoa(scalar_bytes, nelements, nnodes, elements, points, ((const float *)parameters)[0], ((const float *)parameters)[1], ((const float *)parameters)[3], ((const float *)parameters)[4], ((const float *)parameters)[5], ((const float *)parameters)[6], ((const float *)parameters)[7], ((const float *)parameters)[8], ((const float *)parameters)[9], ((const float *)parameters)[10], ((const float *)parameters)[11], ((const float *)parameters)[12], ((const float *)parameters)[13], ((const float *)parameters)[14], ((const float *)parameters)[15], ((const float *)parameters)[16], ((const float *)parameters)[17], ((const float *)parameters)[18], ((const float *)parameters)[20], ((const float *)parameters)[21], ((const float *)parameters)[24], 2, (const float *)current + 0, (const float *)current + 1, 2, (const float *)direction + 0, (const float *)direction + 1, 2, (float *)output + 0, (float *)output + 1);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_c_p_w_proteus_hex8_jacobian_action_i_maos", -1, (int)scalar_bytes);
}
