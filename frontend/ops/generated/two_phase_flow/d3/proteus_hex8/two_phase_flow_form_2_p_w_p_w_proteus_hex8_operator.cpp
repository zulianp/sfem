...
extern "C" int two_phase_flow_form_2_p_w_p_w_proteus_hex8_residual_esoa(
  ...
  sfem::codegen::two_phase_flow_form_2_p_w_p_w_d3_tensor_product_residual_block<double, 27, 8, 16>(ne, geometry_stride, determinant, sfem::codegen::ref_line_p1_q3<double>::shape_1d(), sfem::codegen::quad_line_q3<double>::q_weight_1d(), output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_proteus_hex8_residual_esoa_float(
  ...
  sfem::codegen::two_phase_flow_form_2_p_w_p_w_d3_tensor_product_residual_block<float, 27, 8, 16>(ne, geometry_stride, determinant, sfem::codegen::ref_line_p1_q3<float>::shape_1d(), sfem::codegen::quad_line_q3<float>::q_weight_1d(), output);
  return SFEM_SUCCESS;
}
