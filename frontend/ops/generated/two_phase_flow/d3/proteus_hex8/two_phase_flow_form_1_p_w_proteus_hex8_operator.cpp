...
extern "C" double two_phase_flow_form_1_p_w_proteus_hex8_residual_esoa_arithmetic_intensity(
    const ptrdiff_t nelements,
    const size_t scalar_bytes,
    const size_t real_bytes,
    const size_t accumulator_bytes) {
  return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_residual_esoa_diagnostics_data,
      nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_residual_esoa_print_rate(
...
extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_residual_esoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
      "two_phase_flow_form_1_p_w_proteus_hex8_residual_esoa_float",
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_residual_a_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_1_p_w_proteus_hex8_residual_a_msoa",
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_residual_a_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_1_p_w_proteus_hex8_residual_a_msoa_float",
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_residual_i_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_1_p_w_proteus_hex8_residual_i_msoa",
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_residual_i_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_1_p_w_proteus_hex8_residual_i_msoa_float",
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" double two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa_arithmetic_intensity(
    const ptrdiff_t nelements,
    const size_t scalar_bytes,
    const size_t real_bytes,
    const size_t accumulator_bytes) {
  return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa_diagnostics_data,
      nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
...
extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
      "two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa_float",
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_a_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_a_msoa",
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_a_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_a_msoa_float",
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_msoa",
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_msoa_float",
      &sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_residual_i_msoa(
  ...
  return sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_residual_i_msoa_impl<double>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, previous_stride, p_w_old, p_c_old, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_residual_i_msoa_float(
  ...
  return sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_residual_i_msoa_impl<float>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, previous_stride, p_w_old, p_c_old, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_residual_i_maos_float(
  ...
  return two_phase_flow_form_1_p_w_proteus_hex8_residual_i_msoa_float(nelements, nnodes, elements, points, parameters[2], parameters[3], parameters[4], parameters[5], parameters[6], parameters[7], parameters[8], parameters[9], parameters[10], parameters[11], parameters[13], parameters[15], parameters[18], parameters[19], parameters[20], parameters[22], parameters[23], parameters[24], parameters[25], 2, current + 0, current + 1, 2, previous + 0, previous + 1, 2, output + 0, output + 1);
}

extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa(
    const int ne,
    const ptrdiff_t geometry_stride,
    const double *const RSTR determinant,
    double *const RSTR output[16]
) {
  sfem::codegen::two_phase_flow_form_1_p_w_d3_tensor_product_jacobian_action_block<double, 27, 8, 16>(ne, geometry_stride, determinant, sfem::codegen::ref_line_p1_q3<double>::shape_1d(), sfem::codegen::quad_line_q3<double>::q_weight_1d(), output);
  return SFEM_SUCCESS;
}

extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_esoa_float(
    const int ne,
    const ptrdiff_t geometry_stride,
    const float *const RSTR determinant,
    float *const RSTR output[16]
) {
  sfem::codegen::two_phase_flow_form_1_p_w_d3_tensor_product_jacobian_action_block<float, 27, 8, 16>(ne, geometry_stride, determinant, sfem::codegen::ref_line_p1_q3<float>::shape_1d(), sfem::codegen::quad_line_q3<float>::q_weight_1d(), output);
  return SFEM_SUCCESS;
}
...
template <typename s_t, typename g_t>
static SFEM_INLINE int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_a_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t nnodes,
    idx_t **const RSTR elements,
    const g_t *const RSTR g_det0,
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_a_msoa(
  ...
  return sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_a_msoa_impl<double, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_a_msoa_float(
  ...
  return sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_a_msoa_impl<float, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
...
template <typename s_t>
static SFEM_INLINE int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t nnodes,
    idx_t **const RSTR elements,
    const geom_t *const *const RSTR points,
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_msoa(
  ...
  return sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_msoa_impl<double>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_msoa_float(
  ...
  return sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_msoa_impl<float>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_maos(
  ...
  return two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_msoa(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_maos_float(
  ...
  return two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_i_msoa_float(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
