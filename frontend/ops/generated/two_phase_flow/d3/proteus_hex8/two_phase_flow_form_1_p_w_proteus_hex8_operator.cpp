...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_residual_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d3_tensor_product_residual_block<double, 27, 8, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<double>::shape_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<double>::grad_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<double>::q_weight_1d(), current, previous, C_kw1, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_residual_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d3_tensor_product_residual_block<float, 27, 8, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<float>::shape_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<float>::grad_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<float>::q_weight_1d(), current, previous, C_kw1, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int two_phase_flow_form_1_p_w_proteus_hex8_residual_affine_mesh_soa_impl(
    ...
    (void)nnodes;
    const scalar_t *const affine_shape_1d = sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_affine_reference_data<scalar_t>::shape_1d();
    const scalar_t *const affine_grad_1d = sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_affine_reference_data<scalar_t>::grad_1d();
    const scalar_t *const affine_q_weight_1d = sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_affine_reference_data<scalar_t>::q_weight_1d();
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_residual_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, C_kw1, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, previous_stride, p_w_old, p_c_old, out_stride, p_w_out, p_c_out);
}
...
static SFEM_INLINE int two_phase_flow_form_1_p_w_proteus_hex8_residual_isoparametric_mesh_soa_impl(
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_shape_1d = sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<scalar_t>::shape_1d();
    const scalar_t *const isoparametric_grad_1d = sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<scalar_t>::grad_1d();
    const scalar_t *const isoparametric_q_weight_1d = sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<scalar_t>::q_weight_1d();
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d3_tensor_product_jacobian_action_block<double, 27, 8, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<double>::shape_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<double>::q_weight_1d(), output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_1_p_w_d3_tensor_product_jacobian_action_block<float, 27, 8, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<float>::shape_1d(), sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_isoparametric_reference_data<float>::q_weight_1d(), output);
    return SFEM_SUCCESS;
}
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        two_phase_flow_form_1_p_w_d3_tensor_product_jacobian_action_block_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_affine_geometry_streams[0], affine_shape_1d, affine_q_weight_1d, block_output);
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_w_proteus_hex8_jacobian_action_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        two_phase_flow_form_1_p_w_d3_tensor_product_jacobian_action_block_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_determinant, isoparametric_shape_1d, isoparametric_q_weight_1d, block_output);
