...
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_proteus_hex8_residual_affine_mesh_soa_impl(
    ...
    (void)nnodes;
    const s_t *const affine_shape_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_affine_reference_data<s_t>::shape_1d();
    const s_t *const affine_grad_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_affine_reference_data<s_t>::grad_1d();
    const s_t *const affine_q_weight_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_affine_reference_data<s_t>::q_weight_1d();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_2_p_c_p_c_d3_tensor_product_residual_block_contiguous<s_t, NQ, NS, VS>(nelems, 0, bageom_streams[0], affine_shape_1d, affine_q_weight_1d, boutput);
...
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_proteus_hex8_residual_isoparametric_mesh_soa_impl(
    ...
    static constexpr int VS = 16;
    (void)nnodes;
    const s_t *const isoparametric_shape_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<s_t>::shape_1d();
    const s_t *const isoparametric_grad_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<s_t>::grad_1d();
    const s_t *const isoparametric_q_weight_1d = sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<s_t>::q_weight_1d();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_2_p_c_p_c_d3_tensor_product_residual_block_contiguous<s_t, NQ, NS, VS>(nelems, VS, bdeterminant, isoparametric_shape_1d, isoparametric_q_weight_1d, boutput);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        two_phase_flow_form_2_p_c_p_c_d3_tensor_product_jacobian_action_block_contiguous<s_t, NQ, NS, VS>(nelems, 0, bageom_streams[9], badjugate, affine_shape_1d, affine_grad_1d, affine_q_weight_1d, bcurrent, bdirection, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, boutput);
