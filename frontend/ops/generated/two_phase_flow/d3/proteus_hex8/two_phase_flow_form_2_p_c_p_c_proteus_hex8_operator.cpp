...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_hex8_residual_element_soa(
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_c_d3_tensor_product_residual_block<double, 27, 8, 16>(ne, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<double>::shape_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<double>::q_weight_1d(), output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_hex8_residual_element_soa_float(
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_c_d3_tensor_product_residual_block<float, 27, 8, 16>(ne, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<float>::shape_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<float>::q_weight_1d(), output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_hex8_residual_affine_mesh_soa(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_residual_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_hex8_residual_affine_mesh_soa_float(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_residual_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_hex8_jacobian_action_element_soa(
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_c_d3_tensor_product_jacobian_action_block<double, 27, 8, 16>(ne, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<double>::shape_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<double>::grad_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<double>::q_weight_1d(), current, direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_proteus_hex8_jacobian_action_element_soa_float(
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_c_d3_tensor_product_jacobian_action_block<float, 27, 8, 16>(ne, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<float>::shape_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<float>::grad_1d(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_proteus_hex8_isoparametric_reference_data<float>::q_weight_1d(), current, direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, output);
  return SFEM_SUCCESS;
}
