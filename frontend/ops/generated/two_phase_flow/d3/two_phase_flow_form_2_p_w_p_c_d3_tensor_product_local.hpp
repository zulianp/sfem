...
static SFEM_INLINE void two_phase_flow_form_2_p_w_p_c_d3_tensor_product_jacobian_action_block(
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    for (int lane = 0; lane < ne; ++lane) {
      ...
      const s_t p_w_grad_0_ref = current_grad_ref_q0_0[lane];
      const s_t p_w_grad_1_ref = current_grad_ref_q0_1[lane];
      const s_t p_w_grad_2_ref = current_grad_ref_q0_2[lane];
      ...
      const s_t p_c_direction = direction_value_q1[lane];
      ...
      value_coeff_q0[lane] = qw * det * value_coeff0;
      ...
      grad_coeff_ref_q1_0[lane] = s_t(0);
      grad_coeff_ref_q1_1[lane] = s_t(0);
      grad_coeff_ref_q1_2[lane] = s_t(0);
    }
  }
