#ifndef TWO_PHASE_FLOW_FORM_2_P_C_P_C_D3_TENSOR_PRODUCT_LOCAL_HPP
#define TWO_PHASE_FLOW_FORM_2_P_C_P_C_D3_TENSOR_PRODUCT_LOCAL_HPP
...
static SFEM_INLINE void two_phase_flow_form_2_p_c_p_c_d3_tensor_product_residual_block(
        const int nelems,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void two_phase_flow_form_2_p_c_p_c_d3_tensor_product_residual_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT shape_1d,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void two_phase_flow_form_2_p_c_p_c_d3_tensor_product_jacobian_action_block(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
    ...
    for (int q = 0; q < N_QP; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            const scalar_t residual_tmp20 = p_c_direction_grad_2*residual_tmp17;
            const scalar_t residual_tmp21 = -K_0*p_c_grad_0 - K_1*p_c_grad_1 - K_2*p_c_grad_2;
            const scalar_t residual_tmp22 = dt*residual_tmp16;
            const scalar_t residual_tmp23 = residual_tmp21*residual_tmp22;
            const scalar_t residual_tmp24 = C_ka2*dt*residual_tmp14*residual_tmp15*residual_tmp6;
            const scalar_t residual_tmp25 = C_ka1*residual_tmp4*residual_tmp6/residual_tmp13;
            const scalar_t residual_tmp26 = -K_3*p_c_grad_0 - K_4*p_c_grad_1 - K_5*p_c_grad_2;
            const scalar_t residual_tmp27 = residual_tmp22*residual_tmp26;
            const scalar_t residual_tmp28 = -K_6*p_c_grad_0 - K_7*p_c_grad_1 - K_8*p_c_grad_2;
            const scalar_t residual_tmp29 = residual_tmp22*residual_tmp28;
            ...
            const scalar_t grad_coeff1_0 = -K_0*residual_tmp18 - K_1*residual_tmp19 - K_2*residual_tmp20 + M_c*p_c_direction*residual_tmp10*residual_tmp12*residual_tmp7*residual_tmp8*residual_tmp9*(residual_tmp21*residual_tmp24 - residual_tmp23*residual_tmp25 + residual_tmp23);
            const scalar_t grad_coeff1_1 = -K_3*residual_tmp18 - K_4*residual_tmp19 - K_5*residual_tmp20 + M_c*p_c_direction*residual_tmp10*residual_tmp12*residual_tmp7*residual_tmp8*residual_tmp9*(residual_tmp24*residual_tmp26 - residual_tmp25*residual_tmp27 + residual_tmp27);
            const scalar_t grad_coeff1_2 = -K_6*residual_tmp18 - K_7*residual_tmp19 - K_8*residual_tmp20 + M_c*p_c_direction*residual_tmp10*residual_tmp12*residual_tmp7*residual_tmp8*residual_tmp9*(residual_tmp24*residual_tmp28 - residual_tmp25*residual_tmp29 + residual_tmp29);
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void two_phase_flow_form_2_p_c_p_c_d3_tensor_product_jacobian_action_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT adjugate[9],
