...
#include <cstdlib>
#include <string.h>
#include "../../cuda/two_phase_flow_d3_simplex_local.cuh"
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_tet4_jacobian_p_w_p_w_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_tet4_jacobian_p_w_p_c_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_tet4_jacobian_p_c_p_w_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_tet4_jacobian_p_c_p_c_diagnostics(void) {
...
extern "C" int cu_two_phase_flow_tet4_residual_esoa(
...
__global__ void two_phase_flow_tet4_residual_a_msoa_impl(
...
extern "C" int cu_two_phase_flow_tet4_jacobian_action_esoa(
    const int scalar_bytes,
    const int ne,
    const ptrdiff_t geometry_stride,
    const void *const RSTR determinant,
...
template <typename s_t, typename g_t>
__global__ void two_phase_flow_tet4_jacobian_action_a_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t,
    idx_t **const RSTR elements,
    const g_t *const RSTR g_adj0,
...
extern "C" int cu_two_phase_flow_tet4_jacobian_action_a_msoa(
    const int scalar_bytes,
    const ptrdiff_t nelements,
    const ptrdiff_t nnodes,
    idx_t **const RSTR elements,
