...
struct two_phase_flow_form_2_p_c_p_c_tet4_affine_reference_data {
...
template <typename scalar_t>
struct two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data {
    static const scalar_t *shape() {
        static const scalar_t data[44] = {scalar_t(0.25), scalar_t(0.25), scalar_t(0.25), scalar_t(0.25), scalar_t(0.78571428571428581), scalar_t(0.071428571428571425), scalar_t(0.071428571428571425), scalar_t(0.071428571428571425), scalar_t(0.071428571428571452), scalar_t(0.7857142857142857), scalar_t(0.071428571428571425), scalar_t(0.071428571428571425), scalar_t(0.07142857142857148), scalar_t(0.071428571428571425), scalar_t(0.7857142857142857), scalar_t(0.071428571428571425), scalar_t(0.071428571428571508), scalar_t(0.071428571428571425), scalar_t(0.071428571428571425), scalar_t(0.7857142857142857), scalar_t(0.10059642383320075), scalar_t(0.39940357616679922), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.10059642383320078), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922), scalar_t(0.10059642383320078), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922), scalar_t(0.39940357616679922), scalar_t(0.39940357616679922), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922)};
        return data;
    }
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa",
    "TET4",
    3,
    11,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_diagnostics_data,
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_residual_affine_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_c_p_c_tet4_residual_affine_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_residual_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_c_p_c_tet4_residual_affine_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_w_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_w",
    "TET4",
    3,
    11,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_w_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_w_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_w_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_w_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_w_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_w_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_w_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_c_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_c",
    "TET4",
    3,
    11,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_c_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_c_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_c_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_c_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_c_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_c_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_w_p_c_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_w_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_w",
    "TET4",
    3,
    11,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_w_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_w_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_w_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_w_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_w_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_w_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_w_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_c_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_c",
    "TET4",
    3,
    11,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_c_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_c_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_c_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_c_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_c_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_c_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_p_c_p_c_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_diagnostics_data = {
    "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa",
    "TET4",
    3,
    11,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_affine_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_affine_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_affine_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_isoparametric_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_isoparametric_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_isoparametric_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_2_p_c_p_c_d3_simplex_residual_block<double, 11, 4, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<double>::shape(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<double>::q_weight(), output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_residual_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_2_p_c_p_c_d3_simplex_residual_block<float, 11, 4, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<float>::shape(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<float>::q_weight(), output);
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_tet4_residual_affine_mesh_soa_impl(
    ...
    (void)nnodes;
    const scalar_t *const affine_shape = sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_affine_reference_data<scalar_t>::shape();
    const scalar_t *const affine_grad_ref_x = sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_affine_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const affine_grad_ref_y = sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_affine_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const affine_grad_ref_z = sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_affine_reference_data<scalar_t>::grad_ref_z();
    const scalar_t *const affine_q_weight = sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_affine_reference_data<scalar_t>::q_weight();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        two_phase_flow_form_2_p_c_p_c_d3_simplex_residual_block_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_affine_geometry_streams[0], affine_shape, affine_q_weight, block_output);
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_shape = sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<scalar_t>::shape();
    const scalar_t *const isoparametric_grad_ref_x = sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const isoparametric_grad_ref_y = sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const isoparametric_grad_ref_z = sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<scalar_t>::grad_ref_z();
    const scalar_t *const isoparametric_q_weight = sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<scalar_t>::q_weight();
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        two_phase_flow_form_2_p_c_p_c_d3_simplex_residual_block_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_determinant, isoparametric_shape, isoparametric_q_weight, block_output);
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_aos(
    ...
    return two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_soa(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_aos_float(
    ...
    return two_phase_flow_form_2_p_c_p_c_tet4_residual_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_2_p_c_p_c_d3_simplex_jacobian_action_block<double, 11, 4, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<double>::shape(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<double>::grad_ref_x(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<double>::grad_ref_y(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<double>::grad_ref_z(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<double>::q_weight(), current, direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_2_p_c_p_c_d3_simplex_jacobian_action_block<float, 11, 4, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<float>::shape(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<float>::grad_ref_x(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<float>::grad_ref_y(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<float>::grad_ref_z(), sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_isoparametric_reference_data<float>::q_weight(), current, direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, output);
    return SFEM_SUCCESS;
}
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_jacobian_action_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
...
static SFEM_INLINE void two_phase_flow_form_2_p_c_p_c_tet4_hessian_crs_isoparametric_mesh_soa_find_cols(
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_tet4_hessian_crs_isoparametric_mesh_soa_scatter_crs(
    ...
    for (int i = 0; i < N_SHAPE; ++i) {
        ...
        two_phase_flow_form_2_p_c_p_c_tet4_hessian_crs_isoparametric_mesh_soa_find_cols(ev, cols, lenrow, ks);
        for (int j = 0; j < N_SHAPE; ++j) {
            if (ks[j] < 0 || ks[j] >= lenrow || cols[ks[j]] != ev[j]) {
                if (valid_graph) {
                    std::fprintf(stderr, "two_phase_flow_form_2_p_c_p_c_tet4_hessian_crs_isoparametric_mesh_soa_scatter_crs missing graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_tet4_hessian_crs_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static) reduction(|:invalid_matrix_graph)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        invalid_matrix_graph |= (two_phase_flow_form_2_p_c_p_c_tet4_hessian_crs_isoparametric_mesh_soa_scatter_crs(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
    }
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_hessian_crs_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_hessian_crs_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, rowptr, colidx, values);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_hessian_crs_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_hessian_crs_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, rowptr, colidx, values);
}
...
template <typename scalar_t>
static SFEM_INLINE void two_phase_flow_form_2_p_c_p_c_tet4_hessian_coo_triplet_isoparametric_mesh_soa_scatter_coo_triplets(
        const idx_t *const SFEM_RESTRICT ev,
        const ptrdiff_t out_stride,
        const scalar_t *const SFEM_RESTRICT element_matrix,
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_c_tet4_hessian_coo_triplet_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        two_phase_flow_form_2_p_c_p_c_tet4_hessian_coo_triplet_isoparametric_mesh_soa_scatter_coo_triplets(ev, out_stride, element_matrix, element, rows, cols, values);
    }
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_hessian_coo_triplet_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_hessian_coo_triplet_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, out_stride, rows, cols, values);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_c_tet4_hessian_coo_triplet_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_c_p_c_tet4_hessian_coo_triplet_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, out_stride, rows, cols, values);
}
