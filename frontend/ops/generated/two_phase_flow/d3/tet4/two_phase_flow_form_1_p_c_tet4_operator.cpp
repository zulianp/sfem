...
extern "C" int two_phase_flow_form_1_p_c_tet4_jacobian_action_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_c_tet4_jacobian_action_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_1_p_c_tet4_jacobian_action_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_1_p_c_tet4_jacobian_action_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
