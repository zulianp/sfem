...
extern "C" double two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa_arithmetic_intensity(
    const ptrdiff_t nelements,
    const size_t scalar_bytes,
    const size_t real_bytes,
    const size_t accumulator_bytes) {
  return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa_diagnostics_data,
      nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa_print_rate(
...
extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
      "two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_residual_a_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_2_p_c_p_w_tet4_residual_a_msoa",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_residual_a_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_2_p_c_p_w_tet4_residual_a_msoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_residual_i_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_2_p_c_p_w_tet4_residual_i_msoa",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_residual_i_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_2_p_c_p_w_tet4_residual_i_msoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" double two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa_arithmetic_intensity(
    const ptrdiff_t nelements,
    const size_t scalar_bytes,
    const size_t real_bytes,
    const size_t accumulator_bytes) {
  return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa_diagnostics_data,
      nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
...
extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
      "two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_a_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_a_msoa",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_a_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_a_msoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_i_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_i_msoa",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_i_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_i_msoa_float",
      &sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" int two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa(
    const int ne,
    const ptrdiff_t geometry_stride,
    const double *const RSTR determinant,
    double *const RSTR output[8]
) {
  sfem::codegen::two_phase_flow_form_2_p_c_p_w_d3_simplex_residual_block<double, 11, 4, 16>(ne, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<double>::shape(), sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<double>::q_weight(), output);
  return SFEM_SUCCESS;
}

extern "C" int two_phase_flow_form_2_p_c_p_w_tet4_residual_esoa_float(
    const int ne,
    const ptrdiff_t geometry_stride,
    const float *const RSTR determinant,
    float *const RSTR output[8]
) {
  sfem::codegen::two_phase_flow_form_2_p_c_p_w_d3_simplex_residual_block<float, 11, 4, 16>(ne, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<float>::shape(), sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<float>::q_weight(), output);
  return SFEM_SUCCESS;
}
...
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_w_tet4_residual_a_msoa_impl(
    const ptrdiff_t nelements,
  ...
  (void)nnodes;
  const s_t *const affine_shape = sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_affine_reference_data<s_t>::shape();
  const s_t *const affine_grad_ref_x = sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_affine_reference_data<s_t>::grad_ref_x();
  const s_t *const affine_grad_ref_y = sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_affine_reference_data<s_t>::grad_ref_y();
  const s_t *const affine_grad_ref_z = sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_affine_reference_data<s_t>::grad_ref_z();
  const s_t *const affine_q_weight = sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_affine_reference_data<s_t>::q_weight();
...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    two_phase_flow_form_2_p_c_p_w_d3_simplex_residual_block_contiguous<s_t, NQ, NS, VS>(ne, 0, bageom_streams[0], affine_shape, affine_q_weight, boutput);
...
extern "C" int two_phase_flow_form_2_p_c_p_w_tet4_residual_a_msoa(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_residual_a_msoa_impl<double, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_tet4_residual_a_msoa_float(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_residual_a_msoa_impl<float, geom_t>(nelements, nnodes, elements, g_det0, out_stride, p_w_out, p_c_out);
}

extern "C" int two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa(
    const int ne,
    const ptrdiff_t geometry_stride,
    const double *const RSTR determinant,
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_w_d3_simplex_jacobian_action_block<double, 11, 4, 16>(ne, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<double>::shape(), sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<double>::grad_ref_x(), sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<double>::grad_ref_y(), sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<double>::grad_ref_z(), sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<double>::q_weight(), current, direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, output);
  return SFEM_SUCCESS;
}

extern "C" int two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_esoa_float(
    const int ne,
    const ptrdiff_t geometry_stride,
    const float *const RSTR determinant,
  ...
  sfem::codegen::two_phase_flow_form_2_p_c_p_w_d3_simplex_jacobian_action_block<float, 11, 4, 16>(ne, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<float>::shape(), sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<float>::grad_ref_x(), sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<float>::grad_ref_y(), sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<float>::grad_ref_z(), sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_isoparametric_reference_data<float>::q_weight(), current, direction, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, output);
  return SFEM_SUCCESS;
}
...
template <typename s_t, typename g_t>
static SFEM_INLINE int two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_a_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t nnodes,
    idx_t **const RSTR elements,
...
extern "C" int two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_a_msoa(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_a_msoa_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_a_msoa_float(
  ...
  return sfem::codegen::two_phase_flow_form_2_p_c_p_w_tet4_jacobian_action_a_msoa_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
