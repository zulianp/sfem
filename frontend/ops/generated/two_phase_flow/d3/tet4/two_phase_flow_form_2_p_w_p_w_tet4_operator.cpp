...
extern "C" int two_phase_flow_form_2_p_w_p_w_tet4_residual_esoa(
  ...
  sfem::codegen::two_phase_flow_form_2_p_w_p_w_d3_simplex_residual_block<double, 11, 4, 16>(ne, geometry_stride, determinant, sfem::codegen::ref_tet4_q11<double>::shape(), sfem::codegen::quad_tet_q11<double>::q_weight(), output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tet4_residual_esoa_float(
  ...
  sfem::codegen::two_phase_flow_form_2_p_w_p_w_d3_simplex_residual_block<float, 11, 4, 16>(ne, geometry_stride, determinant, sfem::codegen::ref_tet4_q11<float>::shape(), sfem::codegen::quad_tet_q11<float>::q_weight(), output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tet4_jacobian_action_esoa(
  ...
  sfem::codegen::two_phase_flow_form_2_p_w_p_w_d3_simplex_jacobian_action_block<double, 11, 4, 16>(ne, geometry_stride, determinant, adjugate, sfem::codegen::ref_tet4_q11<double>::shape(), sfem::codegen::ref_tet4_q11<double>::grad_ref_x(), sfem::codegen::ref_tet4_q11<double>::grad_ref_y(), sfem::codegen::ref_tet4_q11<double>::grad_ref_z(), sfem::codegen::quad_tet_q11<double>::q_weight(), current, direction, C_kw1, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
  return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_w_p_w_tet4_jacobian_action_esoa_float(
  ...
  sfem::codegen::two_phase_flow_form_2_p_w_p_w_d3_simplex_jacobian_action_block<float, 11, 4, 16>(ne, geometry_stride, determinant, adjugate, sfem::codegen::ref_tet4_q11<float>::shape(), sfem::codegen::ref_tet4_q11<float>::grad_ref_x(), sfem::codegen::ref_tet4_q11<float>::grad_ref_y(), sfem::codegen::ref_tet4_q11<float>::grad_ref_z(), sfem::codegen::quad_tet_q11<float>::q_weight(), current, direction, C_kw1, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
  return SFEM_SUCCESS;
}
