...
static SFEM_INLINE void two_phase_flow_tet4_hessian_crs_isoparametric_mesh_soa_find_cols(
...
static SFEM_INLINE int two_phase_flow_tet4_hessian_crs_isoparametric_mesh_soa_scatter_crs(
    ...
    for (int i = 0; i < N_SHAPE; ++i) {
        ...
        two_phase_flow_tet4_hessian_crs_isoparametric_mesh_soa_find_cols(ev, cols, lenrow, ks);
