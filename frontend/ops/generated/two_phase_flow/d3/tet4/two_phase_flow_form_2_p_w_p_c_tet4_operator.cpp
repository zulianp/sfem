...
struct two_phase_flow_form_2_p_w_p_c_tet4_affine_reference_data {
...
template <typename scalar_t>
struct two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data {
    static const scalar_t *shape() {
        static const scalar_t data[44] = {scalar_t(0.25), scalar_t(0.25), scalar_t(0.25), scalar_t(0.25), scalar_t(0.78571428571428581), scalar_t(0.071428571428571425), scalar_t(0.071428571428571425), scalar_t(0.071428571428571425), scalar_t(0.071428571428571452), scalar_t(0.7857142857142857), scalar_t(0.071428571428571425), scalar_t(0.071428571428571425), scalar_t(0.07142857142857148), scalar_t(0.071428571428571425), scalar_t(0.7857142857142857), scalar_t(0.071428571428571425), scalar_t(0.071428571428571508), scalar_t(0.071428571428571425), scalar_t(0.071428571428571425), scalar_t(0.7857142857142857), scalar_t(0.10059642383320075), scalar_t(0.39940357616679922), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.10059642383320078), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922), scalar_t(0.10059642383320078), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922), scalar_t(0.39940357616679922), scalar_t(0.39940357616679922), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922), scalar_t(0.1005964238332008), scalar_t(0.1005964238332008), scalar_t(0.39940357616679922)};
        return data;
    }
...
static const KernelDiagnostics two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_diagnostics_data = {
    "two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa",
    "TET4",
    3,
    11,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_diagnostics_data,
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_residual_affine_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_w_p_c_tet4_residual_affine_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_residual_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_w_p_c_tet4_residual_affine_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" double two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_w_p_w_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_w_p_w_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_w_p_w_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_w_p_w_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_w_p_w_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" double two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_w_p_c_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_w_p_c_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_w_p_c_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_w_p_c_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_w_p_c_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" double two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_c_p_w_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_c_p_w_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_c_p_w_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_c_p_w_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_c_p_w_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" double two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_c_p_c_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_c_p_c_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_c_p_c_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_c_p_c_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_p_c_p_c_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_diagnostics_data = {
    "two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa",
    "TET4",
    3,
    11,
    4,
...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_diagnostics(void) {
    return &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_diagnostics_data;
}
...
extern "C" double two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_affine_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_affine_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_affine_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_isoparametric_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_isoparametric_mesh_soa",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_isoparametric_mesh_soa_float",
            &sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" int two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_2_p_w_p_c_d3_simplex_residual_block<double, 11, 4, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<double>::shape(), sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<double>::q_weight(), output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_w_p_c_tet4_residual_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_2_p_w_p_c_d3_simplex_residual_block<float, 11, 4, 16>(nelems, geometry_stride, determinant, sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<float>::shape(), sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<float>::q_weight(), output);
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_c_tet4_residual_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const affine_shape = sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_affine_reference_data<scalar_t>::shape();
    const scalar_t *const affine_grad_ref_x = sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_affine_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const affine_grad_ref_y = sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_affine_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const affine_grad_ref_z = sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_affine_reference_data<scalar_t>::grad_ref_z();
    const scalar_t *const affine_q_weight = sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_affine_reference_data<scalar_t>::q_weight();
...
extern "C" int two_phase_flow_form_2_p_w_p_c_tet4_residual_affine_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_residual_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_c_tet4_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_residual_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_determinant0, out_stride, p_w_out, p_c_out);
}
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
...
extern "C" int two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, out_stride, p_w_out, p_c_out);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_aos(
    ...
    return two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_soa(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_aos_float(
    ...
    return two_phase_flow_form_2_p_w_p_c_tet4_residual_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, 2, output + 0, output + 1);
}
...
extern "C" int two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa(
    ...
    sfem::codegen::two_phase_flow_form_2_p_w_p_c_d3_simplex_jacobian_action_block<double, 11, 4, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<double>::shape(), sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<double>::grad_ref_x(), sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<double>::grad_ref_y(), sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<double>::grad_ref_z(), sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<double>::q_weight(), current, direction, C_kw1, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
    return SFEM_SUCCESS;
}
...
extern "C" int two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_element_soa_float(
    ...
    sfem::codegen::two_phase_flow_form_2_p_w_p_c_d3_simplex_jacobian_action_block<float, 11, 4, 16>(nelems, geometry_stride, determinant, adjugate, sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<float>::shape(), sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<float>::grad_ref_x(), sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<float>::grad_ref_y(), sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<float>::grad_ref_z(), sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_isoparametric_reference_data<float>::q_weight(), current, direction, C_kw1, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, output);
    return SFEM_SUCCESS;
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
...
template <typename scalar_t>
static SFEM_INLINE int two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
extern "C" int two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_isoparametric_mesh_soa(
    ...
    return sfem::codegen::two_phase_flow_form_2_p_w_p_c_tet4_jacobian_action_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, p_w, p_c, direction_stride, p_w_direction, p_c_direction, out_stride, p_w_out, p_c_out);
}
