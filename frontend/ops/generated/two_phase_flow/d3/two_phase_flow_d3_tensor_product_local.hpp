...
static SFEM_INLINE void two_phase_flow_d3_tensor_product_residual_block(
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    for (int lane = 0; lane < ne; ++lane) {
      ...
      const s_t p_w_old = previous_value_q0[lane];
      ...
      const s_t p_c_old = previous_value_q1[lane];
...
static SFEM_INLINE void two_phase_flow_d3_tensor_product_jacobian_action_block(
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    for (int lane = 0; lane < ne; ++lane) {
      ...
      const s_t p_w_direction_grad_0_ref = direction_grad_ref_q0_0[lane];
      const s_t p_w_direction_grad_1_ref = direction_grad_ref_q0_1[lane];
      const s_t p_w_direction_grad_2_ref = direction_grad_ref_q0_2[lane];
      ...
      const s_t p_c_direction_grad_0_ref = direction_grad_ref_q1_0[lane];
      const s_t p_c_direction_grad_1_ref = direction_grad_ref_q1_1[lane];
      const s_t p_c_direction_grad_2_ref = direction_grad_ref_q1_2[lane];
