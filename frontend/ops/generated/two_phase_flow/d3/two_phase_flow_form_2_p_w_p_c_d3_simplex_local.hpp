#ifndef TWO_PHASE_FLOW_FORM_2_P_W_P_C_D3_SIMPLEX_LOCAL_HPP
#define TWO_PHASE_FLOW_FORM_2_P_W_P_C_D3_SIMPLEX_LOCAL_HPP
...
static SFEM_INLINE void two_phase_flow_form_2_p_w_p_c_d3_simplex_residual_block(
        const int nelems,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void two_phase_flow_form_2_p_w_p_c_d3_simplex_residual_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT shape,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void two_phase_flow_form_2_p_w_p_c_d3_simplex_tet4_residual_block(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT shape,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void two_phase_flow_form_2_p_w_p_c_d3_simplex_tet4_residual_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT shape,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void two_phase_flow_form_2_p_w_p_c_d3_simplex_jacobian_action_block(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
    ...
    for (int q = 0; q < N_QP; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            const scalar_t residual_tmp5 = S_res + scalar_t(-1);
            const scalar_t residual_tmp6 = p_c_direction*rho_w0/dt;
            const scalar_t residual_tmp7 = pow_m1(residual_tmp2);
            const scalar_t residual_tmp8 = pow_m1(residual_tmp0);
            const scalar_t residual_tmp9 = exp(kappa_T*(p_w - p_wr));
            const scalar_t residual_tmp10 = residual_tmp1*residual_tmp3*residual_tmp7*residual_tmp8*residual_tmp9;
            const scalar_t residual_tmp11 = K_0*p_w_grad_0 + K_1*p_w_grad_1 + K_2*p_w_grad_2;
            const scalar_t residual_tmp12 = residual_tmp4*residual_tmp5;
            const scalar_t residual_tmp13 = S_res - residual_tmp12;
            const scalar_t residual_tmp14 = pow(residual_tmp13, (scalar_t(-1) / scalar_t(2)));
            const scalar_t residual_tmp15 = dt*residual_tmp10*residual_tmp12*residual_tmp14;
            const scalar_t residual_tmp16 = pow(residual_tmp13, pow_m1(C_kw1));
            const scalar_t residual_tmp17 = scalar_t(1) - residual_tmp16;
            const scalar_t residual_tmp18 = pow(residual_tmp17, C_kw1);
            const scalar_t residual_tmp19 = residual_tmp18 + scalar_t(-1);
            const scalar_t residual_tmp20 = ((scalar_t(1) / scalar_t(2)))*pow_2(residual_tmp19);
            const scalar_t residual_tmp21 = pow_m1(residual_tmp17);
            const scalar_t residual_tmp22 = residual_tmp6/mu_w;
            const scalar_t residual_tmp23 = K_3*p_w_grad_0 + K_4*p_w_grad_1 + K_5*p_w_grad_2;
            const scalar_t residual_tmp24 = residual_tmp15*residual_tmp20;
            const scalar_t residual_tmp25 = K_6*p_w_grad_0 + K_7*p_w_grad_1 + K_8*p_w_grad_2;
            const scalar_t value_coeff0 = -porosity*residual_tmp10*residual_tmp4*residual_tmp5*residual_tmp6;
            const scalar_t grad_coeff0_0 = residual_tmp22*(scalar_t(2)*dt*residual_tmp1*residual_tmp11*residual_tmp14*residual_tmp16*residual_tmp18*residual_tmp19*residual_tmp21*residual_tmp3*residual_tmp4*residual_tmp5*residual_tmp7*residual_tmp8*residual_tmp9 - residual_tmp11*residual_tmp15*residual_tmp20);
            const scalar_t grad_coeff0_1 = residual_tmp22*(scalar_t(2)*dt*residual_tmp1*residual_tmp14*residual_tmp16*residual_tmp18*residual_tmp19*residual_tmp21*residual_tmp23*residual_tmp3*residual_tmp4*residual_tmp5*residual_tmp7*residual_tmp8*residual_tmp9 - residual_tmp23*residual_tmp24);
            const scalar_t grad_coeff0_2 = residual_tmp22*(scalar_t(2)*dt*residual_tmp1*residual_tmp14*residual_tmp16*residual_tmp18*residual_tmp19*residual_tmp21*residual_tmp25*residual_tmp3*residual_tmp4*residual_tmp5*residual_tmp7*residual_tmp8*residual_tmp9 - residual_tmp24*residual_tmp25);
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void two_phase_flow_form_2_p_w_p_c_d3_simplex_jacobian_action_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT adjugate[9],
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void two_phase_flow_form_2_p_w_p_c_d3_simplex_tet4_jacobian_action_block(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT adjugate[9],
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void two_phase_flow_form_2_p_w_p_c_d3_simplex_tet4_jacobian_action_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT adjugate[9],
