...
static const KernelDiagnostics two_phase_flow_form_2_p_w_p_c_hex8_residual_esoa_diagnostics_data = {
  "two_phase_flow_form_2_p_w_p_c_hex8_residual_esoa",
  "HEX8",
  3,
  64,
  8,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_2_p_w_p_c_hex8_residual_esoa_diagnostics(void) {
  return &sfem::codegen::two_phase_flow_form_2_p_w_p_c_hex8_residual_esoa_diagnostics_data;
}
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_2_p_w_p_c_hex8_jacobian_p_w_p_w_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_2_p_w_p_c_hex8_jacobian_p_w_p_c_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_2_p_w_p_c_hex8_jacobian_p_c_p_w_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_2_p_w_p_c_hex8_jacobian_p_c_p_c_diagnostics(void) {
...
static const KernelDiagnostics two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_esoa_diagnostics_data = {
  "two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_esoa",
  "HEX8",
  3,
  64,
  8,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_esoa_diagnostics(void) {
  return &sfem::codegen::two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_esoa_diagnostics_data;
}

extern "C" int cu_two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_esoa(
...
__global__ void two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_a_msoa_impl(
...
extern "C" int cu_two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_a_msoa(
    const int scalar_bytes,
    const ptrdiff_t nelements,
...
__global__ void two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_i_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t,
    idx_t **const RSTR elements,
...
extern "C" int cu_two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_i_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        const int block_size = 256;
        const int grid_size = (int)((nelements + block_size - 1) / block_size);
        sfem::codegen::two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_i_msoa_impl<double><<<grid_size, block_size, 0, (cudaStream_t)stream>>>(nelements, nnodes, elements, points, C_kw1, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, P_r, S_res, dt, kappa_T, m, mu_w, p_wr, porosity, rho_w0, current_stride, (const double *)p_w, (const double *)p_c, direction_stride, (const double *)p_w_direction, (const double *)p_c_direction, out_stride, (double *)p_w_out, (double *)p_c_out);
        return sfem::codegen::launch_status("two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_i_msoa_impl");
    }
    case (int)sizeof(float): {
        const int block_size = 256;
        const int grid_size = (int)((nelements + block_size - 1) / block_size);
  ...
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_i_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int cu_two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_i_maos(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return cu_two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_i_msoa(scalar_bytes, nelements, nnodes, elements, points, ((const double *)parameters)[2], ((const double *)parameters)[3], ((const double *)parameters)[4], ((const double *)parameters)[5], ((const double *)parameters)[6], ((const double *)parameters)[7], ((const double *)parameters)[8], ((const double *)parameters)[9], ((const double *)parameters)[10], ((const double *)parameters)[11], ((const double *)parameters)[13], ((const double *)parameters)[15], ((const double *)parameters)[18], ((const double *)parameters)[19], ((const double *)parameters)[20], ((const double *)parameters)[22], ((const double *)parameters)[23], ((const double *)parameters)[24], ((const double *)parameters)[25], 2, (const double *)current + 0, (const double *)current + 1, 2, (const double *)direction + 0, (const double *)direction + 1, 2, (double *)output + 0, (double *)output + 1, stream);
    }
    case (int)sizeof(float): {
  ...
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_2_p_w_p_c_hex8_jacobian_action_i_maos", -1, (int)scalar_bytes);
}
