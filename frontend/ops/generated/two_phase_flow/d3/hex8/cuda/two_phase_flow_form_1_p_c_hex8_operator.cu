...
static const KernelDiagnostics two_phase_flow_form_1_p_c_hex8_residual_esoa_diagnostics_data = {
  "two_phase_flow_form_1_p_c_hex8_residual_esoa",
  "HEX8",
  3,
  64,
  8,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_1_p_c_hex8_residual_esoa_diagnostics(void) {
  return &sfem::codegen::two_phase_flow_form_1_p_c_hex8_residual_esoa_diagnostics_data;
}
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_1_p_c_hex8_jacobian_p_w_p_w_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_1_p_c_hex8_jacobian_p_w_p_c_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_1_p_c_hex8_jacobian_p_c_p_w_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_1_p_c_hex8_jacobian_p_c_p_c_diagnostics(void) {
...
static const KernelDiagnostics two_phase_flow_form_1_p_c_hex8_jacobian_action_esoa_diagnostics_data = {
  "two_phase_flow_form_1_p_c_hex8_jacobian_action_esoa",
  "HEX8",
  3,
  64,
  8,
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_two_phase_flow_form_1_p_c_hex8_jacobian_action_esoa_diagnostics(void) {
  return &sfem::codegen::two_phase_flow_form_1_p_c_hex8_jacobian_action_esoa_diagnostics_data;
}

extern "C" int cu_two_phase_flow_form_1_p_c_hex8_residual_esoa(
...
__global__ void two_phase_flow_form_1_p_c_hex8_residual_a_msoa_impl(
...
extern "C" int cu_two_phase_flow_form_1_p_c_hex8_residual_a_msoa(
    const int scalar_bytes,
    const ptrdiff_t nelements,
  ...
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_1_p_c_hex8_residual_a_msoa", -1, (int)scalar_bytes);
}
...
__global__ void two_phase_flow_form_1_p_c_hex8_residual_i_msoa_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t,
    idx_t **const RSTR elements,
...
extern "C" int cu_two_phase_flow_form_1_p_c_hex8_residual_i_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        const int block_size = 256;
        const int grid_size = (int)((nelements + block_size - 1) / block_size);
        sfem::codegen::two_phase_flow_form_1_p_c_hex8_residual_i_msoa_impl<double><<<grid_size, block_size, 0, (cudaStream_t)stream>>>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, (const double *)p_w, (const double *)p_c, previous_stride, (const double *)p_w_old, (const double *)p_c_old, out_stride, (double *)p_w_out, (double *)p_c_out);
        return sfem::codegen::launch_status("two_phase_flow_form_1_p_c_hex8_residual_i_msoa_impl");
    }
    case (int)sizeof(float): {
        const int block_size = 256;
        const int grid_size = (int)((nelements + block_size - 1) / block_size);
        sfem::codegen::two_phase_flow_form_1_p_c_hex8_residual_i_msoa_impl<float><<<grid_size, block_size, 0, (cudaStream_t)stream>>>(nelements, nnodes, elements, points, C_ka1, C_ka2, K_0, K_1, K_2, K_3, K_4, K_5, K_6, K_7, K_8, M_c, P_r, R, S_res, T, Z, dt, m, mu_c, porosity, current_stride, (const float *)p_w, (const float *)p_c, previous_stride, (const float *)p_w_old, (const float *)p_c_old, out_stride, (float *)p_w_out, (float *)p_c_out);
        return sfem::codegen::launch_status("two_phase_flow_form_1_p_c_hex8_residual_i_msoa_impl");
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_1_p_c_hex8_residual_i_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int cu_two_phase_flow_form_1_p_c_hex8_residual_i_maos(
  ...
  return sfem::codegen::unsupported_dispatch("two_phase_flow_form_1_p_c_hex8_residual_i_maos", -1, (int)scalar_bytes);
}
