...
__host__ __device__ __forceinline__ void two_phase_flow_form_2_p_c_p_w_d3_tensor_product_jacobian_action_block(
    const int ne,
...
template <typename s_t, int NQ, int NS, int VS>
__host__ __device__ __forceinline__ void two_phase_flow_form_2_p_c_p_w_d3_tensor_product_jacobian_action_block_contiguous(
    const int ne,
    const ptrdiff_t geometry_stride,
    const s_t *const RSTR determinant,
    const s_t *const RSTR adjugate[9],
