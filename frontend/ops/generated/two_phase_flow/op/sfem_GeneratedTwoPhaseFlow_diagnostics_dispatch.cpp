...
extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_c_quad4_jacobian_action_esoa_diagnostics(void);
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_c_jacobian_action_2d_esoa_diagnostics(
  ...
  switch (element_type) {
    ...
    case smesh::QUAD4:
      return two_phase_flow_form_1_p_c_quad4_jacobian_action_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_1_p_c_tri3_jacobian_action_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_c_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_c_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_form_1_p_c_proteus_quad4_residual_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_form_1_p_c_quad4_residual_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_1_p_c_tri3_residual_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_c_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_w_jacobian_action_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_form_1_p_w_proteus_quad4_jacobian_action_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_form_1_p_w_quad4_jacobian_action_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_1_p_w_tri3_jacobian_action_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_w_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_w_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_form_1_p_w_proteus_quad4_residual_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_form_1_p_w_quad4_residual_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_1_p_w_tri3_residual_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_1_p_w_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_jacobian_action_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_form_2_p_c_p_c_proteus_quad4_jacobian_action_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_form_2_p_c_p_c_quad4_jacobian_action_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_2_p_c_p_c_tri3_jacobian_action_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_form_2_p_c_p_c_proteus_quad4_residual_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_form_2_p_c_p_c_quad4_residual_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_2_p_c_p_c_tri3_residual_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_c_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_w_jacobian_action_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_form_2_p_c_p_w_proteus_quad4_jacobian_action_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_form_2_p_c_p_w_quad4_jacobian_action_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_2_p_c_p_w_tri3_jacobian_action_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_w_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_w_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_form_2_p_c_p_w_proteus_quad4_residual_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_form_2_p_c_p_w_quad4_residual_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_2_p_c_p_w_tri3_residual_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_c_p_w_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_c_jacobian_action_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_form_2_p_w_p_c_proteus_quad4_jacobian_action_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_form_2_p_w_p_c_quad4_jacobian_action_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_2_p_w_p_c_tri3_jacobian_action_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_c_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_c_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_form_2_p_w_p_c_proteus_quad4_residual_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_form_2_p_w_p_c_quad4_residual_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_2_p_w_p_c_tri3_residual_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_c_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_w_jacobian_action_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_form_2_p_w_p_w_proteus_quad4_jacobian_action_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_form_2_p_w_p_w_quad4_jacobian_action_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_2_p_w_p_w_tri3_jacobian_action_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_w_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_w_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_form_2_p_w_p_w_proteus_quad4_residual_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_form_2_p_w_p_w_quad4_residual_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_form_2_p_w_p_w_tri3_residual_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_form_2_p_w_p_w_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_jacobian_action_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_proteus_quad4_jacobian_action_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_quad4_jacobian_action_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_tri3_jacobian_action_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return two_phase_flow_proteus_quad4_residual_esoa_diagnostics();
    case smesh::QUAD4:
      return two_phase_flow_quad4_residual_esoa_diagnostics();
    case smesh::TRI3:
      return two_phase_flow_tri3_residual_esoa_diagnostics();
    default:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *two_phase_flow_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX8:
