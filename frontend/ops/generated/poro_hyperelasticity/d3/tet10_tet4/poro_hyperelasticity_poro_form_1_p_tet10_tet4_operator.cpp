#include <type_traits>
#include "../poro_hyperelasticity_poro_form_1_p_d3_simplex_mixed_local.hpp"
...
static const KernelDiagnostics poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_diagnostics_data = {
    "poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa",
    "TET10",
    3,
    11,
    10,
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_diagnostics_data;
}
...
extern "C" double poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_diagnostics_data,
...
extern "C" void poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
extern "C" void poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_affine_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_affine_mesh_soa",
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_affine_mesh_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_isoparametric_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_isoparametric_mesh_soa",
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_isoparametric_mesh_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data = {
    "poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa",
    "TET10",
    3,
    11,
    10,
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data;
}
...
extern "C" double poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_affine_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_affine_mesh_soa",
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_affine_mesh_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_isoparametric_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_isoparametric_mesh_soa",
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_isoparametric_mesh_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static SFEM_INLINE int poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_affine_mesh_mixed_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const field_shape[N_FIELDS] = {sfem::codegen::poro_hyperelasticity_poro_form_1_p_affine_reference_data<scalar_t>::tet10_shape(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_affine_reference_data<scalar_t>::tet4_shape()};
    const scalar_t *const field_grad_ref[N_FIELDS * DIM] = {sfem::codegen::poro_hyperelasticity_poro_form_1_p_affine_reference_data<scalar_t>::tet10_grad_ref_x(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_affine_reference_data<scalar_t>::tet10_grad_ref_y(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_affine_reference_data<scalar_t>::tet10_grad_ref_z(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_affine_reference_data<scalar_t>::tet4_grad_ref_x(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_affine_reference_data<scalar_t>::tet4_grad_ref_y(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_affine_reference_data<scalar_t>::tet4_grad_ref_z()};
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            block_current[10][lane] = u_data[1][ev[0 * VECTOR_SIZE + lane] * current_stride];
            block_previous[10][lane] = u_old_data[1][ev[0 * VECTOR_SIZE + lane] * previous_stride];
            block_current[11][lane] = u_data[1][ev[1 * VECTOR_SIZE + lane] * current_stride];
            block_previous[11][lane] = u_old_data[1][ev[1 * VECTOR_SIZE + lane] * previous_stride];
            block_current[12][lane] = u_data[1][ev[2 * VECTOR_SIZE + lane] * current_stride];
            block_previous[12][lane] = u_old_data[1][ev[2 * VECTOR_SIZE + lane] * previous_stride];
            block_current[13][lane] = u_data[1][ev[3 * VECTOR_SIZE + lane] * current_stride];
            block_previous[13][lane] = u_old_data[1][ev[3 * VECTOR_SIZE + lane] * previous_stride];
            block_current[14][lane] = u_data[1][ev[4 * VECTOR_SIZE + lane] * current_stride];
            block_previous[14][lane] = u_old_data[1][ev[4 * VECTOR_SIZE + lane] * previous_stride];
            block_current[15][lane] = u_data[1][ev[5 * VECTOR_SIZE + lane] * current_stride];
            block_previous[15][lane] = u_old_data[1][ev[5 * VECTOR_SIZE + lane] * previous_stride];
            block_current[16][lane] = u_data[1][ev[6 * VECTOR_SIZE + lane] * current_stride];
            block_previous[16][lane] = u_old_data[1][ev[6 * VECTOR_SIZE + lane] * previous_stride];
            block_current[17][lane] = u_data[1][ev[7 * VECTOR_SIZE + lane] * current_stride];
            block_previous[17][lane] = u_old_data[1][ev[7 * VECTOR_SIZE + lane] * previous_stride];
            block_current[18][lane] = u_data[1][ev[8 * VECTOR_SIZE + lane] * current_stride];
            block_previous[18][lane] = u_old_data[1][ev[8 * VECTOR_SIZE + lane] * previous_stride];
            block_current[19][lane] = u_data[1][ev[9 * VECTOR_SIZE + lane] * current_stride];
            block_previous[19][lane] = u_old_data[1][ev[9 * VECTOR_SIZE + lane] * previous_stride];
            block_current[20][lane] = u_data[2][ev[0 * VECTOR_SIZE + lane] * current_stride];
            block_previous[20][lane] = u_old_data[2][ev[0 * VECTOR_SIZE + lane] * previous_stride];
            block_current[21][lane] = u_data[2][ev[1 * VECTOR_SIZE + lane] * current_stride];
            block_previous[21][lane] = u_old_data[2][ev[1 * VECTOR_SIZE + lane] * previous_stride];
            block_current[22][lane] = u_data[2][ev[2 * VECTOR_SIZE + lane] * current_stride];
            block_previous[22][lane] = u_old_data[2][ev[2 * VECTOR_SIZE + lane] * previous_stride];
            block_current[23][lane] = u_data[2][ev[3 * VECTOR_SIZE + lane] * current_stride];
            block_previous[23][lane] = u_old_data[2][ev[3 * VECTOR_SIZE + lane] * previous_stride];
            block_current[24][lane] = u_data[2][ev[4 * VECTOR_SIZE + lane] * current_stride];
            block_previous[24][lane] = u_old_data[2][ev[4 * VECTOR_SIZE + lane] * previous_stride];
            block_current[25][lane] = u_data[2][ev[5 * VECTOR_SIZE + lane] * current_stride];
            block_previous[25][lane] = u_old_data[2][ev[5 * VECTOR_SIZE + lane] * previous_stride];
            block_current[26][lane] = u_data[2][ev[6 * VECTOR_SIZE + lane] * current_stride];
            block_previous[26][lane] = u_old_data[2][ev[6 * VECTOR_SIZE + lane] * previous_stride];
            block_current[27][lane] = u_data[2][ev[7 * VECTOR_SIZE + lane] * current_stride];
            block_previous[27][lane] = u_old_data[2][ev[7 * VECTOR_SIZE + lane] * previous_stride];
            block_current[28][lane] = u_data[2][ev[8 * VECTOR_SIZE + lane] * current_stride];
            block_previous[28][lane] = u_old_data[2][ev[8 * VECTOR_SIZE + lane] * previous_stride];
            block_current[29][lane] = u_data[2][ev[9 * VECTOR_SIZE + lane] * current_stride];
            block_previous[29][lane] = u_old_data[2][ev[9 * VECTOR_SIZE + lane] * previous_stride];
            block_current[30][lane] = p_data[ev[0 * VECTOR_SIZE + lane] * current_stride];
            block_previous[30][lane] = p_old_data[ev[0 * VECTOR_SIZE + lane] * previous_stride];
            block_current[31][lane] = p_data[ev[1 * VECTOR_SIZE + lane] * current_stride];
            block_previous[31][lane] = p_old_data[ev[1 * VECTOR_SIZE + lane] * previous_stride];
            block_current[32][lane] = p_data[ev[2 * VECTOR_SIZE + lane] * current_stride];
            block_previous[32][lane] = p_old_data[ev[2 * VECTOR_SIZE + lane] * previous_stride];
            block_current[33][lane] = p_data[ev[3 * VECTOR_SIZE + lane] * current_stride];
            block_previous[33][lane] = p_old_data[ev[3 * VECTOR_SIZE + lane] * previous_stride];
        }
        ...
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[1][ev[0 * VECTOR_SIZE + scatter] * out_stride] += block_output[10][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[1][ev[1 * VECTOR_SIZE + scatter] * out_stride] += block_output[11][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[1][ev[2 * VECTOR_SIZE + scatter] * out_stride] += block_output[12][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[1][ev[3 * VECTOR_SIZE + scatter] * out_stride] += block_output[13][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[1][ev[4 * VECTOR_SIZE + scatter] * out_stride] += block_output[14][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[1][ev[5 * VECTOR_SIZE + scatter] * out_stride] += block_output[15][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[1][ev[6 * VECTOR_SIZE + scatter] * out_stride] += block_output[16][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[1][ev[7 * VECTOR_SIZE + scatter] * out_stride] += block_output[17][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[1][ev[8 * VECTOR_SIZE + scatter] * out_stride] += block_output[18][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[1][ev[9 * VECTOR_SIZE + scatter] * out_stride] += block_output[19][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[2][ev[0 * VECTOR_SIZE + scatter] * out_stride] += block_output[20][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[2][ev[1 * VECTOR_SIZE + scatter] * out_stride] += block_output[21][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[2][ev[2 * VECTOR_SIZE + scatter] * out_stride] += block_output[22][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[2][ev[3 * VECTOR_SIZE + scatter] * out_stride] += block_output[23][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[2][ev[4 * VECTOR_SIZE + scatter] * out_stride] += block_output[24][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[2][ev[5 * VECTOR_SIZE + scatter] * out_stride] += block_output[25][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[2][ev[6 * VECTOR_SIZE + scatter] * out_stride] += block_output[26][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[2][ev[7 * VECTOR_SIZE + scatter] * out_stride] += block_output[27][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[2][ev[8 * VECTOR_SIZE + scatter] * out_stride] += block_output[28][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                u_out[2][ev[9 * VECTOR_SIZE + scatter] * out_stride] += block_output[29][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                p_out[ev[0 * VECTOR_SIZE + scatter] * out_stride] += block_output[30][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                p_out[ev[1 * VECTOR_SIZE + scatter] * out_stride] += block_output[31][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                p_out[ev[2 * VECTOR_SIZE + scatter] * out_stride] += block_output[32][scatter];
            }
        }
        {
            for (int scatter = 0; scatter < nelems; ++scatter) {
                #pragma omp atomic update
                p_out[ev[3 * VECTOR_SIZE + scatter] * out_stride] += block_output[33][scatter];
            }
        }
    }
    return SFEM_SUCCESS;
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_isoparametric_mesh_mixed_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_cell_grad_ref_0 = sfem::codegen::poro_hyperelasticity_poro_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_x();
    const scalar_t *const isoparametric_cell_grad_ref_1 = sfem::codegen::poro_hyperelasticity_poro_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_y();
    const scalar_t *const isoparametric_cell_grad_ref_2 = sfem::codegen::poro_hyperelasticity_poro_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_z();
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        const int nelems = (int)MIN((ptrdiff_t)VECTOR_SIZE, nelements - evbegin);
        idx_t ev[VECTOR_SIZE * CELL_N_SHAPE];
        ...
        const scalar_t *const field_shape[N_FIELDS] = {sfem::codegen::poro_hyperelasticity_poro_form_1_p_isoparametric_reference_data<scalar_t>::tet10_shape(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_isoparametric_reference_data<scalar_t>::tet4_shape()};
        const scalar_t *const field_grad_ref[N_FIELDS * DIM] = {sfem::codegen::poro_hyperelasticity_poro_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_x(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_y(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_z(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_isoparametric_reference_data<scalar_t>::tet4_grad_ref_x(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_isoparametric_reference_data<scalar_t>::tet4_grad_ref_y(), sfem::codegen::poro_hyperelasticity_poro_form_1_p_isoparametric_reference_data<scalar_t>::tet4_grad_ref_z()};
...
extern "C" int poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_isoparametric_mesh_mixed_impl<double>(nelements, nnodes, elements, points, alpha, dt, hydraulic_conductivity, storage, current_stride, u_data, p_data, previous_stride, u_old_data, p_old_data, out_stride, u_out, p_out);
}
...
extern "C" int poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_poro_form_1_p_tet10_tet4_residual_isoparametric_mesh_mixed_impl<float>(nelements, nnodes, elements, points, alpha, dt, hydraulic_conductivity, storage, current_stride, u_data, p_data, previous_stride, u_old_data, p_old_data, out_stride, u_out, p_out);
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_affine_mesh_mixed_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_determinant0,
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_poro_form_1_p_tet10_tet4_jacobian_action_isoparametric_mesh_mixed_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
