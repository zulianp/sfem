...
static const KernelDiagnostics poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_element_soa_diagnostics_data = {
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_element_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_element_soa_diagnostics_data;
}
...
static const KernelDiagnostics poro_hyperelasticity_poro_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics_data = {
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_poro_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_poro_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics_data;
}
...
static SFEM_INLINE int poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_affine_mesh_mixed_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const field_shape[N_FIELDS] = {sfem::codegen::poro_hyperelasticity_poro_form_1_u_affine_reference_data<scalar_t>::tet10_shape(), sfem::codegen::poro_hyperelasticity_poro_form_1_u_affine_reference_data<scalar_t>::tet4_shape()};
    const scalar_t *const field_grad_ref[N_FIELDS * DIM] = {sfem::codegen::poro_hyperelasticity_poro_form_1_u_affine_reference_data<scalar_t>::tet10_grad_ref_x(), sfem::codegen::poro_hyperelasticity_poro_form_1_u_affine_reference_data<scalar_t>::tet10_grad_ref_y(), sfem::codegen::poro_hyperelasticity_poro_form_1_u_affine_reference_data<scalar_t>::tet10_grad_ref_z(), sfem::codegen::poro_hyperelasticity_poro_form_1_u_affine_reference_data<scalar_t>::tet4_grad_ref_x(), sfem::codegen::poro_hyperelasticity_poro_form_1_u_affine_reference_data<scalar_t>::tet4_grad_ref_y(), sfem::codegen::poro_hyperelasticity_poro_form_1_u_affine_reference_data<scalar_t>::tet4_grad_ref_z()};
...
extern "C" int poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_affine_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_affine_mesh_mixed_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, alpha, current_stride, u_data, p_data, out_stride, u_out, p_out);
}
...
extern "C" int poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_affine_mesh_mixed_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, alpha, current_stride, u_data, p_data, out_stride, u_out, p_out);
}
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_isoparametric_mesh_mixed_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_cell_grad_ref_0 = sfem::codegen::poro_hyperelasticity_poro_form_1_u_isoparametric_reference_data<scalar_t>::tet10_grad_ref_x();
    const scalar_t *const isoparametric_cell_grad_ref_1 = sfem::codegen::poro_hyperelasticity_poro_form_1_u_isoparametric_reference_data<scalar_t>::tet10_grad_ref_y();
    const scalar_t *const isoparametric_cell_grad_ref_2 = sfem::codegen::poro_hyperelasticity_poro_form_1_u_isoparametric_reference_data<scalar_t>::tet10_grad_ref_z();
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        const int nelems = (int)MIN((ptrdiff_t)VECTOR_SIZE, nelements - evbegin);
        idx_t ev[VECTOR_SIZE * CELL_N_SHAPE];
...
extern "C" int poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_isoparametric_mesh_mixed_impl<double>(nelements, nnodes, elements, points, alpha, current_stride, u_data, p_data, out_stride, u_out, p_out);
}
...
extern "C" int poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_isoparametric_mesh_mixed_impl<float>(nelements, nnodes, elements, points, alpha, current_stride, u_data, p_data, out_stride, u_out, p_out);
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int poro_hyperelasticity_poro_form_1_u_tet10_tet4_jacobian_action_affine_mesh_mixed_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_determinant0,
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_poro_form_1_u_tet10_tet4_jacobian_action_isoparametric_mesh_mixed_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
