...
extern "C" int poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_affine_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_affine_mesh_mixed_impl<double>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, alpha, current_stride, u_data, p_data, out_stride, u_out, p_out);
}
...
extern "C" int poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_poro_form_1_u_tet10_tet4_residual_affine_mesh_mixed_impl<float>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, alpha, current_stride, u_data, p_data, out_stride, u_out, p_out);
}
