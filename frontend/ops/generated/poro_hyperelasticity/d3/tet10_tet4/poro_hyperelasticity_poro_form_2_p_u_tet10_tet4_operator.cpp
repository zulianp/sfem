...
#pragma omp atomic update
            u_out[1][ev[lane * CELL_N_SHAPE + 0] * out_stride] += block_output[10][lane];
#pragma omp atomic update
            u_out[1][ev[lane * CELL_N_SHAPE + 1] * out_stride] += block_output[11][lane];
#pragma omp atomic update
            u_out[1][ev[lane * CELL_N_SHAPE + 2] * out_stride] += block_output[12][lane];
#pragma omp atomic update
            u_out[1][ev[lane * CELL_N_SHAPE + 3] * out_stride] += block_output[13][lane];
#pragma omp atomic update
            u_out[1][ev[lane * CELL_N_SHAPE + 4] * out_stride] += block_output[14][lane];
#pragma omp atomic update
            u_out[1][ev[lane * CELL_N_SHAPE + 5] * out_stride] += block_output[15][lane];
#pragma omp atomic update
            u_out[1][ev[lane * CELL_N_SHAPE + 6] * out_stride] += block_output[16][lane];
#pragma omp atomic update
            u_out[1][ev[lane * CELL_N_SHAPE + 7] * out_stride] += block_output[17][lane];
#pragma omp atomic update
            u_out[1][ev[lane * CELL_N_SHAPE + 8] * out_stride] += block_output[18][lane];
#pragma omp atomic update
            u_out[1][ev[lane * CELL_N_SHAPE + 9] * out_stride] += block_output[19][lane];
#pragma omp atomic update
            u_out[2][ev[lane * CELL_N_SHAPE + 0] * out_stride] += block_output[20][lane];
#pragma omp atomic update
            u_out[2][ev[lane * CELL_N_SHAPE + 1] * out_stride] += block_output[21][lane];
#pragma omp atomic update
            u_out[2][ev[lane * CELL_N_SHAPE + 2] * out_stride] += block_output[22][lane];
#pragma omp atomic update
            u_out[2][ev[lane * CELL_N_SHAPE + 3] * out_stride] += block_output[23][lane];
#pragma omp atomic update
            u_out[2][ev[lane * CELL_N_SHAPE + 4] * out_stride] += block_output[24][lane];
#pragma omp atomic update
            u_out[2][ev[lane * CELL_N_SHAPE + 5] * out_stride] += block_output[25][lane];
#pragma omp atomic update
            u_out[2][ev[lane * CELL_N_SHAPE + 6] * out_stride] += block_output[26][lane];
#pragma omp atomic update
            u_out[2][ev[lane * CELL_N_SHAPE + 7] * out_stride] += block_output[27][lane];
#pragma omp atomic update
            u_out[2][ev[lane * CELL_N_SHAPE + 8] * out_stride] += block_output[28][lane];
#pragma omp atomic update
            u_out[2][ev[lane * CELL_N_SHAPE + 9] * out_stride] += block_output[29][lane];
#pragma omp atomic update
            p_out[ev[lane * CELL_N_SHAPE + 0] * out_stride] += block_output[30][lane];
#pragma omp atomic update
            p_out[ev[lane * CELL_N_SHAPE + 1] * out_stride] += block_output[31][lane];
#pragma omp atomic update
            p_out[ev[lane * CELL_N_SHAPE + 2] * out_stride] += block_output[32][lane];
#pragma omp atomic update
            p_out[ev[lane * CELL_N_SHAPE + 3] * out_stride] += block_output[33][lane];
        }
    }
    return SFEM_SUCCESS;
}
