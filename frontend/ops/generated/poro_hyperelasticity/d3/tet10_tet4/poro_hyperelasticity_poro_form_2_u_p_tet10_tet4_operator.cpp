...
static const KernelDiagnostics poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_diagnostics_data = {
    "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa",
    "TET10",
    3,
    11,
    10,
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_diagnostics_data;
}
...
extern "C" double poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_diagnostics_data,
...
extern "C" void poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
extern "C" void poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_affine_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_affine_mesh_soa",
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_affine_mesh_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_isoparametric_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_isoparametric_mesh_soa",
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_isoparametric_mesh_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data = {
    "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa",
    "TET10",
    3,
    11,
    10,
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data;
}
...
extern "C" double poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_affine_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_affine_mesh_soa",
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_affine_mesh_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_isoparametric_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_isoparametric_mesh_soa",
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_isoparametric_mesh_soa_float",
            &sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_residual_isoparametric_mesh_mixed_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
...
static SFEM_INLINE int poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_affine_mesh_mixed_impl(
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const field_shape[N_FIELDS] = {sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_affine_reference_data<scalar_t>::tet10_shape(), sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_affine_reference_data<scalar_t>::tet4_shape()};
    const scalar_t *const field_grad_ref[N_FIELDS * DIM] = {sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_affine_reference_data<scalar_t>::tet10_grad_ref_x(), sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_affine_reference_data<scalar_t>::tet10_grad_ref_y(), sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_affine_reference_data<scalar_t>::tet10_grad_ref_z(), sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_affine_reference_data<scalar_t>::tet4_grad_ref_x(), sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_affine_reference_data<scalar_t>::tet4_grad_ref_y(), sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_affine_reference_data<scalar_t>::tet4_grad_ref_z()};
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_isoparametric_mesh_mixed_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
extern "C" int poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_poro_form_2_u_p_tet10_tet4_jacobian_action_isoparametric_mesh_mixed_impl<double>(nelements, nnodes, elements, points, alpha, direction_stride, u_direction_data, p_direction_data, out_stride, u_out, p_out);
}
