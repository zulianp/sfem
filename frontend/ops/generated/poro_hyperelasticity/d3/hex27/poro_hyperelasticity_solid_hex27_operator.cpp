#include <cstdio>
#include <type_traits>
#include "../poro_hyperelasticity_solid_d3_tensor_product_local.hpp"
...
struct poro_hyperelasticity_solid_hex27_affine_reference_data {
...
template <typename scalar_t>
struct poro_hyperelasticity_solid_hex27_isoparametric_reference_data {
    static const scalar_t *shape_1d() {
...
static const KernelDiagnostics poro_hyperelasticity_solid_hex27_hex27_objective_soa_diagnostics_data = {
    "poro_hyperelasticity_solid_hex27_hex27_objective_soa",
    "HEX27",
    3,
    64,
    27,
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_solid_hex27_hex27_objective_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_objective_soa_diagnostics_data;
}
...
extern "C" double poro_hyperelasticity_solid_hex27_hex27_objective_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_objective_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void poro_hyperelasticity_solid_hex27_hex27_objective_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "poro_hyperelasticity_solid_hex27_hex27_objective_soa_float",
            &sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_objective_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const affine_shape_1d = sfem::codegen::poro_hyperelasticity_solid_hex27_affine_reference_data<scalar_t>::shape_1d();
    const scalar_t *const affine_grad_1d = sfem::codegen::poro_hyperelasticity_solid_hex27_affine_reference_data<scalar_t>::grad_1d();
    const scalar_t *const affine_q_weight_1d = sfem::codegen::poro_hyperelasticity_solid_hex27_affine_reference_data<scalar_t>::q_weight_1d();
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_objective_affine_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_objective_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, value);
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_objective_steps_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_objective_steps_affine_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_objective_steps_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_objective_steps_affine_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_objective_steps_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_objective_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    const scalar_t *const isoparametric_shape_1d = sfem::codegen::poro_hyperelasticity_solid_hex27_isoparametric_reference_data<scalar_t>::shape_1d();
    const scalar_t *const isoparametric_grad_1d = sfem::codegen::poro_hyperelasticity_solid_hex27_isoparametric_reference_data<scalar_t>::grad_1d();
    const scalar_t *const isoparametric_q_weight_1d = sfem::codegen::poro_hyperelasticity_solid_hex27_isoparametric_reference_data<scalar_t>::q_weight_1d();
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_objective_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_objective_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, value);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_objective_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_objective_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, value);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_objective_steps_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_objective_steps_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_objective_steps_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_objective_steps_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_objective_steps_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
static const KernelDiagnostics poro_hyperelasticity_solid_hex27_hex27_gradient_soa_diagnostics_data = {
    "poro_hyperelasticity_solid_hex27_hex27_gradient_soa",
    "HEX27",
    3,
    64,
    27,
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_solid_hex27_hex27_gradient_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_gradient_soa_diagnostics_data;
}
...
extern "C" double poro_hyperelasticity_solid_hex27_hex27_gradient_soa_arithmetic_intensity(
        ...
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_gradient_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void poro_hyperelasticity_solid_hex27_hex27_gradient_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "poro_hyperelasticity_solid_hex27_hex27_gradient_soa_float",
            &sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_gradient_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        poro_hyperelasticity_solid_d3_tensor_product_gradient_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, affine_shape_1d, affine_grad_1d, affine_q_weight_1d, mu, lmbda, block_u_streams, block_out_streams);
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_gradient_affine_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_gradient_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_gradient_affine_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_gradient_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_gradient_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_gradient_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_gradient_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_gradient_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_gradient_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
static const KernelDiagnostics poro_hyperelasticity_solid_hex27_hex27_apply_soa_diagnostics_data = {
    "poro_hyperelasticity_solid_hex27_hex27_apply_soa",
    "HEX27",
    3,
    64,
    27,
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_solid_hex27_hex27_apply_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_apply_soa_diagnostics_data;
}
...
extern "C" double poro_hyperelasticity_solid_hex27_hex27_apply_soa_arithmetic_intensity(
        ...
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_apply_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void poro_hyperelasticity_solid_hex27_hex27_apply_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "poro_hyperelasticity_solid_hex27_hex27_apply_soa_float",
            &sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_apply_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        poro_hyperelasticity_solid_d3_tensor_product_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, 0, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_adjugate4, block_jacobian_adjugate5, block_jacobian_adjugate6, block_jacobian_adjugate7, block_jacobian_adjugate8, block_jacobian_determinant0, affine_shape_1d, affine_grad_1d, affine_q_weight_1d, mu, lmbda, block_u_streams, block_h_streams, block_out_streams);
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_apply_affine_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_apply_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_apply_affine_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_apply_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_apply_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_apply_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_apply_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_apply_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_apply_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
template <typename scalar_t>
static SFEM_INLINE count_t poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_find_col(
        const idx_t node_i,
        const idx_t node_j,
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_bsr(
    ...
    for (int i = 0; i < N_SHAPE; ++i) {
        ...
        for (int j = 0; j < N_SHAPE; ++j) {
            const count_t entry = poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_find_col<scalar_t>(ev[i], ev[j], rowptr, colidx);
            if (entry == row_end) {
                if (valid_block_graph) {
                    std::fprintf(stderr, "poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_bsr missing block graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_crs(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
        const count_t *const SFEM_RESTRICT rowptr,
        const idx_t *const SFEM_RESTRICT colidx,
    ...
    for (int i = 0; i < N_SHAPE; ++i) {
        ...
        const count_t row_end = rowptr[ev[i] + 1];
        lenrow[i] = (int)(row_end - row_begin[i]);
        for (int j = 0; j < N_SHAPE; ++j) {
            const count_t entry = poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_find_col<scalar_t>(ev[i], ev[j], rowptr, colidx);
            if (entry == row_end) {
                if (valid_graph) {
                    std::fprintf(stderr, "poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_crs missing graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
                local_col[i * N_SHAPE + j] = 0;
                valid_graph = false;
            } else {
                local_col[i * N_SHAPE + j] = (int)(entry - row_begin[i]);
            }
        }
    }
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_dia(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
        const ptrdiff_t nnodes,
        ...
        for (int j = 0; j < N_SHAPE; ++j) {
            ...
            if (diagonal == ndiag) {
                if (valid_diagonal_offsets) {
                    std::fprintf(stderr, "poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_dia missing diagonal offset %d\n", offset);
                }
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_coo(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
        const ptrdiff_t nnz,
        ...
        for (int j = 0; j < N_SHAPE; ++j) {
            ...
            if (lo == nnz || rows[lo] != ev[i] || cols[lo] != ev[j]) {
                if (valid_coo_entries) {
                    std::fprintf(stderr, "poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_coo missing graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
...
template <typename scalar_t>
static SFEM_INLINE void poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_coo_triplets(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_patch(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
    ...
    static constexpr int DIM = 3;
    static constexpr int N_SHAPE = 27;
    idx_t patch_nodes[N_SHAPE];
    int active_shapes[N_SHAPE];
    int nactive = 0;
    bool valid_patch_ids = true;
    for (int shape = 0; shape < N_SHAPE; ++shape) {
        const idx_t patch = node_to_patch[ev[shape]];
        patch_nodes[shape] = patch;
        if (patch >= npatch) {
            if (valid_patch_ids) {
                std::fprintf(stderr, "poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_patch patch id %ld outside patch count %td\n", (long)patch, npatch);
            }
            valid_patch_ids = false;
        } else if (patch >= 0) {
            active_shapes[nactive++] = shape;
        }
    }
    if (!valid_patch_ids) return SFEM_FAILURE;
    for (int ai = 0; ai < nactive; ++ai) {
        const int i = active_shapes[ai];
        const idx_t pi = patch_nodes[i];
        for (int aj = 0; aj < nactive; ++aj) {
            const int j = active_shapes[aj];
            const idx_t pj = patch_nodes[j];
...
static int poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static) reduction(|:invalid_matrix_graph)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        const scalar_t *const block_coordinate_streams[N_SHAPE * DIM] = {block_coordinate_data[0], block_coordinate_data[1], block_coordinate_data[2], block_coordinate_data[24], block_coordinate_data[25], block_coordinate_data[26], block_coordinate_data[3], block_coordinate_data[4], block_coordinate_data[5], block_coordinate_data[33], block_coordinate_data[34], block_coordinate_data[35], block_coordinate_data[72], block_coordinate_data[73], block_coordinate_data[74], block_coordinate_data[27], block_coordinate_data[28], block_coordinate_data[29], block_coordinate_data[9], block_coordinate_data[10], block_coordinate_data[11], block_coordinate_data[30], block_coordinate_data[31], block_coordinate_data[32], block_coordinate_data[6], block_coordinate_data[7], block_coordinate_data[8], block_coordinate_data[48], block_coordinate_data[49], block_coordinate_data[50], block_coordinate_data[60], block_coordinate_data[61], block_coordinate_data[62], block_coordinate_data[51], block_coordinate_data[52], block_coordinate_data[53], block_coordinate_data[69], block_coordinate_data[70], block_coordinate_data[71], block_coordinate_data[78], block_coordinate_data[79], block_coordinate_data[80], block_coordinate_data[63], block_coordinate_data[64], block_coordinate_data[65], block_coordinate_data[57], block_coordinate_data[58], block_coordinate_data[59], block_coordinate_data[66], block_coordinate_data[67], block_coordinate_data[68], block_coordinate_data[54], block_coordinate_data[55], block_coordinate_data[56], block_coordinate_data[12], block_coordinate_data[13], block_coordinate_data[14], block_coordinate_data[36], block_coordinate_data[37], block_coordinate_data[38], block_coordinate_data[15], block_coordinate_data[16], block_coordinate_data[17], block_coordinate_data[45], block_coordinate_data[46], block_coordinate_data[47], block_coordinate_data[75], block_coordinate_data[76], block_coordinate_data[77], block_coordinate_data[39], block_coordinate_data[40], block_coordinate_data[41], block_coordinate_data[21], block_coordinate_data[22], block_coordinate_data[23], block_coordinate_data[42], block_coordinate_data[43], block_coordinate_data[44], block_coordinate_data[18], block_coordinate_data[19], block_coordinate_data[20]};
        const scalar_t *const block_u_streams[N_SHAPE * DIM] = {block_u_data[0], block_u_data[1], block_u_data[2], block_u_data[24], block_u_data[25], block_u_data[26], block_u_data[3], block_u_data[4], block_u_data[5], block_u_data[33], block_u_data[34], block_u_data[35], block_u_data[72], block_u_data[73], block_u_data[74], block_u_data[27], block_u_data[28], block_u_data[29], block_u_data[9], block_u_data[10], block_u_data[11], block_u_data[30], block_u_data[31], block_u_data[32], block_u_data[6], block_u_data[7], block_u_data[8], block_u_data[48], block_u_data[49], block_u_data[50], block_u_data[60], block_u_data[61], block_u_data[62], block_u_data[51], block_u_data[52], block_u_data[53], block_u_data[69], block_u_data[70], block_u_data[71], block_u_data[78], block_u_data[79], block_u_data[80], block_u_data[63], block_u_data[64], block_u_data[65], block_u_data[57], block_u_data[58], block_u_data[59], block_u_data[66], block_u_data[67], block_u_data[68], block_u_data[54], block_u_data[55], block_u_data[56], block_u_data[12], block_u_data[13], block_u_data[14], block_u_data[36], block_u_data[37], block_u_data[38], block_u_data[15], block_u_data[16], block_u_data[17], block_u_data[45], block_u_data[46], block_u_data[47], block_u_data[75], block_u_data[76], block_u_data[77], block_u_data[39], block_u_data[40], block_u_data[41], block_u_data[21], block_u_data[22], block_u_data[23], block_u_data[42], block_u_data[43], block_u_data[44], block_u_data[18], block_u_data[19], block_u_data[20]};
        const scalar_t *const block_h_streams[N_SHAPE * DIM] = {block_h_data[0], block_h_data[1], block_h_data[2], block_h_data[24], block_h_data[25], block_h_data[26], block_h_data[3], block_h_data[4], block_h_data[5], block_h_data[33], block_h_data[34], block_h_data[35], block_h_data[72], block_h_data[73], block_h_data[74], block_h_data[27], block_h_data[28], block_h_data[29], block_h_data[9], block_h_data[10], block_h_data[11], block_h_data[30], block_h_data[31], block_h_data[32], block_h_data[6], block_h_data[7], block_h_data[8], block_h_data[48], block_h_data[49], block_h_data[50], block_h_data[60], block_h_data[61], block_h_data[62], block_h_data[51], block_h_data[52], block_h_data[53], block_h_data[69], block_h_data[70], block_h_data[71], block_h_data[78], block_h_data[79], block_h_data[80], block_h_data[63], block_h_data[64], block_h_data[65], block_h_data[57], block_h_data[58], block_h_data[59], block_h_data[66], block_h_data[67], block_h_data[68], block_h_data[54], block_h_data[55], block_h_data[56], block_h_data[12], block_h_data[13], block_h_data[14], block_h_data[36], block_h_data[37], block_h_data[38], block_h_data[15], block_h_data[16], block_h_data[17], block_h_data[45], block_h_data[46], block_h_data[47], block_h_data[75], block_h_data[76], block_h_data[77], block_h_data[39], block_h_data[40], block_h_data[41], block_h_data[21], block_h_data[22], block_h_data[23], block_h_data[42], block_h_data[43], block_h_data[44], block_h_data[18], block_h_data[19], block_h_data[20]};
        scalar_t *const block_out_streams[N_SHAPE * DIM] = {block_out_data[0], block_out_data[1], block_out_data[2], block_out_data[24], block_out_data[25], block_out_data[26], block_out_data[3], block_out_data[4], block_out_data[5], block_out_data[33], block_out_data[34], block_out_data[35], block_out_data[72], block_out_data[73], block_out_data[74], block_out_data[27], block_out_data[28], block_out_data[29], block_out_data[9], block_out_data[10], block_out_data[11], block_out_data[30], block_out_data[31], block_out_data[32], block_out_data[6], block_out_data[7], block_out_data[8], block_out_data[48], block_out_data[49], block_out_data[50], block_out_data[60], block_out_data[61], block_out_data[62], block_out_data[51], block_out_data[52], block_out_data[53], block_out_data[69], block_out_data[70], block_out_data[71], block_out_data[78], block_out_data[79], block_out_data[80], block_out_data[63], block_out_data[64], block_out_data[65], block_out_data[57], block_out_data[58], block_out_data[59], block_out_data[66], block_out_data[67], block_out_data[68], block_out_data[54], block_out_data[55], block_out_data[56], block_out_data[12], block_out_data[13], block_out_data[14], block_out_data[36], block_out_data[37], block_out_data[38], block_out_data[15], block_out_data[16], block_out_data[17], block_out_data[45], block_out_data[46], block_out_data[47], block_out_data[75], block_out_data[76], block_out_data[77], block_out_data[39], block_out_data[40], block_out_data[41], block_out_data[21], block_out_data[22], block_out_data[23], block_out_data[42], block_out_data[43], block_out_data[44], block_out_data[18], block_out_data[19], block_out_data[20]};
        ...
        if constexpr (FORMAT == 1) {
            invalid_matrix_graph |= (poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_bsr(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 0) {
            invalid_matrix_graph |= (poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_crs(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 2) {
            invalid_matrix_graph |= (poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_dia(ev, element_matrix, nnodes, diag_offsets, ndiag, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 3) {
            invalid_matrix_graph |= (poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_coo(ev, element_matrix, coo_nnz, coo_rows, coo_cols, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 5) {
            poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_coo_triplets(ev, element_matrix, element, coo_triplet_rows, coo_triplet_cols, values);
        } else {
            invalid_matrix_graph |= (poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_patch(ev, element_matrix, node_to_patch, npatch, values) != SFEM_SUCCESS);
        }
    }
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_crs_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 0>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_crs_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 0>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_bsr_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 1>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_bsr_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 1>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_dia_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 2>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, diag_offsets, ndiag, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_dia_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 2>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, diag_offsets, ndiag, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_coo_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 3>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, nullptr, 0, nnz, rows, cols, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_coo_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 3>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, nullptr, 0, nnz, rows, cols, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_coo_triplet_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 5>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, nullptr, 0, 0, nullptr, nullptr, rows, cols, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_coo_triplet_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 5>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, nullptr, 0, 0, nullptr, nullptr, rows, cols, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_patch_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 4>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, node_to_patch, npatch);
}
...
extern "C" int poro_hyperelasticity_solid_hex27_hex27_hessian_patch_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 4>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, node_to_patch, npatch);
}
