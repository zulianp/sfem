#ifndef PORO_HYPERELASTICITY_PORO_FORM_1_P_D3_SIMPLEX_MIXED_LOCAL_HPP
#define PORO_HYPERELASTICITY_PORO_FORM_1_P_D3_SIMPLEX_MIXED_LOCAL_HPP
...
static SFEM_INLINE void poro_hyperelasticity_poro_form_1_p_d3_simplex_mixed_residual_block(
        const int nelems,
    ...
    for (int q = 0; q < N_QP; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            scalar_t u0_old_grad_2_ref = scalar_t(0);
            ...
            u0_old_grad_2_ref += coeff_previous_u0_0 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 0];
            ...
            u0_old_grad_2_ref += coeff_previous_u0_1 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 1];
            ...
            u0_old_grad_2_ref += coeff_previous_u0_2 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 2];
            ...
            u0_old_grad_2_ref += coeff_previous_u0_3 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 3];
            ...
            u0_old_grad_2_ref += coeff_previous_u0_4 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 4];
            ...
            u0_old_grad_2_ref += coeff_previous_u0_5 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 5];
            const scalar_t coeff_previous_u0_6 = previous[6][lane];
            u0_old += coeff_previous_u0_6 * field_shape[0][q * U_N_SHAPE + 6];
            u0_old_grad_0_ref += coeff_previous_u0_6 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 6];
            u0_old_grad_1_ref += coeff_previous_u0_6 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 6];
            u0_old_grad_2_ref += coeff_previous_u0_6 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 6];
            const scalar_t coeff_previous_u0_7 = previous[7][lane];
            u0_old += coeff_previous_u0_7 * field_shape[0][q * U_N_SHAPE + 7];
            u0_old_grad_0_ref += coeff_previous_u0_7 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 7];
            u0_old_grad_1_ref += coeff_previous_u0_7 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 7];
            u0_old_grad_2_ref += coeff_previous_u0_7 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 7];
            const scalar_t coeff_previous_u0_8 = previous[8][lane];
            u0_old += coeff_previous_u0_8 * field_shape[0][q * U_N_SHAPE + 8];
            u0_old_grad_0_ref += coeff_previous_u0_8 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 8];
            u0_old_grad_1_ref += coeff_previous_u0_8 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 8];
            u0_old_grad_2_ref += coeff_previous_u0_8 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 8];
            const scalar_t coeff_previous_u0_9 = previous[9][lane];
            u0_old += coeff_previous_u0_9 * field_shape[0][q * U_N_SHAPE + 9];
            u0_old_grad_0_ref += coeff_previous_u0_9 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 9];
            u0_old_grad_1_ref += coeff_previous_u0_9 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 9];
            u0_old_grad_2_ref += coeff_previous_u0_9 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 9];
            ...
            scalar_t u1_old_grad_2_ref = scalar_t(0);
            ...
            u1_old_grad_2_ref += coeff_previous_u1_0 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 0];
            ...
            u1_old_grad_2_ref += coeff_previous_u1_1 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 1];
            ...
            u1_old_grad_2_ref += coeff_previous_u1_2 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 2];
            ...
            u1_old_grad_2_ref += coeff_previous_u1_3 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 3];
            ...
            u1_old_grad_2_ref += coeff_previous_u1_4 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 4];
            ...
            u1_old_grad_2_ref += coeff_previous_u1_5 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 5];
            const scalar_t coeff_previous_u1_6 = previous[16][lane];
            u1_old += coeff_previous_u1_6 * field_shape[0][q * U_N_SHAPE + 6];
            u1_old_grad_0_ref += coeff_previous_u1_6 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 6];
            u1_old_grad_1_ref += coeff_previous_u1_6 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 6];
            u1_old_grad_2_ref += coeff_previous_u1_6 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 6];
            const scalar_t coeff_previous_u1_7 = previous[17][lane];
            u1_old += coeff_previous_u1_7 * field_shape[0][q * U_N_SHAPE + 7];
            u1_old_grad_0_ref += coeff_previous_u1_7 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 7];
            u1_old_grad_1_ref += coeff_previous_u1_7 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 7];
            u1_old_grad_2_ref += coeff_previous_u1_7 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 7];
            const scalar_t coeff_previous_u1_8 = previous[18][lane];
            u1_old += coeff_previous_u1_8 * field_shape[0][q * U_N_SHAPE + 8];
            u1_old_grad_0_ref += coeff_previous_u1_8 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 8];
            u1_old_grad_1_ref += coeff_previous_u1_8 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 8];
            u1_old_grad_2_ref += coeff_previous_u1_8 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 8];
            const scalar_t coeff_previous_u1_9 = previous[19][lane];
            u1_old += coeff_previous_u1_9 * field_shape[0][q * U_N_SHAPE + 9];
            u1_old_grad_0_ref += coeff_previous_u1_9 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 9];
            u1_old_grad_1_ref += coeff_previous_u1_9 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 9];
            u1_old_grad_2_ref += coeff_previous_u1_9 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 9];
            ...
            scalar_t u2_old_grad_0_ref = scalar_t(0);
            scalar_t u2_old_grad_1_ref = scalar_t(0);
            scalar_t u2_old_grad_2_ref = scalar_t(0);
            const scalar_t coeff_previous_u2_0 = previous[20][lane];
            u2_old += coeff_previous_u2_0 * field_shape[0][q * U_N_SHAPE + 0];
            u2_old_grad_0_ref += coeff_previous_u2_0 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 0];
            u2_old_grad_1_ref += coeff_previous_u2_0 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 0];
            u2_old_grad_2_ref += coeff_previous_u2_0 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 0];
            const scalar_t coeff_previous_u2_1 = previous[21][lane];
            u2_old += coeff_previous_u2_1 * field_shape[0][q * U_N_SHAPE + 1];
            u2_old_grad_0_ref += coeff_previous_u2_1 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 1];
            u2_old_grad_1_ref += coeff_previous_u2_1 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 1];
            u2_old_grad_2_ref += coeff_previous_u2_1 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 1];
            const scalar_t coeff_previous_u2_2 = previous[22][lane];
            u2_old += coeff_previous_u2_2 * field_shape[0][q * U_N_SHAPE + 2];
            u2_old_grad_0_ref += coeff_previous_u2_2 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 2];
            u2_old_grad_1_ref += coeff_previous_u2_2 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 2];
            u2_old_grad_2_ref += coeff_previous_u2_2 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 2];
            const scalar_t coeff_previous_u2_3 = previous[23][lane];
            u2_old += coeff_previous_u2_3 * field_shape[0][q * U_N_SHAPE + 3];
            u2_old_grad_0_ref += coeff_previous_u2_3 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 3];
            u2_old_grad_1_ref += coeff_previous_u2_3 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 3];
            u2_old_grad_2_ref += coeff_previous_u2_3 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 3];
            const scalar_t coeff_previous_u2_4 = previous[24][lane];
            u2_old += coeff_previous_u2_4 * field_shape[0][q * U_N_SHAPE + 4];
            u2_old_grad_0_ref += coeff_previous_u2_4 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 4];
            u2_old_grad_1_ref += coeff_previous_u2_4 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 4];
            u2_old_grad_2_ref += coeff_previous_u2_4 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 4];
            const scalar_t coeff_previous_u2_5 = previous[25][lane];
            u2_old += coeff_previous_u2_5 * field_shape[0][q * U_N_SHAPE + 5];
            u2_old_grad_0_ref += coeff_previous_u2_5 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 5];
            u2_old_grad_1_ref += coeff_previous_u2_5 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 5];
            u2_old_grad_2_ref += coeff_previous_u2_5 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 5];
            const scalar_t coeff_previous_u2_6 = previous[26][lane];
            u2_old += coeff_previous_u2_6 * field_shape[0][q * U_N_SHAPE + 6];
            u2_old_grad_0_ref += coeff_previous_u2_6 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 6];
            u2_old_grad_1_ref += coeff_previous_u2_6 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 6];
            u2_old_grad_2_ref += coeff_previous_u2_6 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 6];
            const scalar_t coeff_previous_u2_7 = previous[27][lane];
            u2_old += coeff_previous_u2_7 * field_shape[0][q * U_N_SHAPE + 7];
            u2_old_grad_0_ref += coeff_previous_u2_7 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 7];
            u2_old_grad_1_ref += coeff_previous_u2_7 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 7];
            u2_old_grad_2_ref += coeff_previous_u2_7 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 7];
            const scalar_t coeff_previous_u2_8 = previous[28][lane];
            u2_old += coeff_previous_u2_8 * field_shape[0][q * U_N_SHAPE + 8];
            u2_old_grad_0_ref += coeff_previous_u2_8 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 8];
            u2_old_grad_1_ref += coeff_previous_u2_8 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 8];
            u2_old_grad_2_ref += coeff_previous_u2_8 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 8];
            const scalar_t coeff_previous_u2_9 = previous[29][lane];
            u2_old += coeff_previous_u2_9 * field_shape[0][q * U_N_SHAPE + 9];
            u2_old_grad_0_ref += coeff_previous_u2_9 * field_grad_ref[0 * DIM + 0][q * U_N_SHAPE + 9];
            u2_old_grad_1_ref += coeff_previous_u2_9 * field_grad_ref[0 * DIM + 1][q * U_N_SHAPE + 9];
            u2_old_grad_2_ref += coeff_previous_u2_9 * field_grad_ref[0 * DIM + 2][q * U_N_SHAPE + 9];
            ...
            scalar_t p_old_grad_2_ref = scalar_t(0);
            ...
            p_old_grad_2_ref += coeff_previous_p_0 * field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 0];
            ...
            p_old_grad_2_ref += coeff_previous_p_1 * field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 1];
            ...
            p_old_grad_2_ref += coeff_previous_p_2 * field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 2];
            const scalar_t coeff_previous_p_3 = previous[33][lane];
            p_old += coeff_previous_p_3 * field_shape[1][q * P_N_SHAPE + 3];
            p_old_grad_0_ref += coeff_previous_p_3 * field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 3];
            p_old_grad_1_ref += coeff_previous_p_3 * field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 3];
            p_old_grad_2_ref += coeff_previous_p_3 * field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 3];
            ...
            const scalar_t test_grad0_p_0 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 0] * adj0 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 0] * adj3 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 0] * adj6) / det;
            const scalar_t test_grad1_p_0 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 0] * adj1 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 0] * adj4 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 0] * adj7) / det;
            const scalar_t test_grad2_p_0 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 0] * adj2 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 0] * adj5 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 0] * adj8) / det;
            output[30][lane] += q_weight[q] * det * (value_coeff3 * test_value_p_0 + grad_coeff3_0 * test_grad0_p_0 + grad_coeff3_1 * test_grad1_p_0 + grad_coeff3_2 * test_grad2_p_0);
            const scalar_t test_value_p_1 = field_shape[1][q * P_N_SHAPE + 1];
            const scalar_t test_grad0_p_1 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 1] * adj0 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 1] * adj3 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 1] * adj6) / det;
            const scalar_t test_grad1_p_1 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 1] * adj1 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 1] * adj4 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 1] * adj7) / det;
            const scalar_t test_grad2_p_1 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 1] * adj2 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 1] * adj5 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 1] * adj8) / det;
            output[31][lane] += q_weight[q] * det * (value_coeff3 * test_value_p_1 + grad_coeff3_0 * test_grad0_p_1 + grad_coeff3_1 * test_grad1_p_1 + grad_coeff3_2 * test_grad2_p_1);
            const scalar_t test_value_p_2 = field_shape[1][q * P_N_SHAPE + 2];
            const scalar_t test_grad0_p_2 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 2] * adj0 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 2] * adj3 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 2] * adj6) / det;
            const scalar_t test_grad1_p_2 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 2] * adj1 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 2] * adj4 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 2] * adj7) / det;
            const scalar_t test_grad2_p_2 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 2] * adj2 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 2] * adj5 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 2] * adj8) / det;
            output[32][lane] += q_weight[q] * det * (value_coeff3 * test_value_p_2 + grad_coeff3_0 * test_grad0_p_2 + grad_coeff3_1 * test_grad1_p_2 + grad_coeff3_2 * test_grad2_p_2);
            const scalar_t test_value_p_3 = field_shape[1][q * P_N_SHAPE + 3];
            const scalar_t test_grad0_p_3 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 3] * adj0 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 3] * adj3 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 3] * adj6) / det;
            const scalar_t test_grad1_p_3 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 3] * adj1 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 3] * adj4 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 3] * adj7) / det;
            const scalar_t test_grad2_p_3 = (field_grad_ref[1 * DIM + 0][q * P_N_SHAPE + 3] * adj2 + field_grad_ref[1 * DIM + 1][q * P_N_SHAPE + 3] * adj5 + field_grad_ref[1 * DIM + 2][q * P_N_SHAPE + 3] * adj8) / det;
            output[33][lane] += q_weight[q] * det * (value_coeff3 * test_value_p_3 + grad_coeff3_0 * test_grad0_p_3 + grad_coeff3_1 * test_grad1_p_3 + grad_coeff3_2 * test_grad2_p_3);
        }
    }
}

template <typename scalar_t, int N_QP, int CELL_N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void poro_hyperelasticity_poro_form_1_p_d3_simplex_mixed_residual_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT adjugate[9],
...
template <typename scalar_t, int N_QP, int CELL_N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void poro_hyperelasticity_poro_form_1_p_d3_simplex_mixed_jacobian_action_block(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT field_shape[2],
...
template <typename scalar_t, int N_QP, int CELL_N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE void poro_hyperelasticity_poro_form_1_p_d3_simplex_mixed_jacobian_action_block_contiguous(
        const int nelems,
        const ptrdiff_t geometry_stride,
        const scalar_t *const SFEM_RESTRICT determinant,
        const scalar_t *const SFEM_RESTRICT field_shape[2],
