...
namespace sfem {
    ...
    public:
        ...
        explicit GeneratedPoroHyperelasticity(const std::shared_ptr<FunctionSpace> &space);
        ~GeneratedPoroHyperelasticity() override;

        const char *name() const override { return "GeneratedPoroHyperelasticity"; }
