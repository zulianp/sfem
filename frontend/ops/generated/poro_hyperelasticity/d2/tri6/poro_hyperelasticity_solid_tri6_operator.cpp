#include <cstdio>
#include <type_traits>
#include "../poro_hyperelasticity_solid_d2_simplex_local.hpp"
...
struct poro_hyperelasticity_solid_tri6_affine_reference_data {
...
template <typename scalar_t>
struct poro_hyperelasticity_solid_tri6_isoparametric_reference_data {
    static const scalar_t *shape() {
...
static const KernelDiagnostics poro_hyperelasticity_solid_tri6_tri6_objective_soa_diagnostics_data = {
    "poro_hyperelasticity_solid_tri6_tri6_objective_soa",
    "TRI6",
    2,
    6,
    6,
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_solid_tri6_tri6_objective_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_objective_soa_diagnostics_data;
}
...
extern "C" double poro_hyperelasticity_solid_tri6_tri6_objective_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_objective_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void poro_hyperelasticity_solid_tri6_tri6_objective_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "poro_hyperelasticity_solid_tri6_tri6_objective_soa_float",
            &sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_objective_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_objective_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const affine_grad_ref_x = sfem::codegen::poro_hyperelasticity_solid_tri6_affine_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const affine_grad_ref_y = sfem::codegen::poro_hyperelasticity_solid_tri6_affine_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const affine_q_weight = sfem::codegen::poro_hyperelasticity_solid_tri6_affine_reference_data<scalar_t>::q_weight();
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_objective_affine_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_objective_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, value);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_objective_affine_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_objective_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, value);
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_objective_steps_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_objective_steps_affine_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_objective_steps_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, h_stride, hx, hy, nsteps, steps, value);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_objective_steps_affine_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_objective_steps_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, h_stride, hx, hy, nsteps, steps, value);
}
...
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_objective_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    const scalar_t *const isoparametric_grad_ref_x = sfem::codegen::poro_hyperelasticity_solid_tri6_isoparametric_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const isoparametric_grad_ref_y = sfem::codegen::poro_hyperelasticity_solid_tri6_isoparametric_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const isoparametric_q_weight = sfem::codegen::poro_hyperelasticity_solid_tri6_isoparametric_reference_data<scalar_t>::q_weight();
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_objective_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_objective_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, value);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_objective_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_objective_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, value);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_objective_steps_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_objective_steps_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_objective_steps_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, h_stride, hx, hy, nsteps, steps, value);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_objective_steps_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_objective_steps_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, h_stride, hx, hy, nsteps, steps, value);
}
...
static const KernelDiagnostics poro_hyperelasticity_solid_tri6_tri6_gradient_soa_diagnostics_data = {
    "poro_hyperelasticity_solid_tri6_tri6_gradient_soa",
    "TRI6",
    2,
    6,
    6,
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_solid_tri6_tri6_gradient_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_gradient_soa_diagnostics_data;
}
...
extern "C" double poro_hyperelasticity_solid_tri6_tri6_gradient_soa_arithmetic_intensity(
        ...
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_gradient_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void poro_hyperelasticity_solid_tri6_tri6_gradient_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "poro_hyperelasticity_solid_tri6_tri6_gradient_soa_float",
            &sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_gradient_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_gradient_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_gradient_affine_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_gradient_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, out_stride, outx, outy);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_gradient_affine_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_gradient_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, out_stride, outx, outy);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_gradient_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_gradient_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_gradient_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, out_stride, outx, outy);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_gradient_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_gradient_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, out_stride, outx, outy);
}
...
static const KernelDiagnostics poro_hyperelasticity_solid_tri6_tri6_apply_soa_diagnostics_data = {
    "poro_hyperelasticity_solid_tri6_tri6_apply_soa",
    "TRI6",
    2,
    6,
    6,
...
extern "C" const sfem::codegen::KernelDiagnostics *poro_hyperelasticity_solid_tri6_tri6_apply_soa_diagnostics(void) {
    return &sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_apply_soa_diagnostics_data;
}
...
extern "C" double poro_hyperelasticity_solid_tri6_tri6_apply_soa_arithmetic_intensity(
        ...
        const size_t real_bytes,
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(&sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_apply_soa_diagnostics_data, nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void poro_hyperelasticity_solid_tri6_tri6_apply_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "poro_hyperelasticity_solid_tri6_tri6_apply_soa_float",
            &sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_apply_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_apply_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_apply_affine_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_apply_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, h_stride, hx, hy, out_stride, outx, outy);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_apply_affine_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_apply_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, h_stride, hx, hy, out_stride, outx, outy);
}
...
template <typename scalar_t, typename geometry_t>
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_apply_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_apply_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_apply_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, h_stride, hx, hy, out_stride, outx, outy);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_apply_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_apply_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, h_stride, hx, hy, out_stride, outx, outy);
}
...
template <typename scalar_t>
static SFEM_INLINE count_t poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_find_col(
        const idx_t node_i,
        const idx_t node_j,
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_bsr(
    ...
    for (int i = 0; i < N_SHAPE; ++i) {
        ...
        for (int j = 0; j < N_SHAPE; ++j) {
            const count_t entry = poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_find_col<scalar_t>(ev[i], ev[j], rowptr, colidx);
            if (entry == row_end) {
                if (valid_block_graph) {
                    std::fprintf(stderr, "poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_bsr missing block graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_crs(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
        const count_t *const SFEM_RESTRICT rowptr,
        const idx_t *const SFEM_RESTRICT colidx,
    ...
    for (int i = 0; i < N_SHAPE; ++i) {
        ...
        for (int j = 0; j < N_SHAPE; ++j) {
            ...
            if (entry == row_end) {
                if (valid_graph) {
                    std::fprintf(stderr, "poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_crs missing graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_dia(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
        const ptrdiff_t nnodes,
        ...
        for (int j = 0; j < N_SHAPE; ++j) {
            ...
            if (diagonal == ndiag) {
                if (valid_diagonal_offsets) {
                    std::fprintf(stderr, "poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_dia missing diagonal offset %d\n", offset);
                }
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_coo(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
        const ptrdiff_t nnz,
        ...
        for (int j = 0; j < N_SHAPE; ++j) {
            ...
            if (lo == nnz || rows[lo] != ev[i] || cols[lo] != ev[j]) {
                if (valid_coo_entries) {
                    std::fprintf(stderr, "poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_coo missing graph entry (%ld, %ld)\n", (long)ev[i], (long)ev[j]);
                }
...
template <typename scalar_t>
static SFEM_INLINE void poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_coo_triplets(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_patch(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
    ...
    for (int shape = 0; shape < N_SHAPE; ++shape) {
        ...
        if (patch >= npatch) {
            if (valid_patch_ids) {
                std::fprintf(stderr, "poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_patch patch id %ld outside patch count %td\n", (long)patch, npatch);
            }
...
static int poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static) reduction(|:invalid_matrix_graph)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        scalar_t block_jacobian_determinant0[N_QP * VECTOR_SIZE];
        scalar_t *block_jacobian_adjugate_streams[DIM * DIM] = {block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3};
        const scalar_t *const block_coordinate_streams[N_SHAPE * DIM] = {block_coordinate_data[0], block_coordinate_data[1], block_coordinate_data[2], block_coordinate_data[3], block_coordinate_data[4], block_coordinate_data[5], block_coordinate_data[6], block_coordinate_data[7], block_coordinate_data[8], block_coordinate_data[9], block_coordinate_data[10], block_coordinate_data[11]};
        const scalar_t *const block_u_streams[N_SHAPE * DIM] = {block_u_data[0], block_u_data[1], block_u_data[2], block_u_data[3], block_u_data[4], block_u_data[5], block_u_data[6], block_u_data[7], block_u_data[8], block_u_data[9], block_u_data[10], block_u_data[11]};
        const scalar_t *const block_h_streams[N_SHAPE * DIM] = {block_h_data[0], block_h_data[1], block_h_data[2], block_h_data[3], block_h_data[4], block_h_data[5], block_h_data[6], block_h_data[7], block_h_data[8], block_h_data[9], block_h_data[10], block_h_data[11]};
        scalar_t *const block_out_streams[N_SHAPE * DIM] = {block_out_data[0], block_out_data[1], block_out_data[2], block_out_data[3], block_out_data[4], block_out_data[5], block_out_data[6], block_out_data[7], block_out_data[8], block_out_data[9], block_out_data[10], block_out_data[11]};
        ...
        if constexpr (FORMAT == 1) {
            invalid_matrix_graph |= (poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_bsr(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 0) {
            invalid_matrix_graph |= (poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_crs(ev, element_matrix, rowptr, colidx, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 2) {
            invalid_matrix_graph |= (poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_dia(ev, element_matrix, nnodes, diag_offsets, ndiag, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 3) {
            invalid_matrix_graph |= (poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_coo(ev, element_matrix, coo_nnz, coo_rows, coo_cols, values) != SFEM_SUCCESS);
        } else if constexpr (FORMAT == 5) {
            poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_coo_triplets(ev, element_matrix, element, coo_triplet_rows, coo_triplet_cols, values);
        } else {
            invalid_matrix_graph |= (poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_scatter_patch(ev, element_matrix, node_to_patch, npatch, values) != SFEM_SUCCESS);
        }
    }
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_crs_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 0>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_crs_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 0>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_bsr_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 1>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_bsr_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 1>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_dia_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 2>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, nullptr, nullptr, values, diag_offsets, ndiag, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_dia_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 2>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, nullptr, nullptr, values, diag_offsets, ndiag, 0, nullptr, nullptr, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_coo_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 3>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, nullptr, nullptr, values, nullptr, 0, nnz, rows, cols, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_coo_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 3>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, nullptr, nullptr, values, nullptr, 0, nnz, rows, cols, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_coo_triplet_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 5>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, nullptr, nullptr, values, nullptr, 0, 0, nullptr, nullptr, rows, cols, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_coo_triplet_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 5>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, nullptr, nullptr, values, nullptr, 0, 0, nullptr, nullptr, rows, cols, nullptr, 0);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_patch_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 4>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, nullptr, nullptr, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, node_to_patch, npatch);
}
...
extern "C" int poro_hyperelasticity_solid_tri6_tri6_hessian_patch_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_solid_tri6_tri6_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 4>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, nullptr, nullptr, values, nullptr, 0, 0, nullptr, nullptr, nullptr, nullptr, node_to_patch, npatch);
}
