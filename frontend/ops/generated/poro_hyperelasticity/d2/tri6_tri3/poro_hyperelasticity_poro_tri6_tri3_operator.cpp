...
template <typename scalar_t>
static SFEM_INLINE void poro_hyperelasticity_poro_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa_scatter_coo_triplets(
        idx_t **const SFEM_RESTRICT elements,
...
template <typename scalar_t>
static SFEM_INLINE int poro_hyperelasticity_poro_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        poro_hyperelasticity_poro_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa_scatter_coo_triplets(elements, element, out_stride, element_matrix, rows, cols, values);
    }
...
extern "C" int poro_hyperelasticity_poro_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa(
    ...
    return sfem::codegen::poro_hyperelasticity_poro_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, alpha, dt, hydraulic_conductivity, storage, out_stride, rows, cols, values);
}
...
extern "C" int poro_hyperelasticity_poro_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::poro_hyperelasticity_poro_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, alpha, dt, hydraulic_conductivity, storage, out_stride, rows, cols, values);
}
