...
template <typename scalar_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_residual_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_shape = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_isoparametric_reference_data<scalar_t>::shape();
    const scalar_t *const isoparametric_grad_ref_x = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_isoparametric_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const isoparametric_grad_ref_y = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_isoparametric_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const isoparametric_q_weight = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_isoparametric_reference_data<scalar_t>::q_weight();
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_residual_isoparametric_mesh_soa(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_residual_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, eta_b, eta_s, newmark_velocity_alpha, current_stride, u0, u1, previous_stride, u0_old, u1_old, out_stride, u0_out, u1_out);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_residual_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_residual_isoparametric_mesh_soa_impl<float>(nelements, nnodes, elements, points, eta_b, eta_s, newmark_velocity_alpha, current_stride, u0, u1, previous_stride, u0_old, u1_old, out_stride, u0_out, u1_out);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_residual_isoparametric_mesh_aos(
    ...
    return mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_residual_isoparametric_mesh_soa(nelements, nnodes, elements, points, parameters[0], parameters[1], parameters[2], 2, current + 0, current + 1, 2, previous + 0, previous + 1, 2, output + 0, output + 1);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_residual_isoparametric_mesh_aos_float(
    ...
    return mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_residual_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, parameters[0], parameters[1], parameters[2], 2, current + 0, current + 1, 2, previous + 0, previous + 1, 2, output + 0, output + 1);
}
...
template <typename scalar_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_jacobian_action_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_jacobian_action_isoparametric_mesh_soa(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_jacobian_action_isoparametric_mesh_soa_impl<double>(nelements, nnodes, elements, points, eta_b, eta_s, newmark_velocity_alpha, current_stride, u0, u1, previous_stride, u0_old, u1_old, direction_stride, u0_direction, u1_direction, out_stride, u0_out, u1_out);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_jacobian_action_isoparametric_mesh_aos(
    ...
    return mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_jacobian_action_isoparametric_mesh_soa(nelements, nnodes, elements, points, parameters[0], parameters[1], parameters[2], 2, current + 0, current + 1, 2, previous + 0, previous + 1, 2, direction + 0, direction + 1, 2, output + 0, output + 1);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_jacobian_action_isoparametric_mesh_aos_float(
    ...
    return mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_jacobian_action_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, parameters[0], parameters[1], parameters[2], 2, current + 0, current + 1, 2, previous + 0, previous + 1, 2, direction + 0, direction + 1, 2, output + 0, output + 1);
}
