#ifndef MOONEY_RIVLIN_KELVIN_VOIGT_NEWMARK_ELASTIC_TRI3_ELEMENT_API_CUH
#define MOONEY_RIVLIN_KELVIN_VOIGT_NEWMARK_ELASTIC_TRI3_ELEMENT_API_CUH
...
static __host__ __device__ __forceinline__ int mooney_rivlin_kelvin_voigt_newmark_elastic_tri3_energy_egeometry_soa(
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int mooney_rivlin_kelvin_voigt_newmark_elastic_tri3_energy_ecoords_soa(
        const ptrdiff_t nelements,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int mooney_rivlin_kelvin_voigt_newmark_elastic_tri3_energy_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int mooney_rivlin_kelvin_voigt_newmark_elastic_tri3_gradient_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int mooney_rivlin_kelvin_voigt_newmark_elastic_tri3_gradient_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int mooney_rivlin_kelvin_voigt_newmark_elastic_tri3_gradient_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int mooney_rivlin_kelvin_voigt_newmark_elastic_tri3_hessian_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int mooney_rivlin_kelvin_voigt_newmark_elastic_tri3_hessian_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int mooney_rivlin_kelvin_voigt_newmark_elastic_tri3_hessian_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
