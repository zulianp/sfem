#ifndef MOONEY_RIVLIN_KELVIN_VOIGT_NEWMARK_ELASTIC_PROTEUS_QUAD4_ELEMENT_API_HPP
#define MOONEY_RIVLIN_KELVIN_VOIGT_NEWMARK_ELASTIC_PROTEUS_QUAD4_ELEMENT_API_HPP
...
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_quad4_energy_element_geometry_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        mooney_rivlin_kelvin_voigt_newmark_elastic_d2_tensor_product_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_quad4_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_quad4_isoparametric_reference_data<scalar_t>::grad_1d(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_quad4_isoparametric_reference_data<scalar_t>::q_weight_1d(), lmbda, mu, block_u_streams, block_value);
    }
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_quad4_energy_element_coords_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        tensor_gradient_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE, 2>(nelems, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_quad4_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_quad4_isoparametric_reference_data<scalar_t>::grad_1d(), block_coordinate_data, 0, coordinate_grad_ref + 0 * N_QP * SPATIAL_DIM * VECTOR_SIZE);
        tensor_gradient_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE, 2>(nelems, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_quad4_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_quad4_isoparametric_reference_data<scalar_t>::grad_1d(), block_coordinate_data, 1, coordinate_grad_ref + 1 * N_QP * SPATIAL_DIM * VECTOR_SIZE);
