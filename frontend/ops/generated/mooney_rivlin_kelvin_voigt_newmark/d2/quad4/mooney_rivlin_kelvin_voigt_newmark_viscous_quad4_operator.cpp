...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_quad4_hessian_bsr_i_msoa(
    ...
    return mooney_rivlin_kelvin_voigt_newmark_viscous_proteus_quad4_hessian_bsr_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, rowptr, colidx, values);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_quad4_jacobian_action_i_msoa(
    ...
    return mooney_rivlin_kelvin_voigt_newmark_viscous_proteus_quad4_jacobian_action_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, direction_stride, u0_direction, u1_direction, out_stride, u0_out, u1_out);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_quad4_residual_i_msoa(
    ...
    return mooney_rivlin_kelvin_voigt_newmark_viscous_proteus_quad4_residual_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, out_stride, u0_out, u1_out);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_quad4_jacobian_action_a_msoa(
    ...
    return mooney_rivlin_kelvin_voigt_newmark_viscous_proteus_quad4_jacobian_action_a_msoa(scalar_bytes, nelements, nnodes, proteus_elements, g_adj0, g_adj1, g_adj2, g_adj3, g_det0, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, direction_stride, u0_direction, u1_direction, out_stride, u0_out, u1_out);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_quad4_residual_a_msoa(
    ...
    return mooney_rivlin_kelvin_voigt_newmark_viscous_proteus_quad4_residual_a_msoa(scalar_bytes, nelements, nnodes, proteus_elements, g_adj0, g_adj1, g_adj2, g_adj3, g_det0, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, out_stride, u0_out, u1_out);
}
