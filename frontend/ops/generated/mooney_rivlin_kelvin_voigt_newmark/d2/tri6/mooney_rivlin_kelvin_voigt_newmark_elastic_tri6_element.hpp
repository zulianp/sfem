#ifndef MOONEY_RIVLIN_KELVIN_VOIGT_NEWMARK_ELASTIC_TRI6_ELEMENT_API_HPP
#define MOONEY_RIVLIN_KELVIN_VOIGT_NEWMARK_ELASTIC_TRI6_ELEMENT_API_HPP
...
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_energy_element_geometry_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        mooney_rivlin_kelvin_voigt_newmark_elastic_d2_simplex_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_isoparametric_reference_data<scalar_t>::grad_ref_x(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_isoparametric_reference_data<scalar_t>::grad_ref_y(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_isoparametric_reference_data<scalar_t>::q_weight(), lmbda, mu, block_u_streams, block_value);
    }
    return SFEM_SUCCESS;
}

template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_energy_element_coords_soa(
        const ptrdiff_t nelements,
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        scalar_t block_jacobian_adjugate3[N_QP * VECTOR_SIZE];
        scalar_t block_jacobian_determinant0[N_QP * VECTOR_SIZE];
        const scalar_t *const grad_ref_x = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_isoparametric_reference_data<scalar_t>::grad_ref_x();
        const scalar_t *const grad_ref_y = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_isoparametric_reference_data<scalar_t>::grad_ref_y();
        for (int q = 0; q < N_QP; ++q) {
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_energy_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_gradient_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t lmbda,
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        mooney_rivlin_kelvin_voigt_newmark_elastic_d2_simplex_gradient_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_isoparametric_reference_data<scalar_t>::grad_ref_x(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_isoparametric_reference_data<scalar_t>::grad_ref_y(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_isoparametric_reference_data<scalar_t>::q_weight(), lmbda, mu, block_u_streams, block_out_streams);
    }
    return SFEM_SUCCESS;
}

template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_gradient_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_gradient_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_hessian_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t lmbda,
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        for (int col = 0; col < NDOFS; ++col) {
            ...
            mooney_rivlin_kelvin_voigt_newmark_elastic_d2_simplex_apply_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_isoparametric_reference_data<scalar_t>::grad_ref_x(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_isoparametric_reference_data<scalar_t>::grad_ref_y(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_isoparametric_reference_data<scalar_t>::q_weight(), lmbda, mu, block_u_streams, block_h_streams, block_out_streams);
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_hessian_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tri6_hessian_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t lmbda,
        const scalar_t mu,
