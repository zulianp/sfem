...
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex27_energy_element_coords_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        tensor_gradient_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE, 3>(nelems, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex27_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex27_isoparametric_reference_data<scalar_t>::grad_1d(), block_coordinate_data, 0, coordinate_grad_ref + 0 * N_QP * DIM * VECTOR_SIZE);
        tensor_gradient_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE, 3>(nelems, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex27_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex27_isoparametric_reference_data<scalar_t>::grad_1d(), block_coordinate_data, 1, coordinate_grad_ref + 1 * N_QP * DIM * VECTOR_SIZE);
        tensor_gradient_contiguous<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE, 3>(nelems, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex27_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex27_isoparametric_reference_data<scalar_t>::grad_1d(), block_coordinate_data, 2, coordinate_grad_ref + 2 * N_QP * DIM * VECTOR_SIZE);
