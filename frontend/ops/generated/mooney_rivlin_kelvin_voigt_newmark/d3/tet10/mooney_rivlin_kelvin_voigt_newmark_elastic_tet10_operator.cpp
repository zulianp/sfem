...
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_affine_mesh_soa_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const affine_grad_ref_x = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_affine_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const affine_grad_ref_y = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_affine_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const affine_grad_ref_z = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_affine_reference_data<scalar_t>::grad_ref_z();
    const scalar_t *const affine_q_weight = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_affine_reference_data<scalar_t>::q_weight();
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_affine_mesh_soa(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, value);
}

extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_affine_mesh_soa_float(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const SFEM_RESTRICT g_jacobian_adjugate0,
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_steps_affine_mesh_soa(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_steps_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_isoparametric_mesh_soa_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    const scalar_t *const isoparametric_grad_ref_x = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_isoparametric_reference_data<scalar_t>::grad_ref_x();
    const scalar_t *const isoparametric_grad_ref_y = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_isoparametric_reference_data<scalar_t>::grad_ref_y();
    const scalar_t *const isoparametric_grad_ref_z = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_isoparametric_reference_data<scalar_t>::grad_ref_z();
    const scalar_t *const isoparametric_q_weight = sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_isoparametric_reference_data<scalar_t>::q_weight();
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_isoparametric_mesh_soa(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_isoparametric_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_isoparametric_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, points, lmbda, mu, u_stride, ux, uy, uz, value);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_gradient_affine_mesh_soa(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_gradient_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_gradient_affine_mesh_soa_float(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_gradient_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_apply_affine_mesh_soa(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_apply_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
