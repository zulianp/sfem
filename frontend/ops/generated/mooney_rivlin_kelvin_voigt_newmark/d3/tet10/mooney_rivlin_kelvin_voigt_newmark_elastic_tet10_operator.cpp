...
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_steps_packed_a_msoa_impl(
...
template <typename s_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_objective_steps_packed_i_msoa_impl(
    const ptrdiff_t n_packs,
    const ptrdiff_t n_elements_per_pack,
    const ptrdiff_t nelements,
    const ptrdiff_t,
...
template <typename s_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_gradient_packed_a_msoa_impl(
    const ptrdiff_t n_packs,
    const ptrdiff_t n_elements_per_pack,
    const ptrdiff_t nelements,
    const ptrdiff_t,
...
template <typename s_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_gradient_packed_two_pass_a_msoa_impl(
    const ptrdiff_t n_packs,
    const ptrdiff_t n_elements_per_pack,
    const ptrdiff_t nelements,
    const ptrdiff_t,
...
template <typename s_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_gradient_packed_i_msoa_impl(
    const ptrdiff_t n_packs,
    const ptrdiff_t n_elements_per_pack,
    const ptrdiff_t nelements,
    const ptrdiff_t,
...
template <typename s_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_gradient_packed_two_pass_i_msoa_impl(
    const ptrdiff_t n_packs,
    const ptrdiff_t n_elements_per_pack,
    const ptrdiff_t nelements,
    const ptrdiff_t,
...
template <typename s_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_apply_packed_a_msoa_impl(
    const ptrdiff_t n_packs,
    const ptrdiff_t n_elements_per_pack,
    const ptrdiff_t nelements,
    const ptrdiff_t,
...
template <typename s_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_apply_packed_two_pass_a_msoa_impl(
    const ptrdiff_t n_packs,
    const ptrdiff_t n_elements_per_pack,
    const ptrdiff_t nelements,
    const ptrdiff_t,
...
template <typename s_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_apply_packed_i_msoa_impl(
    const ptrdiff_t n_packs,
    const ptrdiff_t n_elements_per_pack,
    const ptrdiff_t nelements,
    const ptrdiff_t,
...
template <typename s_t>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet10_apply_packed_two_pass_i_msoa_impl(
    const ptrdiff_t n_packs,
    const ptrdiff_t n_elements_per_pack,
    const ptrdiff_t nelements,
    const ptrdiff_t,
