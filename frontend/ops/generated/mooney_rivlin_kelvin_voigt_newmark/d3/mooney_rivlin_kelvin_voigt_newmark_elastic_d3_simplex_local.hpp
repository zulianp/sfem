...
static SFEM_INLINE void mooney_rivlin_kelvin_voigt_newmark_elastic_d3_simplex_objective_block(
    ...
    static_assert(VECTOR_SIZE > 0, "VECTOR_SIZE must be positive");
        ...
        const scalar_t weak_obj_tmp1 = grad_u1*grad_u3*weak_obj_tmp0;
        const scalar_t weak_obj_tmp2 = grad_u4 + scalar_t(1);
        const scalar_t weak_obj_tmp3 = grad_u2*grad_u6*weak_obj_tmp2;
        const scalar_t weak_obj_tmp4 = grad_u0 + scalar_t(1);
        const scalar_t weak_obj_tmp5 = grad_u5*grad_u7*weak_obj_tmp4;
        const scalar_t weak_obj_tmp6 = pow_2(grad_u1) + pow_2(grad_u7) + pow_2(weak_obj_tmp2);
        const scalar_t weak_obj_tmp7 = pow_2(grad_u2) + pow_2(grad_u5) + pow_2(weak_obj_tmp0);
        const scalar_t weak_obj_tmp8 = pow_2(grad_u3) + pow_2(grad_u6) + pow_2(weak_obj_tmp4);
        const scalar_t weak_obj_tmp9 = weak_obj_tmp6 + weak_obj_tmp7 + weak_obj_tmp8;
        value[lane] += qw * jacobian_determinant_lane0 * (((scalar_t(1) / scalar_t(2)))*lmbda*pow_2(grad_u1*grad_u5*grad_u6 + grad_u2*grad_u3*grad_u7 + weak_obj_tmp0*weak_obj_tmp2*weak_obj_tmp4 - weak_obj_tmp1 - weak_obj_tmp3 - weak_obj_tmp5 + scalar_t(-1)) + mu*(-scalar_t(6)*grad_u1*grad_u5*grad_u6 - scalar_t(6)*grad_u2*grad_u3*grad_u7 - scalar_t(6)*weak_obj_tmp0*weak_obj_tmp2*weak_obj_tmp4 + scalar_t(6)*weak_obj_tmp1 + scalar_t(6)*weak_obj_tmp3 + scalar_t(6)*weak_obj_tmp5 - (scalar_t(1) / scalar_t(2))*pow_2(weak_obj_tmp6) - (scalar_t(1) / scalar_t(2))*pow_2(weak_obj_tmp7) - (scalar_t(1) / scalar_t(2))*pow_2(weak_obj_tmp8) + ((scalar_t(1) / scalar_t(2)))*pow_2(weak_obj_tmp9) + weak_obj_tmp9 - pow_2(grad_u1*grad_u2 + grad_u5*weak_obj_tmp2 + grad_u7*weak_obj_tmp0) - pow_2(grad_u1*weak_obj_tmp4 + grad_u3*weak_obj_tmp2 + grad_u6*grad_u7) - pow_2(grad_u2*weak_obj_tmp4 + grad_u3*grad_u5 + grad_u6*weak_obj_tmp0)));
            }
        }
}
...
static SFEM_INLINE void mooney_rivlin_kelvin_voigt_newmark_elastic_d3_simplex_gradient_block(
    ...
    static_assert(VECTOR_SIZE > 0, "VECTOR_SIZE must be positive");
        ...
        const scalar_t grad_u7 = (grad_u_ref6 * jacobian_adjugate_lane1 + grad_u_ref7 * jacobian_adjugate_lane4 + grad_u_ref8 * jacobian_adjugate_lane7) * inv_jacobian_determinant;
        const scalar_t grad_u8 = (grad_u_ref6 * jacobian_adjugate_lane2 + grad_u_ref7 * jacobian_adjugate_lane5 + grad_u_ref8 * jacobian_adjugate_lane8) * inv_jacobian_determinant;
        const scalar_t weak_mat_tmp0 = scalar_t(2)*grad_u5;
        ...
        const scalar_t weak_mat_tmp4 = grad_u5*grad_u7;
        const scalar_t weak_mat_tmp5 = ((scalar_t(1) / scalar_t(2)))*lmbda*(-grad_u1*grad_u3*weak_mat_tmp2 + grad_u1*grad_u5*grad_u6 + grad_u2*grad_u3*grad_u7 - grad_u2*grad_u6*weak_mat_tmp1 + weak_mat_tmp1*weak_mat_tmp2*weak_mat_tmp3 - weak_mat_tmp3*weak_mat_tmp4 + scalar_t(-1));
        const scalar_t weak_mat_tmp6 = grad_u1*weak_mat_tmp3 + grad_u3*weak_mat_tmp1 + grad_u6*grad_u7;
        const scalar_t weak_mat_tmp7 = scalar_t(2)*grad_u1;
        const scalar_t weak_mat_tmp8 = grad_u2*weak_mat_tmp3 + grad_u3*grad_u5 + grad_u6*weak_mat_tmp2;
        const scalar_t weak_mat_tmp9 = scalar_t(2)*grad_u2;
        const scalar_t weak_mat_tmp10 = pow_2(grad_u3) + pow_2(grad_u6) + pow_2(weak_mat_tmp3);
        ...
        const scalar_t weak_mat_tmp15 = scalar_t(2)*grad_u3;
        const scalar_t weak_mat_tmp16 = grad_u1*grad_u2 + grad_u5*weak_mat_tmp1 + grad_u7*weak_mat_tmp2;
        const scalar_t weak_mat_tmp17 = scalar_t(2)*grad_u6;
        const scalar_t weak_mat_tmp18 = scalar_t(6)*grad_u2;
        const scalar_t weak_mat_tmp19 = scalar_t(2)*weak_mat_tmp1;
        const scalar_t weak_mat_tmp20 = scalar_t(2)*grad_u7;
        const scalar_t weak_mat_tmp21 = scalar_t(6)*grad_u1;
        const scalar_t weak_mat_tmp22 = scalar_t(2)*weak_mat_tmp2;
        const scalar_t material0 = mu*(scalar_t(2)*grad_u0 - scalar_t(6)*weak_mat_tmp1*weak_mat_tmp2 - weak_mat_tmp10*weak_mat_tmp11 + weak_mat_tmp11*weak_mat_tmp14 + scalar_t(6)*weak_mat_tmp4 - weak_mat_tmp6*weak_mat_tmp7 - weak_mat_tmp8*weak_mat_tmp9 + scalar_t(2)) + weak_mat_tmp5*(-grad_u7*weak_mat_tmp0 + scalar_t(2)*weak_mat_tmp1*weak_mat_tmp2);
        const scalar_t material1 = mu*(scalar_t(2)*grad_u1*weak_mat_tmp14 + scalar_t(2)*grad_u1 + scalar_t(6)*grad_u3*weak_mat_tmp2 - scalar_t(6)*grad_u5*grad_u6 - weak_mat_tmp11*weak_mat_tmp6 - weak_mat_tmp12*weak_mat_tmp7 - weak_mat_tmp16*weak_mat_tmp9) + weak_mat_tmp5*(scalar_t(2)*grad_u5*grad_u6 - weak_mat_tmp15*weak_mat_tmp2);
        const scalar_t material2 = mu*(scalar_t(2)*grad_u2*weak_mat_tmp14 + scalar_t(2)*grad_u2 - scalar_t(6)*grad_u3*grad_u7 + scalar_t(6)*grad_u6*weak_mat_tmp1 - weak_mat_tmp11*weak_mat_tmp8 - weak_mat_tmp13*weak_mat_tmp9 - weak_mat_tmp16*weak_mat_tmp7) + weak_mat_tmp5*(grad_u7*weak_mat_tmp15 - weak_mat_tmp1*weak_mat_tmp17);
        const scalar_t material3 = mu*(scalar_t(6)*grad_u1*weak_mat_tmp2 + scalar_t(2)*grad_u3*weak_mat_tmp14 + scalar_t(2)*grad_u3 - grad_u7*weak_mat_tmp18 - weak_mat_tmp0*weak_mat_tmp8 - weak_mat_tmp10*weak_mat_tmp15 - weak_mat_tmp19*weak_mat_tmp6) + weak_mat_tmp5*(scalar_t(2)*grad_u2*grad_u7 - weak_mat_tmp2*weak_mat_tmp7);
        const scalar_t material4 = mu*(scalar_t(2)*grad_u4 + grad_u6*weak_mat_tmp18 - weak_mat_tmp0*weak_mat_tmp16 - weak_mat_tmp12*weak_mat_tmp19 + weak_mat_tmp14*weak_mat_tmp19 - weak_mat_tmp15*weak_mat_tmp6 - scalar_t(6)*weak_mat_tmp2*weak_mat_tmp3 + scalar_t(2)) + weak_mat_tmp5*(-grad_u6*weak_mat_tmp9 + scalar_t(2)*weak_mat_tmp2*weak_mat_tmp3);
        const scalar_t material5 = mu*(scalar_t(2)*grad_u5*weak_mat_tmp14 + scalar_t(2)*grad_u5 - grad_u6*weak_mat_tmp21 + scalar_t(6)*grad_u7*weak_mat_tmp3 - weak_mat_tmp0*weak_mat_tmp13 - weak_mat_tmp15*weak_mat_tmp8 - weak_mat_tmp16*weak_mat_tmp19) + weak_mat_tmp5*(grad_u6*weak_mat_tmp7 - weak_mat_tmp20*weak_mat_tmp3);
        const scalar_t material6 = mu*(scalar_t(6)*grad_u2*weak_mat_tmp1 - grad_u5*weak_mat_tmp21 + scalar_t(2)*grad_u6*weak_mat_tmp14 + scalar_t(2)*grad_u6 - weak_mat_tmp10*weak_mat_tmp17 - weak_mat_tmp20*weak_mat_tmp6 - weak_mat_tmp22*weak_mat_tmp8) + weak_mat_tmp5*(grad_u5*weak_mat_tmp7 - weak_mat_tmp1*weak_mat_tmp9);
        const scalar_t material7 = mu*(-grad_u3*weak_mat_tmp18 + scalar_t(6)*grad_u5*weak_mat_tmp3 + scalar_t(2)*grad_u7*weak_mat_tmp14 + scalar_t(2)*grad_u7 - weak_mat_tmp12*weak_mat_tmp20 - weak_mat_tmp16*weak_mat_tmp22 - weak_mat_tmp17*weak_mat_tmp6) + weak_mat_tmp5*(grad_u3*weak_mat_tmp9 - weak_mat_tmp0*weak_mat_tmp3);
        const scalar_t material8 = mu*(grad_u3*weak_mat_tmp21 + scalar_t(2)*grad_u8 - scalar_t(6)*weak_mat_tmp1*weak_mat_tmp3 - weak_mat_tmp13*weak_mat_tmp22 + weak_mat_tmp14*weak_mat_tmp22 - weak_mat_tmp16*weak_mat_tmp20 - weak_mat_tmp17*weak_mat_tmp8 + scalar_t(2)) + weak_mat_tmp5*(-grad_u3*weak_mat_tmp7 + scalar_t(2)*weak_mat_tmp1*weak_mat_tmp3);
...
static SFEM_INLINE void mooney_rivlin_kelvin_voigt_newmark_elastic_d3_simplex_apply_block(
    ...
    static_assert(VECTOR_SIZE > 0, "VECTOR_SIZE must be positive");
        ...
        const scalar_t weak_mat_tmp0 = scalar_t(2)*grad_u6;
        const scalar_t weak_mat_tmp1 = grad_u7*weak_mat_tmp0;
        const scalar_t weak_mat_tmp2 = grad_u4 + scalar_t(1);
        const scalar_t weak_mat_tmp3 = scalar_t(2)*grad_u3;
        const scalar_t weak_mat_tmp4 = weak_mat_tmp2*weak_mat_tmp3;
        const scalar_t weak_mat_tmp5 = mu*(-weak_mat_tmp1 - weak_mat_tmp4);
        const scalar_t weak_mat_tmp6 = grad_u8 + scalar_t(1);
        const scalar_t weak_mat_tmp7 = grad_u3*weak_mat_tmp6;
        const scalar_t weak_mat_tmp8 = grad_u5*grad_u6 - weak_mat_tmp7;
        const scalar_t weak_mat_tmp9 = grad_u5*grad_u7;
        ...
        const scalar_t weak_mat_tmp14 = grad_u5*weak_mat_tmp3;
        const scalar_t weak_mat_tmp15 = weak_mat_tmp0*weak_mat_tmp6;
        const scalar_t weak_mat_tmp16 = mu*(-weak_mat_tmp14 - weak_mat_tmp15);
        const scalar_t weak_mat_tmp17 = grad_u3*grad_u7;
        const scalar_t weak_mat_tmp18 = grad_u6*weak_mat_tmp2;
        const scalar_t weak_mat_tmp19 = weak_mat_tmp17 - weak_mat_tmp18;
        const scalar_t weak_mat_tmp20 = scalar_t(2)*grad_u2;
        const scalar_t weak_mat_tmp21 = grad_u5*weak_mat_tmp20;
        const scalar_t weak_mat_tmp22 = scalar_t(2)*grad_u1;
        const scalar_t weak_mat_tmp23 = weak_mat_tmp2*weak_mat_tmp22;
        const scalar_t weak_mat_tmp24 = mu*(-weak_mat_tmp21 - weak_mat_tmp23);
        const scalar_t weak_mat_tmp25 = grad_u1*weak_mat_tmp6;
        const scalar_t weak_mat_tmp26 = grad_u2*grad_u7 - weak_mat_tmp25;
        const scalar_t weak_mat_tmp27 = grad_u7*weak_mat_tmp22;
        const scalar_t weak_mat_tmp28 = weak_mat_tmp20*weak_mat_tmp6;
        const scalar_t weak_mat_tmp29 = mu*(-weak_mat_tmp27 - weak_mat_tmp28);
        const scalar_t weak_mat_tmp30 = grad_u1*grad_u5;
        const scalar_t weak_mat_tmp31 = grad_u2*weak_mat_tmp2;
        const scalar_t weak_mat_tmp32 = weak_mat_tmp30 - weak_mat_tmp31;
        const scalar_t weak_mat_tmp33 = scalar_t(2)*pow_2(grad_u5);
        ...
        const scalar_t weak_mat_tmp36 = scalar_t(2)*pow_2(grad_u7);
        ...
        const scalar_t weak_mat_tmp40 = grad_u1*grad_u6;
        const scalar_t weak_mat_tmp41 = grad_u0 + scalar_t(1);
        const scalar_t weak_mat_tmp42 = grad_u7*weak_mat_tmp41;
        const scalar_t weak_mat_tmp43 = weak_mat_tmp40 - weak_mat_tmp42;
        const scalar_t weak_mat_tmp44 = scalar_t(6)*grad_u7;
        const scalar_t weak_mat_tmp45 = grad_u2*grad_u3;
        const scalar_t weak_mat_tmp46 = scalar_t(2)*weak_mat_tmp45;
        const scalar_t weak_mat_tmp47 = grad_u5*weak_mat_tmp41;
        const scalar_t weak_mat_tmp48 = lmbda*(grad_u1*grad_u5*grad_u6 - grad_u1*weak_mat_tmp7 + grad_u2*grad_u3*grad_u7 - grad_u2*weak_mat_tmp18 + weak_mat_tmp2*weak_mat_tmp41*weak_mat_tmp6 - weak_mat_tmp41*weak_mat_tmp9 + scalar_t(-1));
        const scalar_t weak_mat_tmp49 = grad_u7*weak_mat_tmp48;
        ...
        const scalar_t weak_mat_tmp65 = scalar_t(6)*grad_u4 + scalar_t(6);
        ...
        const scalar_t weak_mat_tmp68 = -scalar_t(2)*grad_u5*grad_u6;
        ...
        const scalar_t weak_mat_tmp71 = scalar_t(2)*grad_u5;
        const scalar_t weak_mat_tmp72 = weak_mat_tmp2*weak_mat_tmp71;
        const scalar_t weak_mat_tmp73 = scalar_t(2)*grad_u7;
        ...
        const scalar_t weak_mat_tmp80 = scalar_t(2)*pow_2(grad_u3);
        const scalar_t weak_mat_tmp81 = scalar_t(2)*pow_2(grad_u6);
        const scalar_t weak_mat_tmp82 = weak_mat_tmp80 + weak_mat_tmp81;
        const scalar_t weak_mat_tmp83 = scalar_t(6)*grad_u6;
        const scalar_t weak_mat_tmp84 = scalar_t(2)*weak_mat_tmp31;
        const scalar_t weak_mat_tmp85 = grad_u6*weak_mat_tmp48;
        const scalar_t weak_mat_tmp86 = mu*(scalar_t(4)*grad_u1*grad_u5 - weak_mat_tmp83 - weak_mat_tmp84) + weak_mat_tmp85;
        const scalar_t weak_mat_tmp87 = scalar_t(2)*weak_mat_tmp42;
        const scalar_t weak_mat_tmp88 = mu*(scalar_t(4)*grad_u1*grad_u6 - weak_mat_tmp52 - weak_mat_tmp87) + weak_mat_tmp54;
        const scalar_t weak_mat_tmp89 = scalar_t(6)*grad_u3;
        const scalar_t weak_mat_tmp90 = -scalar_t(2)*grad_u2*grad_u7;
        const scalar_t weak_mat_tmp91 = grad_u3*weak_mat_tmp48;
        ...
        const scalar_t weak_mat_tmp101 = mu*(scalar_t(4)*grad_u2*grad_u3 - weak_mat_tmp100 - weak_mat_tmp44) + weak_mat_tmp49;
        const scalar_t weak_mat_tmp102 = scalar_t(2)*weak_mat_tmp25;
        const scalar_t weak_mat_tmp103 = mu*(scalar_t(4)*grad_u2*grad_u7 - weak_mat_tmp102 - weak_mat_tmp89) + weak_mat_tmp91;
        ...
        const scalar_t weak_mat_tmp116 = scalar_t(2)*pow_2(grad_u2);
        const scalar_t weak_mat_tmp117 = weak_mat_tmp116 + weak_mat_tmp34;
        const scalar_t weak_mat_tmp118 = scalar_t(2)*pow_2(grad_u1);
        const scalar_t weak_mat_tmp119 = weak_mat_tmp118 + weak_mat_tmp36;
        const scalar_t weak_mat_tmp120 = scalar_t(6)*grad_u2;
        const scalar_t weak_mat_tmp121 = grad_u2*weak_mat_tmp48;
        const scalar_t weak_mat_tmp122 = mu*(scalar_t(4)*grad_u3*grad_u7 - weak_mat_tmp120 - weak_mat_tmp96) + weak_mat_tmp121;
        const scalar_t weak_mat_tmp123 = scalar_t(6)*grad_u1;
        const scalar_t weak_mat_tmp124 = grad_u1*weak_mat_tmp48;
        ...
        const scalar_t weak_mat_tmp127 = grad_u2*weak_mat_tmp22;
        const scalar_t weak_mat_tmp128 = mu*(-weak_mat_tmp127 - weak_mat_tmp74);
        const scalar_t weak_mat_tmp129 = grad_u6*weak_mat_tmp3;
        ...
        const scalar_t weak_mat_tmp134 = scalar_t(6)*grad_u0 + scalar_t(6);
        ...
        const scalar_t weak_mat_tmp139 = mu*(scalar_t(4)*grad_u5*grad_u6 - weak_mat_tmp123 - weak_mat_tmp69) + weak_mat_tmp124;
