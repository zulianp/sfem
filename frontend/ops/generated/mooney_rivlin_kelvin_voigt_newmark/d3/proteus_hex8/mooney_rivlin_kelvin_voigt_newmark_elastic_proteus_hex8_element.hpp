...
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex8_energy_element_coords_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        tensor_gradient_contiguous<s_t, NQ, NS, VS, 3>(nelems, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex8_isoparametric_reference_data<s_t>::shape_1d(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex8_isoparametric_reference_data<s_t>::grad_1d(), block_coordinate_data, 0, coordinate_grad_ref + 0 * NQ * ND * VS);
        tensor_gradient_contiguous<s_t, NQ, NS, VS, 3>(nelems, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex8_isoparametric_reference_data<s_t>::shape_1d(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex8_isoparametric_reference_data<s_t>::grad_1d(), block_coordinate_data, 1, coordinate_grad_ref + 1 * NQ * ND * VS);
        tensor_gradient_contiguous<s_t, NQ, NS, VS, 3>(nelems, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex8_isoparametric_reference_data<s_t>::shape_1d(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex8_isoparametric_reference_data<s_t>::grad_1d(), block_coordinate_data, 2, coordinate_grad_ref + 2 * NQ * ND * VS);
