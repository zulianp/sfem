...
static __host__ __device__ __forceinline__ int mooney_rivlin_kelvin_voigt_newmark_elastic_proteus_hex8_energy_egeometry_soa(
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    mooney_rivlin_kelvin_voigt_newmark_elastic_d3_tensor_product_objective_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::ref_line_p1_q2<s_t>::shape_1d(), sfem::codegen::ref_line_p1_q2<s_t>::grad_1d(), sfem::codegen::quad_line_q2<s_t>::q_weight_1d(), lmbda, mu, bu_streams, bvalue);
  }
  return SFEM_SUCCESS;
}
