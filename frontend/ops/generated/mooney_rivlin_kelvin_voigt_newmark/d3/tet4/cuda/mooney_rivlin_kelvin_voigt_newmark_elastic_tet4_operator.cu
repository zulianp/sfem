...
template <typename s_t, typename g_t, int VS>
__global__ void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_a_msoa_impl(
...
extern "C" int cu_mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_a_msoa", -1, (int)scalar_bytes);
}
