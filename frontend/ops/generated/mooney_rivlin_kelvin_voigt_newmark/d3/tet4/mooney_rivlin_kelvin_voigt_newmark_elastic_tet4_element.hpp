...
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_energy_egeometry_soa(
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_energy_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    mooney_rivlin_kelvin_voigt_newmark_elastic_d3_simplex_gradient_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bout_streams);
  }
  return SFEM_SUCCESS;
}

template <typename s_t, int VS = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_hessian_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    for (int col = 0; col < NDOFS; ++col) {
      ...
      mooney_rivlin_kelvin_voigt_newmark_elastic_d3_simplex_apply_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bh_streams, bout_streams);
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_hessian_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_hessian_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
