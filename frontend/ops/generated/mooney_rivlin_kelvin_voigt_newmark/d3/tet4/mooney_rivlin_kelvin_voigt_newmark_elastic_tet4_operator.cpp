...
extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_a_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_a_msoa",
      &sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_soa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_a_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_a_msoa_float",
      &sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_soa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_i_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_i_msoa",
      &sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_soa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_i_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_i_msoa_float",
      &sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_soa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_steps_a_msoa(
  ...
  return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_steps_a_msoa_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_steps_a_msoa_float(
  ...
  return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_steps_a_msoa_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_a_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_a_msoa",
      &sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_soa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_a_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_a_msoa_float",
      &sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_soa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_i_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_i_msoa",
      &sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_soa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_i_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_i_msoa_float",
      &sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_soa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_a_msoa(
  ...
  return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_a_msoa_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_a_msoa_float(
  ...
  return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_a_msoa_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_packed_a_msoa(
  ...
  return mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_packed_a_msoa_impl<double>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_packed_a_msoa_float(
  ...
  return mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_packed_a_msoa_impl<float>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_packed_two_pass_a_msoa(
  ...
  return mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_packed_two_pass_a_msoa_impl<double>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, n_ghost_entries, n_ghost_reduce_rows, ghost_reduce_ptr, ghost_reduce_idx, ghost_reduce_dest, ghost_buf, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_packed_two_pass_a_msoa_float(
  ...
  return mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_packed_two_pass_a_msoa_impl<float>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, n_ghost_entries, n_ghost_reduce_rows, ghost_reduce_ptr, ghost_reduce_idx, ghost_reduce_dest, ghost_buf, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_a_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
...
extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_a_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_a_msoa_float",
      &sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_soa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_i_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_i_msoa",
      &sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_soa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_i_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_i_msoa_float",
      &sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_soa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_a_msoa(
  ...
  return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_a_msoa_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_a_msoa_float(
  ...
  return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_a_msoa_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_packed_a_msoa(
  ...
  return mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_packed_a_msoa_impl<double>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_packed_a_msoa_float(
  ...
  return mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_packed_a_msoa_impl<float>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_packed_two_pass_a_msoa(
  ...
  return mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_packed_two_pass_a_msoa_impl<double>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, n_ghost_entries, n_ghost_reduce_rows, ghost_reduce_ptr, ghost_reduce_idx, ghost_reduce_dest, ghost_buf, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_packed_two_pass_a_msoa_float(
  ...
  return mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_packed_two_pass_a_msoa_impl<float>(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, n_ghost_entries, n_ghost_reduce_rows, ghost_reduce_ptr, ghost_reduce_idx, ghost_reduce_dest, ghost_buf, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
