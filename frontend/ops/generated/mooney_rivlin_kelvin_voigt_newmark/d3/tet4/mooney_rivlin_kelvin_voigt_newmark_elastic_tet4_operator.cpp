...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_steps_affine_mesh_soa(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_steps_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_steps_affine_mesh_soa_float(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_objective_steps_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_affine_mesh_soa(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_affine_mesh_soa_float(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_gradient_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_affine_mesh_soa(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_affine_mesh_soa_float(
    ...
    return sfem::codegen::mooney_rivlin_kelvin_voigt_newmark_elastic_tet4_apply_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
