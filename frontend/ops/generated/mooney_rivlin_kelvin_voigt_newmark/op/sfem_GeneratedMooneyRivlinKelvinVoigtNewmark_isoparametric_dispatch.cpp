...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_hessian_bsr_2d_i_msoa(
  ...
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_proteus_quad4_hessian_bsr_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, rowptr, colidx, values);
    case smesh::QUAD4:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_quad4_hessian_bsr_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, rowptr, colidx, values);
    case smesh::TRI3:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_tri3_hessian_bsr_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, rowptr, colidx, values);
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch(
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_hessian_bsr_3d_i_msoa(
  ...
  switch (element_type) {
    case smesh::HEX8:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_hex8_hessian_bsr_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, u2, previous_stride, u0_old, u1_old, u2_old, rowptr, colidx, values);
    case smesh::PROTEUS_HEX8:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_proteus_hex8_hessian_bsr_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, u2, previous_stride, u0_old, u1_old, u2_old, rowptr, colidx, values);
    case smesh::TET10:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_tet10_hessian_bsr_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, u2, previous_stride, u0_old, u1_old, u2_old, rowptr, colidx, values);
    case smesh::TET4:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_tet4_hessian_bsr_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, u2, previous_stride, u0_old, u1_old, u2_old, rowptr, colidx, values);
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch(
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_jacobian_action_2d_i_msoa(
  ...
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_proteus_quad4_jacobian_action_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, direction_stride, u0_direction, u1_direction, out_stride, u0_out, u1_out);
    case smesh::QUAD4:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_quad4_jacobian_action_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, direction_stride, u0_direction, u1_direction, out_stride, u0_out, u1_out);
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch(
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_jacobian_action_3d_i_msoa(
  ...
  switch (element_type) {
    case smesh::HEX8:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_hex8_jacobian_action_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, u2, previous_stride, u0_old, u1_old, u2_old, direction_stride, u0_direction, u1_direction, u2_direction, out_stride, u0_out, u1_out, u2_out);
    case smesh::PROTEUS_HEX8:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_residual_2d_i_msoa(
  ...
  switch (element_type) {
    case smesh::PROTEUS_QUAD4:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_proteus_quad4_residual_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, out_stride, u0_out, u1_out);
    case smesh::QUAD4:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_quad4_residual_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, previous_stride, u0_old, u1_old, out_stride, u0_out, u1_out);
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch(
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int mooney_rivlin_kelvin_voigt_newmark_viscous_residual_3d_i_msoa(
  ...
  switch (element_type) {
    case smesh::HEX8:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_hex8_residual_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, u2, previous_stride, u0_old, u1_old, u2_old, out_stride, u0_out, u1_out, u2_out);
    case smesh::PROTEUS_HEX8:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_proteus_hex8_residual_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, u2, previous_stride, u0_old, u1_old, u2_old, out_stride, u0_out, u1_out, u2_out);
    case smesh::TET10:
      return mooney_rivlin_kelvin_voigt_newmark_viscous_tet10_residual_i_msoa((int)resolved_real_type, nelements, nnodes, elements, points, eta_b, eta_s, u_dt_shift, current_stride, u0, u1, u2, previous_stride, u0_old, u1_old, u2_old, out_stride, u0_out, u1_out, u2_out);
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch(
