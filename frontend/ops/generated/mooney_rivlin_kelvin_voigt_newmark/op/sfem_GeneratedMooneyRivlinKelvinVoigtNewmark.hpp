...
namespace sfem {
    ...
    public:
        ...
        explicit GeneratedMooneyRivlinKelvinVoigtNewmark(const std::shared_ptr<FunctionSpace> &space);
        ~GeneratedMooneyRivlinKelvinVoigtNewmark() override;

        const char *name() const override { return "GeneratedMooneyRivlinKelvinVoigtNewmark"; }
