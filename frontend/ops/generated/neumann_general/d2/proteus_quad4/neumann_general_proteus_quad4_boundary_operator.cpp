...
template <typename scalar_t>
static SFEM_INLINE scalar_t neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_measure(
        const int q,
        const idx_t *const SFEM_RESTRICT ev,
        const geom_t *const *const SFEM_RESTRICT points) {
    const scalar_t *const grad = neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_reference_data<scalar_t>::grad();
    const int n_shape = neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_reference_data<scalar_t>::N_SHAPE;
...
static SFEM_INLINE const int *neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_side_nodes() {
...
static SFEM_INLINE void neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_gather_sideset_element(
        const element_idx_t parent_element,
        const int side,
        idx_t **const SFEM_RESTRICT elements,
        idx_t *const SFEM_RESTRICT ev) {
    const int *const SFEM_RESTRICT side_nodes = neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_side_nodes();
...
template <typename scalar_t>
static SFEM_INLINE void neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_element(
        const idx_t *const SFEM_RESTRICT ev,
    ...
    const scalar_t *const shape = neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_reference_data<scalar_t>::shape();
    const scalar_t *const weight = neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_reference_data<scalar_t>::weight();
    const int n_shape = neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_reference_data<scalar_t>::N_SHAPE;
    const int n_qp = neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_reference_data<scalar_t>::N_QP;



    for (int q = 0; q < n_qp; ++q) {
        const scalar_t dS = neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_measure<scalar_t>(q, ev, points);
...
template <typename scalar_t>
static SFEM_INLINE void neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_scatter_element(
        const idx_t *const SFEM_RESTRICT ev,
...
template <typename scalar_t>
static SFEM_INLINE int neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_impl(
...
#pragma omp parallel for
    for (ptrdiff_t e = 0; e < nelements; ++e) {
        ...
        neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_element<scalar_t>(ev, points, t0, t0_010, t0_100, t1, t1_010, t1_100, element_vector);
        neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_scatter_element<scalar_t>(ev, element_vector, out_stride, out0, out1);
    }
...
extern "C" int neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa(
        const ptrdiff_t nelements,
    ...
    return sfem::codegen::neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_impl<real_t>(
            nelements, nnodes, elements, points, t0, t0_010, t0_100, t1, t1_010, t1_100, out_stride, out0, out1);
}

extern "C" int neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_float(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    return sfem::codegen::neumann_general_proteus_quad4_edgeshell2_boundary_residual_soa_impl<float>(
            nelements, nnodes, elements, points, t0, t0_010, t0_100, t1, t1_010, t1_100, out_stride, out0, out1);
}
