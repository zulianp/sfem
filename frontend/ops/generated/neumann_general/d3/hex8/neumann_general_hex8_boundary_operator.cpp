...
template <typename s_t>
static SFEM_INLINE s_t neumann_general_hex8_quadshell4_boundary_residual_soa_measure(
        const int qx,
        const int qy,
        const idx_t *const SFEM_RESTRICT ev,
        const geom_t *const *const SFEM_RESTRICT points) {
    const s_t *const SFEM_RESTRICT shape_1d = neumann_general_hex8_quadshell4_boundary_residual_soa_reference_data<s_t>::shape_1d();
    const s_t *const SFEM_RESTRICT grad_1d = neumann_general_hex8_quadshell4_boundary_residual_soa_reference_data<s_t>::grad_1d();
    const int *const SFEM_RESTRICT shape_index = neumann_general_hex8_quadshell4_boundary_residual_soa_reference_data<s_t>::shape_index();
    constexpr int NS1 = 2;
    s_t dxdr0 = s_t(0);
    s_t dxdr1 = s_t(0);
    s_t dxdr2 = s_t(0);
...
static SFEM_INLINE void neumann_general_hex8_quadshell4_boundary_residual_soa_element(
    ...
    const s_t *const SFEM_RESTRICT shape_1d = neumann_general_hex8_quadshell4_boundary_residual_soa_reference_data<s_t>::shape_1d();
    const s_t *const SFEM_RESTRICT weight_1d = neumann_general_hex8_quadshell4_boundary_residual_soa_reference_data<s_t>::weight_1d();
    const int *const SFEM_RESTRICT shape_index = neumann_general_hex8_quadshell4_boundary_residual_soa_reference_data<s_t>::shape_index();
    constexpr int NS1 = 2;
    constexpr int NQ1 = 2;
