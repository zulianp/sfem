...
namespace sfem {
    class GeneratedNeumannGeneral final : public Op {
    public:
        static std::unique_ptr<Op> create(const std::shared_ptr<FunctionSpace> &space);

        explicit GeneratedNeumannGeneral(const std::shared_ptr<FunctionSpace> &space);
        ~GeneratedNeumannGeneral() override;

        const char *name() const override { return "GeneratedNeumannGeneral"; }
