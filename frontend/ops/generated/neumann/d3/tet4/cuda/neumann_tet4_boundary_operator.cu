...
__host__ __device__ __forceinline__ const int *neumann_tet4_trishell3_boundary_residual_soa_side_nodes() {
...
__host__ __device__ __forceinline__ void neumann_tet4_trishell3_boundary_residual_soa_gather_sideset_element(
...
template <typename s_t>
__host__ __device__ __forceinline__ void neumann_tet4_trishell3_boundary_residual_soa_element(
    const idx_t *const RSTR ev,
...
template <typename s_t>
__host__ __device__ __forceinline__ void neumann_tet4_trishell3_boundary_residual_soa_scatter_element(
    const idx_t *const RSTR ev,
...
template <typename s_t>
__global__ void neumann_tet4_trishell3_boundary_residual_soa_impl(
...
template <typename s_t>
__global__ void neumann_tet4_trishell3_boundary_residual_ss_soa_impl(
...
extern "C" int cu_neumann_tet4_trishell3_boundary_residual_soa(
    const ptrdiff_t nelements,
