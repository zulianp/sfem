...
struct neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_reference_data {
...
template <typename scalar_t>
static SFEM_INLINE scalar_t neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_measure(
        const int qx,
        const int qy,
        const idx_t *const SFEM_RESTRICT ev,
        const geom_t *const *const SFEM_RESTRICT points) {
    const scalar_t *const SFEM_RESTRICT shape_1d = neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_reference_data<scalar_t>::shape_1d();
    const scalar_t *const SFEM_RESTRICT grad_1d = neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_reference_data<scalar_t>::grad_1d();
    const int *const SFEM_RESTRICT shape_index = neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_reference_data<scalar_t>::shape_index();
    constexpr int S = 3;
...
static SFEM_INLINE const int *neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_side_nodes() {
...
static SFEM_INLINE void neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_gather_sideset_element(
        const element_idx_t parent_element,
        const int side,
        idx_t **const SFEM_RESTRICT elements,
        idx_t *const SFEM_RESTRICT ev) {
    const int *const SFEM_RESTRICT side_nodes = neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_side_nodes();
...
template <typename scalar_t>
static SFEM_INLINE void neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_element(
        const idx_t *const SFEM_RESTRICT ev,
    ...
    const scalar_t *const SFEM_RESTRICT shape_1d = neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_reference_data<scalar_t>::shape_1d();
    const scalar_t *const SFEM_RESTRICT weight_1d = neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_reference_data<scalar_t>::weight_1d();
    const int *const SFEM_RESTRICT shape_index = neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_reference_data<scalar_t>::shape_index();
    constexpr int S = 3;
    constexpr int Q = 3;
    ...
    for (int qy = 0; qy < Q; ++qy) {
        for (int qx = 0; qx < Q; ++qx) {
            const scalar_t dS = neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_measure<scalar_t>(qx, qy, ev, points);
...
template <typename scalar_t>
static SFEM_INLINE void neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_scatter_element(
        const idx_t *const SFEM_RESTRICT ev,
...
template <typename scalar_t>
static SFEM_INLINE int neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_impl(
...
#pragma omp parallel for
    for (ptrdiff_t e = 0; e < nelements; ++e) {
        ...
        neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_element<scalar_t>(ev, points, t0, t1, t2, element_vector);
        neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_scatter_element<scalar_t>(ev, element_vector, out_stride, out0, out1, out2);
    }
...
template <typename scalar_t>
static SFEM_INLINE int neumann_proteus_hex27_proteus_quadshell9_boundary_residual_sideset_soa_impl(
...
#pragma omp parallel for
    for (ptrdiff_t s = 0; s < nsides; ++s) {
        idx_t ev[9];
        scalar_t element_vector[3][9];
        neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_gather_sideset_element(parent[s], side_idx[s], elements, ev);
        for (int c = 0; c < 3; ++c) {
            for (int i = 0; i < 9; ++i) {
                element_vector[c][i] = scalar_t(0);
            }
...
extern "C" int neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa(
        const ptrdiff_t nelements,
    ...
    return sfem::codegen::neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_impl<real_t>(
            nelements, nnodes, elements, points, t0, t1, t2, out_stride, out0, out1, out2);
}

extern "C" int neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_float(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    return sfem::codegen::neumann_proteus_hex27_proteus_quadshell9_boundary_residual_soa_impl<float>(
            nelements, nnodes, elements, points, t0, t1, t2, out_stride, out0, out1, out2);
}
...
extern "C" int neumann_proteus_hex27_proteus_quadshell9_boundary_residual_sideset_soa(
        ...
        real_t *const SFEM_RESTRICT out1,
        real_t *const SFEM_RESTRICT out2) {
    return sfem::codegen::neumann_proteus_hex27_proteus_quadshell9_boundary_residual_sideset_soa_impl<real_t>(
...
extern "C" int neumann_proteus_hex27_proteus_quadshell9_boundary_residual_sideset_soa_float(
        ...
        float *const SFEM_RESTRICT out1,
        float *const SFEM_RESTRICT out2) {
    return sfem::codegen::neumann_proteus_hex27_proteus_quadshell9_boundary_residual_sideset_soa_impl<float>(
            nsides, nnodes, elements, parent, side_idx, points, t0, t1, t2, out_stride, out0, out1, out2);
}
