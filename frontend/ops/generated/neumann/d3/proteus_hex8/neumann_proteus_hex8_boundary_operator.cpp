...
template <typename scalar_t>
static SFEM_INLINE scalar_t neumann_proteus_hex8_proteus_quadshell4_boundary_residual_soa_measure(
        const int qx,
        const int qy,
        const idx_t *const SFEM_RESTRICT ev,
        const geom_t *const *const SFEM_RESTRICT points) {
    const scalar_t *const SFEM_RESTRICT shape_1d = neumann_proteus_hex8_proteus_quadshell4_boundary_residual_soa_reference_data<scalar_t>::shape_1d();
    const scalar_t *const SFEM_RESTRICT grad_1d = neumann_proteus_hex8_proteus_quadshell4_boundary_residual_soa_reference_data<scalar_t>::grad_1d();
    const int *const SFEM_RESTRICT shape_index = neumann_proteus_hex8_proteus_quadshell4_boundary_residual_soa_reference_data<scalar_t>::shape_index();
    constexpr int S = 2;
...
static SFEM_INLINE const int *neumann_proteus_hex8_proteus_quadshell4_boundary_residual_soa_side_nodes() {
...
static SFEM_INLINE void neumann_proteus_hex8_proteus_quadshell4_boundary_residual_soa_element(
    ...
    const scalar_t *const SFEM_RESTRICT shape_1d = neumann_proteus_hex8_proteus_quadshell4_boundary_residual_soa_reference_data<scalar_t>::shape_1d();
    const scalar_t *const SFEM_RESTRICT weight_1d = neumann_proteus_hex8_proteus_quadshell4_boundary_residual_soa_reference_data<scalar_t>::weight_1d();
    const int *const SFEM_RESTRICT shape_index = neumann_proteus_hex8_proteus_quadshell4_boundary_residual_soa_reference_data<scalar_t>::shape_index();
    constexpr int S = 2;
    constexpr int Q = 2;
...
#pragma omp parallel for
    for (ptrdiff_t e = 0; e < nelements; ++e) {
        ...
        neumann_proteus_hex8_proteus_quadshell4_boundary_residual_soa_element<scalar_t>(ev, points, t0, t1, t2, element_vector);
        neumann_proteus_hex8_proteus_quadshell4_boundary_residual_soa_scatter_element<scalar_t>(ev, element_vector, out_stride, out0, out1, out2);
    }
