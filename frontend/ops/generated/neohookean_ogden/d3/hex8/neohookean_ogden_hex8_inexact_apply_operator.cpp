...
extern "C" int neohookean_ogden_hex8_inexact_apply_tangent_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("neohookean_ogden_hex8_inexact_apply_tangent_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int neohookean_ogden_hex8_inexact_apply_stored_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("neohookean_ogden_hex8_inexact_apply_stored_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int neohookean_ogden_hex8_inexact_apply_stored_packed_two_pass_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("neohookean_ogden_hex8_inexact_apply_stored_packed_two_pass_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int neohookean_ogden_hex8_inexact_apply_compressed_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("neohookean_ogden_hex8_inexact_apply_compressed_a_msoa", -1, (int)scalar_bytes);
}
