...
extern "C" int neohookean_ogden_hex8_apply_i_msoa(
    ...
    return neohookean_ogden_proteus_hex8_apply_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int neohookean_ogden_hex8_gradient_i_msoa(
    ...
    return neohookean_ogden_proteus_hex8_gradient_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int neohookean_ogden_hex8_hessian_bsr_i_msoa(
    ...
    return neohookean_ogden_proteus_hex8_hessian_bsr_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, lmbda, mu, u_stride, ux, uy, uz, rowptr, colidx, values);
}
...
extern "C" int neohookean_ogden_hex8_objective_steps_i_msoa(
    ...
    return neohookean_ogden_proteus_hex8_objective_steps_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int neohookean_ogden_hex8_apply_a_msoa(
    ...
    return neohookean_ogden_proteus_hex8_apply_a_msoa(scalar_bytes, nelements, nnodes, proteus_elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int neohookean_ogden_hex8_gradient_a_msoa(
    ...
    return neohookean_ogden_proteus_hex8_gradient_a_msoa(scalar_bytes, nelements, nnodes, proteus_elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int neohookean_ogden_hex8_objective_steps_a_msoa(
    ...
    return neohookean_ogden_proteus_hex8_objective_steps_a_msoa(scalar_bytes, nelements, nnodes, proteus_elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int neohookean_ogden_hex8_apply_packed_i_msoa(
    ...
    return neohookean_ogden_proteus_hex8_apply_packed_i_msoa(scalar_bytes, n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int neohookean_ogden_hex8_gradient_packed_i_msoa(
    ...
    return neohookean_ogden_proteus_hex8_gradient_packed_i_msoa(scalar_bytes, n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, points, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int neohookean_ogden_hex8_objective_steps_packed_i_msoa(
    ...
    return neohookean_ogden_proteus_hex8_objective_steps_packed_i_msoa(scalar_bytes, n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, points, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int neohookean_ogden_hex8_apply_packed_a_msoa(
    ...
    return neohookean_ogden_proteus_hex8_apply_packed_a_msoa(scalar_bytes, n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int neohookean_ogden_hex8_gradient_packed_a_msoa(
    ...
    return neohookean_ogden_proteus_hex8_gradient_packed_a_msoa(scalar_bytes, n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, lmbda, mu, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
