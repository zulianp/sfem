...
static SFEM_INLINE int neohookean_ogden_hex8_hex8_objective_soa_impl(
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_hex8_hex8_objective_soa(
        const ptrdiff_t nelements,
    ...
    return sfem::codegen::neohookean_ogden_hex8_hex8_objective_soa_impl<real_t, 8, 8, 16>(nelements, jacobian_adjugate0, jacobian_adjugate1, jacobian_adjugate2, jacobian_adjugate3, jacobian_adjugate4, jacobian_adjugate5, jacobian_adjugate6, jacobian_adjugate7, jacobian_adjugate8, jacobian_determinant0, sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::shape_1d(), sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::grad_1d(), sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::q_weight_1d(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, ux4, uy4, uz4, ux5, uy5, uz5, ux6, uy6, uz6, ux7, uy7, uz7, value);
}
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_hex8_hex8_objective_isoparametric_soa_impl(
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_hex8_hex8_objective_isoparametric_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
    ...
    return sfem::codegen::neohookean_ogden_hex8_hex8_objective_isoparametric_soa_impl<real_t, 8, 8, 16>(nelements, x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4, x5, y5, z5, x6, y6, z6, x7, y7, z7, sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::shape_1d(), sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::grad_1d(), sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::q_weight_1d(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, ux4, uy4, uz4, ux5, uy5, uz5, ux6, uy6, uz6, ux7, uy7, uz7, value);
}
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_hex8_hex8_gradient_soa_impl(
        const ptrdiff_t nelements,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate0,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate1,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate2,
...
extern "C" int neohookean_ogden_hex8_hex8_gradient_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT jacobian_adjugate0,
        const real_t *const SFEM_RESTRICT jacobian_adjugate1,
        const real_t *const SFEM_RESTRICT jacobian_adjugate2,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_hex8_hex8_gradient_isoparametric_soa_impl(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
...
extern "C" int neohookean_ogden_hex8_hex8_gradient_isoparametric_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
    ...
    return sfem::codegen::neohookean_ogden_hex8_hex8_gradient_isoparametric_soa_impl<real_t, 8, 8, 16>(nelements, x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4, x5, y5, z5, x6, y6, z6, x7, y7, z7, sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::shape_1d(), sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::grad_1d(), sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::q_weight_1d(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, ux4, uy4, uz4, ux5, uy5, uz5, ux6, uy6, uz6, ux7, uy7, uz7, outx0, outy0, outz0, outx1, outy1, outz1, outx2, outy2, outz2, outx3, outy3, outz3, outx4, outy4, outz4, outx5, outy5, outz5, outx6, outy6, outz6, outx7, outy7, outz7);
}
...
extern "C" int neohookean_ogden_hex8_hex8_gradient_affine_mesh_soa(
    ...
    return sfem::codegen::neohookean_ogden_hex8_hex8_gradient_affine_mesh_soa_impl<double>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
extern "C" int neohookean_ogden_hex8_hex8_gradient_affine_mesh_soa_float(
    ...
    return sfem::codegen::neohookean_ogden_hex8_hex8_gradient_affine_mesh_soa_impl<float>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, out_stride, outx, outy, outz);
}
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_hex8_hex8_apply_soa_impl(
        const ptrdiff_t nelements,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate0,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate1,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate2,
...
extern "C" int neohookean_ogden_hex8_hex8_apply_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT jacobian_adjugate0,
        const real_t *const SFEM_RESTRICT jacobian_adjugate1,
        const real_t *const SFEM_RESTRICT jacobian_adjugate2,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_hex8_hex8_apply_isoparametric_soa_impl(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
...
extern "C" int neohookean_ogden_hex8_hex8_apply_isoparametric_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
    ...
    return sfem::codegen::neohookean_ogden_hex8_hex8_apply_isoparametric_soa_impl<real_t, 8, 8, 16>(nelements, x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4, x5, y5, z5, x6, y6, z6, x7, y7, z7, sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::shape_1d(), sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::grad_1d(), sfem::codegen::neohookean_ogden_hex8_isoparametric_reference_data<real_t>::q_weight_1d(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, ux4, uy4, uz4, ux5, uy5, uz5, ux6, uy6, uz6, ux7, uy7, uz7, hx0, hy0, hz0, hx1, hy1, hz1, hx2, hy2, hz2, hx3, hy3, hz3, hx4, hy4, hz4, hx5, hy5, hz5, hx6, hy6, hz6, hx7, hy7, hz7, outx0, outy0, outz0, outx1, outy1, outz1, outx2, outy2, outz2, outx3, outy3, outz3, outx4, outy4, outz4, outx5, outy5, outz5, outx6, outy6, outz6, outx7, outy7, outz7);
}
