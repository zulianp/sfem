...
static SFEM_INLINE int neohookean_ogden_hex8_energy_element_coords_soa(
    ...
    return neohookean_ogden_proteus_hex8_energy_element_coords_soa<s_t, VS>(nelements, ordered_coords, lmbda, mu, ordered_u_streams, values);
}
...
static SFEM_INLINE int neohookean_ogden_hex8_energy_element_soa(
    ...
    return neohookean_ogden_proteus_hex8_energy_element_soa<s_t, VS>(nelements, ordered_coords, lmbda, mu, ordered_u_streams, values);
}
...
static SFEM_INLINE int neohookean_ogden_hex8_gradient_element_coords_soa(
    ...
    return neohookean_ogden_proteus_hex8_gradient_element_coords_soa<s_t, VS>(nelements, ordered_coords, lmbda, mu, ordered_u_streams, ordered_out_streams);
}
...
static SFEM_INLINE int neohookean_ogden_hex8_gradient_element_soa(
    ...
    return neohookean_ogden_proteus_hex8_gradient_element_soa<s_t, VS>(nelements, ordered_coords, lmbda, mu, ordered_u_streams, ordered_out_streams);
}
...
static SFEM_INLINE int neohookean_ogden_hex8_hessian_element_coords_soa(
    ...
    return neohookean_ogden_proteus_hex8_hessian_element_coords_soa<s_t, VS>(nelements, ordered_coords, lmbda, mu, ordered_u_streams, ordered_matrix_streams);
}
...
static SFEM_INLINE int neohookean_ogden_hex8_hessian_element_soa(
    ...
    return neohookean_ogden_proteus_hex8_hessian_element_soa<s_t, VS>(nelements, ordered_coords, lmbda, mu, ordered_u_streams, ordered_matrix_streams);
}
