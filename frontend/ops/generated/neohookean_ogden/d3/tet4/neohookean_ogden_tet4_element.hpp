...
static SFEM_INLINE int neohookean_ogden_tet4_energy_egeometry_soa(
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    neohookean_ogden_d3_simplex_objective_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bvalue);
  }
  return SFEM_SUCCESS;
}
...
static SFEM_INLINE int neohookean_ogden_tet4_gradient_egeometry_soa(
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    neohookean_ogden_d3_simplex_gradient_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bout_streams);
  }
  return SFEM_SUCCESS;
}
...
static SFEM_INLINE int neohookean_ogden_tet4_hessian_egeometry_soa(
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    for (int col = 0; col < NDOFS; ++col) {
      ...
      neohookean_ogden_d3_simplex_apply_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bh_streams, bout_streams);
