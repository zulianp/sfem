...
static SFEM_INLINE int neohookean_ogden_tet4_energy_element_geometry_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        neohookean_ogden_d3_simplex_objective_block<s_t, NQ, NS, VS>(nelems, VS, bjacobian_adjugate0, bjacobian_adjugate1, bjacobian_adjugate2, bjacobian_adjugate3, bjacobian_adjugate4, bjacobian_adjugate5, bjacobian_adjugate6, bjacobian_adjugate7, bjacobian_adjugate8, bjacobian_determinant0, sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bvalue);
    }
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int neohookean_ogden_tet4_gradient_element_geometry_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        neohookean_ogden_d3_simplex_gradient_block<s_t, NQ, NS, VS>(nelems, VS, bjacobian_adjugate0, bjacobian_adjugate1, bjacobian_adjugate2, bjacobian_adjugate3, bjacobian_adjugate4, bjacobian_adjugate5, bjacobian_adjugate6, bjacobian_adjugate7, bjacobian_adjugate8, bjacobian_determinant0, sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bout_streams);
    }
    return SFEM_SUCCESS;
}
...
static SFEM_INLINE int neohookean_ogden_tet4_hessian_element_geometry_soa(
    ...
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        for (int col = 0; col < NDOFS; ++col) {
            ...
            neohookean_ogden_d3_simplex_apply_block<s_t, NQ, NS, VS>(nelems, VS, bjacobian_adjugate0, bjacobian_adjugate1, bjacobian_adjugate2, bjacobian_adjugate3, bjacobian_adjugate4, bjacobian_adjugate5, bjacobian_adjugate6, bjacobian_adjugate7, bjacobian_adjugate8, bjacobian_determinant0, sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::grad_ref_z(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bh_streams, bout_streams);
