...
static SFEM_INLINE int neohookean_ogden_tet4_tet4_objective_soa_impl(
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_tet4_tet4_objective_soa(
        const ptrdiff_t nelements,
    ...
    return sfem::codegen::neohookean_ogden_tet4_tet4_objective_soa_impl<real_t, 1, 4, 16>(nelements, jacobian_adjugate0, jacobian_adjugate1, jacobian_adjugate2, jacobian_adjugate3, jacobian_adjugate4, jacobian_adjugate5, jacobian_adjugate6, jacobian_adjugate7, jacobian_adjugate8, jacobian_determinant0, sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_z(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::q_weight(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, value);
}
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_tet4_tet4_objective_isoparametric_soa_impl(
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_tet4_tet4_objective_isoparametric_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
    ...
    return sfem::codegen::neohookean_ogden_tet4_tet4_objective_isoparametric_soa_impl<real_t, 1, 4, 16>(nelements, x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_z(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::q_weight(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, value);
}
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_tet4_tet4_gradient_soa_impl(
        const ptrdiff_t nelements,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate0,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate1,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate2,
...
extern "C" int neohookean_ogden_tet4_tet4_gradient_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT jacobian_adjugate0,
        const real_t *const SFEM_RESTRICT jacobian_adjugate1,
        const real_t *const SFEM_RESTRICT jacobian_adjugate2,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_tet4_tet4_gradient_isoparametric_soa_impl(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
...
extern "C" int neohookean_ogden_tet4_tet4_gradient_isoparametric_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
    ...
    return sfem::codegen::neohookean_ogden_tet4_tet4_gradient_isoparametric_soa_impl<real_t, 1, 4, 16>(nelements, x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_z(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::q_weight(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, outx0, outy0, outz0, outx1, outy1, outz1, outx2, outy2, outz2, outx3, outy3, outz3);
}
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_tet4_tet4_apply_soa_impl(
        const ptrdiff_t nelements,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate0,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate1,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate2,
...
extern "C" int neohookean_ogden_tet4_tet4_apply_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT jacobian_adjugate0,
        const real_t *const SFEM_RESTRICT jacobian_adjugate1,
        const real_t *const SFEM_RESTRICT jacobian_adjugate2,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_tet4_tet4_apply_isoparametric_soa_impl(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
...
extern "C" int neohookean_ogden_tet4_tet4_apply_isoparametric_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
    ...
    return sfem::codegen::neohookean_ogden_tet4_tet4_apply_isoparametric_soa_impl<real_t, 1, 4, 16>(nelements, x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::grad_ref_z(), sfem::codegen::neohookean_ogden_tet4_isoparametric_reference_data<real_t>::q_weight(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, hx0, hy0, hz0, hx1, hy1, hz1, hx2, hy2, hz2, hx3, hy3, hz3, outx0, outy0, outz0, outx1, outy1, outz1, outx2, outy2, outz2, outx3, outy3, outz3);
}
