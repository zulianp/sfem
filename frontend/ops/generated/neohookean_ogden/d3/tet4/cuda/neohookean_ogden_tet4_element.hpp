#ifndef NEOHOOKEAN_OGDEN_TET4_ELEMENT_API_CUH
#define NEOHOOKEAN_OGDEN_TET4_ELEMENT_API_CUH
...
static __host__ __device__ __forceinline__ int neohookean_ogden_tet4_energy_egeometry_soa(
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int neohookean_ogden_tet4_energy_ecoords_soa(
        const ptrdiff_t nelements,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int neohookean_ogden_tet4_energy_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int neohookean_ogden_tet4_gradient_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    neohookean_ogden_d3_simplex_gradient_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, badj4, badj5, badj6, badj7, badj8, bdet0, sfem::codegen::ref_tet4_q1<s_t>::grad_ref_x(), sfem::codegen::ref_tet4_q1<s_t>::grad_ref_y(), sfem::codegen::ref_tet4_q1<s_t>::grad_ref_z(), sfem::codegen::quad_tet_q1<s_t>::q_weight(), lmbda, mu, bu_streams, bout_streams);
  }
  return SFEM_SUCCESS;
}

template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int neohookean_ogden_tet4_gradient_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int neohookean_ogden_tet4_gradient_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int neohookean_ogden_tet4_hessian_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int neohookean_ogden_tet4_hessian_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS>
static __host__ __device__ __forceinline__ int neohookean_ogden_tet4_hessian_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
