...
extern "C" int neohookean_ogden_hex27_hex27_objective_steps_affine_mesh_soa(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_objective_steps_affine_mesh_soa_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int neohookean_ogden_hex27_hex27_objective_steps_affine_mesh_soa_float(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_objective_steps_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, nsteps, steps, value);
}
...
extern "C" int neohookean_ogden_hex27_hex27_apply_affine_mesh_soa_float(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_apply_affine_mesh_soa_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
template <typename scalar_t>
static SFEM_INLINE count_t neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_find_col(
        const idx_t node_i,
        const idx_t node_j,
...
template <typename scalar_t>
static SFEM_INLINE void neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_bsr(
    ...
    for (int i = 0; i < N_SHAPE; ++i) {
        for (int j = 0; j < N_SHAPE; ++j) {
            const count_t entry = neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_find_col<scalar_t>(ev[i], ev[j], rowptr, colidx);
...
template <typename scalar_t>
static SFEM_INLINE void neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_crs(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
        const count_t *const SFEM_RESTRICT rowptr,
        const idx_t *const SFEM_RESTRICT colidx,
...
template <typename scalar_t>
static SFEM_INLINE void neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_dia(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
        const ptrdiff_t nnodes,
...
template <typename scalar_t>
static SFEM_INLINE void neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_coo(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
        const ptrdiff_t nnz,
...
template <typename scalar_t>
static SFEM_INLINE void neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_patch(
        const idx_t *const SFEM_RESTRICT ev,
        const scalar_t *const SFEM_RESTRICT element_matrix,
...
static int neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geometry_t *const *const SFEM_RESTRICT points,
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t element = 0; element < nelements; ++element) {
        ...
        if constexpr (FORMAT == 1) {
            neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_bsr(ev, element_matrix, rowptr, colidx, values);
        } else if constexpr (FORMAT == 0) {
            neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_crs(ev, element_matrix, rowptr, colidx, values);
        } else if constexpr (FORMAT == 2) {
            neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_dia(ev, element_matrix, nnodes, diag_offsets, ndiag, values);
        } else if constexpr (FORMAT == 3) {
            neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_coo(ev, element_matrix, coo_nnz, coo_rows, coo_cols, values);
        } else {
            neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_scatter_patch(ev, element_matrix, node_to_patch, npatch, values);
        }
    }
...
extern "C" int neohookean_ogden_hex27_hex27_hessian_crs_isoparametric_mesh_soa(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 0>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int neohookean_ogden_hex27_hex27_hessian_crs_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 0>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int neohookean_ogden_hex27_hex27_hessian_bsr_isoparametric_mesh_soa(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 1>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int neohookean_ogden_hex27_hex27_hessian_bsr_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 1>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, rowptr, colidx, values, nullptr, 0, 0, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int neohookean_ogden_hex27_hex27_hessian_dia_isoparametric_mesh_soa(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 2>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, diag_offsets, ndiag, 0, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int neohookean_ogden_hex27_hex27_hessian_dia_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 2>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, diag_offsets, ndiag, 0, nullptr, nullptr, nullptr, 0);
}
...
extern "C" int neohookean_ogden_hex27_hex27_hessian_coo_isoparametric_mesh_soa(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 3>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, nullptr, 0, nnz, rows, cols, nullptr, 0);
}
...
extern "C" int neohookean_ogden_hex27_hex27_hessian_coo_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 3>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, nullptr, 0, nnz, rows, cols, nullptr, 0);
}
...
extern "C" int neohookean_ogden_hex27_hex27_hessian_patch_isoparametric_mesh_soa(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<double, geom_t, 4>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, nullptr, 0, 0, nullptr, nullptr, node_to_patch, npatch);
}
...
extern "C" int neohookean_ogden_hex27_hex27_hessian_patch_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::neohookean_ogden_hex27_hex27_hessian_isoparametric_mesh_soa_assemble_impl<float, geom_t, 4>(nelements, nnodes, elements, points, mu, lmbda, u_stride, ux, uy, uz, nullptr, nullptr, values, nullptr, 0, 0, nullptr, nullptr, node_to_patch, npatch);
}
