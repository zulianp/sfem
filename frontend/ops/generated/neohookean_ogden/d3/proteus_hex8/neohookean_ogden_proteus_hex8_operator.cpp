...
static SFEM_INLINE int neohookean_ogden_proteus_hex8_proteus_hex8_objective_soa_impl(
        const ptrdiff_t nelements,
...
#pragma omp simd
        ...
        const scalar_t *const block_u_streams[N_SHAPE * 3] = {block_ux0, block_uy0, block_uz0, block_ux1, block_uy1, block_uz1, block_ux2, block_uy2, block_uz2, block_ux3, block_uy3, block_uz3, block_ux4, block_uy4, block_uz4, block_ux5, block_uy5, block_uz5, block_ux6, block_uy6, block_uz6, block_ux7, block_uy7, block_uz7};
...
extern "C" int neohookean_ogden_proteus_hex8_proteus_hex8_objective_soa(
        const ptrdiff_t nelements,
    ...
    return sfem::codegen::neohookean_ogden_proteus_hex8_proteus_hex8_objective_soa_impl<real_t, 8, 8, 16>(nelements, jacobian_adjugate0, jacobian_adjugate1, jacobian_adjugate2, jacobian_adjugate3, jacobian_adjugate4, jacobian_adjugate5, jacobian_adjugate6, jacobian_adjugate7, jacobian_adjugate8, jacobian_determinant0, sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::shape_1d(), sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::grad_1d(), sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::q_weight_1d(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, ux4, uy4, uz4, ux5, uy5, uz5, ux6, uy6, uz6, ux7, uy7, uz7, value);
}
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_proteus_hex8_proteus_hex8_objective_isoparametric_soa_impl(
        const ptrdiff_t nelements,
...
#pragma omp simd
        ...
        const scalar_t *const block_coordinate_streams[DIM * N_SHAPE] = {block_x0, block_y0, block_z0, block_x1, block_y1, block_z1, block_x2, block_y2, block_z2, block_x3, block_y3, block_z3, block_x4, block_y4, block_z4, block_x5, block_y5, block_z5, block_x6, block_y6, block_z6, block_x7, block_y7, block_z7};
...
extern "C" int neohookean_ogden_proteus_hex8_proteus_hex8_objective_isoparametric_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
    ...
    return sfem::codegen::neohookean_ogden_proteus_hex8_proteus_hex8_objective_isoparametric_soa_impl<real_t, 8, 8, 16>(nelements, x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4, x5, y5, z5, x6, y6, z6, x7, y7, z7, sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::shape_1d(), sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::grad_1d(), sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::q_weight_1d(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, ux4, uy4, uz4, ux5, uy5, uz5, ux6, uy6, uz6, ux7, uy7, uz7, value);
}
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_proteus_hex8_proteus_hex8_gradient_soa_impl(
        const ptrdiff_t nelements,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate0,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate1,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate2,
...
extern "C" int neohookean_ogden_proteus_hex8_proteus_hex8_gradient_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT jacobian_adjugate0,
        const real_t *const SFEM_RESTRICT jacobian_adjugate1,
        const real_t *const SFEM_RESTRICT jacobian_adjugate2,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_proteus_hex8_proteus_hex8_gradient_isoparametric_soa_impl(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
...
extern "C" int neohookean_ogden_proteus_hex8_proteus_hex8_gradient_isoparametric_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
    ...
    return sfem::codegen::neohookean_ogden_proteus_hex8_proteus_hex8_gradient_isoparametric_soa_impl<real_t, 8, 8, 16>(nelements, x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4, x5, y5, z5, x6, y6, z6, x7, y7, z7, sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::shape_1d(), sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::grad_1d(), sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::q_weight_1d(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, ux4, uy4, uz4, ux5, uy5, uz5, ux6, uy6, uz6, ux7, uy7, uz7, outx0, outy0, outz0, outx1, outy1, outz1, outx2, outy2, outz2, outx3, outy3, outz3, outx4, outy4, outz4, outx5, outy5, outz5, outx6, outy6, outz6, outx7, outy7, outz7);
}
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_proteus_hex8_proteus_hex8_apply_soa_impl(
        const ptrdiff_t nelements,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate0,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate1,
        const scalar_t *const SFEM_RESTRICT jacobian_adjugate2,
...
#pragma omp simd
        ...
        const scalar_t *const block_u_streams[N_SHAPE * 3] = {block_ux0, block_uy0, block_uz0, block_ux1, block_uy1, block_uz1, block_ux2, block_uy2, block_uz2, block_ux3, block_uy3, block_uz3, block_ux4, block_uy4, block_uz4, block_ux5, block_uy5, block_uz5, block_ux6, block_uy6, block_uz6, block_ux7, block_uy7, block_uz7};
        const scalar_t *const block_h_streams[N_SHAPE * 3] = {block_hx0, block_hy0, block_hz0, block_hx1, block_hy1, block_hz1, block_hx2, block_hy2, block_hz2, block_hx3, block_hy3, block_hz3, block_hx4, block_hy4, block_hz4, block_hx5, block_hy5, block_hz5, block_hx6, block_hy6, block_hz6, block_hx7, block_hy7, block_hz7};
        scalar_t *const block_out_streams[N_SHAPE * 3] = {block_outx0, block_outy0, block_outz0, block_outx1, block_outy1, block_outz1, block_outx2, block_outy2, block_outz2, block_outx3, block_outy3, block_outz3, block_outx4, block_outy4, block_outz4, block_outx5, block_outy5, block_outz5, block_outx6, block_outy6, block_outz6, block_outx7, block_outy7, block_outz7};
...
extern "C" int neohookean_ogden_proteus_hex8_proteus_hex8_apply_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT jacobian_adjugate0,
        const real_t *const SFEM_RESTRICT jacobian_adjugate1,
        const real_t *const SFEM_RESTRICT jacobian_adjugate2,
...
template <typename scalar_t, int N_QP, int N_SHAPE, int VECTOR_SIZE>
static SFEM_INLINE int neohookean_ogden_proteus_hex8_proteus_hex8_apply_isoparametric_soa_impl(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
...
extern "C" int neohookean_ogden_proteus_hex8_proteus_hex8_apply_isoparametric_soa(
        const ptrdiff_t nelements,
        const real_t *const SFEM_RESTRICT x0,
        const real_t *const SFEM_RESTRICT y0,
        const real_t *const SFEM_RESTRICT z0,
    ...
    return sfem::codegen::neohookean_ogden_proteus_hex8_proteus_hex8_apply_isoparametric_soa_impl<real_t, 8, 8, 16>(nelements, x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4, x5, y5, z5, x6, y6, z6, x7, y7, z7, sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::shape_1d(), sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::grad_1d(), sfem::codegen::neohookean_ogden_proteus_hex8_isoparametric_reference_data<real_t>::q_weight_1d(), mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, ux4, uy4, uz4, ux5, uy5, uz5, ux6, uy6, uz6, ux7, uy7, uz7, hx0, hy0, hz0, hx1, hy1, hz1, hx2, hy2, hz2, hx3, hy3, hz3, hx4, hy4, hz4, hx5, hy5, hz5, hx6, hy6, hz6, hx7, hy7, hz7, outx0, outy0, outz0, outx1, outy1, outz1, outx2, outy2, outz2, outx3, outy3, outz3, outx4, outy4, outz4, outx5, outy5, outz5, outx6, outy6, outz6, outx7, outy7, outz7);
}
...
extern "C" int neohookean_ogden_proteus_hex8_proteus_hex8_apply_affine_mesh_soa(
    ...
    return sfem::codegen::neohookean_ogden_proteus_hex8_proteus_hex8_apply_affine_mesh_soa_impl<double>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
...
extern "C" int neohookean_ogden_proteus_hex8_proteus_hex8_apply_affine_mesh_soa_float(
    ...
    return sfem::codegen::neohookean_ogden_proteus_hex8_proteus_hex8_apply_affine_mesh_soa_impl<float>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, uz, h_stride, hx, hy, hz, out_stride, outx, outy, outz);
}
