...
static SFEM_INLINE void neohookean_ogden_d3_tensor_product_objective_block(
    ...
    for (int q = 0; q < NQ; ++q) {
        ...
        const s_t weak_obj_tmp0 = grad_u[0] + s_t(1);
        const s_t weak_obj_tmp1 = grad_u[4] + s_t(1);
        const s_t weak_obj_tmp2 = grad_u[8] + s_t(1);
        const s_t weak_obj_tmp3 = log(-grad_u[1]*grad_u[3]*weak_obj_tmp2 + grad_u[1]*grad_u[5]*grad_u[6] + grad_u[2]*grad_u[3]*grad_u[7] - grad_u[2]*grad_u[6]*weak_obj_tmp1 - grad_u[5]*grad_u[7]*weak_obj_tmp0 + weak_obj_tmp0*weak_obj_tmp1*weak_obj_tmp2);
        value[lane] += qw * jacobian_determinant_lane0 * (((s_t(1) / s_t(2)))*lmbda*pow_2(weak_obj_tmp3) - mu*weak_obj_tmp3 + ((s_t(1) / s_t(2)))*mu*(pow_2(grad_u[1]) + pow_2(grad_u[2]) + pow_2(grad_u[3]) + pow_2(grad_u[5]) + pow_2(grad_u[6]) + pow_2(grad_u[7]) + pow_2(weak_obj_tmp0) + pow_2(weak_obj_tmp1) + pow_2(weak_obj_tmp2) + s_t(-3)));
        }
    }
}
...
static SFEM_INLINE void neohookean_ogden_d3_tensor_product_gradient_block(
    ...
    for (int q = 0; q < NQ; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            s_t loperand[9];
        s_t material[9];
        const s_t weak_mat_tmp0 = grad_u[0] + s_t(1);
        const s_t weak_mat_tmp1 = grad_u[5]*grad_u[7];
        const s_t weak_mat_tmp2 = grad_u[4] + s_t(1);
        const s_t weak_mat_tmp3 = grad_u[8] + s_t(1);
        const s_t weak_mat_tmp4 = -weak_mat_tmp1 + weak_mat_tmp2*weak_mat_tmp3;
        const s_t weak_mat_tmp5 = grad_u[3]*weak_mat_tmp3;
        const s_t weak_mat_tmp6 = grad_u[6]*weak_mat_tmp2;
        const s_t weak_mat_tmp7 = grad_u[1]*grad_u[5]*grad_u[6] - grad_u[1]*weak_mat_tmp5 + grad_u[2]*grad_u[3]*grad_u[7] - grad_u[2]*weak_mat_tmp6 - weak_mat_tmp0*weak_mat_tmp1 + weak_mat_tmp0*weak_mat_tmp2*weak_mat_tmp3;
        ...
        const s_t weak_mat_tmp11 = grad_u[5]*grad_u[6] - weak_mat_tmp5;
        const s_t weak_mat_tmp12 = grad_u[3]*grad_u[7] - weak_mat_tmp6;
        const s_t weak_mat_tmp13 = -grad_u[1]*weak_mat_tmp3 + grad_u[2]*grad_u[7];
        const s_t weak_mat_tmp14 = -grad_u[2]*grad_u[6] + weak_mat_tmp0*weak_mat_tmp3;
        const s_t weak_mat_tmp15 = grad_u[1]*grad_u[6] - grad_u[7]*weak_mat_tmp0;
        const s_t weak_mat_tmp16 = grad_u[1]*grad_u[5] - grad_u[2]*weak_mat_tmp2;
        const s_t weak_mat_tmp17 = grad_u[2]*grad_u[3] - grad_u[5]*weak_mat_tmp0;
        const s_t weak_mat_tmp18 = -grad_u[1]*grad_u[3] + weak_mat_tmp0*weak_mat_tmp2;
...
static SFEM_INLINE void neohookean_ogden_d3_tensor_product_apply_block(
    ...
    for (int q = 0; q < NQ; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            s_t loperand[9];
        s_t material[9];
        const s_t weak_mat_tmp0 = grad_u[5]*grad_u[7];
        ...
        const s_t weak_mat_tmp5 = grad_u[3]*weak_mat_tmp2;
        const s_t weak_mat_tmp6 = grad_u[6]*weak_mat_tmp1;
        const s_t weak_mat_tmp7 = grad_u[0] + s_t(1);
        const s_t weak_mat_tmp8 = grad_u[1]*grad_u[5]*grad_u[6] - grad_u[1]*weak_mat_tmp5 + grad_u[2]*grad_u[3]*grad_u[7] - grad_u[2]*weak_mat_tmp6 - weak_mat_tmp0*weak_mat_tmp7 + weak_mat_tmp1*weak_mat_tmp2*weak_mat_tmp7;
        ...
        const s_t weak_mat_tmp15 = -grad_u[5]*grad_u[6] + weak_mat_tmp5;
        ...
        const s_t weak_mat_tmp34 = grad_u[7]*weak_mat_tmp33;
        const s_t weak_mat_tmp35 = lmbda*weak_mat_tmp13*weak_mat_tmp32;
        const s_t weak_mat_tmp36 = grad_u[7]*weak_mat_tmp35;
        const s_t weak_mat_tmp37 = weak_mat_tmp17*weak_mat_tmp30 + weak_mat_tmp34 - weak_mat_tmp36;
        const s_t weak_mat_tmp38 = grad_u[2]*grad_u[3] - grad_u[5]*weak_mat_tmp7;
        const s_t weak_mat_tmp39 = -weak_mat_tmp38;
        const s_t weak_mat_tmp40 = grad_u[5]*weak_mat_tmp33;
        const s_t weak_mat_tmp41 = grad_u[5]*weak_mat_tmp35;
        const s_t weak_mat_tmp42 = weak_mat_tmp17*weak_mat_tmp38 + weak_mat_tmp40 - weak_mat_tmp41;
        const s_t weak_mat_tmp43 = grad_u[2]*grad_u[6] - weak_mat_tmp2*weak_mat_tmp7;
        ...
        const s_t weak_mat_tmp48 = grad_u[1]*grad_u[3] - weak_mat_tmp1*weak_mat_tmp7;
        ...
        const s_t weak_mat_tmp59 = grad_u[6]*weak_mat_tmp33;
        const s_t weak_mat_tmp60 = grad_u[6]*weak_mat_tmp35;
        ...
        const s_t weak_mat_tmp64 = grad_u[3]*weak_mat_tmp33;
        const s_t weak_mat_tmp65 = grad_u[3]*weak_mat_tmp35;
        ...
        const s_t weak_mat_tmp82 = grad_u[2]*weak_mat_tmp33;
        const s_t weak_mat_tmp83 = grad_u[2]*weak_mat_tmp35;
        const s_t weak_mat_tmp84 = weak_mat_tmp38*weak_mat_tmp77 - weak_mat_tmp82 + weak_mat_tmp83;
        const s_t weak_mat_tmp85 = grad_u[1]*weak_mat_tmp33;
        const s_t weak_mat_tmp86 = grad_u[1]*weak_mat_tmp35;
