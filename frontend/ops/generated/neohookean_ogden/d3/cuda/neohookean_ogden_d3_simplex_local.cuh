...
static __host__ __device__ __forceinline__ void neohookean_ogden_d3_simplex_objective_block(
  ...
  static_assert(VS > 0, "VS must be positive");
    ...
    value[step * value_stride + 0] += qw * det_value0 * (((s_t(1) / s_t(2)))*lmbda*pow_2(weak_obj_tmp4) - mu*weak_obj_tmp4 + ((s_t(1) / s_t(2)))*mu*(pow_2(gu0) + s_t(2)*gu0 + pow_2(gu1) + pow_2(gu2) + pow_2(gu3) + pow_2(gu4) + s_t(2)*gu4 + pow_2(gu5) + pow_2(gu6) + pow_2(gu7) + pow_2(gu8) + s_t(2)*gu8));
        }
      }
    }
}
