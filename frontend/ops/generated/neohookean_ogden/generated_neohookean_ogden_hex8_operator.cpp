...
static const real_t generated_neohookean_ogden_hex8_hex8_shape_1d[4] = {0.78867513459481287, 0.21132486540518708, 0.21132486540518713, 0.78867513459481287};
static const real_t generated_neohookean_ogden_hex8_hex8_grad_1d[4] = {-1, 1, -1, 1};
static const real_t generated_neohookean_ogden_hex8_hex8_q_weight_1d[2] = {0.5, 0.5};
...
#pragma omp simd
        ...
        const scalar_t *const block_coordinate_streams[N_SHAPE * 3] = {block_x0, block_y0, block_z0, block_x1, block_y1, block_z1, block_x2, block_y2, block_z2, block_x3, block_y3, block_z3, block_x4, block_y4, block_z4, block_x5, block_y5, block_z5, block_x6, block_y6, block_z6, block_x7, block_y7, block_z7};
...
extern "C" int generated_neohookean_ogden_hex8_hex8_objective_isoparametric_soa(
    ...
    return sfem::codegen::generated_neohookean_ogden_hex8_hex8_objective_isoparametric_soa_impl<real_t, 8, 8, 16>(nelements, x0, y0, z0, x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4, x5, y5, z5, x6, y6, z6, x7, y7, z7, sfem::codegen::generated_neohookean_ogden_hex8_hex8_shape_1d, sfem::codegen::generated_neohookean_ogden_hex8_hex8_grad_1d, sfem::codegen::generated_neohookean_ogden_hex8_hex8_q_weight_1d, mu, lmbda, ux0, uy0, uz0, ux1, uy1, uz1, ux2, uy2, uz2, ux3, uy3, uz3, ux4, uy4, uz4, ux5, uy5, uz5, ux6, uy6, uz6, ux7, uy7, uz7, value);
}
