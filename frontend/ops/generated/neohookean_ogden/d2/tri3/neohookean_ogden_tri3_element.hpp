...
static SFEM_INLINE int neohookean_ogden_tri3_energy_egeometry_soa(
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    neohookean_ogden_d2_simplex_objective_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, bdet0, sfem::codegen::neohookean_ogden_tri3_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tri3_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tri3_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bvalue);
  }
  return SFEM_SUCCESS;
}

template <typename s_t, int VS = 16>
static SFEM_INLINE int neohookean_ogden_tri3_energy_ecoords_soa(
        const ptrdiff_t nelements,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    s_t badj3[NQ * VS];
    s_t bdet0[NQ * VS];
    const s_t *const grad_ref_x = sfem::codegen::neohookean_ogden_tri3_isoparametric_reference_data<s_t>::grad_ref_x();
    const s_t *const grad_ref_y = sfem::codegen::neohookean_ogden_tri3_isoparametric_reference_data<s_t>::grad_ref_y();
    {
        const int q = 0;  // TRI3 evaluates in closed form
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int neohookean_ogden_tri3_energy_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int neohookean_ogden_tri3_gradient_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    neohookean_ogden_d2_simplex_gradient_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, bdet0, sfem::codegen::neohookean_ogden_tri3_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tri3_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tri3_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bout_streams);
  }
  return SFEM_SUCCESS;
}

template <typename s_t, int VS = 16>
static SFEM_INLINE int neohookean_ogden_tri3_gradient_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int neohookean_ogden_tri3_gradient_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int neohookean_ogden_tri3_hessian_egeometry_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR adj,
        const s_t *const RSTR det,
        const s_t lmbda,
  ...
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    for (int col = 0; col < NDOFS; ++col) {
      ...
      neohookean_ogden_d2_simplex_apply_block<s_t, NQ, NS, VS>(ne, VS, badj0, badj1, badj2, badj3, bdet0, sfem::codegen::neohookean_ogden_tri3_isoparametric_reference_data<s_t>::grad_ref_x(), sfem::codegen::neohookean_ogden_tri3_isoparametric_reference_data<s_t>::grad_ref_y(), sfem::codegen::neohookean_ogden_tri3_isoparametric_reference_data<s_t>::q_weight(), lmbda, mu, bu_streams, bh_streams, bout_streams);
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int neohookean_ogden_tri3_hessian_ecoords_soa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
...
template <typename s_t, int VS = 16>
static SFEM_INLINE int neohookean_ogden_tri3_hessian_esoa(
        const ptrdiff_t nelements,
        const s_t *const *const RSTR coords,
        const s_t lmbda,
        const s_t mu,
