...
extern "C" int neohookean_ogden_tri3_tri3_objective_steps_affine_mesh_soa(
    ...
    return sfem::codegen::neohookean_ogden_tri3_tri3_objective_steps_affine_mesh_soa_impl<double>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, h_stride, hx, hy, nsteps, steps, value);
}
...
extern "C" int neohookean_ogden_tri3_tri3_objective_steps_affine_mesh_soa_float(
    ...
    return sfem::codegen::neohookean_ogden_tri3_tri3_objective_steps_affine_mesh_soa_impl<float>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, mu, lmbda, u_stride, ux, uy, h_stride, hx, hy, nsteps, steps, value);
}
