...
extern "C" int neohookean_ogden_quad4_quad4_apply_packed_two_pass_affine_mesh_soa(
    ...
    return neohookean_ogden_proteus_quad4_proteus_quad4_apply_packed_two_pass_affine_mesh_soa(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, n_ghost_entries, n_ghost_reduce_rows, ghost_reduce_ptr, ghost_reduce_idx, ghost_reduce_dest, ghost_buf, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, h_stride, hx, hy, out_stride, outx, outy);
}
...
extern "C" int neohookean_ogden_quad4_quad4_apply_packed_two_pass_isoparametric_mesh_soa_float(
    ...
    return neohookean_ogden_proteus_quad4_proteus_quad4_apply_packed_two_pass_isoparametric_mesh_soa_float(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, n_ghost_entries, n_ghost_reduce_rows, ghost_reduce_ptr, ghost_reduce_idx, ghost_reduce_dest, ghost_buf, points, lmbda, mu, u_stride, ux, uy, h_stride, hx, hy, out_stride, outx, outy);
}
...
extern "C" int neohookean_ogden_quad4_quad4_bsr_apply_affine_mesh_soa(
    ...
    return neohookean_ogden_proteus_quad4_proteus_quad4_bsr_apply_affine_mesh_soa(nelements, nnodes, proteus_elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, h_stride, hx, hy, out_stride, outx, outy);
}
...
extern "C" int neohookean_ogden_quad4_quad4_bsr_apply_affine_mesh_soa_float(
    ...
    return neohookean_ogden_proteus_quad4_proteus_quad4_bsr_apply_affine_mesh_soa_float(nelements, nnodes, proteus_elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, h_stride, hx, hy, out_stride, outx, outy);
}
...
extern "C" int neohookean_ogden_quad4_quad4_bsr_apply_isoparametric_mesh_soa(
    ...
    return neohookean_ogden_proteus_quad4_proteus_quad4_bsr_apply_isoparametric_mesh_soa(nelements, nnodes, proteus_elements, points, lmbda, mu, u_stride, ux, uy, h_stride, hx, hy, out_stride, outx, outy);
}
...
extern "C" int neohookean_ogden_quad4_quad4_bsr_apply_isoparametric_mesh_soa_float(
    ...
    return neohookean_ogden_proteus_quad4_proteus_quad4_bsr_apply_isoparametric_mesh_soa_float(nelements, nnodes, proteus_elements, points, lmbda, mu, u_stride, ux, uy, h_stride, hx, hy, out_stride, outx, outy);
}
...
extern "C" int neohookean_ogden_quad4_quad4_gradient_packed_two_pass_affine_mesh_soa_float(
    ...
    return neohookean_ogden_proteus_quad4_proteus_quad4_gradient_packed_two_pass_affine_mesh_soa_float(n_packs, n_elements_per_pack, nelements, nnodes, max_nodes_per_pack, proteus_elements, owned_nodes_ptr, n_shared_nodes, ghost_ptr, ghost_idx, n_ghost_entries, n_ghost_reduce_rows, ghost_reduce_ptr, ghost_reduce_idx, ghost_reduce_dest, ghost_buf, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_determinant0, lmbda, mu, u_stride, ux, uy, out_stride, outx, outy);
}
...
extern "C" int neohookean_ogden_quad4_quad4_hessian_bsr_isoparametric_mesh_soa(
    ...
    return neohookean_ogden_proteus_quad4_proteus_quad4_hessian_bsr_isoparametric_mesh_soa(nelements, nnodes, proteus_elements, points, lmbda, mu, u_stride, ux, uy, rowptr, colidx, values);
}
...
extern "C" int neohookean_ogden_quad4_quad4_hessian_bsr_isoparametric_mesh_soa_float(
    ...
    return neohookean_ogden_proteus_quad4_proteus_quad4_hessian_bsr_isoparametric_mesh_soa_float(nelements, nnodes, proteus_elements, points, lmbda, mu, u_stride, ux, uy, rowptr, colidx, values);
}
