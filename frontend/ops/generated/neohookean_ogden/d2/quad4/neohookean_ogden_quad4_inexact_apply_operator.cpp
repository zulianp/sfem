...
static const KernelDiagnostics neohookean_ogden_quad4_inexact_apply_tangent_a_msoa_diagnostics_data = {
  "neohookean_ogden_quad4_inexact_apply_tangent_a_msoa",
  "QUAD4",
  2,
  4,
  4,
...
static const KernelDiagnostics neohookean_ogden_quad4_inexact_apply_stored_a_msoa_diagnostics_data = {
  "neohookean_ogden_quad4_inexact_apply_stored_a_msoa",
  "QUAD4",
  2,
  0,
  4,
...
static const KernelDiagnostics neohookean_ogden_quad4_inexact_apply_compressed_a_msoa_diagnostics_data = {
  "neohookean_ogden_quad4_inexact_apply_compressed_a_msoa",
  "QUAD4",
  2,
  0,
  4,
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_quad4_inexact_apply_tangent_a_msoa_diagnostics(void) {
  return &sfem::codegen::neohookean_ogden_quad4_inexact_apply_tangent_a_msoa_diagnostics_data;
}
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_quad4_inexact_apply_stored_a_msoa_diagnostics(void) {
  return &sfem::codegen::neohookean_ogden_quad4_inexact_apply_stored_a_msoa_diagnostics_data;
}
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_quad4_inexact_apply_compressed_a_msoa_diagnostics(void) {
  return &sfem::codegen::neohookean_ogden_quad4_inexact_apply_compressed_a_msoa_diagnostics_data;
}
