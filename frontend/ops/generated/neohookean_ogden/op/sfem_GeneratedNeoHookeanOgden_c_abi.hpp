...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_inexact_apply_compressed_a_2d_msoa_diagnostics(
    const smesh::ElemType element_type);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_inexact_apply_compressed_a_3d_msoa_diagnostics(
    const smesh::ElemType element_type);
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_inexact_apply_stored_a_2d_msoa_diagnostics(
    const smesh::ElemType element_type);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_inexact_apply_stored_a_3d_msoa_diagnostics(
    const smesh::ElemType element_type);
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_inexact_apply_tangent_a_2d_msoa_diagnostics(
    const smesh::ElemType element_type);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_inexact_apply_tangent_a_3d_msoa_diagnostics(
    const smesh::ElemType element_type);
