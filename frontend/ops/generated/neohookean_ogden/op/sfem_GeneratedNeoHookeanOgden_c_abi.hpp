...
extern "C" int neohookean_ogden_apply_packed_two_pass_2d_affine_mesh_soa(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_apply_packed_two_pass_2d_affine_mesh_soa_float(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_apply_packed_two_pass_2d_isoparametric_mesh_soa(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_apply_packed_two_pass_2d_isoparametric_mesh_soa_float(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_apply_packed_two_pass_3d_affine_mesh_soa_float(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_apply_packed_two_pass_3d_isoparametric_mesh_soa_float(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_gradient_packed_two_pass_2d_affine_mesh_soa(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_gradient_packed_two_pass_2d_affine_mesh_soa_float(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_gradient_packed_two_pass_2d_isoparametric_mesh_soa(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_gradient_packed_two_pass_2d_isoparametric_mesh_soa_float(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_gradient_packed_two_pass_3d_affine_mesh_soa_float(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_gradient_packed_two_pass_3d_isoparametric_mesh_soa_float(
        const smesh::ElemType element_type,
        const ptrdiff_t n_packs,
        const ptrdiff_t n_elements_per_pack,
        const ptrdiff_t nelements,
...
extern "C" int neohookean_ogden_hessian_bsr_2d_isoparametric_mesh_soa_float(
        const smesh::ElemType element_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
...
extern "C" int neohookean_ogden_hessian_bsr_3d_isoparametric_mesh_soa_float(
        const smesh::ElemType element_type,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_hex27_apply_soa_diagnostics(void);
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_hex27_gradient_soa_diagnostics(void);
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_hex27_objective_soa_diagnostics(void);
...
extern "C" void neohookean_ogden_hex8_apply_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_apply_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_apply_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_apply_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_hex8_apply_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_hex8_apply_soa_diagnostics(void);

extern "C" void neohookean_ogden_hex8_apply_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_apply_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_gradient_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_gradient_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_gradient_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_gradient_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_hex8_gradient_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_hex8_gradient_soa_diagnostics(void);

extern "C" void neohookean_ogden_hex8_gradient_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_gradient_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" void neohookean_ogden_hex8_objective_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_objective_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_objective_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_objective_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_hex8_objective_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_hex8_objective_soa_diagnostics(void);

extern "C" void neohookean_ogden_hex8_objective_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_hex8_objective_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_proteus_hex27_apply_soa_diagnostics(void);
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_proteus_hex27_gradient_soa_diagnostics(void);
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_proteus_hex27_objective_soa_diagnostics(void);
...
extern "C" void neohookean_ogden_proteus_hex64_apply_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_apply_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_apply_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_apply_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_proteus_hex64_apply_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_proteus_hex64_apply_soa_diagnostics(void);

extern "C" void neohookean_ogden_proteus_hex64_apply_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_apply_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_gradient_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_gradient_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_gradient_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_gradient_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_proteus_hex64_gradient_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_proteus_hex64_gradient_soa_diagnostics(void);

extern "C" void neohookean_ogden_proteus_hex64_gradient_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_gradient_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" void neohookean_ogden_proteus_hex64_objective_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_objective_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_objective_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_objective_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_proteus_hex64_objective_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_proteus_hex64_objective_soa_diagnostics(void);

extern "C" void neohookean_ogden_proteus_hex64_objective_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex64_objective_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" void neohookean_ogden_proteus_hex8_apply_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_apply_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_apply_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_apply_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_proteus_hex8_apply_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);
...
extern "C" void neohookean_ogden_proteus_hex8_apply_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_apply_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_gradient_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_gradient_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_gradient_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_gradient_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_proteus_hex8_gradient_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);
...
extern "C" void neohookean_ogden_proteus_hex8_gradient_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_gradient_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" void neohookean_ogden_proteus_hex8_objective_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_objective_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_objective_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_objective_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_proteus_hex8_objective_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);
...
extern "C" void neohookean_ogden_proteus_hex8_objective_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_proteus_hex8_objective_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_quad4_apply_soa_diagnostics(void);
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_quad4_gradient_soa_diagnostics(void);
...
extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_quad4_objective_soa_diagnostics(void);
...
extern "C" double neohookean_ogden_tet10_apply_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_tet10_apply_soa_diagnostics(void);

extern "C" void neohookean_ogden_tet10_apply_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet10_apply_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" double neohookean_ogden_tet10_gradient_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_tet10_gradient_soa_diagnostics(void);

extern "C" void neohookean_ogden_tet10_gradient_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet10_gradient_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" double neohookean_ogden_tet10_objective_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_tet10_objective_soa_diagnostics(void);

extern "C" void neohookean_ogden_tet10_objective_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet10_objective_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet4_apply_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet4_apply_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet4_apply_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet4_apply_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" void neohookean_ogden_tet4_gradient_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet4_gradient_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet4_gradient_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet4_gradient_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" void neohookean_ogden_tet4_objective_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet4_objective_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet4_objective_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tet4_objective_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" void neohookean_ogden_tri3_apply_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_apply_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_apply_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_apply_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_tri3_apply_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_tri3_apply_soa_diagnostics(void);

extern "C" void neohookean_ogden_tri3_apply_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_apply_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_gradient_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_gradient_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_gradient_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_gradient_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_tri3_gradient_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_tri3_gradient_soa_diagnostics(void);

extern "C" void neohookean_ogden_tri3_gradient_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_gradient_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
...
extern "C" void neohookean_ogden_tri3_objective_affine_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_objective_affine_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_objective_isoparametric_mesh_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_objective_isoparametric_mesh_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" double neohookean_ogden_tri3_objective_soa_arithmetic_intensity(
        const ptrdiff_t nelements,
        const size_t scalar_bytes,
        const size_t real_bytes,
        const size_t accumulator_bytes);

extern "C" const sfem::codegen::KernelDiagnostics *neohookean_ogden_tri3_objective_soa_diagnostics(void);

extern "C" void neohookean_ogden_tri3_objective_soa_float_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);

extern "C" void neohookean_ogden_tri3_objective_soa_print_rate(
        const double elapsed,
        const ptrdiff_t nelements,
        const ptrdiff_t ndofs);
