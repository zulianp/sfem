#ifndef SCALAR_POTENTIAL_PROTEUS_QUAD4_ELEMENT_API_HPP
#define SCALAR_POTENTIAL_PROTEUS_QUAD4_ELEMENT_API_HPP
...
static SFEM_INLINE int scalar_potential_proteus_quad4_energy_element_geometry_soa(
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        scalar_potential_d2_tensor_product_objective_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, sfem::codegen::scalar_potential_proteus_quad4_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::scalar_potential_proteus_quad4_isoparametric_reference_data<scalar_t>::grad_1d(), sfem::codegen::scalar_potential_proteus_quad4_isoparametric_reference_data<scalar_t>::q_weight_1d(), kappa, block_u_streams, block_value);
    }
    return SFEM_SUCCESS;
}

template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int scalar_potential_proteus_quad4_energy_element_coords_soa(
        const ptrdiff_t nelements,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int scalar_potential_proteus_quad4_energy_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t kappa,
        const scalar_t *const *const SFEM_RESTRICT u_streams,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int scalar_potential_proteus_quad4_gradient_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t kappa,
    ...
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        scalar_potential_d2_tensor_product_gradient_block<scalar_t, N_QP, N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_jacobian_adjugate0, block_jacobian_adjugate1, block_jacobian_adjugate2, block_jacobian_adjugate3, block_jacobian_determinant0, sfem::codegen::scalar_potential_proteus_quad4_isoparametric_reference_data<scalar_t>::shape_1d(), sfem::codegen::scalar_potential_proteus_quad4_isoparametric_reference_data<scalar_t>::grad_1d(), sfem::codegen::scalar_potential_proteus_quad4_isoparametric_reference_data<scalar_t>::q_weight_1d(), kappa, block_u_streams, block_out_streams);
    }
    return SFEM_SUCCESS;
}

template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int scalar_potential_proteus_quad4_gradient_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t kappa,
        const scalar_t *const *const SFEM_RESTRICT u_streams,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int scalar_potential_proteus_quad4_gradient_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t kappa,
        const scalar_t *const *const SFEM_RESTRICT u_streams,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int scalar_potential_proteus_quad4_hessian_element_geometry_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT jacobian_adjugate,
        const scalar_t *const SFEM_RESTRICT jacobian_determinant,
        const scalar_t kappa,
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int scalar_potential_proteus_quad4_hessian_element_coords_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t kappa,
        scalar_t *const *const SFEM_RESTRICT matrix_streams
...
template <typename scalar_t, int VECTOR_SIZE = 16>
static SFEM_INLINE int scalar_potential_proteus_quad4_hessian_element_soa(
        const ptrdiff_t nelements,
        const scalar_t *const *const SFEM_RESTRICT coords,
        const scalar_t kappa,
        scalar_t *const *const SFEM_RESTRICT matrix_streams
