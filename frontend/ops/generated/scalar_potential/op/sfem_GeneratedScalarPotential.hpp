...
namespace sfem {
    class GeneratedScalarPotential final : public Op {
    public:
        static std::unique_ptr<Op> create(const std::shared_ptr<FunctionSpace> &space);

        explicit GeneratedScalarPotential(const std::shared_ptr<FunctionSpace> &space);
        ~GeneratedScalarPotential() override;

        const char *name() const override { return "GeneratedScalarPotential"; }
