...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        navier_stokes_form_1_u_d3_tensor_product_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, 0, bageom_streams[9], badjugate, field_shape_1d, field_grad_1d, sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::q_weight_1d(), bcurrent, bprevious, convection_scale, dt, f0, f1, f2, nu, rho, boutput);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        navier_stokes_form_1_u_d3_tensor_product_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, VS, bdeterminant, badjugate, field_shape_1d, field_grad_1d, sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::q_weight_1d(), bcurrent, bprevious, convection_scale, dt, f0, f1, f2, nu, rho, boutput);
