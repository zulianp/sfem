#include <type_traits>
#include "../navier_stokes_form_1_p_d3_tensor_product_mixed_local.hpp"
...
static const KernelDiagnostics navier_stokes_form_1_p_hex27_hex8_residual_element_soa_diagnostics_data = {
    "navier_stokes_form_1_p_hex27_hex8_residual_element_soa",
    "HEX27",
    3,
    64,
    27,
...
extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_p_hex27_hex8_residual_element_soa_diagnostics(void) {
    return &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_residual_element_soa_diagnostics_data;
}
...
extern "C" double navier_stokes_form_1_p_hex27_hex8_residual_element_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_residual_element_soa_diagnostics_data,
...
extern "C" void navier_stokes_form_1_p_hex27_hex8_residual_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "navier_stokes_form_1_p_hex27_hex8_residual_element_soa_float",
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
...
extern "C" void navier_stokes_form_1_p_hex27_hex8_residual_affine_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "navier_stokes_form_1_p_hex27_hex8_residual_affine_mesh_soa",
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void navier_stokes_form_1_p_hex27_hex8_residual_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "navier_stokes_form_1_p_hex27_hex8_residual_affine_mesh_soa_float",
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void navier_stokes_form_1_p_hex27_hex8_residual_isoparametric_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "navier_stokes_form_1_p_hex27_hex8_residual_isoparametric_mesh_soa",
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void navier_stokes_form_1_p_hex27_hex8_residual_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "navier_stokes_form_1_p_hex27_hex8_residual_isoparametric_mesh_soa_float",
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_diagnostics_data = {
    "navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa",
    "HEX27",
    3,
    64,
    27,
...
extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_diagnostics(void) {
    return &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_diagnostics_data;
}
...
extern "C" double navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_float",
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void navier_stokes_form_1_p_hex27_hex8_jacobian_action_affine_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "navier_stokes_form_1_p_hex27_hex8_jacobian_action_affine_mesh_soa",
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void navier_stokes_form_1_p_hex27_hex8_jacobian_action_affine_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "navier_stokes_form_1_p_hex27_hex8_jacobian_action_affine_mesh_soa_float",
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void navier_stokes_form_1_p_hex27_hex8_jacobian_action_isoparametric_mesh_soa_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "navier_stokes_form_1_p_hex27_hex8_jacobian_action_isoparametric_mesh_soa",
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void navier_stokes_form_1_p_hex27_hex8_jacobian_action_isoparametric_mesh_soa_float_print_rate(
        ...
        const int repeat) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "navier_stokes_form_1_p_hex27_hex8_jacobian_action_isoparametric_mesh_soa_float",
            &sfem::codegen::navier_stokes_form_1_p_hex27_hex8_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs, repeat,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static SFEM_INLINE int navier_stokes_form_1_p_hex27_hex8_residual_affine_mesh_mixed_impl(
        const ptrdiff_t nelements,
    ...
    (void)nnodes;
    const scalar_t *const field_shape_1d[N_FIELDS] = {sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::hex27_shape_1d(), sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::hex8_shape_1d()};
    const scalar_t *const field_grad_1d[N_FIELDS] = {sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::hex27_grad_1d(), sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::hex8_grad_1d()};
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        navier_stokes_form_1_p_d3_tensor_product_mixed_residual_block<scalar_t, N_QP, CELL_N_SHAPE, VECTOR_SIZE>(nelems, 0, block_affine_geometry_streams[9], block_adjugate, field_shape_1d, field_grad_1d, sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::q_weight_1d(), block_current_streams, block_output_streams);
...
extern "C" int navier_stokes_form_1_p_hex27_hex8_residual_affine_mesh_soa(
    ...
    return sfem::codegen::navier_stokes_form_1_p_hex27_hex8_residual_affine_mesh_mixed_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, current_stride, u_data, p_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_form_1_p_hex27_hex8_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::navier_stokes_form_1_p_hex27_hex8_residual_affine_mesh_mixed_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, current_stride, u_data, p_data, out_stride, u_out, p_out);
}
...
template <typename scalar_t>
static SFEM_INLINE int navier_stokes_form_1_p_hex27_hex8_residual_isoparametric_mesh_mixed_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_shape_1d = sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::hex27_shape_1d();
    const scalar_t *const isoparametric_grad_1d = sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::hex27_grad_1d();
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        const int nelems = (int)MIN((ptrdiff_t)VECTOR_SIZE, nelements - evbegin);
        ...
        const scalar_t *const field_shape_1d[N_FIELDS] = {sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::hex27_shape_1d(), sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::hex8_shape_1d()};
        const scalar_t *const field_grad_1d[N_FIELDS] = {sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::hex27_grad_1d(), sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::hex8_grad_1d()};
        ...
        navier_stokes_form_1_p_d3_tensor_product_mixed_residual_block<scalar_t, N_QP, CELL_N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_determinant, block_adjugate, field_shape_1d, field_grad_1d, sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::q_weight_1d(), block_current_streams, block_output_streams);
...
extern "C" int navier_stokes_form_1_p_hex27_hex8_residual_isoparametric_mesh_soa(
    ...
    return sfem::codegen::navier_stokes_form_1_p_hex27_hex8_residual_isoparametric_mesh_mixed_impl<double>(nelements, nnodes, elements, points, current_stride, u_data, p_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_form_1_p_hex27_hex8_residual_isoparametric_mesh_soa_float(
    ...
    return sfem::codegen::navier_stokes_form_1_p_hex27_hex8_residual_isoparametric_mesh_mixed_impl<float>(nelements, nnodes, elements, points, current_stride, u_data, p_data, out_stride, u_out, p_out);
}
...
template <typename scalar_t, typename jacobian_t>
static SFEM_INLINE int navier_stokes_form_1_p_hex27_hex8_jacobian_action_affine_mesh_mixed_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const jacobian_t *const SFEM_RESTRICT g_jacobian_determinant0,
...
template <typename scalar_t>
static SFEM_INLINE int navier_stokes_form_1_p_hex27_hex8_jacobian_action_isoparametric_mesh_mixed_impl(
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const SFEM_RESTRICT elements,
        const geom_t *const *const SFEM_RESTRICT points,
