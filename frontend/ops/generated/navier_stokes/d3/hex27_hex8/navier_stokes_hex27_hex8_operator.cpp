...
extern "C" int navier_stokes_form_2_p_u_proteus_hex27_proteus_hex8_jacobian_action_a_msoa(
        const int scalar_bytes,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const RSTR elements,
...
extern "C" int navier_stokes_form_2_u_p_proteus_hex27_proteus_hex8_jacobian_action_a_msoa(
        const int scalar_bytes,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const RSTR elements,
...
extern "C" int navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_a_msoa(
        const int scalar_bytes,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const RSTR elements,
...
extern "C" int navier_stokes_proteus_hex27_proteus_hex8_residual_a_msoa(
        const int scalar_bytes,
        const ptrdiff_t nelements,
        const ptrdiff_t nnodes,
        idx_t **const RSTR elements,
...
extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_form_2_p_u_proteus_hex27_proteus_hex8_jacobian_action_esoa_diagnostics(
        void
);
extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_form_2_p_u_proteus_hex27_proteus_hex8_residual_esoa_diagnostics(
        void
);
extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_form_2_u_p_proteus_hex27_proteus_hex8_jacobian_action_esoa_diagnostics(
        void
);
extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_form_2_u_p_proteus_hex27_proteus_hex8_residual_esoa_diagnostics(
        void
);
extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_esoa_diagnostics(
        void
);
extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_proteus_hex27_proteus_hex8_residual_esoa_diagnostics(
        void
);
...
extern "C" int navier_stokes_form_2_p_u_hex27_hex8_jacobian_action_i_msoa(
    ...
    return navier_stokes_form_2_p_u_proteus_hex27_proteus_hex8_jacobian_action_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, direction_stride, u_direction_data, p_direction_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_form_2_u_p_hex27_hex8_jacobian_action_i_msoa(
    ...
    return navier_stokes_form_2_u_p_proteus_hex27_proteus_hex8_jacobian_action_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, direction_stride, u_direction_data, p_direction_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_hex27_hex8_jacobian_action_i_msoa(
    ...
    return navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, convection_scale, dt, nu, rho, previous_stride, u_old_data, p_old_data, direction_stride, u_direction_data, p_direction_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_hex27_hex8_residual_i_msoa(
    ...
    return navier_stokes_proteus_hex27_proteus_hex8_residual_i_msoa(scalar_bytes, nelements, nnodes, proteus_elements, points, convection_scale, dt, f0, f1, f2, nu, rho, current_stride, u_data, p_data, previous_stride, u_old_data, p_old_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_form_2_p_u_hex27_hex8_jacobian_action_a_msoa(
    ...
    return navier_stokes_form_2_p_u_proteus_hex27_proteus_hex8_jacobian_action_a_msoa(scalar_bytes, nelements, nnodes, proteus_elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, direction_stride, u_direction_data, p_direction_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_form_2_u_p_hex27_hex8_jacobian_action_a_msoa(
    ...
    return navier_stokes_form_2_u_p_proteus_hex27_proteus_hex8_jacobian_action_a_msoa(scalar_bytes, nelements, nnodes, proteus_elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, direction_stride, u_direction_data, p_direction_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_hex27_hex8_jacobian_action_a_msoa(
    ...
    return navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_a_msoa(scalar_bytes, nelements, nnodes, proteus_elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, convection_scale, dt, nu, rho, previous_stride, u_old_data, p_old_data, direction_stride, u_direction_data, p_direction_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_hex27_hex8_residual_a_msoa(
    ...
    return navier_stokes_proteus_hex27_proteus_hex8_residual_a_msoa(scalar_bytes, nelements, nnodes, proteus_elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, convection_scale, dt, f0, f1, f2, nu, rho, current_stride, u_data, p_data, previous_stride, u_old_data, p_old_data, out_stride, u_out, p_out);
}
...
extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_form_2_p_u_hex27_hex8_jacobian_action_esoa_diagnostics(
        void
) {
    return navier_stokes_form_2_p_u_proteus_hex27_proteus_hex8_jacobian_action_esoa_diagnostics();
}

extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_form_2_p_u_hex27_hex8_residual_esoa_diagnostics(
        void
) {
    return navier_stokes_form_2_p_u_proteus_hex27_proteus_hex8_residual_esoa_diagnostics();
}

extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_form_2_u_p_hex27_hex8_jacobian_action_esoa_diagnostics(
        void
) {
    return navier_stokes_form_2_u_p_proteus_hex27_proteus_hex8_jacobian_action_esoa_diagnostics();
}

extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_form_2_u_p_hex27_hex8_residual_esoa_diagnostics(
        void
) {
    return navier_stokes_form_2_u_p_proteus_hex27_proteus_hex8_residual_esoa_diagnostics();
}

extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_hex27_hex8_jacobian_action_esoa_diagnostics(
        void
) {
    return navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_esoa_diagnostics();
}

extern "C" const sfem::codegen::KernelDiagnostics * navier_stokes_hex27_hex8_residual_esoa_diagnostics(
        void
) {
