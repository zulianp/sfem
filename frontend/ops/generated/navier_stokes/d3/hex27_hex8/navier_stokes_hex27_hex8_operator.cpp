...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    navier_stokes_d3_tensor_product_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(ne, 0, bageom_streams[9], badjugate, field_shape_1d, field_grad_1d, sfem::codegen::quad_line_q4<s_t>::q_weight_1d(), bcurrent, bprevious, convection_scale, dt, f0, f1, f2, nu, rho, boutput);
...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    navier_stokes_d3_tensor_product_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(ne, VS, bdeterminant, badjugate, field_shape_1d, field_grad_1d, sfem::codegen::quad_line_q4<s_t>::q_weight_1d(), bcurrent, bprevious, convection_scale, dt, f0, f1, f2, nu, rho, boutput);
...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    navier_stokes_d3_tensor_product_mixed_jacobian_action_block_contiguous<s_t, NQ, CELL_NS, VS>(ne, 0, bageom_streams[9], badjugate, field_shape_1d, field_grad_1d, sfem::codegen::quad_line_q4<s_t>::q_weight_1d(), bprevious, bdirection, convection_scale, dt, nu, rho, boutput);
...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    navier_stokes_d3_tensor_product_mixed_jacobian_action_block_contiguous<s_t, NQ, CELL_NS, VS>(ne, VS, bdeterminant, badjugate, field_shape_1d, field_grad_1d, sfem::codegen::quad_line_q4<s_t>::q_weight_1d(), bprevious, bdirection, convection_scale, dt, nu, rho, boutput);
