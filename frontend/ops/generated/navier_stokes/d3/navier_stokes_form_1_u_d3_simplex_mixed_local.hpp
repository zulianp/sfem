...
static SFEM_INLINE void navier_stokes_form_1_u_d3_simplex_mixed_residual_block(
        ...
        const s_t *const SFEM_RESTRICT fgref[6],
    ...
    for (int q = 0; q < NQ; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            u0_grad_2_ref += coeff_current_u0_0 * fgref[0 * ND + 2][q * U_NS + 0];
            ...
            u0_grad_2_ref += coeff_current_u0_1 * fgref[0 * ND + 2][q * U_NS + 1];
            ...
            u0_grad_2_ref += coeff_current_u0_2 * fgref[0 * ND + 2][q * U_NS + 2];
            ...
            u0_grad_2_ref += coeff_current_u0_3 * fgref[0 * ND + 2][q * U_NS + 3];
            ...
            u0_grad_2_ref += coeff_current_u0_4 * fgref[0 * ND + 2][q * U_NS + 4];
            ...
            u0_grad_2_ref += coeff_current_u0_5 * fgref[0 * ND + 2][q * U_NS + 5];
            const s_t coeff_current_u0_6 = current[6][lane];
            u0 += coeff_current_u0_6 * field_shape[0][q * U_NS + 6];
            u0_grad_0_ref += coeff_current_u0_6 * fgref[0 * ND + 0][q * U_NS + 6];
            u0_grad_1_ref += coeff_current_u0_6 * fgref[0 * ND + 1][q * U_NS + 6];
            u0_grad_2_ref += coeff_current_u0_6 * fgref[0 * ND + 2][q * U_NS + 6];
            const s_t coeff_current_u0_7 = current[7][lane];
            u0 += coeff_current_u0_7 * field_shape[0][q * U_NS + 7];
            u0_grad_0_ref += coeff_current_u0_7 * fgref[0 * ND + 0][q * U_NS + 7];
            u0_grad_1_ref += coeff_current_u0_7 * fgref[0 * ND + 1][q * U_NS + 7];
            u0_grad_2_ref += coeff_current_u0_7 * fgref[0 * ND + 2][q * U_NS + 7];
            const s_t coeff_current_u0_8 = current[8][lane];
            u0 += coeff_current_u0_8 * field_shape[0][q * U_NS + 8];
            u0_grad_0_ref += coeff_current_u0_8 * fgref[0 * ND + 0][q * U_NS + 8];
            u0_grad_1_ref += coeff_current_u0_8 * fgref[0 * ND + 1][q * U_NS + 8];
            u0_grad_2_ref += coeff_current_u0_8 * fgref[0 * ND + 2][q * U_NS + 8];
            const s_t coeff_current_u0_9 = current[9][lane];
            u0 += coeff_current_u0_9 * field_shape[0][q * U_NS + 9];
            u0_grad_0_ref += coeff_current_u0_9 * fgref[0 * ND + 0][q * U_NS + 9];
            u0_grad_1_ref += coeff_current_u0_9 * fgref[0 * ND + 1][q * U_NS + 9];
            u0_grad_2_ref += coeff_current_u0_9 * fgref[0 * ND + 2][q * U_NS + 9];
            ...
            u1_grad_2_ref += coeff_current_u1_0 * fgref[0 * ND + 2][q * U_NS + 0];
            ...
            u1_grad_2_ref += coeff_current_u1_1 * fgref[0 * ND + 2][q * U_NS + 1];
            ...
            u1_grad_2_ref += coeff_current_u1_2 * fgref[0 * ND + 2][q * U_NS + 2];
            ...
            u1_grad_2_ref += coeff_current_u1_3 * fgref[0 * ND + 2][q * U_NS + 3];
            ...
            u1_grad_2_ref += coeff_current_u1_4 * fgref[0 * ND + 2][q * U_NS + 4];
            ...
            u1_grad_2_ref += coeff_current_u1_5 * fgref[0 * ND + 2][q * U_NS + 5];
            const s_t coeff_current_u1_6 = current[16][lane];
            u1 += coeff_current_u1_6 * field_shape[0][q * U_NS + 6];
            u1_grad_0_ref += coeff_current_u1_6 * fgref[0 * ND + 0][q * U_NS + 6];
            u1_grad_1_ref += coeff_current_u1_6 * fgref[0 * ND + 1][q * U_NS + 6];
            u1_grad_2_ref += coeff_current_u1_6 * fgref[0 * ND + 2][q * U_NS + 6];
            const s_t coeff_current_u1_7 = current[17][lane];
            u1 += coeff_current_u1_7 * field_shape[0][q * U_NS + 7];
            u1_grad_0_ref += coeff_current_u1_7 * fgref[0 * ND + 0][q * U_NS + 7];
            u1_grad_1_ref += coeff_current_u1_7 * fgref[0 * ND + 1][q * U_NS + 7];
            u1_grad_2_ref += coeff_current_u1_7 * fgref[0 * ND + 2][q * U_NS + 7];
            const s_t coeff_current_u1_8 = current[18][lane];
            u1 += coeff_current_u1_8 * field_shape[0][q * U_NS + 8];
            u1_grad_0_ref += coeff_current_u1_8 * fgref[0 * ND + 0][q * U_NS + 8];
            u1_grad_1_ref += coeff_current_u1_8 * fgref[0 * ND + 1][q * U_NS + 8];
            u1_grad_2_ref += coeff_current_u1_8 * fgref[0 * ND + 2][q * U_NS + 8];
            const s_t coeff_current_u1_9 = current[19][lane];
            u1 += coeff_current_u1_9 * field_shape[0][q * U_NS + 9];
            u1_grad_0_ref += coeff_current_u1_9 * fgref[0 * ND + 0][q * U_NS + 9];
            u1_grad_1_ref += coeff_current_u1_9 * fgref[0 * ND + 1][q * U_NS + 9];
            u1_grad_2_ref += coeff_current_u1_9 * fgref[0 * ND + 2][q * U_NS + 9];
            ...
            u2_grad_0_ref += coeff_current_u2_0 * fgref[0 * ND + 0][q * U_NS + 0];
            u2_grad_1_ref += coeff_current_u2_0 * fgref[0 * ND + 1][q * U_NS + 0];
            u2_grad_2_ref += coeff_current_u2_0 * fgref[0 * ND + 2][q * U_NS + 0];
            const s_t coeff_current_u2_1 = current[21][lane];
            u2 += coeff_current_u2_1 * field_shape[0][q * U_NS + 1];
            u2_grad_0_ref += coeff_current_u2_1 * fgref[0 * ND + 0][q * U_NS + 1];
            u2_grad_1_ref += coeff_current_u2_1 * fgref[0 * ND + 1][q * U_NS + 1];
            u2_grad_2_ref += coeff_current_u2_1 * fgref[0 * ND + 2][q * U_NS + 1];
            const s_t coeff_current_u2_2 = current[22][lane];
            u2 += coeff_current_u2_2 * field_shape[0][q * U_NS + 2];
            u2_grad_0_ref += coeff_current_u2_2 * fgref[0 * ND + 0][q * U_NS + 2];
            u2_grad_1_ref += coeff_current_u2_2 * fgref[0 * ND + 1][q * U_NS + 2];
            u2_grad_2_ref += coeff_current_u2_2 * fgref[0 * ND + 2][q * U_NS + 2];
            const s_t coeff_current_u2_3 = current[23][lane];
            u2 += coeff_current_u2_3 * field_shape[0][q * U_NS + 3];
            u2_grad_0_ref += coeff_current_u2_3 * fgref[0 * ND + 0][q * U_NS + 3];
            u2_grad_1_ref += coeff_current_u2_3 * fgref[0 * ND + 1][q * U_NS + 3];
            u2_grad_2_ref += coeff_current_u2_3 * fgref[0 * ND + 2][q * U_NS + 3];
            const s_t coeff_current_u2_4 = current[24][lane];
            u2 += coeff_current_u2_4 * field_shape[0][q * U_NS + 4];
            u2_grad_0_ref += coeff_current_u2_4 * fgref[0 * ND + 0][q * U_NS + 4];
            u2_grad_1_ref += coeff_current_u2_4 * fgref[0 * ND + 1][q * U_NS + 4];
            u2_grad_2_ref += coeff_current_u2_4 * fgref[0 * ND + 2][q * U_NS + 4];
            const s_t coeff_current_u2_5 = current[25][lane];
            u2 += coeff_current_u2_5 * field_shape[0][q * U_NS + 5];
            u2_grad_0_ref += coeff_current_u2_5 * fgref[0 * ND + 0][q * U_NS + 5];
            u2_grad_1_ref += coeff_current_u2_5 * fgref[0 * ND + 1][q * U_NS + 5];
            u2_grad_2_ref += coeff_current_u2_5 * fgref[0 * ND + 2][q * U_NS + 5];
            const s_t coeff_current_u2_6 = current[26][lane];
            u2 += coeff_current_u2_6 * field_shape[0][q * U_NS + 6];
            u2_grad_0_ref += coeff_current_u2_6 * fgref[0 * ND + 0][q * U_NS + 6];
            u2_grad_1_ref += coeff_current_u2_6 * fgref[0 * ND + 1][q * U_NS + 6];
            u2_grad_2_ref += coeff_current_u2_6 * fgref[0 * ND + 2][q * U_NS + 6];
            const s_t coeff_current_u2_7 = current[27][lane];
            u2 += coeff_current_u2_7 * field_shape[0][q * U_NS + 7];
            u2_grad_0_ref += coeff_current_u2_7 * fgref[0 * ND + 0][q * U_NS + 7];
            u2_grad_1_ref += coeff_current_u2_7 * fgref[0 * ND + 1][q * U_NS + 7];
            u2_grad_2_ref += coeff_current_u2_7 * fgref[0 * ND + 2][q * U_NS + 7];
            const s_t coeff_current_u2_8 = current[28][lane];
            u2 += coeff_current_u2_8 * field_shape[0][q * U_NS + 8];
            u2_grad_0_ref += coeff_current_u2_8 * fgref[0 * ND + 0][q * U_NS + 8];
            u2_grad_1_ref += coeff_current_u2_8 * fgref[0 * ND + 1][q * U_NS + 8];
            u2_grad_2_ref += coeff_current_u2_8 * fgref[0 * ND + 2][q * U_NS + 8];
            const s_t coeff_current_u2_9 = current[29][lane];
            u2 += coeff_current_u2_9 * field_shape[0][q * U_NS + 9];
            u2_grad_0_ref += coeff_current_u2_9 * fgref[0 * ND + 0][q * U_NS + 9];
            u2_grad_1_ref += coeff_current_u2_9 * fgref[0 * ND + 1][q * U_NS + 9];
            u2_grad_2_ref += coeff_current_u2_9 * fgref[0 * ND + 2][q * U_NS + 9];
            ...
            p_grad_2_ref += coeff_current_p_0 * fgref[1 * ND + 2][q * P_NS + 0];
            ...
            p_grad_2_ref += coeff_current_p_1 * fgref[1 * ND + 2][q * P_NS + 1];
            ...
            p_grad_2_ref += coeff_current_p_2 * fgref[1 * ND + 2][q * P_NS + 2];
            const s_t coeff_current_p_3 = current[33][lane];
            p += coeff_current_p_3 * field_shape[1][q * P_NS + 3];
            p_grad_0_ref += coeff_current_p_3 * fgref[1 * ND + 0][q * P_NS + 3];
            p_grad_1_ref += coeff_current_p_3 * fgref[1 * ND + 1][q * P_NS + 3];
            p_grad_2_ref += coeff_current_p_3 * fgref[1 * ND + 2][q * P_NS + 3];
