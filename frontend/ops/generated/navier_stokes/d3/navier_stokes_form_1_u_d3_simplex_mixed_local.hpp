...
static SFEM_INLINE void navier_stokes_form_1_u_d3_simplex_mixed_residual_block(
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    for (int lane = 0; lane < ne; ++lane) {
      ...
      u0_grad_2_ref += coeff_current_u0_0 * fgref[2][q * U_NS + 0];
      ...
      u1_grad_2_ref += coeff_current_u1_0 * fgref[2][q * U_NS + 0];
      ...
      u2_grad_0_ref += coeff_current_u2_0 * fgref[0][q * U_NS + 0];
      u2_grad_1_ref += coeff_current_u2_0 * fgref[1][q * U_NS + 0];
      u2_grad_2_ref += coeff_current_u2_0 * fgref[2][q * U_NS + 0];
      ...
      p_grad_2_ref += coeff_current_p_0 * fgref[ND + 2][q * P_NS + 0];
      ...
      p_grad_2_ref += coeff_current_p_1 * fgref[ND + 2][q * P_NS + 1];
      const s_t coeff_current_p_2 = current[32][lane];
      p += coeff_current_p_2 * field_shape[1][q * P_NS + 2];
      p_grad_0_ref += coeff_current_p_2 * fgref[ND][q * P_NS + 2];
      p_grad_1_ref += coeff_current_p_2 * fgref[ND + 1][q * P_NS + 2];
      p_grad_2_ref += coeff_current_p_2 * fgref[ND + 2][q * P_NS + 2];
      const s_t coeff_current_p_3 = current[33][lane];
      p += coeff_current_p_3 * field_shape[1][q * P_NS + 3];
      p_grad_0_ref += coeff_current_p_3 * fgref[ND][q * P_NS + 3];
      p_grad_1_ref += coeff_current_p_3 * fgref[ND + 1][q * P_NS + 3];
      p_grad_2_ref += coeff_current_p_3 * fgref[ND + 2][q * P_NS + 3];
