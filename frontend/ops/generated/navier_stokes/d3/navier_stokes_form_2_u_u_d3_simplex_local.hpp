...
static SFEM_INLINE void navier_stokes_form_2_u_u_d3_simplex_jacobian_action_block(
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    for (int lane = 0; lane < ne; ++lane) {
      ...
      u0_direction_grad_2_ref += coeff_direction_u0_0 * fgref[2][q * U_NS + 0];
      ...
      u1_direction_grad_2_ref += coeff_direction_u1_0 * fgref[2][q * U_NS + 0];
      ...
      u2_direction_grad_0_ref += coeff_direction_u2_0 * fgref[0][q * U_NS + 0];
      u2_direction_grad_1_ref += coeff_direction_u2_0 * fgref[1][q * U_NS + 0];
      u2_direction_grad_2_ref += coeff_direction_u2_0 * fgref[2][q * U_NS + 0];
      ...
      const s_t test_grad0_u0_0 = (fgref[0][q * U_NS + 0] * adj0 + fgref[1][q * U_NS + 0] * adj3 + fgref[2][q * U_NS + 0] * adj6) / det;
      const s_t test_grad1_u0_0 = (fgref[0][q * U_NS + 0] * adj1 + fgref[1][q * U_NS + 0] * adj4 + fgref[2][q * U_NS + 0] * adj7) / det;
      const s_t test_grad2_u0_0 = (fgref[0][q * U_NS + 0] * adj2 + fgref[1][q * U_NS + 0] * adj5 + fgref[2][q * U_NS + 0] * adj8) / det;
      ...
      const s_t test_grad0_u1_0 = (fgref[0][q * U_NS + 0] * adj0 + fgref[1][q * U_NS + 0] * adj3 + fgref[2][q * U_NS + 0] * adj6) / det;
      const s_t test_grad1_u1_0 = (fgref[0][q * U_NS + 0] * adj1 + fgref[1][q * U_NS + 0] * adj4 + fgref[2][q * U_NS + 0] * adj7) / det;
      const s_t test_grad2_u1_0 = (fgref[0][q * U_NS + 0] * adj2 + fgref[1][q * U_NS + 0] * adj5 + fgref[2][q * U_NS + 0] * adj8) / det;
      ...
      const s_t test_grad0_u2_0 = (fgref[0][q * U_NS + 0] * adj0 + fgref[1][q * U_NS + 0] * adj3 + fgref[2][q * U_NS + 0] * adj6) / det;
      const s_t test_grad1_u2_0 = (fgref[0][q * U_NS + 0] * adj1 + fgref[1][q * U_NS + 0] * adj4 + fgref[2][q * U_NS + 0] * adj7) / det;
      const s_t test_grad2_u2_0 = (fgref[0][q * U_NS + 0] * adj2 + fgref[1][q * U_NS + 0] * adj5 + fgref[2][q * U_NS + 0] * adj8) / det;
