#ifndef NAVIER_STOKES_D3_TENSOR_PRODUCT_MIXED_LOCAL_HPP
#define NAVIER_STOKES_D3_TENSOR_PRODUCT_MIXED_LOCAL_HPP
...
__host__ __device__ __forceinline__ void navier_stokes_d3_tensor_product_mixed_residual_block(
  ...
  tensor_evaluate<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], field_grad_1d[0], current_u0_streams, current_u0_value, current_u0_grad_ref);
  ...
  tensor_evaluate_value<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], previous_u0_streams, previous_u0_value);
  ...
  tensor_evaluate<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], field_grad_1d[0], current_u1_streams, current_u1_value, current_u1_grad_ref);
  ...
  tensor_evaluate_value<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], previous_u1_streams, previous_u1_value);
  ...
  tensor_evaluate_value<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], previous_u2_streams, previous_u2_value);
  ...
  tensor_evaluate_value<s_t, NQ, P_NS, VS, ND, 1>(
      ne, field_shape_1d[1], current_p_streams, current_p_value);
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    s_t *const RSTR p_grad_coeff_ref_q2 = &p_grad_coeff_ref[(q * ND + 2) * VS];
    {
      ...
      const s_t u0 = current_u0_value_q[0];
      const s_t u0_grad_0_ref = current_u0_grad_ref_q0[0];
      const s_t u0_grad_1_ref = current_u0_grad_ref_q1[0];
      const s_t u0_grad_2_ref = current_u0_grad_ref_q2[0];
      ...
      const s_t u0_old = previous_u0_value_q[0];
      const s_t u1 = current_u1_value_q[0];
      const s_t u1_grad_0_ref = current_u1_grad_ref_q0[0];
      const s_t u1_grad_1_ref = current_u1_grad_ref_q1[0];
      const s_t u1_grad_2_ref = current_u1_grad_ref_q2[0];
      ...
      const s_t u1_old = previous_u1_value_q[0];
      const s_t u2 = current_u2_value_q[0];
      const s_t u2_grad_0_ref = current_u2_grad_ref_q0[0];
      const s_t u2_grad_1_ref = current_u2_grad_ref_q1[0];
      const s_t u2_grad_2_ref = current_u2_grad_ref_q2[0];
      ...
      const s_t u2_old = previous_u2_value_q[0];
      const s_t p = current_p_value_q[0];
      ...
      u0_value_coeff_q[0] = qw * det * value_coeff0;
      u0_grad_coeff_ref_q0[0] = qw * (adj0 * grad_coeff0_0 + adj1 * grad_coeff0_1 + adj2 * grad_coeff0_2);
      u0_grad_coeff_ref_q1[0] = qw * (adj3 * grad_coeff0_0 + adj4 * grad_coeff0_1 + adj5 * grad_coeff0_2);
      u0_grad_coeff_ref_q2[0] = qw * (adj6 * grad_coeff0_0 + adj7 * grad_coeff0_1 + adj8 * grad_coeff0_2);
      u1_value_coeff_q[0] = qw * det * value_coeff1;
      u1_grad_coeff_ref_q0[0] = qw * (adj0 * grad_coeff1_0 + adj1 * grad_coeff1_1 + adj2 * grad_coeff1_2);
      u1_grad_coeff_ref_q1[0] = qw * (adj3 * grad_coeff1_0 + adj4 * grad_coeff1_1 + adj5 * grad_coeff1_2);
      u1_grad_coeff_ref_q2[0] = qw * (adj6 * grad_coeff1_0 + adj7 * grad_coeff1_1 + adj8 * grad_coeff1_2);
      u2_value_coeff_q[0] = qw * det * value_coeff2;
      u2_grad_coeff_ref_q0[0] = qw * (adj0 * grad_coeff2_0 + adj1 * grad_coeff2_1 + adj2 * grad_coeff2_2);
      u2_grad_coeff_ref_q1[0] = qw * (adj3 * grad_coeff2_0 + adj4 * grad_coeff2_1 + adj5 * grad_coeff2_2);
      u2_grad_coeff_ref_q2[0] = qw * (adj6 * grad_coeff2_0 + adj7 * grad_coeff2_1 + adj8 * grad_coeff2_2);
      p_value_coeff_q[0] = qw * det * value_coeff3;
      p_grad_coeff_ref_q0[0] = s_t(0);
      p_grad_coeff_ref_q1[0] = s_t(0);
      p_grad_coeff_ref_q2[0] = s_t(0);
    }
  }
...
__host__ __device__ __forceinline__ void navier_stokes_d3_tensor_product_mixed_residual_block_contiguous(
  ...
  tensor_evaluate_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], field_grad_1d[0], current + 0, current_u0_value, current_u0_grad_ref);
  s_t previous_u0_value[NQ * VS];
  tensor_evaluate_value_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], previous + 0, previous_u0_value);
  s_t current_u1_value[NQ * VS];
  s_t current_u1_grad_ref[NQ * ND * VS];
  tensor_evaluate_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], field_grad_1d[0], current + 27, current_u1_value, current_u1_grad_ref);
  s_t previous_u1_value[NQ * VS];
  tensor_evaluate_value_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], previous + 27, previous_u1_value);
  s_t current_u2_value[NQ * VS];
  s_t current_u2_grad_ref[NQ * ND * VS];
  tensor_evaluate_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
  ...
  s_t previous_u2_value[NQ * VS];
  tensor_evaluate_value_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], previous + 54, previous_u2_value);
  s_t current_p_value[NQ * VS];
  tensor_evaluate_value_contiguous<s_t, NQ, P_NS, VS, ND, 1>(
      ne, field_shape_1d[1], current + 81, current_p_value);
  s_t u0_value_coeff[NQ * VS];
  s_t u0_grad_coeff_ref[NQ * ND * VS];
  s_t u1_value_coeff[NQ * VS];
  s_t u1_grad_coeff_ref[NQ * ND * VS];
...
__host__ __device__ __forceinline__ void navier_stokes_d3_tensor_product_mixed_jacobian_action_block(
  ...
  tensor_evaluate<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], field_grad_1d[0], direction_u0_streams, direction_u0_value, direction_u0_grad_ref);
  s_t previous_u1_value[NQ * VS];
  const s_t *const previous_u1_streams[U_NS] = {previous[27], previous[28], previous[29], previous[30], previous[31], previous[32], previous[33], previous[34], previous[35], previous[36], previous[37], previous[38], previous[39], previous[40], previous[41], previous[42], previous[43], previous[44], previous[45], previous[46], previous[47], previous[48], previous[49], previous[50], previous[51], previous[52], previous[53]};
  tensor_evaluate_value<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], previous_u1_streams, previous_u1_value);
  ...
  tensor_evaluate<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], field_grad_1d[0], direction_u1_streams, direction_u1_value, direction_u1_grad_ref);
  s_t previous_u2_value[NQ * VS];
  const s_t *const previous_u2_streams[U_NS] = {previous[54], previous[55], previous[56], previous[57], previous[58], previous[59], previous[60], previous[61], previous[62], previous[63], previous[64], previous[65], previous[66], previous[67], previous[68], previous[69], previous[70], previous[71], previous[72], previous[73], previous[74], previous[75], previous[76], previous[77], previous[78], previous[79], previous[80]};
  tensor_evaluate_value<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], previous_u2_streams, previous_u2_value);
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    s_t *const RSTR p_grad_coeff_ref_q2 = &p_grad_coeff_ref[(q * ND + 2) * VS];
    {
      ...
      const s_t adj8 = adj_q8[0];
      const s_t u0_old = previous_u0_value_q[0];
      const s_t u0_direction = direction_u0_value_q[0];
      const s_t u0_direction_grad_0_ref = direction_u0_grad_ref_q0[0];
      const s_t u0_direction_grad_1_ref = direction_u0_grad_ref_q1[0];
      const s_t u0_direction_grad_2_ref = direction_u0_grad_ref_q2[0];
      ...
      const s_t u1_old = previous_u1_value_q[0];
      const s_t u1_direction = direction_u1_value_q[0];
      const s_t u1_direction_grad_0_ref = direction_u1_grad_ref_q0[0];
      const s_t u1_direction_grad_1_ref = direction_u1_grad_ref_q1[0];
      const s_t u1_direction_grad_2_ref = direction_u1_grad_ref_q2[0];
      ...
      const s_t u2_old = previous_u2_value_q[0];
      const s_t u2_direction = direction_u2_value_q[0];
      const s_t u2_direction_grad_0_ref = direction_u2_grad_ref_q0[0];
      const s_t u2_direction_grad_1_ref = direction_u2_grad_ref_q1[0];
      const s_t u2_direction_grad_2_ref = direction_u2_grad_ref_q2[0];
      ...
      const s_t p_direction = direction_p_value_q[0];
...
__host__ __device__ __forceinline__ void navier_stokes_d3_tensor_product_mixed_jacobian_action_block_contiguous(
  ...
  s_t direction_u0_grad_ref[NQ * ND * VS];
  tensor_evaluate_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], field_grad_1d[0], direction + 0, direction_u0_value, direction_u0_grad_ref);
  s_t previous_u1_value[NQ * VS];
  tensor_evaluate_value_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], previous + 27, previous_u1_value);
  s_t direction_u1_value[NQ * VS];
  s_t direction_u1_grad_ref[NQ * ND * VS];
  tensor_evaluate_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], field_grad_1d[0], direction + 27, direction_u1_value, direction_u1_grad_ref);
  s_t previous_u2_value[NQ * VS];
  tensor_evaluate_value_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], previous + 54, previous_u2_value);
  s_t direction_u2_value[NQ * VS];
