...
__host__ __device__ __forceinline__ void navier_stokes_form_2_u_p_d3_tensor_product_mixed_jacobian_action_block(
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    s_t *const RSTR p_grad_coeff_ref_q2 = &p_grad_coeff_ref[(q * ND + 2) * VS];
    {
      ...
      u0_grad_coeff_ref_q0[0] = qw * (adj0 * grad_coeff0_0);
      u0_grad_coeff_ref_q1[0] = qw * (adj3 * grad_coeff0_0);
      u0_grad_coeff_ref_q2[0] = qw * (adj6 * grad_coeff0_0);
      u1_value_coeff_q[0] = s_t(0);
      u1_grad_coeff_ref_q0[0] = qw * (adj1 * grad_coeff1_1);
      u1_grad_coeff_ref_q1[0] = qw * (adj4 * grad_coeff1_1);
      u1_grad_coeff_ref_q2[0] = qw * (adj7 * grad_coeff1_1);
      u2_value_coeff_q[0] = s_t(0);
      u2_grad_coeff_ref_q0[0] = qw * (adj2 * grad_coeff2_2);
      u2_grad_coeff_ref_q1[0] = qw * (adj5 * grad_coeff2_2);
      u2_grad_coeff_ref_q2[0] = qw * (adj8 * grad_coeff2_2);
