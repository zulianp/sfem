...
__host__ __device__ __forceinline__ void navier_stokes_form_2_p_u_d3_tensor_product_mixed_jacobian_action_block(
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    s_t *const RSTR p_value_coeff_q = &p_value_coeff[q * VS];
    {
      ...
      u0_value_coeff_q[0] = s_t(0);
      u1_value_coeff_q[0] = s_t(0);
      u2_value_coeff_q[0] = s_t(0);
  ...
  tensor_integrate_value<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], u0_value_coeff, u0_output_streams);
  ...
  tensor_integrate_value<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], u1_value_coeff, u1_output_streams);
  ...
  tensor_integrate_value<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], u2_value_coeff, u2_output_streams);
  ...
  tensor_integrate_value<s_t, NQ, P_NS, VS, ND, 1>(
      ne, field_shape_1d[1], p_value_coeff, p_output_streams);
}
...
__host__ __device__ __forceinline__ void navier_stokes_form_2_p_u_d3_tensor_product_mixed_jacobian_action_block_contiguous(
  ...
  tensor_integrate_value_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], u0_value_coeff, output + 0);
  tensor_integrate_value_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], u1_value_coeff, output + 27);
  tensor_integrate_value_contiguous<s_t, NQ, U_NS, VS, ND, 1>(
      ne, field_shape_1d[0], u2_value_coeff, output + 54);
