...
__host__ __device__ __forceinline__ void navier_stokes_form_2_p_u_d3_simplex_mixed_jacobian_action_block(
    const int ne,
...
template <typename s_t, int NQ, int CELL_NS, int VS>
__host__ __device__ __forceinline__ void navier_stokes_form_2_p_u_d3_simplex_mixed_jacobian_action_block_contiguous(
    const int ne,
    const ptrdiff_t geometry_stride,
    const s_t *const RSTR determinant,
    const s_t *const RSTR adjugate[9],
