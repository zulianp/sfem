...
static SFEM_INLINE void navier_stokes_d3_tensor_product_mixed_residual_block(
    ...
    for (int q = 0; q < N_QP; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            const scalar_t value_coeff3 = u0_grad_0 + u1_grad_1 + u2_grad_2;
...
static SFEM_INLINE void navier_stokes_d3_tensor_product_mixed_jacobian_action_block(
    ...
    for (int q = 0; q < N_QP; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            const scalar_t residual_tmp5 = -p_direction;
            const scalar_t residual_tmp6 = nu*rho;
            const scalar_t residual_tmp7 = scalar_t(2)*residual_tmp6;
            const scalar_t residual_tmp8 = residual_tmp6*u0_direction_grad_1 + residual_tmp6*u1_direction_grad_0;
            const scalar_t residual_tmp9 = residual_tmp6*u0_direction_grad_2 + residual_tmp6*u2_direction_grad_0;
            const scalar_t residual_tmp10 = residual_tmp6*u1_direction_grad_2 + residual_tmp6*u2_direction_grad_1;
            ...
            const scalar_t grad_coeff0_0 = residual_tmp5 + residual_tmp7*u0_direction_grad_0;
            const scalar_t grad_coeff0_1 = residual_tmp8;
            const scalar_t grad_coeff0_2 = residual_tmp9;
            ...
            const scalar_t grad_coeff1_0 = residual_tmp8;
            const scalar_t grad_coeff1_1 = residual_tmp5 + residual_tmp7*u1_direction_grad_1;
            const scalar_t grad_coeff1_2 = residual_tmp10;
            ...
            const scalar_t grad_coeff2_0 = residual_tmp9;
            const scalar_t grad_coeff2_1 = residual_tmp10;
            const scalar_t grad_coeff2_2 = residual_tmp5 + residual_tmp7*u2_direction_grad_2;
            const scalar_t value_coeff3 = u0_direction_grad_0 + u1_direction_grad_1 + u2_direction_grad_2;
            u0_value_coeff[q * VECTOR_SIZE + lane] = qw * det * value_coeff0;
            u0_grad_coeff_ref[(q * DIM + 0) * VECTOR_SIZE + lane] = qw * (adj0 * grad_coeff0_0 + adj1 * grad_coeff0_1 + adj2 * grad_coeff0_2);
            u0_grad_coeff_ref[(q * DIM + 1) * VECTOR_SIZE + lane] = qw * (adj3 * grad_coeff0_0 + adj4 * grad_coeff0_1 + adj5 * grad_coeff0_2);
            u0_grad_coeff_ref[(q * DIM + 2) * VECTOR_SIZE + lane] = qw * (adj6 * grad_coeff0_0 + adj7 * grad_coeff0_1 + adj8 * grad_coeff0_2);
