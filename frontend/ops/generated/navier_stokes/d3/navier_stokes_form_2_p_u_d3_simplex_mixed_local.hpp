...
static SFEM_INLINE void navier_stokes_form_2_p_u_d3_simplex_mixed_jacobian_action_block(
    ...
    for (int q = 0; q < NQ; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            p_direction_grad_2_ref += coeff_direction_p_0 * fgref[1 * ND + 2][q * P_NS + 0];
            ...
            p_direction_grad_2_ref += coeff_direction_p_1 * fgref[1 * ND + 2][q * P_NS + 1];
            ...
            p_direction_grad_2_ref += coeff_direction_p_2 * fgref[1 * ND + 2][q * P_NS + 2];
            const s_t coeff_direction_p_3 = direction[33][lane];
            p_direction_grad_0_ref += coeff_direction_p_3 * fgref[1 * ND + 0][q * P_NS + 3];
            p_direction_grad_1_ref += coeff_direction_p_3 * fgref[1 * ND + 1][q * P_NS + 3];
            p_direction_grad_2_ref += coeff_direction_p_3 * fgref[1 * ND + 2][q * P_NS + 3];
