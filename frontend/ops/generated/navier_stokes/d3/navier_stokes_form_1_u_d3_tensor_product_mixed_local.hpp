#ifndef NAVIER_STOKES_FORM_1_U_D3_TENSOR_PRODUCT_MIXED_LOCAL_HPP
#define NAVIER_STOKES_FORM_1_U_D3_TENSOR_PRODUCT_MIXED_LOCAL_HPP
...
static SFEM_INLINE void navier_stokes_form_1_u_d3_tensor_product_mixed_residual_block(
    const int ne,
...
template <typename s_t, int NQ, int CELL_NS, int VS>
static SFEM_INLINE void navier_stokes_form_1_u_d3_tensor_product_mixed_residual_block_contiguous(
    const int ne,
    const ptrdiff_t geometry_stride,
    const s_t *const RSTR determinant,
    const s_t *const RSTR adjugate[9],
...
template <typename s_t, int NQ, int CELL_NS, int VS>
static SFEM_INLINE void navier_stokes_form_1_u_d3_tensor_product_mixed_jacobian_action_block(
    const int ne,
    const ptrdiff_t geometry_stride,
    const s_t *const RSTR determinant,
    const s_t *const RSTR field_shape_1d[2],
...
template <typename s_t, int NQ, int CELL_NS, int VS>
static SFEM_INLINE void navier_stokes_form_1_u_d3_tensor_product_mixed_jacobian_action_block_contiguous(
    const int ne,
    const ptrdiff_t geometry_stride,
    const s_t *const RSTR determinant,
    const s_t *const RSTR field_shape_1d[2],
