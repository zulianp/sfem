...
static SFEM_INLINE void navier_stokes_form_2_u_u_d3_tensor_product_residual_block(
        ...
        const s_t *const SFEM_RESTRICT field_shape_1d[1],
        const s_t *const SFEM_RESTRICT q_weight_1d,
        s_t *const SFEM_RESTRICT output[81]
) {
...
static SFEM_INLINE void navier_stokes_form_2_u_u_d3_tensor_product_jacobian_action_block(
        ...
        const s_t *const SFEM_RESTRICT field_shape_1d[1],
        const s_t *const SFEM_RESTRICT field_grad_1d[1],
        const s_t *const SFEM_RESTRICT q_weight_1d,
        const s_t *const SFEM_RESTRICT previous[81],
        const s_t *const SFEM_RESTRICT direction[81],
