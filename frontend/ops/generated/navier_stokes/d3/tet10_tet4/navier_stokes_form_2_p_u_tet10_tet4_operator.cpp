...
extern "C" int navier_stokes_form_2_p_u_tet10_tet4_jacobian_action_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::navier_stokes_form_2_p_u_tet10_tet4_jacobian_action_affine_mesh_mixed_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, direction_stride, (const double *const *)u_direction_data, (const double *)p_direction_data, out_stride, (double *const *)u_out, (double *)p_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::navier_stokes_form_2_p_u_tet10_tet4_jacobian_action_affine_mesh_mixed_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, direction_stride, (const float *const *)u_direction_data, (const float *)p_direction_data, out_stride, (float *const *)u_out, (float *)p_out);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("navier_stokes_form_2_p_u_tet10_tet4_jacobian_action_a_msoa", -1, (int)scalar_bytes);
}
...
extern "C" int navier_stokes_form_2_p_u_tet10_tet4_jacobian_action_i_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::navier_stokes_form_2_p_u_tet10_tet4_jacobian_action_isoparametric_mesh_mixed_impl<double>(nelements, nnodes, elements, points, direction_stride, (const double *const *)u_direction_data, (const double *)p_direction_data, out_stride, (double *const *)u_out, (double *)p_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::navier_stokes_form_2_p_u_tet10_tet4_jacobian_action_isoparametric_mesh_mixed_impl<float>(nelements, nnodes, elements, points, direction_stride, (const float *const *)u_direction_data, (const float *)p_direction_data, out_stride, (float *const *)u_out, (float *)p_out);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("navier_stokes_form_2_p_u_tet10_tet4_jacobian_action_i_msoa", -1, (int)scalar_bytes);
}
