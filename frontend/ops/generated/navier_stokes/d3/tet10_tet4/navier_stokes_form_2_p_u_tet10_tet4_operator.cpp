...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        navier_stokes_form_2_p_u_d3_simplex_mixed_jacobian_action_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, 0, bageom_streams[9], badjugate, field_shape, fgref, sfem::codegen::navier_stokes_form_2_p_u_affine_reference_data<s_t>::q_weight(), bdirection, boutput);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        navier_stokes_form_2_p_u_d3_simplex_mixed_jacobian_action_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, VS, bdeterminant, badjugate, field_shape, fgref, sfem::codegen::navier_stokes_form_2_p_u_isoparametric_reference_data<s_t>::q_weight(), bdirection, boutput);
