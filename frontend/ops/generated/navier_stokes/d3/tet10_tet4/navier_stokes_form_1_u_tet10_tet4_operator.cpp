...
static SFEM_INLINE int navier_stokes_form_1_u_tet10_tet4_residual_affine_mesh_mixed_impl(
    ...
    const s_t *const field_grad_ref[NC * ND] = {sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet10_grad_ref_x(), sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet10_grad_ref_y(), sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet10_grad_ref_z(), sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet4_grad_ref_x(), sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet4_grad_ref_y(), sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet4_grad_ref_z()};
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VS) {
        ...
        navier_stokes_form_1_u_d3_simplex_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, 0, block_affine_geometry_streams[9], block_adjugate, field_shape, field_grad_ref, sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::q_weight(), block_current, block_previous, convection_scale, dt, f0, f1, f2, nu, rho, block_output);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VS) {
        ...
        const s_t *const field_grad_ref[NC * ND] = {sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet10_grad_ref_x(), sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet10_grad_ref_y(), sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet10_grad_ref_z(), sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet4_grad_ref_x(), sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet4_grad_ref_y(), sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet4_grad_ref_z()};
        ...
        navier_stokes_form_1_u_d3_simplex_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, VS, block_determinant, block_adjugate, field_shape, field_grad_ref, sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::q_weight(), block_current, block_previous, convection_scale, dt, f0, f1, f2, nu, rho, block_output);
