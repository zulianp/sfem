...
static const KernelDiagnostics navier_stokes_form_1_u_tet10_tet4_residual_element_soa_diagnostics_data = {
    "navier_stokes_form_1_u_tet10_tet4_residual_element_soa",
    "TET10",
    3,
    11,
    10,
...
extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_u_tet10_tet4_residual_element_soa_diagnostics(void) {
    return &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_residual_element_soa_diagnostics_data;
}
...
extern "C" double navier_stokes_form_1_u_tet10_tet4_residual_element_soa_arithmetic_intensity(
    ...
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_residual_element_soa_diagnostics_data,
...
extern "C" void navier_stokes_form_1_u_tet10_tet4_residual_element_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "navier_stokes_form_1_u_tet10_tet4_residual_element_soa_float",
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs,
...
extern "C" void navier_stokes_form_1_u_tet10_tet4_residual_affine_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "navier_stokes_form_1_u_tet10_tet4_residual_affine_mesh_soa",
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void navier_stokes_form_1_u_tet10_tet4_residual_affine_mesh_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "navier_stokes_form_1_u_tet10_tet4_residual_affine_mesh_soa_float",
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void navier_stokes_form_1_u_tet10_tet4_residual_isoparametric_mesh_soa_print_rate(
    ...
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "navier_stokes_form_1_u_tet10_tet4_residual_isoparametric_mesh_soa",
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void navier_stokes_form_1_u_tet10_tet4_residual_isoparametric_mesh_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "navier_stokes_form_1_u_tet10_tet4_residual_isoparametric_mesh_soa_float",
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_residual_element_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static const KernelDiagnostics navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics_data = {
    "navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa",
    "TET10",
    3,
    11,
    10,
...
extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics(void) {
    return &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics_data;
}
...
extern "C" double navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_arithmetic_intensity(
        ...
        const size_t accumulator_bytes) {
    return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            nelements, scalar_bytes, real_bytes, accumulator_bytes);
}
...
extern "C" void navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate(
            "navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_float",
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void navier_stokes_form_1_u_tet10_tet4_jacobian_action_affine_mesh_soa_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "navier_stokes_form_1_u_tet10_tet4_jacobian_action_affine_mesh_soa",
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void navier_stokes_form_1_u_tet10_tet4_jacobian_action_affine_mesh_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
            "navier_stokes_form_1_u_tet10_tet4_jacobian_action_affine_mesh_soa_float",
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" void navier_stokes_form_1_u_tet10_tet4_jacobian_action_isoparametric_mesh_soa_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "navier_stokes_form_1_u_tet10_tet4_jacobian_action_isoparametric_mesh_soa",
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(double), sizeof(double), sizeof(double));
}
...
extern "C" void navier_stokes_form_1_u_tet10_tet4_jacobian_action_isoparametric_mesh_soa_float_print_rate(
        ...
        const ptrdiff_t ndofs) {
    sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
            "navier_stokes_form_1_u_tet10_tet4_jacobian_action_isoparametric_mesh_soa_float",
            &sfem::codegen::navier_stokes_form_1_u_tet10_tet4_jacobian_action_element_soa_diagnostics_data,
            elapsed, nelements, ndofs,
            sizeof(float), sizeof(float), sizeof(float));
}
...
static SFEM_INLINE int navier_stokes_form_1_u_tet10_tet4_residual_affine_mesh_mixed_impl(
    ...
    (void)nnodes;
    const s_t *const field_shape[NC] = {sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet10_shape(), sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet4_shape()};
    const s_t *const fgref[NC * ND] = {sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet10_grad_ref_x(), sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet10_grad_ref_y(), sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet10_grad_ref_z(), sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet4_grad_ref_x(), sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet4_grad_ref_y(), sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::tet4_grad_ref_z()};
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        navier_stokes_form_1_u_d3_simplex_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, 0, bageom_streams[9], badjugate, field_shape, fgref, sfem::codegen::navier_stokes_form_1_u_affine_reference_data<s_t>::q_weight(), bcurrent, bprevious, convection_scale, dt, f0, f1, f2, nu, rho, boutput);
...
extern "C" int navier_stokes_form_1_u_tet10_tet4_residual_affine_mesh_soa(
    ...
    return sfem::codegen::navier_stokes_form_1_u_tet10_tet4_residual_affine_mesh_mixed_impl<double, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, convection_scale, dt, f0, f1, f2, nu, rho, current_stride, u_data, p_data, previous_stride, u_old_data, p_old_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_form_1_u_tet10_tet4_residual_affine_mesh_soa_float(
    ...
    return sfem::codegen::navier_stokes_form_1_u_tet10_tet4_residual_affine_mesh_mixed_impl<float, geom_t>(nelements, nnodes, elements, g_jacobian_adjugate0, g_jacobian_adjugate1, g_jacobian_adjugate2, g_jacobian_adjugate3, g_jacobian_adjugate4, g_jacobian_adjugate5, g_jacobian_adjugate6, g_jacobian_adjugate7, g_jacobian_adjugate8, g_jacobian_determinant0, convection_scale, dt, f0, f1, f2, nu, rho, current_stride, u_data, p_data, previous_stride, u_old_data, p_old_data, out_stride, u_out, p_out);
}
...
static SFEM_INLINE int navier_stokes_form_1_u_tet10_tet4_residual_isoparametric_mesh_mixed_impl(
    ...
    static constexpr int VS = 16;
    (void)nnodes;
    const s_t *const isoparametric_cell_grad_ref_0 = sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet10_grad_ref_x();
    const s_t *const isoparametric_cell_grad_ref_1 = sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet10_grad_ref_y();
    const s_t *const isoparametric_cell_grad_ref_2 = sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet10_grad_ref_z();
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        const int nelems = (int)MIN((ptrdiff_t)VS, nelements - evb);
        ...
        const s_t *const field_shape[NC] = {sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet10_shape(), sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet4_shape()};
        const s_t *const fgref[NC * ND] = {sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet10_grad_ref_x(), sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet10_grad_ref_y(), sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet10_grad_ref_z(), sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet4_grad_ref_x(), sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet4_grad_ref_y(), sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::tet4_grad_ref_z()};
        ...
        navier_stokes_form_1_u_d3_simplex_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, VS, bdeterminant, badjugate, field_shape, fgref, sfem::codegen::navier_stokes_form_1_u_isoparametric_reference_data<s_t>::q_weight(), bcurrent, bprevious, convection_scale, dt, f0, f1, f2, nu, rho, boutput);
