#include <type_traits>
#include "../../cuda/navier_stokes_form_1_u_d3_simplex_mixed_local.cuh"
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_navier_stokes_form_1_u_tet10_tet4_residual_esoa_diagnostics(void) {
...
extern "C" const sfem::codegen::KernelDiagnostics *cu_navier_stokes_form_1_u_tet10_tet4_jacobian_action_esoa_diagnostics(void) {
...
__global__ void navier_stokes_form_1_u_tet10_tet4_residual_affine_mesh_mixed_impl(
...
__global__ void navier_stokes_form_1_u_tet10_tet4_residual_isoparametric_mesh_mixed_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t,
    idx_t **const RSTR elements,
