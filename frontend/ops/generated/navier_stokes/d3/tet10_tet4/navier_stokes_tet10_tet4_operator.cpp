#include <type_traits>
#include "../navier_stokes_d3_simplex_mixed_local.hpp"
...
extern "C" double navier_stokes_tet10_tet4_residual_esoa_arithmetic_intensity(
    const ptrdiff_t nelements,
    const size_t scalar_bytes,
    const size_t real_bytes,
    const size_t accumulator_bytes) {
  return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
      &sfem::codegen::navier_stokes_tet10_tet4_residual_esoa_diagnostics_data,
      nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void navier_stokes_tet10_tet4_residual_esoa_print_rate(
...
extern "C" void navier_stokes_tet10_tet4_residual_esoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
      "navier_stokes_tet10_tet4_residual_esoa_float",
      &sfem::codegen::navier_stokes_tet10_tet4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void navier_stokes_tet10_tet4_residual_a_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "navier_stokes_tet10_tet4_residual_a_msoa",
      &sfem::codegen::navier_stokes_tet10_tet4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void navier_stokes_tet10_tet4_residual_a_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "navier_stokes_tet10_tet4_residual_a_msoa_float",
      &sfem::codegen::navier_stokes_tet10_tet4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void navier_stokes_tet10_tet4_residual_i_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "navier_stokes_tet10_tet4_residual_i_msoa",
      &sfem::codegen::navier_stokes_tet10_tet4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void navier_stokes_tet10_tet4_residual_i_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "navier_stokes_tet10_tet4_residual_i_msoa_float",
      &sfem::codegen::navier_stokes_tet10_tet4_residual_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}
...
extern "C" double navier_stokes_tet10_tet4_jacobian_action_esoa_arithmetic_intensity(
    const ptrdiff_t nelements,
    const size_t scalar_bytes,
    const size_t real_bytes,
    const size_t accumulator_bytes) {
  return sfem::codegen::KernelDiagnostics_arithmetic_intensity(
      &sfem::codegen::navier_stokes_tet10_tet4_jacobian_action_esoa_diagnostics_data,
      nelements, scalar_bytes, real_bytes, accumulator_bytes);
}

extern "C" void navier_stokes_tet10_tet4_jacobian_action_esoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
...
extern "C" void navier_stokes_tet10_tet4_jacobian_action_esoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate(
      "navier_stokes_tet10_tet4_jacobian_action_esoa_float",
      &sfem::codegen::navier_stokes_tet10_tet4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void navier_stokes_tet10_tet4_jacobian_action_a_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "navier_stokes_tet10_tet4_jacobian_action_a_msoa",
      &sfem::codegen::navier_stokes_tet10_tet4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void navier_stokes_tet10_tet4_jacobian_action_a_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_affine_mesh(
      "navier_stokes_tet10_tet4_jacobian_action_a_msoa_float",
      &sfem::codegen::navier_stokes_tet10_tet4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}

extern "C" void navier_stokes_tet10_tet4_jacobian_action_i_msoa_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "navier_stokes_tet10_tet4_jacobian_action_i_msoa",
      &sfem::codegen::navier_stokes_tet10_tet4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(double), sizeof(double), sizeof(double));
}

extern "C" void navier_stokes_tet10_tet4_jacobian_action_i_msoa_float_print_rate(
    const double elapsed,
    const ptrdiff_t nelements,
    const ptrdiff_t ndofs) {
  sfem::codegen::KernelDiagnostics_print_rate_isoparametric_mesh(
      "navier_stokes_tet10_tet4_jacobian_action_i_msoa_float",
      &sfem::codegen::navier_stokes_tet10_tet4_jacobian_action_esoa_diagnostics_data,
      elapsed, nelements, ndofs,
      sizeof(float), sizeof(float), sizeof(float));
}
...
static SFEM_INLINE int navier_stokes_tet10_tet4_residual_affine_mesh_mixed_impl(
  ...
  (void)nnodes;
  const s_t *const field_shape[NC] = {sfem::codegen::navier_stokes_affine_reference_data<s_t>::tet10_shape(), sfem::codegen::navier_stokes_affine_reference_data<s_t>::tet4_shape()};
  const s_t *const fgref[NC * ND] = {sfem::codegen::navier_stokes_affine_reference_data<s_t>::tet10_grad_ref_x(), sfem::codegen::navier_stokes_affine_reference_data<s_t>::tet10_grad_ref_y(), sfem::codegen::navier_stokes_affine_reference_data<s_t>::tet10_grad_ref_z(), sfem::codegen::navier_stokes_affine_reference_data<s_t>::tet4_grad_ref_x(), sfem::codegen::navier_stokes_affine_reference_data<s_t>::tet4_grad_ref_y(), sfem::codegen::navier_stokes_affine_reference_data<s_t>::tet4_grad_ref_z()};
...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    navier_stokes_d3_simplex_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(ne, 0, bageom_streams[9], badjugate, field_shape, fgref, sfem::codegen::navier_stokes_affine_reference_data<s_t>::q_weight(), bcurrent, bprevious, convection_scale, dt, f0, f1, f2, nu, rho, boutput);
...
extern "C" int navier_stokes_tet10_tet4_residual_a_msoa(
  ...
  return sfem::codegen::navier_stokes_tet10_tet4_residual_affine_mesh_mixed_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, convection_scale, dt, f0, f1, f2, nu, rho, current_stride, u_data, p_data, previous_stride, u_old_data, p_old_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_tet10_tet4_residual_a_msoa_float(
  ...
  return sfem::codegen::navier_stokes_tet10_tet4_residual_affine_mesh_mixed_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, convection_scale, dt, f0, f1, f2, nu, rho, current_stride, u_data, p_data, previous_stride, u_old_data, p_old_data, out_stride, u_out, p_out);
}
...
static SFEM_INLINE int navier_stokes_tet10_tet4_residual_isoparametric_mesh_mixed_impl(
  ...
  static constexpr int VS = 16;
  (void)nnodes;
  const s_t *const isoparametric_cell_grad_ref_0 = sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::tet10_grad_ref_x();
  const s_t *const isoparametric_cell_grad_ref_1 = sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::tet10_grad_ref_y();
  const s_t *const isoparametric_cell_grad_ref_2 = sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::tet10_grad_ref_z();
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    const int ne = (int)MIN((ptrdiff_t)VS, nelements - evb);
    ...
    const s_t *const field_shape[NC] = {sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::tet10_shape(), sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::tet4_shape()};
    const s_t *const fgref[NC * ND] = {sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::tet10_grad_ref_x(), sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::tet10_grad_ref_y(), sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::tet10_grad_ref_z(), sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::tet4_grad_ref_x(), sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::tet4_grad_ref_y(), sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::tet4_grad_ref_z()};
    ...
    navier_stokes_d3_simplex_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(ne, VS, bdeterminant, badjugate, field_shape, fgref, sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::q_weight(), bcurrent, bprevious, convection_scale, dt, f0, f1, f2, nu, rho, boutput);
...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    navier_stokes_d3_simplex_mixed_jacobian_action_block_contiguous<s_t, NQ, CELL_NS, VS>(ne, 0, bageom_streams[9], badjugate, field_shape, fgref, sfem::codegen::navier_stokes_affine_reference_data<s_t>::q_weight(), bprevious, bdirection, convection_scale, dt, nu, rho, boutput);
...
extern "C" int navier_stokes_tet10_tet4_jacobian_action_a_msoa(
  ...
  return sfem::codegen::navier_stokes_tet10_tet4_jacobian_action_affine_mesh_mixed_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, convection_scale, dt, nu, rho, previous_stride, u_old_data, p_old_data, direction_stride, u_direction_data, p_direction_data, out_stride, u_out, p_out);
}
...
extern "C" int navier_stokes_tet10_tet4_jacobian_action_a_msoa_float(
  ...
  return sfem::codegen::navier_stokes_tet10_tet4_jacobian_action_affine_mesh_mixed_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, convection_scale, dt, nu, rho, previous_stride, u_old_data, p_old_data, direction_stride, u_direction_data, p_direction_data, out_stride, u_out, p_out);
}
...
#pragma omp parallel for schedule(static)
  for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
    ...
    navier_stokes_d3_simplex_mixed_jacobian_action_block_contiguous<s_t, NQ, CELL_NS, VS>(ne, VS, bdeterminant, badjugate, field_shape, fgref, sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::q_weight(), bprevious, bdirection, convection_scale, dt, nu, rho, boutput);
