...
static SFEM_INLINE int navier_stokes_form_1_p_tet10_tet4_residual_affine_mesh_mixed_impl(
    ...
    (void)nnodes;
    const scalar_t *const field_shape[N_FIELDS] = {sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::tet10_shape(), sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::tet4_shape()};
    const scalar_t *const field_grad_ref[N_FIELDS * DIM] = {sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::tet10_grad_ref_x(), sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::tet10_grad_ref_y(), sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::tet10_grad_ref_z(), sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::tet4_grad_ref_x(), sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::tet4_grad_ref_y(), sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::tet4_grad_ref_z()};
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        ...
        navier_stokes_form_1_p_d3_simplex_mixed_residual_block_contiguous<scalar_t, N_QP, CELL_N_SHAPE, VECTOR_SIZE>(nelems, 0, block_affine_geometry_streams[9], block_adjugate, field_shape, field_grad_ref, sfem::codegen::navier_stokes_form_1_p_affine_reference_data<scalar_t>::q_weight(), block_current, block_output);
...
static SFEM_INLINE int navier_stokes_form_1_p_tet10_tet4_residual_isoparametric_mesh_mixed_impl(
    ...
    static constexpr int VECTOR_SIZE = 16;
    (void)nnodes;
    const scalar_t *const isoparametric_cell_grad_ref_0 = sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_x();
    const scalar_t *const isoparametric_cell_grad_ref_1 = sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_y();
    const scalar_t *const isoparametric_cell_grad_ref_2 = sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_z();
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VECTOR_SIZE) {
        const int nelems = (int)MIN((ptrdiff_t)VECTOR_SIZE, nelements - evbegin);
        ...
        const scalar_t *const field_shape[N_FIELDS] = {sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::tet10_shape(), sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::tet4_shape()};
        const scalar_t *const field_grad_ref[N_FIELDS * DIM] = {sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_x(), sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_y(), sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::tet10_grad_ref_z(), sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::tet4_grad_ref_x(), sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::tet4_grad_ref_y(), sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::tet4_grad_ref_z()};
        ...
        navier_stokes_form_1_p_d3_simplex_mixed_residual_block_contiguous<scalar_t, N_QP, CELL_N_SHAPE, VECTOR_SIZE>(nelems, VECTOR_SIZE, block_determinant, block_adjugate, field_shape, field_grad_ref, sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<scalar_t>::q_weight(), block_current, block_output);
