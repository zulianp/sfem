...
static SFEM_INLINE int navier_stokes_form_1_p_proteus_hex27_proteus_hex8_residual_affine_mesh_mixed_impl(
...
extern "C" int navier_stokes_form_1_p_proteus_hex27_proteus_hex8_residual_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::navier_stokes_form_1_p_proteus_hex27_proteus_hex8_residual_affine_mesh_mixed_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, current_stride, (const double *const *)u_data, (const double *)p_data, out_stride, (double *const *)u_out, (double *)p_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::navier_stokes_form_1_p_proteus_hex27_proteus_hex8_residual_affine_mesh_mixed_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, current_stride, (const float *const *)u_data, (const float *)p_data, out_stride, (float *const *)u_out, (float *)p_out);
    }
    default:
      break;
  }
...
static SFEM_INLINE int navier_stokes_form_1_p_proteus_hex27_proteus_hex8_residual_isoparametric_mesh_mixed_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t,
    idx_t **const RSTR elements,
...
extern "C" int navier_stokes_form_1_p_proteus_hex27_proteus_hex8_residual_i_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::navier_stokes_form_1_p_proteus_hex27_proteus_hex8_residual_isoparametric_mesh_mixed_impl<double>(nelements, nnodes, elements, points, current_stride, (const double *const *)u_data, (const double *)p_data, out_stride, (double *const *)u_out, (double *)p_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::navier_stokes_form_1_p_proteus_hex27_proteus_hex8_residual_isoparametric_mesh_mixed_impl<float>(nelements, nnodes, elements, points, current_stride, (const float *const *)u_data, (const float *)p_data, out_stride, (float *const *)u_out, (float *)p_out);
    }
    default:
      break;
  }
