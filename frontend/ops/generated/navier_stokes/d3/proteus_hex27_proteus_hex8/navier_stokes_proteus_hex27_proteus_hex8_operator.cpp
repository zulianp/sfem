...
static const KernelDiagnostics navier_stokes_proteus_hex27_proteus_hex8_residual_esoa_diagnostics_data = {
  "navier_stokes_proteus_hex27_proteus_hex8_residual_esoa",
  "PROTEUS_HEX27",
  3,
  64,
  27,
...
extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_proteus_hex27_proteus_hex8_residual_esoa_diagnostics(void) {
  return &sfem::codegen::navier_stokes_proteus_hex27_proteus_hex8_residual_esoa_diagnostics_data;
}

namespace sfem {
namespace codegen {

static const KernelDiagnostics navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_esoa_diagnostics_data = {
  "navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_esoa",
  "PROTEUS_HEX27",
  3,
  64,
  27,
...
extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_esoa_diagnostics(void) {
  return &sfem::codegen::navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_esoa_diagnostics_data;
}
...
static SFEM_INLINE int navier_stokes_proteus_hex27_proteus_hex8_residual_affine_mesh_mixed_impl(
...
extern "C" int navier_stokes_proteus_hex27_proteus_hex8_residual_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::navier_stokes_proteus_hex27_proteus_hex8_residual_affine_mesh_mixed_impl<double, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, convection_scale, dt, f0, f1, f2, nu, rho, current_stride, (const double *const *)u_data, (const double *)p_data, previous_stride, (const double *const *)u_old_data, (const double *)p_old_data, out_stride, (double *const *)u_out, (double *)p_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::navier_stokes_proteus_hex27_proteus_hex8_residual_affine_mesh_mixed_impl<float, geom_t>(nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, convection_scale, dt, f0, f1, f2, nu, rho, current_stride, (const float *const *)u_data, (const float *)p_data, previous_stride, (const float *const *)u_old_data, (const float *)p_old_data, out_stride, (float *const *)u_out, (float *)p_out);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("navier_stokes_proteus_hex27_proteus_hex8_residual_a_msoa", -1, (int)scalar_bytes);
}
...
static SFEM_INLINE int navier_stokes_proteus_hex27_proteus_hex8_residual_isoparametric_mesh_mixed_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t,
    idx_t **const RSTR elements,
...
extern "C" int navier_stokes_proteus_hex27_proteus_hex8_residual_i_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("navier_stokes_proteus_hex27_proteus_hex8_residual_i_msoa", -1, (int)scalar_bytes);
}
...
template <typename s_t, typename g_t>
static SFEM_INLINE int navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_affine_mesh_mixed_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t,
    idx_t **const RSTR elements,
    const g_t *const RSTR g_adj0,
...
extern "C" int navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_a_msoa(
  ...
  return sfem::codegen::unsupported_dispatch("navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_a_msoa", -1, (int)scalar_bytes);
}
...
template <typename s_t>
static SFEM_INLINE int navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_isoparametric_mesh_mixed_impl(
    const ptrdiff_t nelements,
    const ptrdiff_t,
    idx_t **const RSTR elements,
    const geom_t *const *const RSTR points,
...
extern "C" int navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_i_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        return sfem::codegen::navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_isoparametric_mesh_mixed_impl<double>(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const double *const *)u_old_data, (const double *)p_old_data, direction_stride, (const double *const *)u_direction_data, (const double *)p_direction_data, out_stride, (double *const *)u_out, (double *)p_out);
    }
    case (int)sizeof(float): {
        return sfem::codegen::navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_isoparametric_mesh_mixed_impl<float>(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const float *const *)u_old_data, (const float *)p_old_data, direction_stride, (const float *const *)u_direction_data, (const float *)p_direction_data, out_stride, (float *const *)u_out, (float *)p_out);
    }
    default:
      break;
  }
  return sfem::codegen::unsupported_dispatch("navier_stokes_proteus_hex27_proteus_hex8_jacobian_action_i_msoa", -1, (int)scalar_bytes);
}
