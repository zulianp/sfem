...
extern "C" int cu_navier_stokes_form_1_u_proteus_hex27_proteus_hex8_residual_a_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        ...
        return sfem::codegen::launch_status("navier_stokes_form_1_u_proteus_hex27_proteus_hex8_residual_affine_mesh_mixed_impl");
    }
...
extern "C" int cu_navier_stokes_form_1_u_proteus_hex27_proteus_hex8_residual_i_msoa(
  ...
  switch (scalar_bytes) {
    case (int)sizeof(double): {
        ...
        return sfem::codegen::launch_status("navier_stokes_form_1_u_proteus_hex27_proteus_hex8_residual_isoparametric_mesh_mixed_impl");
    }
    case (int)sizeof(float): {
        const int block_size = 256;
        const int grid_size = (int)((nelements + block_size - 1) / block_size);
