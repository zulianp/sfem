...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_p_jacobian_action_2d_esoa_diagnostics(
  ...
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_form_1_p_tri6_tri3_jacobian_action_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_form_1_p_jacobian_action_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_p_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_form_1_p_jacobian_action_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_p_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_form_1_p_tri6_tri3_residual_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_form_1_p_residual_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_p_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_form_1_p_residual_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_u_jacobian_action_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_form_1_u_tri6_tri3_jacobian_action_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_form_1_u_jacobian_action_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_u_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_form_1_u_jacobian_action_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_u_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_form_1_u_tri6_tri3_residual_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_form_1_u_residual_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_1_u_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_form_1_u_residual_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_p_u_jacobian_action_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_form_2_p_u_tri6_tri3_jacobian_action_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_form_2_p_u_jacobian_action_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_p_u_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_form_2_p_u_jacobian_action_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_p_u_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_form_2_p_u_tri6_tri3_residual_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_form_2_p_u_residual_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_p_u_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_form_2_p_u_residual_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_u_p_jacobian_action_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_form_2_u_p_tri6_tri3_jacobian_action_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_form_2_u_p_jacobian_action_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_u_p_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_form_2_u_p_jacobian_action_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_u_p_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_form_2_u_p_tri6_tri3_residual_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_form_2_u_p_residual_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_u_p_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_form_2_u_p_residual_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_u_u_jacobian_action_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_form_2_u_u_tri6_jacobian_action_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_form_2_u_u_jacobian_action_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_u_u_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_form_2_u_u_jacobian_action_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_u_u_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_form_2_u_u_tri6_residual_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_form_2_u_u_residual_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_form_2_u_u_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_form_2_u_u_residual_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_jacobian_action_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_tri6_tri3_jacobian_action_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_jacobian_action_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_jacobian_action_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_jacobian_action_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_residual_2d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::TRI6:
      return navier_stokes_tri6_tri3_residual_esoa_diagnostics();
    default:
      std::fprintf(stderr, "navier_stokes_residual_2d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}

SFEM_CODEGEN_PUBLIC_C_ABI extern "C" const sfem::codegen::KernelDiagnostics *navier_stokes_residual_3d_esoa_diagnostics(
    const smesh::ElemType element_type) {
  switch (element_type) {
    case smesh::HEX27:
    ...
    default:
      std::fprintf(stderr, "navier_stokes_residual_3d_esoa_diagnostics does not support element type %d\n", (int)element_type);
      return nullptr;
  }
}
