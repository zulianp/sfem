...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_form_2_p_u_hessian_coo_triplet_2d_isoparametric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::TRI6: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_form_2_p_u_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_form_2_p_u_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
    ...
    std::fprintf(stderr,
            "navier_stokes_form_2_p_u_hessian_coo_triplet_2d_isoparametric_mesh_soa does not support element type %d with real type %d\n",
            (int)element_type,
            (int)real_type);
    return SFEM_FAILURE;
}
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_form_2_p_u_hessian_coo_triplet_3d_isoparametric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::HEX27: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_form_2_p_u_hex27_hex8_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_form_2_p_u_hex27_hex8_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
        ...
        case smesh::TET10: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_form_2_p_u_tet10_tet4_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_form_2_p_u_tet10_tet4_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
    ...
    std::fprintf(stderr,
            "navier_stokes_form_2_p_u_hessian_coo_triplet_3d_isoparametric_mesh_soa does not support element type %d with real type %d\n",
            (int)element_type,
            (int)real_type);
    return SFEM_FAILURE;
}
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_form_2_u_p_hessian_coo_triplet_2d_isoparametric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::TRI6: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_form_2_u_p_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_form_2_u_p_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
    ...
    std::fprintf(stderr,
            "navier_stokes_form_2_u_p_hessian_coo_triplet_2d_isoparametric_mesh_soa does not support element type %d with real type %d\n",
            (int)element_type,
            (int)real_type);
    return SFEM_FAILURE;
}
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_form_2_u_p_hessian_coo_triplet_3d_isoparametric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::HEX27: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_form_2_u_p_hex27_hex8_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_form_2_u_p_hex27_hex8_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
        ...
        case smesh::TET10: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_form_2_u_p_tet10_tet4_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_form_2_u_p_tet10_tet4_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
    ...
    std::fprintf(stderr,
            "navier_stokes_form_2_u_p_hessian_coo_triplet_3d_isoparametric_mesh_soa does not support element type %d with real type %d\n",
            (int)element_type,
            (int)real_type);
    return SFEM_FAILURE;
}
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_form_2_u_u_hessian_coo_triplet_2d_isoparametric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::TRI6: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_form_2_u_u_tri6_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const double *const *)u_old_data, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_form_2_u_u_tri6_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const float *const *)u_old_data, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
    ...
    std::fprintf(stderr,
            "navier_stokes_form_2_u_u_hessian_coo_triplet_2d_isoparametric_mesh_soa does not support element type %d with real type %d\n",
            (int)element_type,
            (int)real_type);
    return SFEM_FAILURE;
}
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_form_2_u_u_hessian_coo_triplet_3d_isoparametric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::HEX27: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_form_2_u_u_hex27_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const double *const *)u_old_data, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_form_2_u_u_hex27_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const float *const *)u_old_data, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
        ...
        case smesh::TET10: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_form_2_u_u_tet10_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const double *const *)u_old_data, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_form_2_u_u_tet10_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const float *const *)u_old_data, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
    ...
    std::fprintf(stderr,
            "navier_stokes_form_2_u_u_hessian_coo_triplet_3d_isoparametric_mesh_soa does not support element type %d with real type %d\n",
            (int)element_type,
            (int)real_type);
    return SFEM_FAILURE;
}
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_hessian_coo_triplet_2d_isoparametric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::TRI6: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const double *const *)u_old_data, (const double *)p_old_data, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_tri6_tri3_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const float *const *)u_old_data, (const float *)p_old_data, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
    ...
    std::fprintf(stderr,
            "navier_stokes_hessian_coo_triplet_2d_isoparametric_mesh_soa does not support element type %d with real type %d\n",
            (int)element_type,
            (int)real_type);
    return SFEM_FAILURE;
}
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_hessian_coo_triplet_3d_isoparametric_mesh_soa(
    ...
    switch (element_type) {
        case smesh::HEX27: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_hex27_hex8_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const double *const *)u_old_data, (const double *)p_old_data, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_hex27_hex8_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const float *const *)u_old_data, (const float *)p_old_data, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
        ...
        case smesh::TET10: {
            switch (resolved_real_type) {
                case smesh::SMESH_FLOAT64:
                    return navier_stokes_tet10_tet4_hessian_coo_triplet_isoparametric_mesh_soa(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const double *const *)u_old_data, (const double *)p_old_data, out_stride, rows, cols, (double *)values);
                case smesh::SMESH_FLOAT32:
                    return navier_stokes_tet10_tet4_hessian_coo_triplet_isoparametric_mesh_soa_float(nelements, nnodes, elements, points, convection_scale, dt, nu, rho, previous_stride, (const float *const *)u_old_data, (const float *)p_old_data, out_stride, rows, cols, (float *)values);
                default:
                    break;
            }
            break;
    ...
    std::fprintf(stderr,
            "navier_stokes_hessian_coo_triplet_3d_isoparametric_mesh_soa does not support element type %d with real type %d\n",
            (int)element_type,
            (int)real_type);
    return SFEM_FAILURE;
}
