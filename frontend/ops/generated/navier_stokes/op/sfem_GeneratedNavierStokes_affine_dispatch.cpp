...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_form_1_p_residual_3d_a_msoa(
  ...
  switch (element_type) {
    ...
    case smesh::PROTEUS_HEX27:
      return navier_stokes_form_1_p_proteus_hex27_proteus_hex8_residual_a_msoa((int)resolved_real_type, nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, current_stride, u_data, p_data, out_stride, u_out, p_out);
    case smesh::TET10:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_form_1_u_residual_3d_a_msoa(
  ...
  switch (element_type) {
    ...
    case smesh::PROTEUS_HEX27:
      return navier_stokes_form_1_u_proteus_hex27_proteus_hex8_residual_a_msoa((int)resolved_real_type, nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, convection_scale, dt, f0, f1, f2, nu, rho, current_stride, u_data, p_data, previous_stride, u_old_data, p_old_data, out_stride, u_out, p_out);
    case smesh::TET10:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_form_2_p_u_jacobian_action_3d_a_msoa(
  ...
  switch (element_type) {
    ...
    case smesh::PROTEUS_HEX27:
      return navier_stokes_form_2_p_u_proteus_hex27_proteus_hex8_jacobian_action_a_msoa((int)resolved_real_type, nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, direction_stride, u_direction_data, p_direction_data, out_stride, u_out, p_out);
    case smesh::TET10:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_form_2_u_p_jacobian_action_3d_a_msoa(
  ...
  switch (element_type) {
    ...
    case smesh::PROTEUS_HEX27:
      return navier_stokes_form_2_u_p_proteus_hex27_proteus_hex8_jacobian_action_a_msoa((int)resolved_real_type, nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, direction_stride, u_direction_data, p_direction_data, out_stride, u_out, p_out);
    case smesh::TET10:
...
SFEM_CODEGEN_PUBLIC_C_ABI extern "C" int navier_stokes_form_2_u_u_jacobian_action_3d_a_msoa(
  ...
  switch (element_type) {
    ...
    case smesh::PROTEUS_HEX27:
      return navier_stokes_form_2_u_u_proteus_hex27_jacobian_action_a_msoa((int)resolved_real_type, nelements, nnodes, elements, g_adj0, g_adj1, g_adj2, g_adj3, g_adj4, g_adj5, g_adj6, g_adj7, g_adj8, g_det0, convection_scale, dt, nu, rho, previous_stride, u_old_data, direction_stride, u_direction_data, out_stride, u_out);
    case smesh::TET10:
