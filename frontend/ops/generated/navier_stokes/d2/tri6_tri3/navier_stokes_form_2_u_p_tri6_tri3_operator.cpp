...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VS) {
        ...
        navier_stokes_form_2_u_p_d2_simplex_mixed_jacobian_action_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, 0, block_affine_geometry_streams[4], block_adjugate, field_shape, field_grad_ref, sfem::codegen::navier_stokes_form_2_u_p_affine_reference_data<s_t>::q_weight(), block_direction, block_output);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VS) {
        ...
        navier_stokes_form_2_u_p_d2_simplex_mixed_jacobian_action_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, VS, block_determinant, block_adjugate, field_shape, field_grad_ref, sfem::codegen::navier_stokes_form_2_u_p_isoparametric_reference_data<s_t>::q_weight(), block_direction, block_output);
