...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VS) {
        ...
        navier_stokes_d2_simplex_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, 0, block_affine_geometry_streams[4], block_adjugate, field_shape, field_grad_ref, sfem::codegen::navier_stokes_affine_reference_data<s_t>::q_weight(), block_current, block_previous, convection_scale, dt, f0, f1, nu, rho, block_output);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VS) {
        ...
        navier_stokes_d2_simplex_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, VS, block_determinant, block_adjugate, field_shape, field_grad_ref, sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::q_weight(), block_current, block_previous, convection_scale, dt, f0, f1, nu, rho, block_output);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VS) {
        ...
        navier_stokes_d2_simplex_mixed_jacobian_action_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, 0, block_affine_geometry_streams[4], block_adjugate, field_shape, field_grad_ref, sfem::codegen::navier_stokes_affine_reference_data<s_t>::q_weight(), block_previous, block_direction, convection_scale, dt, nu, rho, block_output);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VS) {
        ...
        navier_stokes_d2_simplex_mixed_jacobian_action_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, VS, block_determinant, block_adjugate, field_shape, field_grad_ref, sfem::codegen::navier_stokes_isoparametric_reference_data<s_t>::q_weight(), block_previous, block_direction, convection_scale, dt, nu, rho, block_output);
