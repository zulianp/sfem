...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        navier_stokes_form_1_p_d2_simplex_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, 0, bageom_streams[4], block_adjugate, field_shape, fgref, sfem::codegen::navier_stokes_form_1_p_affine_reference_data<s_t>::q_weight(), block_current, block_output);
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evb = 0; evb < nelements; evb += VS) {
        ...
        navier_stokes_form_1_p_d2_simplex_mixed_residual_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, VS, block_determinant, block_adjugate, field_shape, fgref, sfem::codegen::navier_stokes_form_1_p_isoparametric_reference_data<s_t>::q_weight(), block_current, block_output);
