...
static SFEM_INLINE int navier_stokes_form_2_u_u_tri6_jacobian_action_affine_mesh_mixed_impl(
    ...
    const s_t *const field_grad_ref[NC * ND] = {sfem::codegen::navier_stokes_form_2_u_u_affine_reference_data<s_t>::tri6_grad_ref_x(), sfem::codegen::navier_stokes_form_2_u_u_affine_reference_data<s_t>::tri6_grad_ref_y()};
...
#pragma omp parallel for schedule(static)
    for (ptrdiff_t evbegin = 0; evbegin < nelements; evbegin += VS) {
        ...
        const s_t *const field_grad_ref[NC * ND] = {sfem::codegen::navier_stokes_form_2_u_u_isoparametric_reference_data<s_t>::tri6_grad_ref_x(), sfem::codegen::navier_stokes_form_2_u_u_isoparametric_reference_data<s_t>::tri6_grad_ref_y()};
        ...
        navier_stokes_form_2_u_u_d2_simplex_jacobian_action_block_contiguous<s_t, NQ, CELL_NS, VS>(nelems, VS, block_determinant, block_adjugate, field_shape, field_grad_ref, sfem::codegen::navier_stokes_form_2_u_u_isoparametric_reference_data<s_t>::q_weight(), block_previous, block_direction, convection_scale, dt, nu, rho, block_output);
