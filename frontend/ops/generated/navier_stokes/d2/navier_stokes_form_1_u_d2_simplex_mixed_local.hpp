...
static SFEM_INLINE void navier_stokes_form_1_u_d2_simplex_mixed_residual_block(
  ...
  for (int q = 0; q < NQ; ++q) {
    ...
    for (int lane = 0; lane < ne; ++lane) {
      ...
      const s_t test_grad0_u0_0 = (fgref[0][q * U_NS + 0] * adj0 + fgref[1][q * U_NS + 0] * adj2) / det;
      const s_t test_grad1_u0_0 = (fgref[0][q * U_NS + 0] * adj1 + fgref[1][q * U_NS + 0] * adj3) / det;
      ...
      const s_t test_grad0_u1_0 = (fgref[0][q * U_NS + 0] * adj0 + fgref[1][q * U_NS + 0] * adj2) / det;
      const s_t test_grad1_u1_0 = (fgref[0][q * U_NS + 0] * adj1 + fgref[1][q * U_NS + 0] * adj3) / det;
