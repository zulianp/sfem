...
static SFEM_INLINE void navier_stokes_d2_simplex_mixed_jacobian_action_block(
    ...
    for (int q = 0; q < N_QP; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            const scalar_t residual_tmp4 = -p_direction;
            ...
            const scalar_t grad_coeff0_0 = residual_tmp4 + residual_tmp6*u0_direction_grad_0;
            ...
            const scalar_t grad_coeff1_1 = residual_tmp4 + residual_tmp6*u1_direction_grad_1;
