...
static SFEM_INLINE void navier_stokes_form_2_u_u_d2_simplex_residual_block(
        ...
        scalar_t *const SFEM_RESTRICT output[12]
) {
...
static SFEM_INLINE void navier_stokes_form_2_u_u_d2_simplex_residual_block_contiguous(
        ...
        const scalar_t *const SFEM_RESTRICT field_shape[1],
        const scalar_t *const SFEM_RESTRICT q_weight,
        scalar_t output[12][VECTOR_SIZE]
) {
    static constexpr int DIM = 2;
    static constexpr int N_FIELDS = 1;
    static constexpr int N_FIELD_STREAMS = 12;
...
static SFEM_INLINE void navier_stokes_form_2_u_u_d2_simplex_jacobian_action_block(
        ...
        const scalar_t *const SFEM_RESTRICT q_weight,
        const scalar_t *const SFEM_RESTRICT previous[12],
        const scalar_t *const SFEM_RESTRICT direction[12],
    ...
    for (int q = 0; q < N_QP; ++q) {
        ...
        for (int lane = 0; lane < nelems; ++lane) {
            ...
            const scalar_t residual_tmp3 = rho/dt;
            const scalar_t residual_tmp4 = nu*rho;
            const scalar_t residual_tmp5 = scalar_t(2)*residual_tmp4;
            const scalar_t residual_tmp6 = residual_tmp4*u0_direction_grad_1 + residual_tmp4*u1_direction_grad_0;
            const scalar_t value_coeff0 = residual_tmp1*u0_direction_grad_0 + residual_tmp2*u0_direction_grad_1 + residual_tmp3*u0_direction;
            const scalar_t grad_coeff0_0 = residual_tmp5*u0_direction_grad_0;
            const scalar_t grad_coeff0_1 = residual_tmp6;
            const scalar_t value_coeff1 = residual_tmp1*u1_direction_grad_0 + residual_tmp2*u1_direction_grad_1 + residual_tmp3*u1_direction;
            const scalar_t grad_coeff1_0 = residual_tmp6;
            const scalar_t grad_coeff1_1 = residual_tmp5*u1_direction_grad_1;
...
static SFEM_INLINE void navier_stokes_form_2_u_u_d2_simplex_jacobian_action_block_contiguous(
        ...
        const scalar_t *const SFEM_RESTRICT field_grad_ref[2],
        const scalar_t *const SFEM_RESTRICT q_weight,
        const scalar_t previous[12][VECTOR_SIZE],
        const scalar_t direction[12][VECTOR_SIZE],
        const scalar_t convection_scale,
        const scalar_t dt,
        const scalar_t nu,
        const scalar_t rho,
