...
namespace sfem {
    ...
    public:
         ...
         */
        virtual std::shared_ptr<Op> lor_op(const std::shared_ptr<FunctionSpace> &space) {
            return nullptr;
        }
         ...
         */
        virtual std::shared_ptr<Op> derefine_op(const std::shared_ptr<FunctionSpace> &space) {
            return nullptr;
        }
    ...
    public:
        ...
        int hessian_crs(const real_t *const /*x*/,
                        const count_t *const /*rowptr*/,
                        const idx_t *const /*colidx*/,
                        real_t *const /*values*/) override { return SFEM_SUCCESS; }
